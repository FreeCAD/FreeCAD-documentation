...
Addons from the <img alt="" src=images/Std_AddonMgr.svg  style="width:16px;"> [Addon Manager](Std_AddonMgr.md) offer yet another way to customize the user interface. Several dedicated [external workbenches](External_workbenches.md) and [Preference Packs](Preference_Packs.md) are available.
