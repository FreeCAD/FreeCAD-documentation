...
2.  There are several ways to invoke the command:
    -   Select the {{MenuCommand|View → Visibility → <img src="images/Std_ShowSelection.svg" width=16px> Show selection}} option from the menu.
    -   Select the {{MenuCommand|<img src="images/Std_ShowSelection.svg" width=16px> Show selection}} option from the Tree view context menu. This option is not available in the [PartDesign Workbench](PartDesign_Workbench.md).
