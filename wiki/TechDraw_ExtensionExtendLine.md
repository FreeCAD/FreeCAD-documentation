---
 GuiCommand:
   ...
   Shortcut: 
   Version: 0.20
   SeeAlso: TechDraw_ExtensionShortenLine
---
...
3.  There are several ways to invoke the tool:
    -   Press the **<img src="images/TechDraw_ExtensionExtendLine.svg" width=16px> [Extend Line](TechDraw_ExtensionExtendLine.md)** button.
