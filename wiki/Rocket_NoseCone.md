...
-   Parabolic series. This shape is constrained using a coefficient, as explained in the Wikipedia article.
 ...
 ![](images/NC_Parabolic_0.5_small.png )   ![](images/NC_Parabolic_1_small.png )  
...
-   Haack Series. This shape is constrained using a coefficient, as explained in the Wikipedia article.
 ...
 ![](images/NC_Haack_0.33_small.png )   ![](images/NC_Haack_2_small.png )  
...
Nose cones can be created with or without shoulders
 ![](images/NC_Ogive_small.png )   ![](images/NC_No_Shoulder_small.png )  
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [API]] and ](Category_API]] and .md) > [Addons](Category_Addons.md) > [External Workbenches](Category_External Workbenches.md) > Rocket NoseCone
