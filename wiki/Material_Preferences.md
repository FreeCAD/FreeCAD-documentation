...
The preferences for the <img alt="" src=images/Workbench_Material.svg  style="width:24px;"> [Material Workbench](Material_Workbench.md) can be found in the [Preferences Editor](Preferences_Editor.md). In the menu select **Edit → Preferences...** and then **<img src="images/Workbench_Material.svg" width=16px> Material**.

There are two pages: [General](#General.md) and [Default Material](#Default_Material.md).

## General

<img alt="General preferences" src=images/Preferences_Material_Page_General.png  style="width:350px;">
...
<img alt="Default Material preferences" src=images/Preferences_Material_Page_Default_Material.png  style="width:350px;">

### Default Material 

-   Material Selector: Specifies the material used by default in FreeCAD.

-    **Launch editor**: Opens the [Materials editor](Materials_Edit.md).



---
⏵ [documentation index](../README.md) > [Material](Material_Workbench.md) > Material Preferences
