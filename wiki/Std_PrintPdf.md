...
2.  Select the {{MenuCommand|File → <img src="images/Std_PrintPdf.svg" width=16px> Export PDF...}} option from the menu.
...
-   To create a PDF from a TechDraw page you can also use the {{MenuCommand|File → Export → Technical Drawing (*.svg *.dxf *.pdf)}} menu option. Or you can right-click the TechDraw page in the [Main view area](Main_view_area.md) and select {{MenuCommand|Export PDF}} from the context menu.
