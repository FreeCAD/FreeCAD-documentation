...
1.  Activate the <img alt="" src=images/Assembly_LockMover.svg  style="width:16px;"> **Lock mover** command using one of the following:
    -   The **<img src="images/Assembly_LockMover.svg_" width=16px> [Lock mover](Assembly3_LockMover.md)** button.
    -   The **Assembly3 → <img src="images/Assembly_LockMover.svg_" width=16px> Lock mover** menu option.
