...
3.  There are several ways to invoke the tool:
    -   Press the **<img src="images/TechDraw_ExtensionChangeLineAttributes.svg" width=16px> [Change Line Attributes](TechDraw_ExtensionChangeLineAttributes.md)** button.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw ExtensionChangeLineAttributes
