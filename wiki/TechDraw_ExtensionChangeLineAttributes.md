...
The <img alt="" src=images/TechDraw_ExtensionChangeLineAttributes.svg  style="width:24px;"> **TechDraw ExtensionChangeLineAttributes** tool changes the style, width and color of selected lines and center lines created with the [Extensions tools](TechDraw_Workbench#Extensions.md). But the tool can also be used to change cosmetic lines created with other [TechDraw](TechDraw_Workbench.md) tools.
...
---
[documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw ExtensionChangeLineAttributes
