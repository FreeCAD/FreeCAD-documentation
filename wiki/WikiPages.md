...
-   Use a sandbox to test your code, for example, [FreeCADDocu:Sandbox](FreeCADDocu_Sandbox.md) or a particular page with your name [Sandbox:Yourname](Sandbox_Yourname.md). Sandbox pages must be placed in the Sandbox category. This is done by adding [[<img src="images/Property.png" style="width:16px"> Sandbox]] at the bottom of the wiki code.
...
|                                                                                                  |                                                                                                                           |                                                                                                                                                                                                                                                                                                                           |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| [Softredirect](Template_Softredirect.md)                                                 |                                                                                                                              | Use it instead of the normal redirect, when you are redirecting to a special page (such as Media: or <img src="images/Property.png" style="width:16px"> ), in which cases the normal redirect is disabled.                                                                                                                                                          |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
---
[documentation index](../README.md) > [Documentation](Category_Documentation.md) > WikiPages
