...
1.  Select a B-spline knot, either:
    ...
    -   Use the menu {{MenuCommand|Sketch → Sketcher B-spline tools → <img src=images/Sketcher_BSplineIncreaseKnotMultiplicity.svg style="width:24px"> Increase knot multiplicity}}.
