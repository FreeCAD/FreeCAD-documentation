...
2.  Invoke the command either by   *
    -   Pressing the button **<img src="images/FEM_PostFilterDataAlongLine.svg" width=16px> [Line clip filter](FEM_PostFilterDataAlongLine.md)**.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [FEM](Category_FEM.md) > FEM PostFilterDataAlongLine
