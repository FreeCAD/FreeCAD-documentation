...
-   Improving _: implementing missing functions and improving CSG shell generation in special cases

_ _

---
[documentation index](../README.md) > [Roadmap](Category_Roadmap.md) > 0.20 Development Cycle
