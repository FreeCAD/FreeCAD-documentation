...
2.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Meshes → <img src="images/Mesh_Decimating.svg" width=16px> Decimation...}} option from the menu.
3.  The {{MenuCommand|Decimating}} task panel opens.
4.  Specify the {{MenuCommand|Reduction}}:
    ...
    -   In other cases:
        ...
        -   Specify the {{MenuCommand|tolerance}}.
