...
3.  Select the {{MenuCommand|Edit → Alignment...}} option from the menu.
...
7.  Right-click one of the views and select the {{MenuCommand|Align}} option from the context menu to complete the command.
