...
1.  Create an internal involute gear profile with the required number of grooves and adapt the values of pressure angle, addendum-, dedendum- and root fillet coefficient. See also the table in [#Notes](#Notes.md) below for feasible values. For example:
    1.  
        **External Gear**
    ...
    6.  
        **Root Fillet Coefficient**
        ...
        : 0.3
2.  Select the profile in the [Tree view](Tree_view.md).
3.  Press the **<img src="images/PartDesign_Pocket.svg" width=16px> '''Pocket'''** button.
4.  Set the pocket\'s **Type** to **Through All**
5.  Check the pocket\'s **Symmetric To Plane** option
6.  Click **OK**.
...
-   Tooth length reduction may be required to prevent undercut or to strengthen the teeth (cf. [stub teeth](https://khkgears.net/new/gear_knowledge/gear-nomenclature/stub-teeth.html)). For internal gears the addednum (here pointing inwards) may need shortening to avoid certain interferences or non-involute flanks; when indicated in combination with longer teeth of the pinion.

-   For splined shafts and hubs ISO 4156 defines the following parameters:

++++++
|                           | 30° (flat root) | 30° (fillet root) | 37,5° | 45°  |
| **Pressure Angle**          |                 |                   |       |      |
|                                       |                 |                   |       |      |
+==========================================+=================+===================+=======+======+
|                           | 0.5             | 0.5               | 0.45  | 0.4  |
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [PartDesign](PartDesign_Workbench.md) > PartDesign InvoluteGear
