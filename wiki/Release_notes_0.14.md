...
### Move to pyside, FreeCAD is now fully LGPL {#move_to_pyside_freecad_is_now_fully_lgpl}
...
### Plugins and side projects: Parts library, BOLTS, Eagle importer {#plugins_and_side_projects_parts_library_bolts_eagle_importer}
...
### Display style override {#display_style_override}
...
### 3D window anti-aliasing {#d_window_anti_aliasing}
...
### Part Primitives {#part_primitives}
...
### Automatic projections {#automatic_projections}
...
### New rendering tools {#new_rendering_tools}
...
### Luxrender support {#luxrender_support}
...
### DWG import/export {#dwg_importexport}
...
### Draft to Drawing works with groups {#draft_to_drawing_works_with_groups}
...
### Dimensions recoded {#dimensions_recoded}
...
### Upgrade and downgrade recoded {#upgrade_and_downgrade_recoded}
...
### Structure presets + profiles {#structure_presets_profiles}
...
### Multilayer walls {#multilayer_walls}
...
### Reinforcing bars {#reinforcing_bars}
...
### IFC import & export {#ifc_import_export}
