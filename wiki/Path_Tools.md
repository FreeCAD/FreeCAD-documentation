...
## Migrating from Legacy Tools {#migrating_from_legacy_tools}
...
## Getting Started with Tools in FC 0.19 {#getting_started_with_tools_in_fc_0.19}
...
### Verify or create a [Tool Shape](Path_ToolShape.md) {#verify_or_create_a_tool_shape}
...
#### Verify your desired [Tool Shape](Path_ToolShape.md) exists {#verify_your_desired_tool_shape_exists}
...
#### Create a new [Tool Shape](Path_ToolShape.md) {#create_a_new_tool_shape}
...
### Load or create a [ToolBit](Path_ToolBit.md) {#load_or_create_a_toolbit}

Once the desired tool shape(profile) exists, you need to create a [tool bit](Path_ToolBit.md) using the tool shape(profile).

1.  In the <img alt="" src=images/Workbench_Path.svg  style="width:24px;"> [Path Workbench](Path_Workbench.md) menu bar, navigate to {{MenuCommand|Path → Create Tool}}.
...
### Save the new [ToolBit](Path_ToolBit.md) {#save_the_new_toolbit}

1.  Locate and select the new tool bit in the object tree in the main FreeCAD window.
2.  In the <img alt="" src=images/Workbench_Path.svg  style="width:24px;"> [Path Workbench](Path_Workbench.md) menu bar, navigate to, and select, {{MenuCommand|Path → Save Tool as...}}.
3.  A pop-up window will appear.
4.  Navigate to the folder where you wish to save the new tool bit file.
5.  Enter a file name for the tool bit.
6.  Click the **Save** button.

### Register the [ToolBit](Path_ToolBit.md) in a [Tool Library](Path_ToolBit_Library.md) {#register_the_toolbit_in_a_tool_library}

1.  In the <img alt="" src=images/Workbench_Path.svg  style="width:24px;"> [Path Workbench](Path_Workbench.md) menu bar, navigate to {{MenuCommand|Path → Open ToolBit Library editor}}.
...
### Add a [ToolBit](Path_ToolBit.md) Tool Controller to a Job {#add_a_toolbit_tool_controller_to_a_job}
