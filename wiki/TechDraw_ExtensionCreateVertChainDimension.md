...
3.  There are several ways to invoke the tool:
    -   Press the **<img src="images/TechDraw_ExtensionCreateVertChainDimension.svg" width=16px> [Create Vertical Chain Dimensions](TechDraw_ExtensionCreateVertChainDimension.md)** button.
