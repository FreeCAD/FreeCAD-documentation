...
### Standards for communication {#standards_for_communication}
...
### Middleware for comunication {#middleware_for_comunication}
...
### Commercial products in that field {#commercial_products_in_that_field}
