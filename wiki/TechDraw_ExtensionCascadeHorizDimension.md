...
- GuiCommand:
   ...
   MenuLocation:TechDraw → Extensions: Attributes/Modifications → Space horizontal dimensions
...
2.  Select the first horizontal dimension. This dimension will not be moved, the dimensions that are added to the selection will be positioned relative to this dimension.
3.  Add one or more horizontal dimensions in the correct order to the selection.
4.  There are several ways to invoke the tool:
    ...
    -   Select the **TechDraw → Extensions: Attributes/Modifications → <img src="images/TechDraw_ExtensionCascadeHorizDimension.svg" width=16px> Space horizontal dimensions** option from the menu.
