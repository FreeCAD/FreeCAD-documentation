...
near the top of the file OpenCASCADEConfig.cmake, change the second of the following two lines to use REAL\_PATH(). This fixes a bug introduced by the use of a symlink from /lib to /usr/lib of Fedora, causing cmake to fail.

This file is usually installed in /usr/lib64/cmake/opencascade/OpenCASCADEConfig.cmake

get\_filename\_component (OpenCASCADE\_INSTALL\_PREFIX \"\${OpenCASCADE\_INSTALL\_PREFIX}\" PATH)

change this to    *

file (REAL\_PATH \${OpenCASCADE\_INSTALL\_PREFIX} OpenCASCADE\_INSTALL\_PREFIX)
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Developer_Documentation](Category_Developer_Documentation.md) > [Developer](Category_Developer.md) > Compile on Linux
