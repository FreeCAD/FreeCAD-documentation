...
2.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Modification → Array tools → <img src="images/Draft_OrthoArray.svg" width=16px> Array}} option from the menu.
3.  The {{MenuCommand|Orthogonal array}} task panel opens. See [Options](#Options.md) for more information.
