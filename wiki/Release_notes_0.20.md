...
-   Support for linear buckling analyses was added for the solver [Calculix](FEM_SolverCalculixCxxtools.md). [Pull request \#4379](https://github.com/FreeCAD/FreeCAD/pull/4379)
...
-   When meshing using the solver [Calculix](FEM_SolverCalculixCxxtools.md), now all CPU kernels will be used by it. [Pull request \#6374](https://github.com/FreeCAD/FreeCAD/pull/6374)
-   When meshing using [Gmsh](FEM_MeshGmshFromShape.md), now all CPU kernels will be used to generate the mesh. [Pull request \#6370](https://github.com/FreeCAD/FreeCAD/pull/6370)
...
-   It is possible to offset the position of [SubShapeBinders](PartDesign_SubShapeBinder.md). [Pull request \#6338](https://github.com/FreeCAD/FreeCAD/pull/6338)
-   [SubShapeBinders](PartDesign_SubShapeBinder.md) have now the *Refine* property like all other PartDesign objects. [Pull request \#6550](https://github.com/FreeCAD/FreeCAD/pull/6550)
