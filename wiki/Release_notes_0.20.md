...
**Note:** Only bug reports with prior forum discussions will be considered. Reports without this will be closed.

### freecad.org

We are happy that the project [KiCAD](https://www.kicad.org/) sponsored us the domain freecad.org. Now all FreeCAD websites are available under [freecadweb.org](https://freecadweb.org) and [freecad.org](https://freecad.org).
...
|                                                                                          |                                                                                                                                                  |
|                                                                                          | In the image the *Hole001* object was selected and then                                                                                          |
|                                                                                          | its dependencies were added to the selection via the context menu.                                                                               |
+++

+++
| <img alt="" src=images/Part_SectionCut_example.png  style="width:200px;"> | The new tool **[Section Cut](Part_SectionCut.md)** allows to get non-hollow and also persistent cuts of parts and assemblies.             |
...
## Sketcher Workbench 
  ...
  <img alt="" src=images/SketcherBSplineInsertKnot_relnotes_0.20.gif  style="width:384px;">                             New <img alt="" src=images/Sketcher_BSplineInsertKnot.svg  style="width:24px;"> [Insert Knot](Sketcher_BSplineInsertKnot.md) tool to insert a knot in an existing B-spline. [Pull request \#5311](https://github.com/FreeCAD/FreeCAD/pull/5311) [Pull request \#6356](https://github.com/FreeCAD/FreeCAD/pull/6356)
...
-   The new *%w* format specifier was made the default one and format specifier preference was moved from Advanced tab to Dimension tab. [Pull request \#6504](https://github.com/FreeCAD/FreeCAD/pull/6504).
...
-   There is a new option to show a grid in a [page](TechDraw_PageDefault.md). The grid spacing can be adjusted. If the grid is by default shown can be set in the [preferences](TechDraw_Preferences#Grid.md). [Pull request \#6465](https://github.com/FreeCAD/FreeCAD/pull/6465).
