...
3.  There are several ways to invoke the tool:
    -   Press the **<img src="images/TechDraw_ExtensionPosVertChainDimension.svg" width=16px> [Position Vertical Chain Dimensions](TechDraw_ExtensionPosVertChainDimension.md)** button.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw ExtensionPosVertChainDimension
