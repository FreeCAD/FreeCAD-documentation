...
### Installing on Mac OS {#installing_on_mac_os}
...
### Setting basic preferences {#setting_basic_preferences}
...
### Installing additional content {#installing_additional_content}
