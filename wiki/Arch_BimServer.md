...
{{VeryImportantMessage|Starting from FreeCAD v0.17, this tool has been removed from the Arch Workbench and is now part of the external [WebTools Workbench](WebTools_Workbench.md) that you can install via menu Tools → <img src="images/AddonManager.svg" width=24px> [Addon manager](Addon_manager.md).
}}
...
2.  Select menu {{MenuCommand|Web Tools → <img src="images/WebTools_BimServer.svg" width=16px> [BIM Server](WebTools_BimServer.md)}}
...
### Downloading revisions {#downloading_revisions}
...
### Uploading revisions {#uploading_revisions}
