...
#### <img src="images/BIM_Column.svg" style="width:16px;"> getBadEdges
...
#### <img src="images/BIM_Column.svg" style="width:16px;"> getFreeEdges
...
---
![](images/Button_right.png) [documentation index](../README.md) > [API](Category_API.md) > Shell API
