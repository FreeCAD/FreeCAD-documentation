...
**The icon for the toolBar**  ![Macro_FCConvertLines](images/Macro_FCConvertLines.png ) 
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro FC Convert Lines
