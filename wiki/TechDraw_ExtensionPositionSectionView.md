...
- GuiCommand:
   ...
   MenuLocation:TechDraw → Extensions: Attributes/Modifications → Align section view
...
*On the right a horizontally aligned section view*
...
2.  There are several ways to invoke the tool:
    ...
    -   Select the **TechDraw → Extensions: Attributes/Modifications → <img src="images/TechDraw_ExtensionPositionSectionView.svg" width=16px> Align section view** option from the menu.
...
---
[documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw ExtensionPositionSectionView
