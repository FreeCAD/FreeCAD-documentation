# <img alt="Std Base icon" src=images/Freecad.svg  style="width:64px;"> Std Macro Menu
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Std Macro Menu
