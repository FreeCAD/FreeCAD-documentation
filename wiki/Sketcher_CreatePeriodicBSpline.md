...
3.  
    <small>(v0.20)</small> (Optionally) Press \"D\" before terminating the input to define the degree of the B-Spline.

4.  
    <small>(v0.20)</small> (Optionally) Press \"Backspace\" before terminating the input to delete the last created control point.
