...
The mirror result can be previewed in real time before clicking  
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [PartDesign](PartDesign_Workbench.md) > PartDesign Mirrored
