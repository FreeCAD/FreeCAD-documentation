...
This page will discuss the strategic objectives for the [CAM Workbench](CAM_Workbench.md). This shouldn\'t be a list of features to implement but broader objectives that will steer the overall direction of CAM development.
...
---
⏵ [documentation index](../README.md) > [Roadmap](Category_Roadmap.md) > [CAM](CAM_Workbench.md) > CAM Development Roadmap
