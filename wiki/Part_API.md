...
#### <img src="images/Type_enum.svg" style="max-width:24px;">Arc

Describes a portion of a curve



#### <img src="images/Type_enum.svg" style="max-width:24px;">ArcOfCircle

Describes a portion of a circle



#### <img src="images/Type_enum.svg" style="max-width:24px;">ArcOfConic

Describes a portion of a conic



#### <img src="images/Type_enum.svg" style="max-width:24px;">ArcOfEllipse

Describes a portion of an ellipse



#### <img src="images/Type_enum.svg" style="max-width:24px;">ArcOfHyperbola

Describes a portion of an hyperbola



#### <img src="images/Type_enum.svg" style="max-width:24px;">ArcOfParabola

Describes a portion of an parabola



#### <img src="images/Type_enum.svg" style="max-width:24px;">AttachEngine

AttachEngine abstract class - the functionality of AttachableObject, but outside of DocumentObject



#### <img src="images/type_module.svg" style="max-width:24px;">BRepFeat

This is a module working with the BRepFeat package.



#### <img src="images/type_module.svg" style="max-width:24px;">BRepOffsetAPI

This is a module working with the BRepOffsetAPI package.



#### <img src="images/Type_enum.svg" style="max-width:24px;">BSplineCurve

Describes a B-Spline curve in 3D space



#### <img src="images/Type_enum.svg" style="max-width:24px;">BSplineSurface

Describes a B-Spline surface in 3D space



#### <img src="images/Type_enum.svg" style="max-width:24px;">BezierCurve
...
#### <img src="images/Type_enum.svg" style="max-width:24px;">BezierSurface
...
#### <img src="images/Type_enum.svg" style="max-width:24px;">BodyBase

Base class of all Body objects



#### <img src="images/Type_enum.svg" style="max-width:24px;">Circle
...
#### <img src="images/Type_enum.svg" style="max-width:24px;">CompSolid

TopoShapeCompSolid is the OpenCasCade topological compound solid wrapper



#### <img src="images/Type_enum.svg" style="max-width:24px;">Compound

Create a compound out of a list of shapes



#### <img src="images/Type_enum.svg" style="max-width:24px;">Cone
...
#### <img src="images/Type_enum.svg" style="max-width:24px;">Conic

Describes an abstract conic in 3d space



#### <img src="images/Type_enum.svg" style="max-width:24px;">Cylinder
...
#### <img src="images/Type_enum.svg" style="max-width:24px;">Ellipse
...
#### <img src="images/Type_enum.svg" style="max-width:24px;">Face
...
#### <img src="images/type_module.svg" style="max-width:24px;">Geom2d

This is a module working with 2d geometries.



#### <img src="images/type_module.svg" style="max-width:24px;">GeomPlate

This is a module working with the GeomPlate framework.



#### <img src="images/Type_enum.svg" style="max-width:24px;">GeometryBoolExtension

A GeometryExtension extending geometry objects with a boolean.



#### <img src="images/Type_enum.svg" style="max-width:24px;">GeometryDoubleExtension

A GeometryExtension extending geometry objects with a double.



#### <img src="images/Type_enum.svg" style="max-width:24px;">GeometryIntExtension

A GeometryExtension extending geometry objects with an int.



#### <img src="images/Type_enum.svg" style="max-width:24px;">GeometryStringExtension
...
#### <img src="images/Type_enum.svg" style="max-width:24px;">Line
...
#### <img src="images/Type_enum.svg" style="max-width:24px;">LineSegment
...
#### <img src="images/Type_enum.svg" style="max-width:24px;">OCCConstructionError





#### <img src="images/Type_enum.svg" style="max-width:24px;">OCCDimensionError





#### <img src="images/Type_enum.svg" style="max-width:24px;">OCCDomainError





#### <img src="images/Type_enum.svg" style="max-width:24px;">OCCError





#### <img src="images/Type_enum.svg" style="max-width:24px;">OCCRangeError





#### <img src="images/Type_enum.svg" style="max-width:24px;">OCC_VERSION
...
#### <img src="images/Type_enum.svg" style="max-width:24px;">OffsetCurve





#### <img src="images/Type_enum.svg" style="max-width:24px;">OffsetSurface





#### <img src="images/Type_enum.svg" style="max-width:24px;">Parabola

Describes a parabola in 3D space



#### <img src="images/Type_enum.svg" style="max-width:24px;">Part2DObject

This object represents a 2D Shape in a 3D World



#### <img src="images/Type_enum.svg" style="max-width:24px;">Plane
...
#### <img src="images/Type_enum.svg" style="max-width:24px;">PlateSurface





#### <img src="images/Type_enum.svg" style="max-width:24px;">Point
...
#### <img src="images/Type_enum.svg" style="max-width:24px;">RectangularTrimmedSurface
...
#### <img src="images/Type_enum.svg" style="max-width:24px;">Shape
...
#### <img src="images/type_module.svg" style="max-width:24px;">ShapeUpgrade

This is a module working with the ShapeUpgrade framework.



#### <img src="images/Type_enum.svg" style="max-width:24px;">Shell

Create a shell out of a list of faces



#### <img src="images/Type_enum.svg" style="max-width:24px;">Solid

Part.Solid(shape): Create a solid out of shells of shape. If shape is a compsolid, the overall volume solid is created.



#### <img src="images/Type_enum.svg" style="max-width:24px;">Sphere

Describes a sphere in 3D space



#### <img src="images/Type_enum.svg" style="max-width:24px;">SurfaceOfExtrusion

Describes a surface of linear extrusion



#### <img src="images/Type_enum.svg" style="max-width:24px;">SurfaceOfRevolution

Describes a surface of revolution



#### <img src="images/Type_enum.svg" style="max-width:24px;">Toroid

Describes a toroid in 3D space



#### <img src="images/Type_enum.svg" style="max-width:24px;">Vertex

TopoShapeVertex is the OpenCasCade topological vertex wrapper



#### <img src="images/Type_enum.svg" style="max-width:24px;">Wire

TopoShapeWire is the OpenCasCade topological wire wrapper



#### <img src="images/type_method.svg" style="max-width:24px;">cast_to_shape

cast_to_shape(shape) -- Cast to the actual shape type



#### <img src="images/type_method.svg" style="max-width:24px;">clearShapeCache
...
#### <img src="images/type_method.svg" style="max-width:24px;">exportUnits

exportUnits([string=MM|M|INCH|FT|MI|KM|MIL|UM|CM|UIN]) -- Set units for exporting STEP/IGES files and returns the units.



#### <img src="images/type_method.svg" style="max-width:24px;">getFacets

getFacets(shape): simplified mesh generation



#### <img src="images/type_method.svg" style="max-width:24px;">getShape
...
#### <img src="images/type_method.svg" style="max-width:24px;">getSortedClusters
...
#### <img src="images/type_method.svg" style="max-width:24px;">joinSubname
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeBox
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeCircle
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeCompound

makeCompound(list) -- Create a compound out of a list of shapes.



#### <img src="images/type_method.svg" style="max-width:24px;">makeCone
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeCylinder
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeFace
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeFilledFace

makeFilledFace(list) -- Create a face out of a list of edges.



#### <img src="images/type_method.svg" style="max-width:24px;">makeHelix
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeLine
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeLoft

makeLoft(list of wires,[solid=False,ruled=False,closed=False,maxDegree=5]) -- Create a loft shape.



#### <img src="images/type_method.svg" style="max-width:24px;">makeLongHelix
...
#### <img src="images/type_method.svg" style="max-width:24px;">makePlane
...
#### <img src="images/type_method.svg" style="max-width:24px;">makePolygon
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeRevolution
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeRuledSurface
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeShell

makeShell(list) -- Create a shell out of a list of faces.



#### <img src="images/type_method.svg" style="max-width:24px;">makeShellFromWires
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeSolid

makeSolid(shape): Create a solid out of shells of shape. If shape is a compsolid, the overall volume solid is created.



#### <img src="images/type_method.svg" style="max-width:24px;">makeSphere
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeSplitShape
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeSweepSurface

makeSweepSurface(edge(path),edge(profile),[float]) -- Create a profile along a path.



#### <img src="images/type_method.svg" style="max-width:24px;">makeThread

makeThread(pitch,depth,height,radius) -- Make a thread with a given pitch, depth, height and radius



#### <img src="images/type_method.svg" style="max-width:24px;">makeTorus
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeTube
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeWedge
...
#### <img src="images/type_method.svg" style="max-width:24px;">makeWireString
...
#### <img src="images/type_method.svg" style="max-width:24px;">setStaticValue
...
#### <img src="images/type_method.svg" style="max-width:24px;">sortEdges
...
#### <img src="images/type_method.svg" style="max-width:24px;">splitSubname
...
---
[documentation index](../README.md) > [API](Category_API.md) > [Part](Part_Workbench.md) > Part API
