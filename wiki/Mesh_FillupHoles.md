...
2.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Meshes → <img src="images/Mesh_FillupHoles.svg" width=16px> Fill holes...}} option from the menu.
3.  The {{MenuCommand|Fill holes}} dialog box opens.
4.  Specify the {{MenuCommand|Fill holes with maximum number of edges}} value.
