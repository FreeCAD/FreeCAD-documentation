...
### Official GitHub repository {#official_github_repository}
...
### Setting your Git username {#setting_your_git_username}
...
#### 2nd Method: Clone FreeCAD directly to your local machine {#nd_method_clone_freecad_directly_to_your_local_machine}
...
## Git development process {#git_development_process}
...
## Adding other repositories (remotes) {#adding_other_repositories_remotes}
...
```python
git branch -a
``` Now, lets view a summarized list of the last 10 commits of bernd\'s  
```python
