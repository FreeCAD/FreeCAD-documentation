# <img alt="Plot workbench icon" src=images/Workbench_Plot.svg  style="width:64px;"> Plot Module/id
...
---
[documentation index](../README.md) > [External_Workbenches](Category:External_Workbenches.md) > Plot Module/id
