# Python scripting tutorial/id
{{TOCright}}

## Introduction

_, or from custom scripts, you can control FreeCAD and make it perform very complex operations.
...
---
[documentation index](../README.md) > [Developer Documentation](Category_Developer Documentation.md) > Python scripting tutorial/id
