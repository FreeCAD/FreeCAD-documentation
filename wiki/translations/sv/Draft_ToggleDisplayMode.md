...
2.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Utilities → <img src="images/Draft_ToggleDisplayMode.svg" width=16px> Toggle normal/wireframe display}} option from the menu.
    -   Select the {{MenuCommand|Utilities → <img src="images/Draft_ToggleDisplayMode.svg" width=16px> Toggle normal/wireframe display}} option from the [Tree view](Tree_view.md) or [3D view](3D_view.md) context menu.
