...
-   Skriv in siffror för att [mata in en koordinat manuellt](Draft_Coordinates.md)
-   Om du trycker ned **ESC** så kommer operationen att avbrytas.
-   Den nyss skapade tråden kommer att anta gällande [linjestil](Draft_Linestyle/sv.md).
