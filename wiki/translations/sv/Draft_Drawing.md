...
detta verktyg tillåter dig att lägga valda objekt på ett svg [ritningsark](Drawing_Workbench/sv.md).
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft Drawing/sv
