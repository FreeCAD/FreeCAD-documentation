...
Detta verktyg ber användaren om flera punkter och ritar en tråd (linje som är gjord av flera segment, eller polyline) mellan dem. Den skapade tråden kommer att ha nuvarande färg och linjebredd. Punkterna kan väljas med musen i 3d vyn eller genom att mata in koordinater med tangentbordet.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft Wire/sv
