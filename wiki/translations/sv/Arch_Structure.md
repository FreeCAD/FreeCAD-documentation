...
- GuiCommand:
   ...
   Shortcut:**S** **T**
   SeeAlso:[Arch Wall](Arch_Wall/sv.md) [Arch Rebar/sv](Arch_Rebar/sv.md)
---
...
{{docnav/sv|[Wall/sv](Arch_Wall/sv.md)|[Arch CompRebarStraight/sv](Arch_CompRebarStraight/sv.md)|[Arch](Arch_Workbench/sv.md)|IconC=Workbench_Arch.svg|IconL=Arch_Wall.png|IconR=Arch CompRebarStraight.png}}
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Arch](Arch_Workbench.md) > Arch Structure/sv
