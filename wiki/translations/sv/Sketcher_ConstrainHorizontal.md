...
- GuiCommand:
   ...
   SeeAlso:[Constraint Vertical](Sketcher_ConstrainVertical/sv.md)
---
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher ConstrainHorizontal/sv
