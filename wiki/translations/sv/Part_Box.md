# Part Box/sv
---
- GuiCommand:/sv   Name:Part Box   MenuLocation:Part → Box   |Workbenches:[SeeAlso:[[Part_CreatePrimitives|Part CreatePrimitives](Part_Workbench___Part]],_Complete.md)---
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Part](Part_Workbench.md) > Part Box/sv
