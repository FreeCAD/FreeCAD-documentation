...
|Translate=ArrayCopy
|Description=Detta makro kopierar det valda objektet flera gånger, på ett matris
|Author=Yorik
|Version=1.0
|Date=2014-05-04
|FCVersion=All
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro ArrayCopy/sv
