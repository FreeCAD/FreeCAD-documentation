...
1.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Drafting → <img src="images/Draft_Point.svg" width=16px> Point}} option from the menu.
2.  The {{MenuCommand|Point}} task panel opens. See [Options](#Options.md) for more information.
...
-   Press **T** or click the {{MenuCommand|Continue}} checkbox to toggle continue mode. If continue mode is on, the command will restart after finishing, allowing you to continue creating points.
