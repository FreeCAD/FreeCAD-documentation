...
FreeCAD manualen är ett pågående arbete av communityn för att få förstklassig dokumentation om hur man använder FreeCAD, och den finns redan på några språk. den saknar fortfarande mycket information, så känn dig fri att gå med och [bidra](Help_FreeCAD/sv.md)!
...
## Om utvecklingen {#om_utvecklingen}
