---
 TutorialInfo:v   Class: Programming   Level: Medium programmer   Time: 15 minutes   FCVersion: All   Author: User:Mario52
---
...
---
⏵ [documentation index](../README.md) > [Developer Documentation](Category_Developer%20Documentation.md) > [Python Code](Category_Python%20Code.md) > How to install macros/sv
