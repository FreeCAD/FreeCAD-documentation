...
-   <img alt="" src=images/Part_Box.svg  style="width:32px;"> [Låda](Part_Box/sv.md): Ritar en låda genom att ge dess dimensioner

-   <img alt="" src=images/Part_Cylinder.svg  style="width:32px;"> [Cylinder](Part_Cylinder/sv.md): Ritar en cylinder genom att ge dess dimensioner

-   <img alt="" src=images/Part_Sphere.svg  style="width:32px;"> [Sfär](Part_Sphere/sv.md): Ritar en sfär genom att ge dess dimensioner

-   <img alt="" src=images/Part_Cone.svg  style="width:32px;"> [Kon](Part_Cone/sv.md): Ritar en kon genom att ge dess dimensioner

-   <img alt="" src=images/Part_Torus.svg  style="width:32px;"> [Torus](Part_Torus/sv.md): Ritar en torus (ring) genom att ge dess dimensioner
...
-   <img alt="" src=images/Part_Primitives.svg  style="width:32px;"> [Create primitives\...](Part_Primitives/sv.md): Ett verktyg för att skapa olika parametriska geometriska primitiver:
...
-   <img alt="" src=images/Part_Shapebuilder.svg  style="width:32px;"> [Shapebuilder](Part_Shapebuilder/sv.md): Ett verktyg för att skapa mer komplexa former från olika parametriska geometriska primitiver
...
-   <img alt="" src=images/Part_Extrude.svg  style="width:32px;"> [Extrudera](Part_Extrude/sv.md): Extruderar plana ytor på ett objekt

-   <img alt="" src=images/Part_Revolve.svg  style="width:32px;"> [Rotera](Part_Revolve/sv.md): Skapar ett objekt genom att rotera ett annat objekt runt en axel

-   <img alt="" src=images/Part_Mirror.svg  style="width:32px;"> [Spegling](Part_Mirror/sv.md): Speglar de valda objekten runt en given axel
...
-   <img alt="" src=images/Part_Fillet.svg  style="width:32px;"> [Fasning](Part_Fillet/sv.md): Fasar (rundar) kanterna på ett objekt

-   <img alt="" src=images/Part_Chamfer.svg  style="width:32px;"> [Fasning](Part_Chamfer/sv.md): Fasar (klipper) kanter på ett objekt
...
-   <img alt="" src=images/Part_RuledSurface.svg  style="width:32px;"> [Ruled Surface](Part_RuledSurface/sv.md):

-   <img alt="" src=images/Part_Loft.svg  style="width:32px;"> [Loft](Part_Loft/sv.md): Lofts från en profil till en annan

-   <img alt="" src=images/Part_Sweep.svg  style="width:32px;"> [Sweep](Part_Sweep/sv.md): Sopa en eller flera profiler längs en bana
...
---
⏵ [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [Part](Category_Part.md) > Part Workbench/sv
