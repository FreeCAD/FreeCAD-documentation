...
---
- GuiCommand:/sv   Name:Sketcher CreatePolyline   Name/sv:Sketcher CreatePolyline   Workbenches:[MenuLocation:Sketch → Sketcher geometries → Create polyline   SeeAlso:[[Sketcher CreateLine/sv|Sketcher Line](Sketcher_Workbench/sv___Sketcher]].md)---
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher CreatePolyline/sv
