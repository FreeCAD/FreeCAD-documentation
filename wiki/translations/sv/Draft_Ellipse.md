...
1.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Drafting → <img src="images/Draft_Ellipse.svg" width=16px> Ellipse}} option from the menu.
    -   Use the keyboard shortcut: **E** then **L**.
2.  The {{MenuCommand|Ellipse}} task panel opens. See [Options](#Options.md) for more information.
...
-   Press **L** or click the {{MenuCommand|Filled}} checkbox to toggle filled mode. If filled mode is on, the created ellipse will have **Make Face** set to `True` and will have a filled face.
-   Press **T** or click the {{MenuCommand|Continue}} checkbox to toggle continue mode. If continue mode is on, the command will restart after finishing, allowing you to continue creating ellipses.
