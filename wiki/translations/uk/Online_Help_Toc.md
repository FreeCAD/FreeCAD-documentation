...
-   -   [Розпочати](Getting_started/uk.md)
    -   [Навігація в 3D-просторі](Mouse_Model/uk.md)
    -   [Структура документа FreeCAD](Document_structure/uk.md)
    -   [Налаштуваня параметрів користувача](Preferences_Editor/uk.md)
    -   [Налаштування інтерфейсу](Interface_Customization/uk.md)
    -   [Властивості об'єктів](Property_editor/uk.md)
    -   [Робота з автоматизованими робочими просторами](Workbenches/uk.md)
    -   [Робочий простір PartDesign](PartDesign_Workbench/uk.md)
    -   [Робочий простір Mesh](Mesh_Workbench/uk.md)
    -   [Робочий простір Part](Part_Workbench/uk.md)
    -   [Робочий простір Drawing](Drawing_Workbench/uk.md)
    -   [Робочий простір Raytracing](Raytracing_Workbench/uk.md)
    -   [Робочий простір Image](Image_Workbench/uk.md)
    -   [Робочий простір Draft](Draft_Workbench/uk.md)
    -   [Архітектурний робочий простір ](Arch_Workbench/uk.md)
    -   [Робочий простір Robot](Robot_Workbench/uk.md)
    -   [Стандартні меню та команди FreeCAD](Standard_Menu/uk.md)
    -   [Перелік всіх команд FreeCAD](List_of_Commands/uk.md)
    -   [Посібники](Tutorials/uk.md)
...
[<img src="images/Property.png" style="width:16px"> Documentation/uk](<img src="images/Property.png" style="width:16px"> Documentation/uk.md) [<img src="images/Property.png" style="width:16px"> Documentation](Category_Documentation.md)

---
[documentation index](../README.md) > [Documentation](Category_Documentation.md) > Online Help Toc/uk
