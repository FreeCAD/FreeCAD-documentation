---
- TutorialInfo:   Topic:Моделювання
   Level:Початківець
   ...
   Time:1 година
   FCVersion:0.19 або вище
   SeeAlso:[Туторіал з проектування базової деталі](Basic_Part_Design_Tutorial.md)
---

# Basic Part Design Tutorial 019/uk
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [PartDesign](Category_PartDesign.md) > [Sketcher](Category_Sketcher.md) > Basic Part Design Tutorial 019/uk
