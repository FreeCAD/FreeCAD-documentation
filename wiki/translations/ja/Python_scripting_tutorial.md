...
-   外部スクリプト。より複雑なプログラムに使用できます。例えば[ワークベンチ](Workbenches/jp.md)全体といったものです。
...
---
⏵ [documentation index](../README.md) > [Developer Documentation](Category_Developer%20Documentation.md) > [Python Code](Category_Python%20Code.md) > Python scripting tutorial/ja
