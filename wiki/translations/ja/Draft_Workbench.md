# <img alt="Draft workbench icon" src=images/Workbench_Draft.svg  style="width:64px;"> Draft Workbench/ja
...
-   製図モジュールには専用の[環境設定](Draft_Preferences.md)ドラフトワークベンチで利用可能な設定。
...
製図モジュール機能には完全な[製図用API](Draft_API/jp.md)があり、スクリプトやマクロからその機能を使用することができます
...
---
⏵ [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [Draft](Category_Draft.md) > Draft Workbench/ja
