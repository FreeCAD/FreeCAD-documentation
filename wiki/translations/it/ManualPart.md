...
-   Parte prima: [ Ambiente Parte](ManualPart/it#Ambiente_Parte.md)
-   Parte seconda: [Strumenti dell\'ambiente Parte per creare primitive](ManualPart/it#Ambiente_Parte:_Creare_oggetti_primitivi.md)
-   Parte terza: [Strumenti dell\'ambiente Parte per modificare gli oggetti](ManualPart/it#Ambiente_Parte:_Modificare_gli_oggetti.md)
-   Parte quarta: [Altri strumenti e strumenti non documentati](ManualPart/it#Ambiente_Parte:_Altri_strumenti_e_strumenti_non_documentati.md)
...
{{:Part_Shapebuilder/it|Crea forma}}
...
{{:Part_RefineShape/it|Pulisci forma}}
...
-   [Importa CAD](Part_ImportCAD/it.md)
-   [Esporta CAD](Part_ExportCAD/it.md)
-   [Crea forma da mesh](Part_ShapeFromMesh/it.md)
-   [Converti in solido](Part_ConvertToSolid/it.md)
-   [Inverti forme](Part_ReverseShapes/it.md)
