...
La traduzione del sito Web di FreeCAD è ora fatta tramite [Crowdin](https://crowdin.com/translate/freecad/561/en-en). Il file si chiama **homepage.po**.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Developer Documentation](Category_Developer Documentation.md) > [Wiki](Category_Wiki.md) > Localisation/it
