# <img alt="Fasteners Workbench icon" src=images/Fasteners_workbench_icon.svg  style="width:64px;"> Fasteners Workbench/it
...
The <img alt="" src=images/Fasteners_workbench_icon.svg  style="width:24px;"> [Fasteners Workbench](Fasteners_Workbench.md) is an [external workbench](External_workbenches.md) that can add/attach various fasteners to parts.
...
For a detailed description see <http://theseger.com/projects/2015/06/fasteners-workbench-for-freecad/>.
...
---
[documentation index](../README.md) > [Addons](Category_Addons.md) > Fasteners Workbench/it
