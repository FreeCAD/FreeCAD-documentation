...
Lo strumento <img alt="" src=images/Surface_GeomFillSurface.svg  style="width:16px;"> [Surface GeomFillSurface](Surface_GeomFillSurface/it.md) crea una superficie da due, tre o quattro bordi, cercando di creare una transizione graduale tra di loro.
...
{{PropertyData/it|Fill Type}}

: L\'algoritmo di riempimento applicato
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Surface](Surface_Workbench.md) > Surface GeomFillSurface/it
