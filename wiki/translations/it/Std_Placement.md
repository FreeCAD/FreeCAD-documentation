...
1.  Selezionare un singolo oggetto che ha una proprietà **Placement**.
2.  Selezionare l\'opzione **Modifica → <img src="images/Std_Placement.svg" width=16px> Posizionamento...** dal menu.
...
La finestra di dialogo può essere avviata anche facendo clic sul pulsante con i puntini di sospensione **...** che appare nell\'[Editor delle proprietà](Property_editor/it.md) quando si fa clic sulla proprietà **Placement**.
