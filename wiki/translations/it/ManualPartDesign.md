...
-   Parte seconda: [Ambiente PartDesign: Strumenti di costruzione](ManualPartDesign/it#Ambiente_PartDesign:_Strumenti_di_costruzione.md)
-   Parte terza: [Ambiente PartDesign: Strumenti di modifica](ManualPartDesign/it#Ambiente_PartDesign:_Strumenti_di_modifica.md)
-   Parte quarta: [Ambiente PartDesign: Strumenti di trasformazione](ManualPartDesign/it#Ambiente_PartDesign:_Strumenti_di_trasformazione.md)
-   Parte quinta: [Altri strumenti e strumenti non documentati](ManualPartDesign/it#Ambiente_PartDesign:_Altri_strumenti_e_strumenti_non_documentati.md)
...
[Gli strumenti di Sketcher](ManualSketcher/it.md) per creare e gestire gli schizzi di base.
