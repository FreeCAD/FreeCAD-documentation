...
1.  Esistono diversi modi per invocare il comando:
    ...
    -   Nel menu contestuale [Vista 3D](3D_view/it.md) andare in {{MenuCommand|Stile di disegno}} e selezionare uno stile.
    -   Usare una delle scorciatoie da tastiera: **V** e poi **1**, **2**, **3**, **4**, **5**, **6** o **7**.

## Stili di disegno disponibili {#stili_di_disegno_disponibili}

### <img alt="" src=images/Std_DrawStyleAsIs.svg  style="width:32px;"> Come è {#std_drawstyleasis.svg_come_è}
...
### <img alt="" src=images/Std_DrawStylePoints.svg  style="width:32px;"> Punti {#std_drawstylepoints.svg_punti}
...
### <img alt="" src=images/Std_DrawStyleWireFrame.svg  style="width:32px;"> Reticolo {#std_drawstylewireframe.svg_reticolo}
...
### <img alt="" src=images/Std_DrawStyleHiddenLine.svg  style="width:32px;"> Linee nascoste {#std_drawstylehiddenline.svg_linee_nascoste}
...
### <img alt="" src=images/Std_DrawStyleNoShading.svg  style="width:32px;"> Senza ombre {#std_drawstylenoshading.svg_senza_ombre}
...
### <img alt="" src=images/Std_DrawStyleShaded.svg  style="width:32px;"> Ombreggiato {#std_drawstyleshaded.svg_ombreggiato}
...
### <img alt="" src=images/Std_DrawStyleFlatLines.svg  style="width:32px;"> Facce piene {#std_drawstyleflatlines.svg_facce_piene}
