...
1.  Assicurarsi di avere un link all\'interno di un contenitore, ad esempio, un link a una **<img src=images/Part_Sphere.svg style="width:16px"> <img src=images/Std_Part.svg style="width:sfera](Part_Sphere/it.md)** all\'interno di una **[16px"> [Parte](Std_Part/it.md)**.
...
L\'originale <img alt="" src=images/Tree_Part_Sphere_Parametric.svg  style="width:16px;"> <img src=images/Std_Part.svg style="width:Sfera](Part_Sphere/it.md) deve ora essere dentro **[16px"> [Parte](Std_Part/it.md)**, e il Link deve essere fuori. Ora questo collegamento può essere cancellato se non è più necessario, e non rovinerà il contenitore.
