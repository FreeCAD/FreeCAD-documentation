...
2.  Selezionare l\'opzione {{MenuCommand|Mesh → <img src="images/Mesh_RemeshGmsh.svg" width=16px> Affinamento...}} dal menu.
3.  Si apre il pannello delle azioni {{MenuCommand|Rigenera con gmsh}}.
