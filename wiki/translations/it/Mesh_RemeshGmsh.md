...
2.  Esistono diversi modi per richiamare il comando:
    -   Premere il pulsante **<img src="images/Mesh_RemeshGmsh.svg" width=16px> [Affinamento](Mesh_RemeshGmsh/it.md)**.
    -   Selezionare l\'opzione **Meshes → <img src="images/Mesh_RemeshGmsh.svg" width=16px> Affinamento...** dal menu.
