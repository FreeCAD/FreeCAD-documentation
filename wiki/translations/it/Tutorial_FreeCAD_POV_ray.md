...
*align=center|Esempio di schupin di un modello 3D e del rendering di alta qualità prodotto con FreeCAD e POV-Ray.*
...
## Editing the .pov file {#editing_the_.pov_file}
...
### Basic re-organization {#basic_re_organization}
...
### Prepare the body textures {#prepare_the_body_textures}
...
### Prepare the global settings, radiosity {#prepare_the_global_settings_radiosity}
