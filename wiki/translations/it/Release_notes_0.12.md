...
-   Recupera dello spazio di lavoro! Il modulo [Disegno 2D (Draft)](Draft_Workbench/it.md) dispone ora di una nuova interfaccia utente che utilizza il pannello *finestra delle attività di FreeCAD*, è una finestra che riunisce tutte le interazione con l\'utente in un unico pannello, recuperando lo spazio prezioso occupato dalla barra degli strumenti di Draft. Per attivarla, andare nelle preferenze di Draft e selezionare la modalità **finestra delle attività**.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [News](Category_News.md) > [Documentation](Category_Documentation.md) > [Releases](Category_Releases.md) > Release notes 0.12/it
