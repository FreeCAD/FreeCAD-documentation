...
2.  Select the {{MenuCommand|Utilities → <img src="images/FEM_Examples.svg" width=16px> Open FEM examples}} option from the menu.
3.  The {{MenuCommand|FEM Examples}} view opens with various categories, {{MenuCommand|All}}, {{MenuCommand|Constraints}}, {{MenuCommand|Equations}}, {{MenuCommand|Materials}}, {{MenuCommand|Meshes}}, {{MenuCommand|Solvers}}.
