...
-   [Importare/Esportare IFC - compilare IfcOpenShell](Import/Export_IFC_-_compiling_IfcOpenShell/it.md); una vecchia guida che descrive il processo generale. Potrebbe non essere più necessario poiché IfcOpenShell è ora distribuito insieme a FreeCAD grazie a [Conda](Conda/it.md).
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [BIM](Category_BIM.md) > [3rd Party](Category_3rd Party.md) > [Arch](Category_Arch.md) > [FEM](Category_FEM.md) > IfcOpenShell/it
