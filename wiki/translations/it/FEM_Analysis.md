---
- GuiCommand:/it   Name:FEM_Analysis   Name/it:Analisi FEM   MenuLocation:Modello → Contenitore analisi   |Workbenches:[Shortcut:**N** **A**   SeeAlso:[[FEM_tutorial/it|Tutorial FEM](FEM_Module/it___FEM]].md)---
