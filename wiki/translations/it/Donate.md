...
-   Alcuni sviluppatori svolgeranno un compito specifico in cambio di denaro o possono essere sponsorizzati per passare del tempo a lavorare su FreeCAD. Ci sono stati un paio di esperimenti di successo in passato, come il [Ambiente Path](Path_Workbench/it.md) o [Esperimento di finanziamento di Ian Rees](https://opendeveloperfunding.wordpress.com/). Al momento, i seguenti sviluppatori possono essere sponsorizzati:
    -   _ via <img alt="yorikvanhavre\|link=<https://www.patreon.com/yorikvanhavre>" src=images/patreonporange.png  style="width:20px;"> _, [Ambiente Architettura](Arch_Workbench/it.md), [BIM](BIM_Workbench/it.md), IFC)
    -   _ via <img alt="kkremitzki\|link=<https://www.patreon.com/kkremitzki>" src=images/patreonporange.png  style="width:20px;"> [Patreon](https://www.patreon.com/kkremitzki) o <img alt="" src=images/Liberapay_logo.svg  style="width:24px;"> [Liberapay](https://liberapay.com/kkremitzki) (infrastruttura, server, imballaggio, Debian/Ubuntu)
    -   Lei Zheng alias _, [Assembly3](Assembly3/it.md))
    -   Lorenz alias looooo via <img alt="" src=images/Liberapay_logo.svg  style="width:24px;"> _ imballaggio)
