...
|Description=Crea una scala con svolta a sinistra o a destra di data altezza. Il dati della scala sono definiti nel file stairs.dat (Dovete copiare i dati nella pagina del wiki). L'alzata viene calcolata secondo l'altezza della scala.
|Author=Berner
|Version=1.0
|Date=2016-10-17
|FCVersion=Tutte
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > Macro Half turn stairs/it
