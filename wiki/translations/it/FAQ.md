...
### Il modo più facile per installare FreeCAD {#il_modo_più_facile_per_installare_freecad}
...
### Quali sono i prerequisiti per eseguire FreeCAD? {#quali_sono_i_prerequisiti_per_eseguire_freecad}


<div class="mw-translate-fuzzy">

Contrariamente alla maggior parte dei software di CAD 3D, FreeCAD può essere eseguito senza problemi anche su computer modesti - it\'s been known to run on Pentium IV and Intel Core2 Solo CPUs. Se nel computer è installato un sistema operativo corrente, è probabile che FreeCAD venga eseguito. L\'unico prerequisito è che la scheda grafica o il chipset supporti [OpenGL](http://en.wikipedia.org/wiki/OpenGL), preferibilmente non più vecchio della versione v2.0. In caso di problemi, consultare la sezione [Risoluzione dei problemi](FAQ/it#Risoluzione_dei_problemi.md) di queste FAQ.
...
#### Per gli utenti Mac {#per_gli_utenti_mac}

Only the MacIntel architecture is supported. There are no builds available for the PowerPC architecture.

### What if I want to compile FreeCAD myself? {#what_if_i_want_to_compile_freecad_myself}
...
### FreeCAD tells me some module or application is missing {#freecad_tells_me_some_module_or_application_is_missing}
...
### FreeCAD doesn\'t start at all {#freecad_doesnt_start_at_all}
...
### FreeCAD starts normally, but not all icons are displayed, some of them are replaced by a black \'X\' {#freecad_starts_normally_but_not_all_icons_are_displayed_some_of_them_are_replaced_by_a_black_x}
...
### I have display problems, the 3D view doesn\'t behave correctly, there is garbage when I move/rotate the view, etc. {#i_have_display_problems_the_3d_view_doesnt_behave_correctly_there_is_garbage_when_i_moverotate_the_view_etc.}
...
### FreeCAD crashes on startup {#freecad_crashes_on_startup}
...
#### OpenGL drivers are not installed, or not working properly {#opengl_drivers_are_not_installed_or_not_working_properly}
...
#### Some library, needed by FreeCAD, is not present on your system, or wasn\'t found by FreeCAD {#some_library_needed_by_freecad_is_not_present_on_your_system_or_wasnt_found_by_freecad}
...
### FreeCAD freezes after startup {#freecad_freezes_after_startup}
...
### FreeCAD crashes after Edit → Alignment {#freecad_crashes_after_edit_alignment}
...
### I have trouble running FreeCAD on macOS {#i_have_trouble_running_freecad_on_macos}
...
### Is FreeCAD really free? Even for commercial use? {#is_freecad_really_free_even_for_commercial_use}
...
### How do I rotate the 3D view? {#how_do_i_rotate_the_3d_view}
...
## Working with Part geometry {#working_with_part_geometry}
...
## Contributing to FreeCAD {#contributing_to_freecad}
