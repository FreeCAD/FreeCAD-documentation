...
Questo strumento misura la distanza tra due elementi topologici selezionati (vertice, bordo, faccia) e visualizza le misurazioni nella [Vista 3D](3D_view/it.md). Vengono mostrate la distanza più breve tra i due elementi e le misurazioni delta (distanze parallele agli assi globali X, Y, Z).
