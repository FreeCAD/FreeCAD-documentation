...
Questo strumento misura la distanza tra due elementi di topologia selezionati (vertice, bordo, faccia) e visualizza la misurazione nella vista 3D. La distanza più breve tra i due elementi è indicata in rosso e le misure delta (distanze parallele agli assi X, Y, Z standard) sono visualizzate in verde.
