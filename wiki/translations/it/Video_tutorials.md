...
Se si desidera contribuire scrivendo documentazione e tutorial wiki, consultare [Aiuta FreeCAD](Help_FreeCAD/it.md), le linee guida generali del wiki in [WikiPages](WikiPages/it.md), e seguire le [tutorial guidelines](tutorial_guidelines.md).

## Product design 

Video che illustrano la modellazione di vari oggetti solidi utilizzando ambienti come <img alt="" src=images/Workbench_Part.svg  style="width:24px;"> [Part](Part_Workbench/it.md), <img alt="" src=images/Workbench_PartDesign.svg  style="width:24px;"> [PartDesign](PartDesign_Workbench/it.md) e <img alt="" src=images/Workbench_Sketcher.svg  style="width:24px;"> [Sketcher](Sketcher_Workbench/it.md).

Poiché sono disponibili molti video che trattano questo argomento, visitare [Tutorial video per la progettazione del prodotto](Video_tutorials_for_product_design/it.md).

## Meshes

-   [Edit STL Files In FreeCAD](https://www.youtube.com/watch?v=5lwENZeNiNg&feature=youtu.be) by AllVisuals4U. Dimostra lo strumento **[<img src=images/Part_ShapeFromMesh.svg style="width:16px"> [Part Forma da mesh](Part_ShapeFromMesh/it.md)**.

## Assembly

-   [Go further with Asm 3 WB](http://help-freecad-jpg87.fr/025c_ass_ex_creat.php) di jpg87 è un sito Web con istruzioni passo passo e video per dimostrare l\'utilizzo di [Assembly3 Workbench](Assembly3_Workbench/it.md).
-   [FreeCAD Tutorial - Assembly 4 Workbench](https://www.youtube.com/watch?v=n04M6nFvdxs) di Martham Engineering. Presenta l\'[Assembly4 Workbench](Assembly4_Workbench/it.md).



## Disegni tecnici 

-   [TechDraw](https://www.youtube.com/watch?v=7LbOmSGW9F0&list=PLEuOia-QxyFKQnmM1U9yVo7eNrK_Mcln8): una serie di 5 video che descrivono l\'[Ambiente TechDraw](TechDraw_Workbench/it.md), by sliptonic; [1 (Basics)](https://www.youtube.com/watch?v=7LbOmSGW9F0), [2 (Dimensions)](https://www.youtube.com/watch?v=z3w84RfvqaE), [3 (Multiview)](https://www.youtube.com/watch?v=uNjXg-m38aI), [4 (Sections and Detail)](https://www.youtube.com/watch?v=3zSdeFV6I5o), and [5 (Customizing templates)](https://www.youtube.com/watch?v=kcmdJ7xa7gg).
...
-   [sliptonic playlists](https://www.youtube.com/user/sliptonic/playlists): vari video sull\'uso di FreeCAD, lavorando con TechDraw e in particolare l\'[Ambiente Path](Path_Workbench/it.md), di sliptonic, uno dei principali sviluppatori di quest\'ultimo.
...
-   [Coder Musashi videos](https://www.youtube.com/channel/UCtNnYMVWGkG-aemOrCtGjCA/videos): vari video sull\'utilizzo dell\' [Ambiente Path](Path_Workbench/it.md).
...
Video che illustrano la modellazione di stanze, case, edifici per uffici e strutture simili e il disegno di planimetrie, utilizzando ambienti di lavoro come <img alt="" src=images/Workbench_Draft.svg  style="width:24px;"> [Draft](Draft_Workbench/it.md) e <img alt="" src=images/Workbench_BIM_.svg  style="width:24px;"> [BIM](BIM_Workbench/it.md).

Poiché ci sono molti video che trattano questo argomento, visitare [Video tutorial per la progettazione architettonica](Video_tutorials_for_architectural_design/it.md).

## Finite element (FEM) simulation 

-   [FreeCAD FEM/Civil/Structural/Arch Tutorial-1-An Introduction](https://www.youtube.com/watch?v=wAJe1R5NDGw): FreeCAD 0.16, un\'introduzione che costruisce una semplice struttura di pilastri e travi ee esegue un\'analisi con l\'<img alt="" src=images/Workbench_FEM.svg  style="width:24px;"> [Ambiente FEM](FEM_Workbench/it.md), di Eklavya Self Learning Tutorials.
