...
FreeCAD può importare le immagini bitmap usando il\'ambiente [Immagine](Image_Workbench/it.md). Altri ambienti possono anche inserire bitmap, come [TechDraw](TechDraw_Workbench/it.md) con il suo strumento [Immagine](TechDraw_Image/it.md).




[Category   *User Documentation](Category_User_Documentation.md) [Category   *TechDraw](Category_TechDraw.md) [Category   *Image](Category_Image.md)



---
![](images/Right_arrow.png) [documentation index](../README.md) > [User Documentation](Category_User Documentation.md) > [TechDraw](Category_TechDraw.md) > [Image](Category_Image.md) > Bitmap/it
