...
11\. Fare clic su **OK** o **Apply** o **Finish** per generare l\'armatura della fondazione.
12. Fare clic su **Cancel** per uscire dalla finestra di dialogo.
...
---
⏵ [documentation index](../README.md) > [Reinforcement](Category_Reinforcement.md) > [Arch](Arch_Workbench.md) > Arch Rebar Footing Reinforcement/it
