---
 GuiCommand:
   ...
   MenuLocation: Aggancio , Aggancia punto finale
...
L\'opzione <img alt="" src=images/Draft_Snap_Endpoint.svg  style="width:24px;"> **Draft Aggancia Punto Finale** esegue l\'aggancio ai punti finali dei bordi. I bordi possono appartenere ad oggetti [Draft](Draft_Workbench/it.md) o [BIM](BIM_Workbench/it.md) ma anche ad oggetti creati con altri [ambienti di lavoro](Workbenches/it.md).
...
2.  Se **Draft Aggancia Punto Finale** non è attivo, eseguire una delle seguenti operazioni:
    -   Premere il pulsante **<img src="images/Draft_Snap_Endpoint.svg" width=16px> [Aggancia punto finale](Draft_Snap_Endpoint/it.md)** nella barra degli strumenti di aggancio Draft.
    -   [Draft](Draft_Workbench/it.md): Tenere premuto il pulsante **<img src="images/Draft_Snap_Lock.svg" width=x16px><img src="images/Toolbar_flyout_arrow.svg" width=x16px>** nel [Draft snap widget](Draft_snap_widget/it.md) e nel menu che si apre selezionare l\'opzione **<img src="images/Draft_Snap_Endpoint.svg" width=16px> Aggancia punto finale**.
    -   [BIM](BIM_Workbench/it.md): Selezionare l\'opzione **Aggancio → <img src="images/Draft_Snap_Endpoint.svg" width=16px> Aggancia punto finale** dal menu o dal menu contestuale della [Vista 3D](3D_view/it.md).
