# Macro Assembly/it
{{Macro/it
|Name=Simulazione di assemblaggio
|Icon=Macro_Assembly.png
|Description=Animazione di un assemblaggio con FreeCad e Python.
|Author=ralvejd
|Version=1.0
|Date=2014-08-08
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro Assembly/it
