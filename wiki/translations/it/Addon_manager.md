...
1.  Selezionare l\'opzione {{MenuCommand|Strumenti → <img src="images/Std_AddonMgr.svg" width=16px> Addon manager}} dal menu principale.
...
## Informazioni per gli sviluppatori {#informazioni_per_gli_sviluppatori}
