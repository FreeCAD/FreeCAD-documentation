...
In alternativa, invece di usare gli <img src=images/PartDesign_AdditiveBox.svg style="width:schizzi](Sketch/it.md), si possono aggiungere [funzioni primitive](PartDesign_Feature/it.md) di PartDesign, ad esempio, un **[16px"> [Cubo additivo](PartDesign_AdditiveBox/it.md)**. Per creare un volume finale è possibile utilizzare qualsiasi numero di funzioni additive e sottrattive.
