...
L\'ambiente [Part](Part_Workbench/it.md) ora fornisce uno strumento [Crea un composto](Part̞_Compound/it.md), che consente di creare rapidamente un oggetto composto da un insieme di forme selezionate.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [News](Category_News.md) > [Documentation](Category_Documentation.md) > [Releases](Category_Releases.md) > Release notes 0.14/it
