# Macro cross section/it
{{Macro/it
|Name=Cross_section
|Translate=Sezione dinamica
|Icon=Macro_cross_section.png
|Description=Sezione trasversale interattiva e scorrevole.
|Author=aleph0
|Version=0.10
|Date=2020-12-19
|FCVersion=0.15 e più
...
<img alt="" src=images/Macro_Cross_Section_01.png  style="width:150px;"> Guardare in basso a destra: \"Conservare la sezione\"
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro cross section/it
