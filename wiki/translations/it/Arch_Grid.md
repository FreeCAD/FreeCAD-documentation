---
 GuiCommand:
   ...
   SeeAlso: Arch_Axis/it, Arch_AxisSystem/it
---
...
Lo strumento Griglia può essere utilizzato nelle [macro](Macros/it.md) e dalla console [Python](Python/it.md) tramite la seguente funzione:
...
---
⏵ [documentation index](../README.md) > [BIM](Category_BIM.md) > Arch Grid/it
