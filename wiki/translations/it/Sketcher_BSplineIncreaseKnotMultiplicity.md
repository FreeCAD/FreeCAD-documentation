...
2.  Richiamare lo strumento usando uno di questi metodi:
    ...
    -   Usare la voce {{MenuCommand|Sketch → Strumenti B-spline → <img src=images/Sketcher_BSplineIncreaseKnotMultiplicity.svg style="width:16px"> Aumenta la molteplicità del nodo}} dal menu principale.
