...
-   Nella **barra degli strumenti snap**, assicurarsi che il pulsante <img alt="" src=images/Draft_Snap_Grid.svg  style="width:16px;"> [Aggancia alla griglia](Draft_ToggleGrid/it.md) sia attivato, in modo da poter utilizzare la griglia per quanto possibile.
-   Impostare come [Piano di lavoro](Draft_SelectPlane/it.md) il piano **XY**
-   Disegnare quattro linee con lo strumento <img alt="" src=images/Draft_Line.svg  style="width:16px;"> [Linea](Draft_Line/it.md). È possibile inserire le coordinate manualmente, o semplicemente scegliere i punti sulla griglia con il mouse:
