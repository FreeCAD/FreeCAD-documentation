...
-   <img alt="" src=images/Std_RestartInSafeMode.svg  style="width:32px;"> [Riavvia in modalità provvisoria](Std_RestartInSafeMode/it.md): riavvia FreeCAD in uno stato di *ripristino delle impostazioni di base* per il debug. {{Version/it|1.0}}

-   <img alt="" src=images/Start_Start.svg  style="width:32px;"> [Start](Start_Start/it.md): apre la pagina iniziale. {{Version/it|1.0}}
