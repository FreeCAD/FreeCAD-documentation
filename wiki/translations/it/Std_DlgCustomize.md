...
2.  Esistono diversi modi per invocare il comando:
    -   Selezionare l\'opzione {{MenuCommand|Strumenti → <img src="images/Std_DlgCustomize.svg" width=16px> Personalizza...}} dal menu.
    -   Fare clic con il tasto destro del mouse su un\'area della barra degli strumenti e selezionare {{MenuCommand|<img src="images/Std_DlgCustomize.svg" width=16px> Personalizza...}} dal menu contestuale.
