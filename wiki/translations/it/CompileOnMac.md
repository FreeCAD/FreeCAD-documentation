...
Questa pagina descrive come compilare il codice sorgente di FreeCAD su MacOS X. Per altre piattaforme, vedere la pagina [Compilazione](Compiling/it.md).
...
### Homebrew Package Manager {#homebrew_package_manager}
...
## Installare le dipendenze {#installare_le_dipendenze}

FreeCAD mantiene un \'tap\' Homebrew che installa le formule e le dipendenze richieste. Inserire nel terminale i seguenti comandi brew:
...
## Updating from Github {#updating_from_github}
...
## Building with Qt4 and Python 2.7 {#building_with_qt4_and_python_2.7}
