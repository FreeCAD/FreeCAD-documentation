...
{{docnav/it|[Creare dialoghi](Dialog_creation/it.md)|[Tracker](Tracker/it.md)}}
...
## Licenze utilizzate in FreeCAD {#licenze_utilizzate_in_freecad}

FreeCAD utilizza due licenze diverse, una per l\'applicazione stessa e una per la documentazione:

**[Lesser General Public Licence, version 2 or superior (LGPL2+)](wikipedia:LGPL.md)** For all of the FreeCAD source code found in the [official Git repository](https://github.com/FreeCAD/FreeCAD)
...
## Impact of the licences {#impact_of_the_licences}
...
#### Professional users {#professional_users}
...
#### Open-source software developers {#open_source_software_developers}
...
#### Closed-source software developers {#closed_source_software_developers}
...
## Statement of the main developer {#statement_of_the_main_developer}
