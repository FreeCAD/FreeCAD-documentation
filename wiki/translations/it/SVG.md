...
FreeCAD può leggere ed esportare la grafica SVG usando la funzione [SVG](Draft_SVG/it.md) di [Draft](Draft_Workbench/it.md). I file SVG vengono utilizzati per molte cose, inclusi simboli e icone nell\'interfaccia utente grafica e per i modelli. Ad esempio, i [modelli di squadrature](TechDraw_Templates/it.md) di [TechDraw](TechDraw_Workbench/it.md) possono essere creati come file SVG con alcuni campi di testo modificabili che l\'utente può riempire.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Draft](Category_Draft.md) > [TechDraw](Category_TechDraw.md) > [File_Formats](Category_File_Formats.md) > SVG/it
