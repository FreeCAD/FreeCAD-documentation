...
<img alt="" src=images/Surface_ExtendFace.svg  style="width:16px;"> [Surface ExtendFace](Surface_ExtendFace/it.md) estrapola una faccia o una superficie esistente dai bordi con i suoi parametri U e V locali.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Surface](Surface_Workbench.md) > Surface ExtendFace/it
