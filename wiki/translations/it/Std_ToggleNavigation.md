...
2.  Select the {{MenuCommand|Meshes → <img src="images/Mesh_BuildRegularSolid.svg" width=16px> Regular solid...}} option from the menu.
...
10. Right-click and choose {{MenuCommand|Inner}} from the context menu.
11. The result is an open mesh with a boundary.
12. Make sure the mesh is still selected.
13. Select the {{MenuCommand|Meshes → <img src="images/Mesh_AddFacet.svg" width=16px> Add triangle}} option from the menu to invoke the [Mesh AddFacet](Mesh_AddFacet.md) command.
...
17. Invoke the **Std ToggleNavigation** command to switch to navigation mode:
    -   Select the {{MenuCommand|View → <img src="images/Std_ToggleNavigation.svg" width=16px> Toggle navigation/Edit mode}} option from the menu.
...
21. Right-click in the 3D view and choose {{MenuCommand|Finish}} from the context menu to end the [Mesh AddFacet](Mesh_AddFacet.md) command.
