...
---
- GuiCommand   */it   Name   *PartDesign SubtractiveCone   Name/it   *Cono sottrattivo   Workbenches   *[MenuLocation   *Part Design → Crea una primitiva sotttrattiva → Cono   Version   *0.17   SeeAlso   *[[PartDesign CompPrimitiveSubtractive/it|Primitive sottrattive](PartDesign_Workbench/it___PartDesign]].md)---
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [PartDesign](PartDesign_Workbench.md) > PartDesign SubtractiveCone/it
