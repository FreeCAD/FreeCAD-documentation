...
-   Lavorare con FreeCAD
    ...
    -   [Navigazione 3D - Tipo di mouse](Mouse_Model/it.md)
...
-   [Python scripting](Scripting_and_macros.md)
    ...
    -   [Basi di scripting per FreeCAD](FreeCAD_Scripting_Basics/it.md)
    -   [Script per Mesh](Mesh_Scripting/it.md)
    -   [Script per Parti](Topological_data_scripting/it.md)
    -   [Passare da Mesh a Parte e viceversa](Mesh_to_Part/it.md)
    -   [Il grafo di scena Coin](Scenegraph/it.md)
    -   [Lavorare con Pivy](Pivy/it.md)
    -   [Lavorare con PySide](PySide/it.md)
...
-   Sviluppare applicazioni per FreeCAD
    ...
    -   Sviluppare FreeCAD
        -   [Strumenti di sviluppo](FreeCAD_Build_Tool/it.md)
        -   [Aggiungere moduli](Module_Creation/it.md)
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Documentation](Category_Documentation.md) > Online Help Toc/it
