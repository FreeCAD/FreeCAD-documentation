...
Questo strumento consente di definire l\'aspetto (modalità di visualizzazione, materiale e vista) degli oggetti selezionati.
...
2.  Nell\'albero del modello o nella vista 3D, fare clic con il tasto destro e selezionare {{MenuCommand|<img src=images/Std_Tool1.svg style="width:16px"> Aspetto}} nel menu contestuale.
...
### Modalità di visualizzazione {#modalità_di_visualizzazione}
