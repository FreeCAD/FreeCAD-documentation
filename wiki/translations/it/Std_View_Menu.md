# <img alt="Icona di base" src=images/Freecad.svg  style="width:64px;"> Std View Menu/it
...
-   <img alt="" src=images/Std_ViewCreate.svg  style="width:32px;"> [Crea una nuova vista](Std_ViewCreate/it.md): crea una nuova vista 3D.

-   <img alt="" src=images/Std_OrthographicCamera.svg  style="width:32px;"> [Vista ortografica](Std_OrthographicCamera/it.md): passa alla modalità di visualizzazione ortografica.

-   <img alt="" src=images/Std_PerspectiveCamera.svg  style="width:32px;"> [Vista in prospettiva](Std_PerspectiveCamera/it.md): Passa alla modalità vista prospettica.
...
-   [Stile di disegno](Std_DrawStyle/it.md)
    -   <img alt="" src=images/Std_DrawStyleAsIs.svg  style="width:32px;"> [Come è](Std_DrawStyle/it#Come_è.md): cambia lo stile di disegno in \"Come è\".
    -   <img alt="" src=images/Std_DrawStylePoints.svg  style="width:32px;"> [Punti](Std_DrawStyle/it#Punti.md): cambia lo stile di disegno in \"Punti\".
    -   <img alt="" src=images/Std_DrawStyleWireFrame.svg  style="width:32px;"> [Reticolo](Std_DrawStyle/it#Reticolo.md): cambia lo stile di disegno in \"Reticolo\".
    -   <img alt="" src=images/Std_DrawStyleHiddenLine.svg  style="width:32px;"> [Linee nascoste](Std_DrawStyle/it#Linee_nascoste.md): cambia lo stile di disegno in \"Linee nascosta\".
    -   <img alt="" src=images/Std_DrawStyleNoShading.svg  style="width:32px;"> [Senza ombre](Std_DrawStyle/it#Senza_ombre.md): cambia lo stile di disegno in \"Senza ombre\".
...
-   Stereo
    ...
    -   <img alt="" src=images/Std_ViewIvStereoQuadBuff.svg  style="width:32px;"> [Stereo quad buffer](Std_ViewIvStereoQuadBuff/it.md): passa alla visualizzazione stereo quad buffer.
...
-   Zoom
    ...
    -   <img alt="" src=images/Std_ViewZoomOut.svg  style="width:32px;"> [Riduci](Std_ViewZoomOut/it.md): riduce la vista.
    -   <img alt="" src=images/Std_ViewBoxZoom.svg  style="width:32px;"> [Finestra di ingrandimento](Std_ViewBoxZoom/it.md): ingrandisce la vista di un\'area rettangolare.

-   Finestra del documento
    -   [Agganciata](Std_ViewDockUndockFullscreen/it#Agganciata.md): aggancia una vista 3D.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Std View Menu/it
