...
Se si conoscono già le B-spline e la loro applicazione, è possibile continuare direttamente con la sezione [B-spline in FreeCAD](#B-splines_in_FreeCAD/it.md).
...
---
⏵ [documentation index](../README.md) > B-Splines/it
