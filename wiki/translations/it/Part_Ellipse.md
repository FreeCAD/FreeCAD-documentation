# Part Ellipse/it
---
- GuiCommand:/it   Name:Part_Ellipse   Name/it:Ellisse   MenuLocation:Parte → _---
...
Al dialogo Create Primitives si accede tramite l\'icona [Crea primitive](Part_CreatePrimitives/it.md) <img alt="" src=images/Part_CreatePrimitives.svg  style="width:32px;"> situata nel menu Part o tramite la barra degli strumenti Parte, nell\'ambiente Parte.
