...
- GuiCommand:/it
   ...
   MenuLocation:Draft → [Aggancio](Draft_Snap/it.md) → Parallela
   Shortcut:   SeeAlso:[Agganciare](Draft_Snap/it.md), [Aggancia](Draft_ToggleSnap/it.md)---
...
1.  Accertarsi che **<img src="images/Snap_Lock.svg" width=16px> [Aggancia](Draft_ToggleSnap/it.md)** e **<img src="images/Snap_Parallel.svg" width=16px> [Parallela](Draft_Parallel/it.md)** siano attivati.
