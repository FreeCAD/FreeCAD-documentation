...
La storia di FreeCAD inizia nel gennaio del 2001, quando [Jürgen Riegel](User:Jriegel.md) ha cominciato a lavorare al progetto che sarebbe poi diventato ufficialmente FreeCAD. Cas.CADE, una struttura di sviluppo di software commerciale tra cui un [kernel di modellazione geometrica](Glossary#Geometric_modeling_kernel.md) (o kernel CAD), era stato rilasciato sotto una licenza open source nel 2000 e ribattezzato [Open Cascade](Glossary#Open_CASCADE.md). Ciò ha reso possibile la realizzazione di un programma CAD 3D open source, dato che dover programmare un kernel CAD da zero avrebbe richiesto un\'enorme quantità di lavoro.
...
Il progetto è stato annunciato al pubblico sul [OpenCascade Forum](http://www.opencascade.org/org/forum) nel 2003. Ancora dalle parole di Jürgen:
...
## Cronologia dei rilasci {#cronologia_dei_rilasci}
