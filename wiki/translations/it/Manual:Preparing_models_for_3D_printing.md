...
-   Poi, duplichiamo questo primo ciclo alcune volte, in modo che lo strumento ritagli l\'intero blocco. Selezionare il percorso FaceProfile, e premere il pulsante <img alt="" src=images/Path_Array.png  style="width:16px;"> [Matrice](Path_Array/it.md).
...
-   Fare una nuova matrice. Selezionare l\'oggetto FacePocket, e premere il pulsante <img alt="" src=images/Path_Array.png  style="width:16px;"> [Matrice](Path_Array/it.md). Impostare il numero di **Copies** a 1 e un **offset** di -2 mm nella direzione Z. Spostare il posizionamento della matrice di 2 mm in direzione Z. Le due operazioni svolte:
...
-   Ora tutto ciò che rimane da fare è unire queste due operazioni in una sola. Questo può essere fatto con un percorso [Composto](Path_Compound/it.md) o un [Progetto](Path_Project/it.md). Dato che non serve più altro e siamo già pronti per l\'esportazione, usiamo il Progetto. Premere il pulsante <img alt="" src=images/Path_Project.png  style="width:16px;"> [Progetto](Path_Project/it.md).
