...
|Description=Implementazione alternativa di [Sezione](Part_Section/it.md) (parametrica)
|Author=DeepSOIC
|Version=1.1
|Date=2018-04-28
|FCVersion=All
...
Lo strumento [Part Sezione](Part_Section/it.md) produce dei bordi discontinui e gran numero di segmenti (nodi), e questo non è molto adatto per il percorso di [Sweep](Part_Sweep/it.md).
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > Macro Section/it
