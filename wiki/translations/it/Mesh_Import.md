...
1.  Esistono diversi modi per invocare il comando:
    ...
    -   Selezionare l\'opzione {{MenuCommand|Mesh → <img src="images/Mesh_Import.svg" width=16px> Importa mesh...}} dal menu.
    -   Selezionare l\'opzione {{MenuCommand|<img src="images/Mesh_Import.svg" width=16px> Importa mesh...}} dal menu contestuale della [vista ad albero](Tree_view/it.md) o della [vista 3D](3D_view/it.md). Questa opzione è disponibile solo se è stato selezionato un oggetto mesh esistente. Notare che l\'oggetto selezionato non viene effettivamente utilizzato o modificato dal comando.
