...
Il comando **Sketcher Aggancio** attiva/disattiva l\'aggancio (snap) in tutti gli schizzi. I singoli agganci ed impostazioni possono essere modificati nel relativo menu.
...
2.  Facoltativamente fare clic sulla freccia giù a destra del pulsante per aprire il menu. Le impostazioni in questo menu possono essere modificate solo se lìaggancio è attivato:
    ...
    -   Se la casella di controllo **Allinea alla griglia** è selezionata, il cursore si aggancerà alle linee e alle intersezioni della griglia. Funziona anche se la griglia è invisibile.
    ...
    -   
        **Angolo di aggancio**
        ...
        specifica l\'angolo per l\'aggancio angolare. L\'aggancio avverrà a multipli di questo valore a partire dalla direzione dell\'asse X positivo dello schizzo. Il tasto **Ctrl** deve essere tenuto premuto per questo aggancio. Funziona solo quando si creano determinate geometrie, ad esempio [linee](Sketcher_CreateLine/it.md).
