...
2.  Premere il pulsante **<img src="images/Draft_SelectPlane.svg" width=16px> [Seleziona il piano](Draft_SelectPlane/it.md)**, oppure fare clic con il tasto destro e selezionare {{MenuCommand|Utilità → <img src="images/Draft_SelectPlane.svg" width=16px> [Seleziona il piano](Draft_SelectPlane/it.md)}}.
