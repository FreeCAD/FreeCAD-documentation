...
-   <img alt="" src=images/Std_ViewScreenShot.svg  style="width:32px;"> [Salva immagine\...](Std_ViewScreenShot/it.md): cattura una schermata della [vista 3D](3D_view/it.md) attiva.

-   <img alt="" src=images/Std_ViewLoadImage.svg  style="width:32px;"> [Carica immagine\...](Std_ViewLoadImage/it.md): carica un\'immagine. {{Version/it|0.21}}

-   <img alt="" src=images/Std_SceneInspector.svg  style="width:32px;"> [Ispettore di scena\...](Std_SceneInspector/it.md): visualizza una panoramica dei nodi del grafo della scena della vista 3D attiva.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Std Tools Menu/it
