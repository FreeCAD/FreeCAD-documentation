# CAM ExportTemplate/it
---
 GuiCommand:   Name: Path ExportTemplate   Name/it: Esporta modello   Workbenches: Path Workbench/it   Path ---
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM ExportTemplate/it
