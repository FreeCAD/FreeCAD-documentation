# Plot Axes/it
---
- GuiCommand:/it   Name:Plot Axes   Name/it:Assi   MenuLocation:Grafico → Assi‏‎   |Workbenches:[[Plot_Workbench/it   Grafico]]|Shortcut:   SeeAlso:---
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [External_Workbenches](Category_External_Workbenches.md) > [Addons](Category_Addons.md) > [Plot](Plot_Workbench.md) > Plot Axes/it
