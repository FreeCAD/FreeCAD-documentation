...
-   <img alt="" src=images/Arch_Panel_Cut.svg  style="width:32px;"> _ {{Version/it|0.17}}
-   <img alt="" src=images/Arch_Panel_Sheet.svg  style="width:32px;"> _ o altri oggetti 2D {{Version/it|0.17}}
