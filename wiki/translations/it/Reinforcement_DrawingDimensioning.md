---
 GuiCommand:
   ...
   SeeAlso: Arch_Rebar_BOM/it, Reinforcement_Bar_Shape_Cut_List/it
   Version: 0.19
---

# Reinforcement DrawingDimensioning/it
...
1\. Apri il modello di FreeCAD contenente le barre d\'armatura create usando [Reinforcement](Reinforcement_Workbench/it.md).
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > Reinforcement DrawingDimensioning/it
