...
## Presentazione di FreeCAD {#presentazione_di_freecad}
...
## Installare FreeCAD {#installare_freecad}
...
## Contenuti opzionali aggiuntivi {#contenuti_opzionali_aggiuntivi}
...
## Suggerimenti per un avvio rapido {#suggerimenti_per_un_avvio_rapido}
...
### Un elenco molto approssimativo di cose che si devono sapere {#un_elenco_molto_approssimativo_di_cose_che_si_devono_sapere}
...
## Esercizio: modellare un pannello del tetto {#esercizio_modellare_un_pannello_del_tetto}
...
### 1. Aprire FreeCAD, quindi impostare le unità di misura preferite in \"imperial\" {#aprire_freecad_quindi_impostare_le_unità_di_misura_preferite_in_imperial}

Nel menu Modifica → Preferenze → Generale → Unità

### 2. Passare in Sketcher e creare un nuovo schizzo nel piano XY. {#passare_in_sketcher_e_creare_un_nuovo_schizzo_nel_piano_xy.}
...
### 3. Disegnare due rettangoli. Applicare su ciascuno di essi un vincolo verticale di 16 piedi e un vincolo orizzontale di 2 pollici. {#disegnare_due_rettangoli._applicare_su_ciascuno_di_essi_un_vincolo_verticale_di_16_piedi_e_un_vincolo_orizzontale_di_2_pollici.}
...
### 4. Quando i due rettangoli hanno la dimensione corretta, posizionare un vincolo verticale di 0 tra i loro punti d\'angolo, e un vincolo orizzontale di 4 piedi. {#quando_i_due_rettangoli_hanno_la_dimensione_corretta_posizionare_un_vincolo_verticale_di_0_tra_i_loro_punti_dangolo_e_un_vincolo_orizzontale_di_4_piedi.}
...
### 5. Aggiungere altri due ulteriori pezzi di 2 x 6 pollici {#aggiungere_altri_due_ulteriori_pezzi_di_2_x_6_pollici}
...
### 6. Aggiungere i pezzi angolari di rinforzo {#aggiungere_i_pezzi_angolari_di_rinforzo}

![](images/Arch_panel_tutorial_06.jpg )

Stessa cosa. Renderli larghi 6 pollici, e separarli da altri rettangoli di 0,05 pollici.

### 7. Disegnare 7 pezzi di rinforzo intermedi, impostare la loro larghezza a 2 pollici, e vincolare i loro punti finali, sinistro e destro, a 0,05 pollici dai rettangoli verticali (oppure a 0 pollici dei punti finali degli altri rettangoli orizzontali) {#disegnare_7_pezzi_di_rinforzo_intermedi_impostare_la_loro_larghezza_a_2_pollici_e_vincolare_i_loro_punti_finali_sinistro_e_destro_a_005_pollici_dai_rettangoli_verticali_oppure_a_0_pollici_dei_punti_finali_degli_altri_rettangoli_orizzontali}
...
### 8. Calcolare la distanza tra i 7 pezzi di rinforzo e impostare i loro vincoli verticali. {#calcolare_la_distanza_tra_i_7_pezzi_di_rinforzo_e_impostare_i_loro_vincoli_verticali.}
...
### 9. Ottenere uno schizzo completamente vincolato {#ottenere_uno_schizzo_completamente_vincolato}
...
### 10. Passare all\'ambiente Arch e, con il disegno selezionato, premere il tasto \"Finestra\" {#passare_allambiente_arch_e_con_il_disegno_selezionato_premere_il_tasto_finestra}
...
### 11. Modificare i componenti della finestra con un doppio clic su di essi nella vista ad albero {#modificare_i_componenti_della_finestra_con_un_doppio_clic_su_di_essi_nella_vista_ad_albero}
...
### 12. Aggiungere il pannello di copertura {#aggiungere_il_pannello_di_copertura}
...
### 13. Commutare la finestra in un altro tipo di componente Arch {#commutare_la_finestra_in_un_altro_tipo_di_componente_arch}
...
### 14. Duplicare il pannello {#duplicare_il_pannello}
...
### 15. Rotazione e posizionamento dei pannelli. {#rotazione_e_posizionamento_dei_pannelli.}
