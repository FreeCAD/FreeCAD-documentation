...
## File della Guida di FreeCAD {#file_della_guida_di_freecad}
...
## Scaricare i file di aiuto {#scaricare_i_file_di_aiuto}
...
## Registrare la documentazione {#registrare_la_documentazione}
...
-   Chiudere la finestra di dialogo confermando la selezione. Ora la scheda {{MenuCommand|Documentazione}} nelle preferenze dovrebbe avere di nuovo una riga con `org.freecad.usermanual`.
-   Chiudere le {{MenuCommand|Preferenze}} con **OK**.
