...
5.  Selezionare la casella {{CheckBox|TRUE|Schermo intero}} per passare alla vista 3D in modalità a schermo intero.
6.  L\'opzione {{CheckBox|FALSE|Abilita il timer}} non è ancora supportata.
