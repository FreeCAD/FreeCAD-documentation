...
|Translate=Macro_FCSpreadsheet_Extract
|Description=Questa macro salva i dati di una tabella con le formule.<br/> <br/>{{ColoredText|#ff0000|#ffffff|Nuova versione solo per FC version 0.18 e piu (PySide2 Qt5)}} <br/> <br/> Per la precedente versione vedi [https://gist.githubusercontent.com/mario52a/29f7dce6934e8adf5d584bdddd2e469f/raw/ef0b0de56a65afc34a9a1a969969797910f3a004/Macro_FCSpreadSheet_Extract.FCMacro Macro_FCSpreadSheet_Extract.FCMacro] installare manualmente
|Author=Mario52
|Version=0.2
|Date=2020-03-14
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > Macro FCSpreadSheet Extract/it
