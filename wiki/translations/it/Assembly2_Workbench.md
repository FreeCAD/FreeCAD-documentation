...
[Assembly2](Assembly2_Workbench/it.md) è un ambiente di assemblaggio per FreeCAD v0.15 con supporto per l\'importazione di parti da file esterni.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [User Documentation](Category_User Documentation.md) > [Addons](Category_Addons.md) > [External Workbenches](Category_External Workbenches.md) > Assembly2 Workbench/it
