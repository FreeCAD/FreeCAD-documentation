...
Poiché FreeCAD è basato sul toolkit grafico Qt, può esportare la vista 3D nativa in PDF. Questo può essere utile per esportare disegni creati con cura che altri utenti non devono modificare. Ad esempio, le pagine create con [TechDraw](TechDraw_Workbench/it.md) possono essere esportate in questo modo per la condivisione o la stampa. In molti casi è anche possibile eseguire una conversione bidirezionale tra PDF e [SVG](SVG/it.md).
