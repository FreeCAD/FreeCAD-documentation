# Part Helix/it
---
- GuiCommand:/it   Name:Part_Helix   Name/it:Elica   MenuLocation:Parte → _---
...
Un uso comune della primitiva elica è per <img src=images/PartDesign_AdditivePipe.svg style="width:creare delle filettature](Thread_for_Screw_Tutorial/it.md) insieme a un profilo chiuso e all\'operazione **<img src="images/Part_Sweep.svg" width=16px> [Sweep](Part_Sweep/it.md)**. Questo processo funziona essenzialmente allo stesso modo in [PartDesign](PartDesign_Workbench/it.md) utilizzando lo strumento **[16px"> [Sweep additivo ](PartDesign_AdditivePipe/it.md)**.
