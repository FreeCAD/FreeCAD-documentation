# <img alt="Icona di base" src=images/Freecad.svg  style="width:64px;"> Std Edit Menu/it
...
-   <img alt="" src=images/Std_Undo.svg  style="width:32px;"> [Annulla](Std_Undo/it.md): annulla l\'ultima azione.

-   <img alt="" src=images/Std_Redo.svg  style="width:32px;"> [Ripristina](Std_Redo/it.md): riapplica l\'ultimo comando cancellato da Annulla.

-   <img alt="" src=images/Std_Cut.svg  style="width:32px;"> [Taglia](Std_Cut/it.md): copia le celle del foglio di calcolo negli appunti e le cancella.

-   <img alt="" src=images/Std_Copy.svg  style="width:32px;"> [Copia](Std_Copy/it.md): copia gli oggetti selezionati negli appunti.
...
-   <img alt="" src=images/Std_BoxSelection.svg  style="width:32px;"> [Box di selezione](Std_BoxSelection/it.md): seleziona gli oggetti di una zona rettangolare.

-   <img alt="" src=images/Std_BoxElementSelection.svg  style="width:32px;"> [Seleziona elementi](Std_BoxElementSelection/it.md): seleziona le facce in un\'area rettangolare.

-   <img alt="" src=images/Std_SelectAll.svg  style="width:32px;"> [Seleziona tutto](Std_SelectAll/it.md): seleziona tutti gli oggetti.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Std Edit Menu/it
