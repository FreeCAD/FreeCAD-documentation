...
|Version=1.0
|Date=2016-11-20
|FCVersion=0.16 e più
|Download=[https://www.freecadweb.org/wiki/images/d/d7/Aliasmanager_icon.png ToolBar Icon]
}}

## Descrizione

<img alt="" src=images/aliasmanager_icon.png  style="width:24px;"> Aiuta a gestire gli alias all\'interno dell\'ambiente Foglio di calcolo di FreeCAD . È in grado di:

-   creare degli alias basati sulla prima colonna (Colonna A)
-   eliminare gli alias di una colonna
-   spostare gli alias da una colonna all\'altra
-   creare una \"famiglia di parti\", cioè, creare file differenti per ogni colonna in un dato intervallo. Al nome originale aggiunge un suffisso basato sulla prima riga (1)

Per maggiori informazioni si può consultare il forum di FreeCAD: [Macro for Spreadsheet Alias setup and Part Family Generation](http://forum.freecadweb.org/viewtopic.php?f=22&t=18437)

Le versioni più aggiornate della macro possono essere scaricate da GitHub: <https://github.com/pgilfernandez/FreeCAD_AliasManager>
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro Alias Manager/it
