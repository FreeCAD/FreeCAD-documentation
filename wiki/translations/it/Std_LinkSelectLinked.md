...
1.  Seleziona un link.
2.  Selezione {{MenuCommand|Link actions → <img src="images/Std_LinkSelectLinked.svg" width=16px> Go to linked object}} dall\'opzione [Visa ad albero](Tree_view/it.md) del menu contestuale.
