# <img alt="" src=images/Freecad_default.jpg  style="width:1024px;"> About FreeCAD/it

**FreeCAD** è un generico [**CAD**](http://en.wikipedia.org/wiki/CAD) 3D modellatore parametrico [open source](http://en.wikipedia.org/wiki/Open_source) concesso in licenza in base alla [licenza LGPL](https://www.gnu.org/licenses/lgpl-3.0.en.html) FreeCAD si rivolge direttamente a [ingegneri meccanici](http://en.wikipedia.org/wiki/Mechanical_engineering) e [progettisti di prodotti](http://en.wikipedia.org/wiki/Product_design) ma, essendo molto generico, si adatta anche ad una gamma più ampia di usi in ambito ingegneristico, come l\'architettura, l\'analisi ad elementi finiti, la stampa 3D, ed altre applicazioni.
