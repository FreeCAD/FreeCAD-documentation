...
Dato che siamo volontari, possiamo dedicare a FreeCAD solo una limitata quantità di tempo. Quindi, se siete interessati a uno dei temi indicati e se siete disposti ad aiutarci, fatecelo sapere! Per la documentazione del progetto usiamo lo stile \[<http://http://it.wikipedia.org/wiki/Detto,_fatto>! Getting Things Done (GTD)\] . Queste sono le [Linee guida del progetto](Project_template/it.md) (Project template).

-   Questo [Organigramma](http://www.freecadweb.org/wiki/index.php?title=Organization_chart) indica di cosa si occupano i collaboratori che contribuiscono a qualcosa nell\'universo di FreeCAD.

-   Si possono seguire i progetti sui quali si sta lavorando attualmente attraverso questo bugtracker: <http://www.freecadweb.org/tracker/roadmap_page.php>.
...
-   La pagina [Release process](Release_process/it.md) per raccogliere le idee per un flusso di lavoro più efficiente rilascio delle versioni
