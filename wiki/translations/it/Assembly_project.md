...
### Modello multiplo {#modello_multiplo}
...
### Gestore dei progetti {#gestore_dei_progetti}
...
### Diritti d\'autore {#diritti_dautore}
...
### Vincoli degli Assemblaggi {#vincoli_degli_assemblaggi}
...
### Controllo delle revisioni {#controllo_delle_revisioni}
...
#### Modelli multipli {#modelli_multipli}
...
#### Interfacce unificate di Trascina/Rilascia/Copia/Incolla {#interfacce_unificate_di_trascinarilasciacopiaincolla}
...
#### Risorse esterne {#risorse_esterne}
...
### Modello di oggetti {#modello_di_oggetti}
...
## Controlli su STEP {#controlli_su_step}
...
### Soluzionatore di vincoli di assemblaggio {#soluzionatore_di_vincoli_di_assemblaggio}
...
### Interfaccia di simulazione fisica {#interfaccia_di_simulazione_fisica}
