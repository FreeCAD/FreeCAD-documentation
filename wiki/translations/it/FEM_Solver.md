...
fcFEM è impacchettato come una libreria python e una macro e può essere scaricato dal [github repository](https://github.com/HarryvL/fcFEM). Alla fine sarà disponibile dal [Addon manager](AddonManager/it.md), o sarà distribuito come parte di FreeCAD stesso.
...
---
[documentation index](../README.md) > FEM Solver/it
