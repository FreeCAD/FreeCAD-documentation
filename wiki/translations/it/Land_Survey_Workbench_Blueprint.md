# Land Survey Workbench Blueprint/it
**
...
**Important note: The Land Survey Workbench has been abandoned. If there are interested developers who want to spearhead it, please let us know on the forum**


{{TOCright}}

Questa pagina elenca i requisiti per l\'implementazione di un nuovo ambiente di lavoro utilizzabile in [Agrimensura](http://en.wikipedia.org/wiki/Land_survey). Questa pagina è un po\' obsoletae. Le ultime informazioni per FreeCAD a questo proposito si trovano nel forum, nella discussione: <http://forum.freecadweb.org/viewtopic.php?f=8&t=6973>
...
Note: the information in this page is based on a shallow understanding of FreeCAD\'s internals. Once it deepens the requirements and implementation may be adjusted. Contributions are welcomed! \--_ 11:00, 26 January 2013 (UTC)
...
---
[documentation index](../README.md) > [Roadmap](Category_Roadmap.md) > Land Survey Workbench Blueprint/it
