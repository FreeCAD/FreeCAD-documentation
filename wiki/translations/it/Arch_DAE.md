...
Notare che gli oggetti importati sono oggetti [Mesh](Mesh_Workbench/it.md), e devono essere convertiti in oggetti costruiti su [Forme](Shape/it.md) di base o in oggetti Architettura per un uso ottimale. Il [Modulo Architettura](Arch_Workbench/it.md) dispone di diversi strumenti che consentono di effettuare tale operazione.
