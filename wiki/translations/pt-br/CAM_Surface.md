...
1.  Press the **<img src="images/CAM_Surface.svg" width=24px> [3D Surface](CAM_Surface.md)** icon, or select **CAM → 3D Surface** from the dropdown menu.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM Surface/pt-br
