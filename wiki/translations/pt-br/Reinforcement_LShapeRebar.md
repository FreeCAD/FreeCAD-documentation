---
 GuiCommand:
   ...
   MenuLocation: 3D/BIM , Reinforcement tools , L-Shape Rebar
   Workbenches: Reinforcement_Workbench, BIM_Workbench
   Version: 0.17
   SeeAlso: 
---

# Reinforcement LShapeRebar/pt-br

## Description

The [Reinforcement LShapeRebar](Reinforcement_LShapeRebar.md) tool allows the user to create a set of L-shaped reinforcing bars inside an [Arch Structure](Arch_Structure.md) object.
...
*Four sets of L-shaped reinforcement bars inside an [Arch Structure](Arch_Structure.md)*

## Usage

1.  Select any face of a previously created **<img src="images/Arch_Structure.svg" width=16px> [[Arch Structure]]** object.

2.  Then select **<img src="images/Reinforcement_LShapeRebar.svg" width=16px> [L-Shape Rebar](Reinforcement_LShapeRebar.md)** from the rebar tools.
...
The Reinforcement LShapeRebar tool can be used in [macros](Macros.md) and from the [Python](Python.md) console by using the following function:
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > [BIM](Category_BIM.md) > Reinforcement LShapeRebar/pt-br
