...
# Reinforcement ColumnRebars/pt-br



## Descrição

The [Reinforcement ColumnRebars](Reinforcement_ColumnRebars.md) tool allows the user to create reinforcing bars inside a Column [Arch Structure](Arch_Structure.md) object.
...
*Single tie reinforcement inside a [column](Arch_Structure.md)*
...
The Reinforcement ColumnRebars tool can be used in [macros](Macros.md) and from the [Python](Python.md) console by using the following function:
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > [BIM](Category_BIM.md) > Reinforcement ColumnRebars/pt-br
