...
- GuiCommand:
   ...
   Version: 0.17
   SeeAlso: PartDesign_CompPrimitiveSubtractive, PartDesign AdditiveCylinder
---

# PartDesign SubtractiveCylinder/pt-br
...
---
⏵ [documentation index](../README.md) > [PartDesign](PartDesign_Workbench.md) > PartDesign SubtractiveCylinder/pt-br
