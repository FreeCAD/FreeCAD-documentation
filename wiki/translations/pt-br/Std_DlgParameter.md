...
Working with the Parameter Editor requires some experience. For the most common parameters the [Preferences Editor](Preferences_Editor.md) should be used instead.
...
---
⏵ [documentation index](../README.md) > Std DlgParameter/pt-br
