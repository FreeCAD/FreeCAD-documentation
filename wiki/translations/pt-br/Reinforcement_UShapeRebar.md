...
# Reinforcement UShapeRebar/pt-br

## Description

The [Reinforcement UShapeRebar](Reinforcement_UShapeRebar.md) tool allows the user to create a set of U-shaped reinforcing bars inside an [Arch Structure](Arch_Structure.md) object.
...
2.  Then select **<img src="images/Reinforcement_UShapeRebar.svg" width=16px> [U-Shape Rebar](Reinforcement_UShapeRebar.md)** from the rebar tools.
...
The Reinforcement UShapeRebar tool can be used in [macros](Macros.md) and from the [Python](Python.md) console by using the following function:
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > [BIM](Category_BIM.md) > Reinforcement UShapeRebar/pt-br
