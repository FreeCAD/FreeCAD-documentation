...
No documento, os objetos podem ser movidos em grupos, e ter um nome único. O gerenciamento de grupos, objetos e nomes de objetos é feito principalmente a partir da _. Na _, mover objetos para grupos, apagar objetos ou grupos, clicando com o botão direito na [Vista em árvore](Tree_view/pt-br.md) ou em um objeto, renomear objetos clicando duas vezes em seus nomes, ou possivelmente outras operações, dependendo da bancada de trabalho atual.

Os objetos em um documento FreeCAD podem ser de diferentes tipos. Cada bancada de trabalho pode criar seus próprios tipos de objetos; por exemplo, o <img alt="" src=images/Workbench_Mesh.svg  style="width:16px;"> _ cria objetos de peças (Part), o <img alt="" src=images/Workbench_Draft.svg  style="width:16px;"> [Bancada de trabalho Draft](Draft_Workbench/pt-br.md) também cria objetos de peças (Part), etc.
