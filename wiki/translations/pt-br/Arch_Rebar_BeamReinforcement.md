...
- GuiCommand:
   ...
   MenuLocation:Arch → Rebar tools → Beam Reinforcement or 3D/BIM → Reinforcement → Beam Reinforcement
...
# Arch Rebar BeamReinforcement/pt-br
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Reinforcement](Category_Reinforcement.md) > [Arch](Arch_Workbench.md) > Arch Rebar BeamReinforcement/pt-br
