...
# Reinforcement BillOfMaterial/pt-br



## Descrição

The [Reinforcement BillOfMaterial](Reinforcement_BillOfMaterial.md) tool allows the user to create a bill of material of reinforcing bars.
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > Reinforcement BillOfMaterial/pt-br
