...
A [Start Workbench](Start_Workbench.md) não é uma bancada de fato, mas apenas uma página exibida quando você abre o FreeCAD sem nenhum documento carregado.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Start](Category_Start.md) > [Workbenches](Category_Workbenches.md) > Start Workbench/pt-br
