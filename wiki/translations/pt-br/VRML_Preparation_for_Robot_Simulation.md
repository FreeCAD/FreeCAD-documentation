...
## Open a file or create one with FreeCAD {#open_a_file_or_create_one_with_freecad}
...
## Measure geometric characteristics {#measure_geometric_characteristics}
...
## Preparation of the vrml file {#preparation_of_the_vrml_file}
