# <img alt="Std Base icon" src=images/Freecad.svg  style="width:64px;"> Std Macro Menu/pt-br
...
The Macro menu provides tools related to the recording and execution of [macros](Macros.md).
...
-   [Step over](Std_MacroStepOver.md): Steps over code.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Std Macro Menu/pt-br
