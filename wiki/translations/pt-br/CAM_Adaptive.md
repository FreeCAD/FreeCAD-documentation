...
The <img alt="" src=images/CAM_Adaptive.svg  style="width:24px;"> [Adaptive](CAM_Adaptive.md) operation algorithm creates clearing and profiling paths. The operation varies cutter engagement so that the material removal never exceeds a maximum value.

## Usage

Usage instructions for the [Adaptive](CAM_Adaptive.md) operation are presented here.

### Basic Operation 

1.  Press the **<img src="images/CAM_Adaptive.svg" width=16px> [Adaptive](CAM_Adaptive.md)** icon, or select the **CAM** → **<img src="images/CAM_Adaptive.svg" width=24px> [Adaptive](CAM_Adaptive.md)** from the top menu.
...
-   The **<img src="images/CAM_Adaptive.svg" width=16px> [Adaptive](CAM_Adaptive.md)** operation might contain a few bugs yet to be clearly identified. Please report bugs and issues in the [FreeCAD Path/CAM Forum](https://forum.freecadweb.org/viewforum.php?f=15).
...
In case CAM Adaptive creates some unwanted paths, try with a **Stock to Leave** set to {{Value|0.001 mm}} or more. You can reduce the diameter of the tool by double that amount to keep the paths exact.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM Adaptive/pt-br
