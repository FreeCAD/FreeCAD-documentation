# Topological data scripting/pt-br
{{TOCright}}
...
Note   * `makePlane()` only accepts `App.Vector()` for start\_pnt and dir\_normal and not tuples. {{Top}}
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Developer Documentation](Category_Developer Documentation.md) > [Python Code](Category_Python Code.md) > Topological data scripting/pt-br
