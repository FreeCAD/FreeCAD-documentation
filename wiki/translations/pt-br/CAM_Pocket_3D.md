...
This command inserts a path <img alt="" src=images/CAM_3DPocket.svg  style="width:24px;"> [3D Pocket](CAM_Pocket_3D.md) object into the Job. This operation takes into account the bottom surface of the pocket, as well as selected walls that are not vertical. In its current state, this operation is used to rough out a pocket with non-vertical walls and/or non-horizontal bottom. A common finishing technique is to use a ball end mill with the experimental <img alt="" src=images/CAM_Surface.svg  style="width:24px;"> [3D Surface](CAM_Surface.md) operation.
...
2.  Invoke the **<img src="images/CAM_3DPocket.svg" width=16px> [Pocket 3D](CAM_Pocket_3D.md)** or select ** CAM** → **<img src="images/CAM_3DPocket.svg" width=16px> [Pocket 3D](CAM_Pocket_3D.md)** command from the top menu.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM Pocket 3D/pt-br
