...
The tool <img alt="" src=images/CAM_Waterline.svg  style="width:24px;"> [Waterline](CAM_Waterline.md) creates a new Waterline operation. As of 0.19_pre, the operation works on the entire model to generate G-code for the Job. Currently, within the operation\'s settings there is no functionality to select specific areas, faces, or regions of the model.
...
Usage instructions for multiple variations of the [Waterline](CAM_Waterline.md) operation are presented here.

#### Basic Operation 

1.  Press the **<img src="images/CAM_Waterline.svg" width=24px> [Waterline](CAM_Waterline.md)** icon, or select the [Waterline](CAM_Waterline.md) tool from the **CAM** menu.
...
-   It is just that, experimental, and not ready for mainstream integration. Please inspect paths with the built-in **<img src="images/CAM_Simulator.svg" width=16px> [CAM Simulator](CAM_Simulator.md)**, or other 3rd-party G-code inspection tools, before cutting with your machine.
...
-   Should you choose to run the path simulator, **<img src="images/CAM_Simulator.svg" width=16px> [CAM Simulator](CAM_Simulator.md)**, in the CAM Workbench, you might not see tool-shape-specific material removal. Be cautious. A small trial job using foam or other very non-dense material is recommended to verify paths are correct with your selected tool controller.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM Waterline/pt-br
