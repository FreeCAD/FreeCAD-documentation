...
O FreeCAD também é [multiplataforma](https://pt.wikipedia.org/wiki/Multiplataforma). Atualmente roda, com a mesma aparência e funcionalidade, nos sistemas Linux/Unix, Windows e Mac OSX.

Para mais informações sobre o FreeCAD, dê uma olhada nos artigos [lista de recursos](feature_list/pt-br.md), nas [notas de versão](Feature_list/pt-br#Notas_de_Versão.md), na [introdução](getting_started/pt-br.md), ou veja mais [capturas de tela](screenshots/pt-br.md).

### Sobre o projeto FreeCAD 

O projeto FreeCAD foi iniciado em 2001, como descrito na página [história](history/pt-br.md).

O FreeCAD é mantido e desenvolvido por uma comunidade de desenvolvedores e usuários entusiastas (veja a página de [colaboradores](contributors/pt-br.md)). Eles trabalham no FreeCAD voluntariamente, em seu tempo livre. Os colaboradores não podem garantir que o FreeCAD contenha tudo o que você gostaria, mas farão o seu melhor! A comunidade se reúne no [fórum do FreeCAD](http://forum.freecadweb.org), onde as ideias e decisões sobre o programa são discutidas. Sinta-se à vontade para se juntar a nós!
