...
# Path OpActiveToggle/pt-br

## Description

The **<img src="images/Path_OpActiveToggle.svg" width=24px> _ is used to toggle the active state of an existing path operation. This tool is not available, indicated as a light gray version of the icon, until you have created one or more path operations. Once your <img alt="" src=images/Path_Job.svg  style="width:24px;"> [Job](Path_Job.md) has at least one path operation the icon will be fully colored indicating it is available for use.
...
3.  The result depends on the selected operation:
    -   If you have selected an active operation the command deactivates it:
        ...
        -   When using the <img alt="" src=images/Path_Inspect.svg  style="width:16px;"> _ command, the operation\'s G-code is not provided.
    -   If you have selected a deactivated operation the command activates it:
        ...
        -   When using the <img alt="" src=images/Path_Inspect.svg  style="width:16px;"> _ command, the operation\'s G-code is provided.
...
---
[documentation index](../README.md) > [Path](Path_Workbench.md) > Path OpActiveToggle/pt-br
