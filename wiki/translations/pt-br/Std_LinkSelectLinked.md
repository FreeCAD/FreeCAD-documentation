...
- GuiCommand:
   ...
   Workbenches: All
   Version: 0.19
   SeeAlso: Std_LinkSelectLinkedFinal, Std_LinkSelectAllLinks, Std_SelBack, Std_SelForward
---

# Std LinkSelectLinked/pt-br
...
1.  Select a link.
2.  Select the **Link actions → <img src="images/Std_LinkSelectLinked.svg" width=16px> Go to linked object** option from the [Tree view](Tree_view.md) context menu.
...
---
⏵ [documentation index](../README.md) > Std LinkSelectLinked/pt-br
