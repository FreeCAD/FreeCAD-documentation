...
-   <img alt="" src=images/Draft_AutoGroup.svg  style="width:32px;"> _, <img alt="" src=images/Draft_Layer.svg  style="width:32px;">_. <small>(v0.17)</small> 
...
---
[documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Draft Workbench/pt-br
