...
Como você pode ter experimentado algumas vezes, os programadores não sabem escrever bem manuais de ajuda! Para eles é tudo muito simples porque foi eles que fizeram desta maneira, portanto, é vital que os usuários experientes nos ajudem a escrever e revisar a documentação. Sim, isso quer dizer **você**! \"Como?\", você pode ter se perguntado. Basta ir à [seção de usuário da wiki](http   *//www.freecadweb.org/wiki/index.php/pt-br). Você precisará de uma conta *wiki* do FreeCAD para fazer o *logon*. Pergunte no fórum ou no [canal IRC](https   *//www.freecadweb.org/wiki/Help#Chat) sobre como obter permissão de edição na *wiki* (ela está protegida para evitar *spam*) e vamos criar uma conta para você. Atualmente a conta *wiki* é separada da conta do fórum, mas vamos criar uma conta *wiki* com o mesmo nome de sua conta do fórum, então você pode começar a editar! Além disso, confira [a página de ajuda](http   *//www.freecadweb.org/wiki/index.php?title=Help_FreeCAD/pt-br) para conhecer mais maneiras de ajudar o FreeCAD.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [User_Documentation](Category_User_Documentation.md) > Online Help Startpage/pt-br
