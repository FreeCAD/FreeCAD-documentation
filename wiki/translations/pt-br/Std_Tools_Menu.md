# <img alt="Std Base icon" src=images/Freecad.svg  style="width:64px;"> Std Tools Menu/pt-br
...
---
[documentation index](../README.md) > [Workbenches](Category:Workbenches.md) > Std Tools Menu/pt-br
