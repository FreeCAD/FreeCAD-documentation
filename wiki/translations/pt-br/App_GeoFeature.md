...
Um objeto [App GeoFeature](App_GeoFeature.md), ou formalmente um `App::GeoFeature`, é a classe base da maioria dos objetos que exibirão elementos geométricos na [Vista 3D](3D_view/pt-br.md), porque inclui uma propriedade **Placement**.
...
---
⏵ [documentation index](../README.md) > App GeoFeature/pt-br
