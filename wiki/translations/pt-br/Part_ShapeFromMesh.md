...
Analyzing and repairing of the mesh, if needed, should be done manually before launching **<img src=images/Part_ShapeFromMesh.svg style="width:16px"> _.
...
---
[documentation index](../README.md) > [Part](Part_Workbench.md) > Part ShapeFromMesh/pt-br
