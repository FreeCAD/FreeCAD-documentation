...
The tool <img alt="" src=images/CAM_Shape.svg  style="width:24px;"> [Shape](CAM_Shape.md) doesn\'t match the current CAM workflow. For that reason it\'s moved to the experimental features.
...
2.  Press the **<img src="images/CAM_Shape.svg" width=16px> [From Shape](CAM_Shape.md)** button.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM Shape/pt-br
