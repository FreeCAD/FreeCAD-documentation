...
3.  
    **Save Image**   * Save the image ex   * **imageBox_000.png** (the \_000 is incremented with each new image)

4.  
    **Follow**   * After saving the first image, press this button to save the next image with the same name. The images saved is incremented ex   * **imageBox_001.png**, **imageBox_002.png**, **imageBox_003.png**, ![](images/Macro_Screen_Wiki_ToolBar_04_4b.png ) etc\...
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > Macro Screen Wiki/pt-br
