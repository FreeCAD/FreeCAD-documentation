...
It also adds three [lines](Topological_data_scripting#Line.md) in the newly created Sketch.
...
---
⏵ [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher scripting/pt-br
