...
# Part CheckGeometry/pt-br

## Description

The **<img src="images/Part_CheckGeometry.svg" width=16px> _) of the model is valid.
...
---
[documentation index](../README.md) > [Part](Part_Workbench.md) > Part CheckGeometry/pt-br
