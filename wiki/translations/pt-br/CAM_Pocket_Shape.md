...
The <img alt="" src=images/CAM_Pocket_Shape.svg  style="width:16px;"> [Pocket Shape](CAM_Pocket_Shape.md) tool creates a pocketing operation from selected bottom faces, or walls, of one or more pockets of the jobs base object.

The CAM Pocket Shape object is made to be part of a <img alt="" src=images/CAM_Job.svg  style="width:24px;"> [CAM Job](CAM_Job.md).
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM Pocket Shape/pt-br
