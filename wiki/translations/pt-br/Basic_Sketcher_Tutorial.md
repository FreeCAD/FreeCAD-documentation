...
The [Sketcher Workbench](Sketcher_Workbench.md) exists as a standalone module, so it can be used to draw generic 2D (planar) objects. However, it is mostly used in conjunction with the <img alt="" src=images/Workbench_PartDesign.svg  style="width   *24px;"> [PartDesign Workbench](PartDesign_Workbench.md). A closed sketch is normally used to create a face or a profile to be extruded into a solid [body](PartDesign_Body.md) with an operation such as **[<img src=images/PartDesign_Pad.svg style="width   *16px"> [PartDesign Pad](PartDesign_Pad.md)**.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Tutorials](Category_Tutorials.md) > [Sketcher](Category_Sketcher.md) > Basic Sketcher Tutorial/pt-br
