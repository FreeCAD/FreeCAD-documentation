...
- GuiCommand:
   ...
   MenuLocation:Arch → Rebar tools → Straight Rebar or 3D/BIM → Reinforcement → Straight Rebar
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Reinforcement](Category_Reinforcement.md) > [Arch](Arch_Workbench.md) > Arch Rebar Straight/pt-br
