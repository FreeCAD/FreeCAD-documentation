...
1.  Select a link.
2.  Select the {{MenuCommand|Link actions → <img src="images/Std_LinkSelectLinkedFinal.svg" width=16px> Go to deepest linked object}} option from the [Tree view](Tree_view.md) context menu.
