...
1.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Drafting → Arc tools → <img src="images/Draft_Arc_3Points.svg" width=16px> Arc by 3 points}} option from the menu.
2.  The {{MenuCommand|Arc by 3 points}} task panel opens. See [Options](#Options.md) for more information.
