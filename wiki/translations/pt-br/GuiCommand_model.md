...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [API]] and ](Category_API]] and .md) > [Workbench](Category_Workbench.md) > [#translation:}}}} <!--use the](Category_#translation:}}}} <!--use the.md) > GuiCommand model/pt-br
