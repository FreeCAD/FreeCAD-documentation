...
The tool <img alt="" src=images/Path_Custom.svg  style="width:24px;"> [Custom](Path_Custom.md) inserts a path object which is built from hand coded custom G-code.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Path](Path_Workbench.md) > Path Custom/pt-br
