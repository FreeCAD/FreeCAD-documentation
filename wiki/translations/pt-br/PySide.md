...
In the past, FreeCAD used PyQt, another Qt binding for Python, but in 2013 (_.
...
---
[documentation index](../README.md) > [Developer Documentation](Category_Developer Documentation.md) > PySide/pt-br
