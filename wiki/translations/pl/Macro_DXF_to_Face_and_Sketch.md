# Macro DXF to Face and Sketch/pl
{{Macro
...
-   Change create\_face=True or create\_sketch=True to False to generate only one item
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > Macro DXF to Face and Sketch/pl
