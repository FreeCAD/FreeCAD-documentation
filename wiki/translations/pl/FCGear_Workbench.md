...
-   <img alt="" src=images/FCGear_InvoluteGear.svg  style="width:32px;"> [Zębatka ewolwentowa](FCGear_InvoluteGear/pl.md): Tworzy zewnętrzne koło zębate ewolwentowe.

-   <img alt="" src=images/FCGear_InternalInvoluteGear.svg  style="width:32px;"> [Wewnętrzna zębatka ewolwentowa](FCGear_InternalInvoluteGear/pl.md): Tworzy wewnętrzne koło zębate ewolwentowe.

-   <img alt="" src=images/FCGear_InvoluteRack.svg  style="width:32px;"> [Listwa zębata ewolwentowa](FCGear_InvoluteRack/pl.md): Tworzy ewolwentową listwę zębatą.

-   <img alt="" src=images/FCGear_CycloidGear.svg  style="width:32px;"> [Zębatka cykloidalna](FCGear_CycloidGear/pl.md): Tworzy przekładnię cykloidalną.

-   <img alt="" src=images/FCGear_CycloidRack.svg  style="width:32px;"> [Listwa zębata cykloidalna](FCGear_CycloidRack/pl.md): Tworzy cykloidalną listwę zębatą.

-   <img alt="" src=images/FCGear_BevelGear.svg  style="width:32px;"> [Zębatka stożkowa](FCGear_BevelGear/pl.md):Tworzy zębatkę stożkową.

-   <img alt="" src=images/FCGear_CrownGear.svg  style="width:32px;"> [Zębatka koronowa](FCGear_CrownGear/pl.md): Tworzy zębatkę koronową.
...
-   <img alt="" src=images/FCGear_HypoCycloidGear.svg  style="width:32px;"> [Zębatka hipocykloidalna](FCGear_HypoCycloidGear/pl.md): Tworzy hipocykloidalne koło zębate ze sworzniami.
...
-   <img alt="PartDesign_InvoluteGear/pl" src=images/PartDesign_InvoluteGear.svg  style="width:24px;"> [Koło zębate ewolwentowe](PartDesign_InvoluteGear/pl.md): To narzędzie pozwala na tworzenie profilu 2D koła zębatego ewolwentowego. Ten profil 2D jest w pełni parametryczny i może być uzupełniony za pomocą funkcji [Wyciągnięcia](PartDesign_Pad.md).
...
---
⏵ [documentation index](../README.md) > [External Workbenches](Category_External%20Workbenches.md) > [Addons](Category_Addons.md) > [FCGear](Category_FCGear.md) > FCGear Workbench/pl
