...
3.  Click on <img alt="" src=images/Raytrace_ResetCamera.svg  style="width:32px;"> or choose ** Raytracing** → **<img src="images/Raytrace_ResetCamera.svg" width=32px> Reset Camera** from the top menu
...
---
[documentation index](../README.md) > [Raytracing](Raytracing_Workbench.md) > Raytracing ResetCamera/pl
