...
2.  Wywołaj wiązanie za pomocą kilku metod:
    ...
    -   Używając z menu głównego {{MenuCommand|Szkicownik → Wiązania szkicownika → <img src=images/Sketcher_ConstrainAngle.svg style="width:16px"> Wiązanie kąta}}
...
## Tryby wiązania {#tryby_wiązania}

### Kąt nachylenia linii {#kąt_nachylenia_linii}
...
### Rozpiętość łuku *(v0.15)* {#rozpiętość_łuku_v0.15}
...
### Pomiędzy liniami {#pomiędzy_liniami}
...
### Między krzywymi na przecięciu *(kąt w punkcie) (v0.15)* {#między_krzywymi_na_przecięciu_kąt_w_punkcie_v0.15}
