...
Polecenie **Przyciąganie szkicownika** włącza przyciąganie we wszystkich szkicach. Poszczególne tryby przyciągania i ustawienia można zmieniać w powiązanym menu.
...
2.  Opcjonalnie kliknij strzałkę w dół po prawej stronie przycisku, aby otworzyć menu. Ustawienia w tym menu można zmienić tylko wtedy, gdy przyciąganie jest włączone:
    ...
    -   Jeżeli zaznaczone jest pole wyboru **Przyciągaj do siatki**, kursor będzie przyciągany do linii siatki i przecięć siatki. Działa również, gdy siatka jest niewidoczna.
    ...
    -   
        **Przyciągaj do kąta**
        ...
        określa kąt przyciągania kursora. Przyciąganie będzie następować przy wielokrotności tej wartości, począwszy od kierunku dodatniej osi X szkicu. Klawisz **Ctrl** musi być przytrzymany do wykonania tego przyciągania. Działa tylko podczas tworzenia określonej geometrii, na przykład [linii](Sketcher_CreateLine/pl.md).
