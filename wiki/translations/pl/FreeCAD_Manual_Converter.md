# FreeCAD Manual Converter/pl
{{Macro/pl
|Name=Makrodefinicja: Konwerter Podręcznika FreeCAD
|Description=Skrypt Pythona, który automatycznie generuje wersje PDF i EPUB Podręcznika FreeCAD.
|Version = 0.1
|Author=Adrianos
|Date=2024-12-16
|FCVersion=Wszystkie
...
---
⏵ [documentation index](../README.md) > FreeCAD Manual Converter/pl
