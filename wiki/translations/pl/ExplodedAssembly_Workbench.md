# <img alt="ExplodedAssembly Workbench icon" src=images/ExplodedAssembly_workbench_icon.svg  style="width:64px;"> ExplodedAssembly Workbench/pl
...
---
[documentation index](../README.md) > [Addons](Category_Addons.md) > ExplodedAssembly Workbench/pl
