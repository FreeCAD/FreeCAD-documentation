...
-   Przycisk {{button|<img src="images/Draft_UndoLine.svg" width=16px> Cofnij}} wyświetlany w programie FreeCAD w wersji 0.19 i wcześniejszych, nie ma zastosowania w tym poleceniu.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft Line/pl
