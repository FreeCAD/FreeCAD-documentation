...
-   Naciśnij przycisk **<img src="images/Draft_UndoLine.svg" width=16px> Cofnij**, aby cofnąć ostatni punkt. Skrót klawiaturowy **Ctrl** + **Z** obecnie nie działa zgodnie z oczekiwaniami.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft Wire/pl
