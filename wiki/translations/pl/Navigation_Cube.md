...
## Strzałki kierunkowe {#strzałki_kierunkowe}
...
## Główny sześcian nawigacyjny {#główny_sześcian_nawigacyjny}
...
### Wybór narożnika {#wybór_narożnika}
...
## Menu mini-kostki {#menu_mini_kostki}
...
## Przesuwanie sześcianu nawigacyjnego na ekranie {#przesuwanie_sześcianu_nawigacyjnego_na_ekranie}
...
Sześcian nawigacyjny jest konfigurowalny, włącznie z dostosowaniem jego rozmiaru: {{MenuCommand|Edycja → Preferencje → Wyświetlanie → Nawigacja → Kostka nawigacyjna}} {{Version/pl|0.19}}.
