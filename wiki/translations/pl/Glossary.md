...
Przejdź do litery: {{CompactTOC|center=yes}}
...
{{term|3D view|content=[Widok 3D](3D_view/pl.md)}}


{{defn|defn=Widok 3D jest składnikiem [interfejs](Interface/pl.md) FreeCAD. Pokazuje on trójwymiarową reprezentację modelu.}}
...
---
⏵ [documentation index](../README.md) > [Wiki](Category_Wiki.md) > [Glossary](Category_Glossary.md) > Glossary/pl
