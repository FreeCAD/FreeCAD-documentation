...
1.  Istnieje kilka sposobów na wywołanie tego polecenia:
    -   Kliknij czarną strzałkę w dół po prawej stronie przycisku **<img src="images/Std_TreeSyncView.svg" width=16px>** i wybierz z menu opcję **Wiele dokumentów**. Uwaga: ikona przycisku zmieni się w zależności od wybranej opcji.
