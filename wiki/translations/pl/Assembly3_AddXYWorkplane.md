...
# Assembly3 AddXYWorkplane/pl

## Description

The <img alt="" src=images/Assembly_Add_Workplane.svg  style="width:24px;"> [Add workplane](Assembly3_AddXYWorkplane.md) command does\...
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > Assembly3 AddXYWorkplane/pl
