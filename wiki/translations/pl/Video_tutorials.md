...
-   [Edycja plików STL we FreeCAD](https://www.youtube.com/watch?v=5lwENZeNiNg&feature=youtu.be) autorstwa AllVisuals4U. Prezentuje on narzędzie **[<img src=images/Part_ShapeFromMesh.svg style="width:16px"> [Część: Kształt z siatki](Part_ShapeFromMesh/pl.md)**.
...
-   [lista odtwarzania BPLRFE](https://www.youtube.com/user/BPLRFE/playlists): Są to playlisty w języku niemieckim autorstwa zmarłego Rolanda Franka *(✝2017)*, ukochanego członka społeczności FreeCAD.
    -   [FreeCAD-Tutorials *(język niemiecki)*](https://www.youtube.com/watch?v=m49z0weonog&list=PLsrwVwvqYb8G4Ri0iz1JIebsOXkgoytAY), FreeCAD 0.14 do 0.16, seria 32 filmów w języku niemieckim, pokazujących jak modelować wiele różnych obiektów i korzystać z wielu możliwości oprogramowania. Prezentują one filmy video z kanału **Learn FreeCAD**.
    -   [Odpowiedzi z Forum FreeCAD](https://www.youtube.com/watch?v=NWS0czLKn68&list=PLsrwVwvqYb8EZyMnFb7Ogn4yjTZNLTKTB), FreeCAD 0.16, seria 27 filmów w języku niemieckim. Filmy te odpowiadają na pytania zadawane na forum.

-   [Learn FreeCAD playlists](https://www.youtube.com/channel/UC_9HwDkwxllq5lFGkYBIH9g/playlists): Są to playlisty w języku angielskim autorstwa nieżyjącego już Rolanda Franka *(✝2017)*, ukochanego członka społeczności FreeCAD.
    -   [Lekcje FreeCAD dla początkujących *(angielski)*](https://www.youtube.com/watch?v=_HEvhclR4-o&list=PL6fZ68Cq3L8k0JhxnIVjZQN26cn9idJrj), FreeCAD 0.14 do 0.16, seria 13 filmów w języku angielskim, pokazujących jak modelować wiele obiektów. Są to angielskie wersje filmów \"FreeCAD-Tutorials *(niemiecki)*\".
    -   [FreeCAD - odpowiedzi do forum](https://www.youtube.com/watch?v=jkVYWUBPvAQ&list=PL6fZ68Cq3L8mW-mFAAkdXHiL26KrAKe5P), FreeCAD 0.16, seria 4 filmów w języku angielskim. Filmy te odpowiadają na pytania zadawane na forum.
