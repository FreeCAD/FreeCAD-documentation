...
This is the project plan for the FreeCAD FEM integration as part of the [Development roadmap](Development_roadmap.md).
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Roadmap](Category_Roadmap.md) > [FEM](Category_FEM.md) > FEM project/pl
