...
- GuiCommand:
   ...
   Shortcut: 
   Version: 0.20
   SeeAlso: TechDraw_ExtensionCascadeHorizDimension/pl, TechDraw_ExtensionCascadeObliqueDimension/pl
---
...
4.  Narzędzie można wywołać na kilka sposobów:
    -   Naciśnij przycisk **<img src="images/TechDraw_ExtensionCascadeVertDimension.svg" width=16px> '''Wymiar pionowy kaskadowo'''**.
    -   Wybierz z menu opcję **Rysunek Techniczny → Rozszerzenia: Atrybuty / Modyfikatory → <img src="images/TechDraw_ExtensionCascadeVertDimension.svg" width=16px> Wymiar pionowy kaskadowo**.
