...
The _ or [Sketch](Sketcher_NewSketch.md)), or from scratch, if no object is selected when launching the command.
...
---
[documentation index](../README.md) > [Arch](Category_Arch.md) > [Arch](Arch_Workbench.md) > Arch Truss/pl
