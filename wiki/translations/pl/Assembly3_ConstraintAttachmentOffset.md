...
# Assembly3 ConstraintAttachmentOffset/pl
...
3.  Press the **<img src="images/Assembly_ConstraintAttachmentOffset.svg‎‎" width=16px> [Create "AttachmentOffset" constraint](Assembly3_ConstraintAttachmentOffset.md)** button.
4.  Both objects remain at their position.



---
![](images/Button_right.svg) [documentation index](../README.md) > Assembly3 ConstraintAttachmentOffset/pl
