...
6.  Wybierz pierwszy punkt, punkt bazowy, w oknie [widoku 3D](3D_view/pl.md) lub wpisz współrzędne i naciśnij przycisk **<img src="images/Draft_AddPoint.svg" width=16px> Wprowadź punkt**.
...
-   Jeśli `copy` ma wartość {{True/pl}}, to zamiast przesuwania oryginalnych obiektów tworzone są ich kopie.
