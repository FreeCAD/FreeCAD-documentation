...
-   <img alt="" src=images/Robot_CreateRobot.svg  style="width:30px;"> [Wstaw robota](Robot_CreateRobot.md): Umieść nowego robota na scenie.
-   <img alt="" src=images/Robot_Simulate.svg  style="width:30px;"> [Uruchom symulacje trajektorii](Robot_Simulate.md): Otwiera okno dialogowe symulacji i pozwala na rozpoczęcie symulacji.
-   <img alt="" src=images/Robot_Export.svg  style="width:30px;"> [Eksport trajektorii](Robot_Export.md): Eksport pliku programu robota.
...
-   <img alt="" src=images/Robot_SetDefaultValues.svg  style="width:30px;"> [Ustaw wartości domyślne](Robot_SetDefaultValues.md): Ustaw wartości domyślne dla sposobu tworzenia punktów trasy.
