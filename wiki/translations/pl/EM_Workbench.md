# <img alt="EM Workbench icon" src=images/EMWorkbench.svg  style="width:64px;"> EM Workbench/pl
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [External Workbenches](Category_External Workbenches.md) > [EM](Category_EM.md) > EM Workbench/pl
