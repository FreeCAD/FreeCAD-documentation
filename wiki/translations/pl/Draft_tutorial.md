...
-   Środowisko pracy [Rysunek Roboczy](Draft_Workbench/pl.md) jest przeznaczone dla rysunków 2D, które nadają się do rysowania na siatce. Środowisko pracy [BIM](BIM_Workbench/pl.md) opiera się głównie na narzędziach zdefiniowanych w środowisku [Rysunek Roboczy](Draft_Workbench/pl.md).
