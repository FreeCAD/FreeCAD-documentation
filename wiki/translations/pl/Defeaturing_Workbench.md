# <img alt="Defeaturing workbench icon" src=images/Defeaturing_workbench_icon.svg  style="width:64px;"> Defeaturing Workbench/pl
...
---
[documentation index](../README.md) > [Addons](Category_Addons.md) > Defeaturing Workbench/pl
