---
 GuiCommand:
   ...
   Name/pl: Rysunek Techniczny: Rozszerzenie Geometria pomocnicza dla otworu gwintowanego, widok z boku
   ...
   Shortcut: 
   Version: 0.20
   SeeAlso: TechDraw_ExtensionThreadBoltSide/pl
---
...
3.  Istnieje kilka sposobów na wywołanie narzędzia:
    -   Naciśnij przycisk **<img src="images/TechDraw_ExtensionThreadHoleSide.svg" width=16px> '''Geometria pomocnicza dla otworu gwintowanego, widok z boku'''**.
...
---
⏵ [documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw ExtensionThreadHoleSide/pl
