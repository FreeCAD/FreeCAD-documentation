...
|Description=To makro pomaga zarządzać komórkami w arkuszu kalkulacyjnym programu FreeCAD. Z jego pomocą można: Wyciąć / usunąć dane i / lub informacje o aliasach, Skopiować dane i / lub informacje o aliasach, Wkleić dane i / lub informacje o aliasach.
|Author=Wilfried Hortschitz
|Version=0.2.08
|Date=2017-11-03
|FCVersion=Wszystkie
|Download=[https://www.freecadweb.org/wiki/images/3/35/Macro_SpreadsheetTools.png Ikonka paska narzędzi]
}}
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro SpreadsheetTools/pl
