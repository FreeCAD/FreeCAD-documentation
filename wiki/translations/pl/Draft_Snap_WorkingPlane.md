...
# Draft Snap WorkingPlane/pl



## Opis

Polecenie <img alt="" src=images/Draft_Snap_WorkingPlane.svg  style="width:24px;"> **Przyciągnij do płaszczyzny roboczej** rzutuje punkty przyciągania na bieżącą [płaszczyznę roboczą](Draft_SelectPlane/pl.md). Może być używana tylko w połączeniu z inną opcją przyciągania.

![](images/Draft_Snap_WorkingPlane_example.png ) 
*Przyciąganie drugiego punktu linii do przewidywanego punktu końcowego krawędzi.*
...
9.  Jeśli zostanie znaleziony punkt przyciągania, zostanie on rzutowany na [płaszczyznę roboczą](Draft_SelectPlane/pl.md), gdzie jest zaznaczony.
...
---
⏵ [documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft Snap WorkingPlane/pl
