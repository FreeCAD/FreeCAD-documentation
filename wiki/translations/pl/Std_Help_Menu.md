...
-   <img alt="" src=images/Std_OnlineHelp.svg  style="width:32px;"> [Pomoc](Std_OnlineHelp/pl.md): Otwiera dokumentację pomocy.
...
-   <img alt="" src=images/Std_PythonHelp.svg  style="width:32px;"> [Automatyczna dokumentacja modułów Python](Std_PythonHelp/pl.md): Otwiera indeks dokumentacji modułu Python w domyślnej przeglądarce internetowej.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Std Help Menu/pl
