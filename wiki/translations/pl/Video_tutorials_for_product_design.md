# Video tutorials for product design/pl
...
Wymienione tutaj poradniki dotyczą projektowania fizycznych produktów do produkcji lub druku 3D. Inne tematy można znaleźć na ogólnej stronie [wideo poradniki](video_tutorials/pl.md).
...
-   [FreeCAD Videos](https://www.youtube.com/watch?v=YOXOlqw1Pvg&list=PLH_3jUdtTUKU9kajyWPz2C848TYSI7GET): seria długich filmów Marka Gansona *(TheMarkster)* z użyciem FreeCAD 0.19. Zaczyna się od samych podstaw, a następnie przechodzi do modelowania za pomocą programu FreeCAD 0.19 w środowisku pracy [Część](Part_Workbench/pl.md). Omówiono tam również takie rzeczy jak [makrodefinicje](Macros/pl.md), oraz środowiska pracy [Arkusz Kalkulacyjny](Spreadsheet_Workbench/pl.md), i [Szkicownik](Sketcher_Workbench/pl.md).
...
-   [German_Plasma_CNC](https://www.youtube.com/channel/UCGuJsIoXW-exBAwdn38dXow/playlists) listy odtwarzania dla FreeCAD, CNC, G-code, Blender i innych tematów. Głównie w języku niemieckim, niektóre filmy w języku angielskim.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Tutorials](Category_Tutorials.md) > Video tutorials for product design/pl
