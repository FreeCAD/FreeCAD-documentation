...
-   [Lista odtwarzania poradników Invent Box](https://www.youtube.com/channel/UCRQCzMftIUElX03kHjV4rmQ/playlists): wiele filmów dotyczących różnych programów do projektowania, w tym GIMP, Krita, Inkscape, Blender, KiCad i FreeCAD.
    -   [Poznaj FreeCAD](https://www.youtube.com/watch?v=CG_czsNdUfs&list=PL2935W76vRNFvUGefQr3q9P9eezJZyj-u): FreeCAD 0.17, seria 15 filmów autorstwa Invent Box Tutorials w języku angielskim. Ta seria wprowadza wiele popularnych narzędzi używanych w środowiskach pracy [Projekt Części](PartDesign_Workbench/pl.md) i [CAM](CAM_Workbench/pl.md) do modelowania części nadającej się do produkcji: szkice, wyciągnięcie, wyciągnięcie przez profile, wyciągnięcie po ścieżce, odbicie lustrzane, szyki liniowe i biegunowe, operacje logiczne, spirala, ścieżki narzędzi, wycinanie kieszeni, wiercenie, grawerowanie, obróbka końcowa i cięcie.
