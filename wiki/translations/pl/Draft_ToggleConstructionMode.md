...
1.  Istnieje kilka sposobów na wywołanie tej komendy:
    -   Naciśnij przycisk **<img src="images/Draft_ToggleConstructionMode.svg" width=16px> '''Przełącz tryb konstrukcyjny'''** na [Tacce narzędziowej](Draft_Tray/pl.md). Ten przycisk jest aktywny, jeśli włączony jest tryb konstrukcji w wersji roboczej.
    -   Wybierz opcję z menu **Przybory → <img src="images/Draft_ToggleConstructionMode.svg" width=16px> Przełącz tryb konstrukcyjny**.
