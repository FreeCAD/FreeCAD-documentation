...
-   **Ścieżka**: może być linią *(krawędzią)* lub serią linii połączonych, linią złożoną lub różnymi elementami pierwotnymi środowiska Część, elementami środowiska Rysunek Roboczy, lub szkicem. Ścieżka jest często wybierana bezpośrednio z głównego okna modelu, jednak może być również wybrana z panela _ może być wybrana jako ścieżka)*.
