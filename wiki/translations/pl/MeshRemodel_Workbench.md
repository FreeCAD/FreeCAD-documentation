...
Środowisko pracy Przebudowa Siatki jest [zewnętrznym środowiskiem](External_workbenches/pl.md), za pomocą którego można przekształcać obiekty siatkowe w natywne obiekty FreeCAD.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Addons](Category_Addons.md) > [External Workbenches](Category_External Workbenches.md) > MeshRemodel Workbench/pl
