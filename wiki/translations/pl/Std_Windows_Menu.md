# <img alt="Ikonka Strony Startowej" src=images/Freecad.svg  style="width:64px;"> Std Windows Menu/pl
...
**Menu Okna** jest jednym z 7 podmenu w [Menu głównym](Standard_Menu/pl.md):
...
Menu Windows pozwala na przełączanie i układanie otwartych okien aplikacji [Głównego obszaru widoku](Main_view_area/pl.md).
...
---
[documentation index](../README.md) > [Workbenches](Category:Workbenches.md) > Std Windows Menu/pl
