...
-   Pole wyboru **Względnie** wyświetlany w programie FreeCAD w wersji 0.19 i starszych, nie ma zastosowania dla tego polecenia..
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft Rotate/pl
