...
Polecenie <img alt="" src=images/Draft_Rotate.svg  style="width:24px;"> **Obróć** - obraca lub kopiuje wybrane obiekty wokół punktu środkowego o zadany kąt. Oś obrotu jest prostopadła do bieżącej [płaszczyzny roboczej](Draft_SelectPlane/pl.md), a kąt obrotu jest względny do tej płaszczyzny. W trybie elementu podrzędnego polecenie obraca wybrane punkty i krawędzie lub kopiuje wybrane krawędzie [linii](Draft_Line/pl.md) i [polilinii](Draft_Wire/pl.md).
...
2.  Istnieje kilka sposobów na wywołanie polecenia:
    ...
    -   [Środowisko pracy Rysunek Roboczy](Draft_Workbench/pl.md): Wybierz z menu **Modyfikacja → <img src="images/Draft_Rotate.svg" width=16px> Obróć**.
    -   [Środowisko pracy BIM](BIM_Workbench/pl.md): Wybierz opcję **Modyfikacja → <img src="images/Draft_Rotate.svg" width=16px> Obróć** z menu.
