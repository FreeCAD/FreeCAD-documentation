...
This macro is a complete application, it allows to fill simply all the fields of the cartridge [A3 Landscape english](Drawing_templates.md)
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro CartoucheFC 2/pl
