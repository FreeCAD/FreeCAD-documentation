---
 GuiCommand:
   ...
   Shortcut: **2**
   SeeAlso: Std_ViewFront/pl, Std_ViewRight/pl
---
...
1.  Istnieje kilka sposobów na wywołanie tego polecenia:
    ...
    -   Z menu podręcznego [widoku 3D](3D_view/pl.md) wybierz opcję **Widoki standardowe → <img src="images/Std_ViewTop.svg" width=16px> Od góry**.
...
---
⏵ [documentation index](../README.md) > Std ViewTop/pl
