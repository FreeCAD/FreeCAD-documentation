...
4.  Naciśnij przycisk **<img src="images/TechDraw_AngleDimension.svg" width=16px> '''Wstaw wymiar kąta'''**.
    -   Wybierz opcję z menu **Rysunek Techniczny → Wymiary → <img src="images/TechDraw_AngleDimension.svg" width=16px> Wstaw wymiar kąta**.
5.  Do widoku zostanie dodany wymiar.
6.  Wymiar można przeciągnąć do żądanej pozycji.
7.  Jeśli to konieczne, dodaj tolerancje, jak opisano na stronie [Wymiarowanie geometrii i tolerancja](TechDraw_Geometric_dimensioning_and_tolerancing/pl#Tolerancja.md).
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw AngleDimension/pl
