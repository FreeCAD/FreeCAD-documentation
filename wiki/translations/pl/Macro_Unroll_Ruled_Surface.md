...
2.  [Draft Downgrade](Draft_Downgrade.md) them.
3.  Select the faces.
4.  Execute the macro.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro Unroll Ruled Surface/pl
