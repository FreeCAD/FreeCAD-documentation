...
1.  Istnieje kilka sposobów na wywołanie tego polecenia:
    ...
    -   Z menu podręcznego [widoku 3D](3D_view/pl.md) wybierz opcję **Widoki standardowe → <img src="images/Std_ViewRear.svg" width=16px> Od tyłu**.
...
---
⏵ [documentation index](../README.md) > Std ViewRear/pl
