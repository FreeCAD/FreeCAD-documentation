---
 TutorialInfo:l
   Topic: Modelowanie
   Level: Początkujący
   Author: Mark Stephen  oraz HarryGeier 
...
---
⏵ [documentation index](../README.md) > [PartDesign](Category_PartDesign.md) > [Sketcher](Category_Sketcher.md) > Basic Part Design Tutorial/pl
