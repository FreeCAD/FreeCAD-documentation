...
7.  Wybierz dolny prawy punkt, *(wierzchołek)* linii poziomej Początku układu współrzędnych, a następnie środkowy punkt siatki i zastosuj ograniczenie zbieżności <img alt="" src=images/Constraint_PointOnPoint.svgg  style="width:32px;">, aby naprawić swój kształt.
