...
# Reinforcement BarBendingSchedule/pl
...
2\. Następnie wybierz **<img src="images/Reinforcement_BarBendingSchedule.svg" width=16px> '''Schemat gięcia prętów'''** z narzędzi prętów zbrojeniowych.
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > Reinforcement BarBendingSchedule/pl
