# Macro FCInfo/pl
**[left|45px|link=](File   *Under_construction_icon-blue.svg.md) obraz i strona nie zostały jeszcze zaktualizowane o nową funkcję ... czeka<br> ''(Ta strona wiki odpowiada wersji 1.22 , 12/11/2020 i nie zawiera nowych funkcji)''.**
...
|Date=2021/12/13
|FCVersion=wszystkie
|SeeAlso=[Arch Survey|<img src=images/Arch_Survey.svg style="width   *24px"> [Arch Survey](Arch_Survey/pl.md)<br>[Macro_SimpleProperties|<img src=images/Macro_SimpleProperties.png style="width   *24px"> [Makro SimpleProperties](Macro_SimpleProperties/pl.md)<br /> [<img src=images/Macro_FCInfoGlass.png style="width   *24px"> [Makro FCInfoGlass](Macro_FCInfoGlass/pl.md)
}}
