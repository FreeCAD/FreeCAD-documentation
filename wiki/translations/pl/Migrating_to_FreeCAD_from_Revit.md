...
FreeCAD jest wielofunkcyjną aplikacją do modelowania 3D. Chociaż nie jest to wyłącznie aplikacją BIM, posiada dedykowane środowiska pracy [BIM](BIM_Workbench/pl.md), które jest dołączone do każdej instalacji programu i zawiera zestaw narzędzi BIM.
...
---
⏵ [documentation index](../README.md) > Migrating to FreeCAD from Revit/pl
