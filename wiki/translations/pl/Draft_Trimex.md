...
## Przytnij lub rozszerz {#przytnij_lub_rozszerz}
...
2.  Istnieje kilka sposobów na wywołanie polecenia:
    ...
    -   Wybierz z menu opcję {{MenuCommand|Modyfikacja → <img src="images/Draft_Trimex.svg" width=16px> Przytnij / Wydłuż}}.
...
4.  Otworzy się panel zadań {{MenuCommand|Przytnij / wydłuż}}. Zobacz akapit [Opcje](#Opcje.md), aby uzyskać więcej informacji.
...
3.  Istnieje kilka sposobów na wywołanie tego polecenia:
    ...
    -   Wybierz z menu opcję {{MenuCommand|Modifikacja → <img src="images/Draft_Trimex.svg" width=16px> Przytnij / wydłuż}}.
    -   Użyj skrótu klawiaturowego: **T**, a następnie **R**.
4.  Jeśli nie wybrałeś jeszcze obiektu lub ściany: wybierz obiekt z pojedynczą ścianą w oknie [widoku 3D](3D_view/pl.md).
5.  Otworzy się panel zadań {{MenuCommand|Przytnij / wydłuż}}. Zobacz [Opcje](#Opcje_2.md), aby uzyskać więcej informacji.
6.  Aby zdefiniować kierunek i odległość wyciągania, wykonaj jedną z poniższych czynności:
    ...
    -   Upewnij się, że kursor znajduje się po właściwej stronie ściany w [widoku 3D](3D_view.md) i wprowadź {{MenuCommand|Odległość}}.
