...
W systemie [narzędzi](CAM_Tools/pl.md) zestawy narzędzi są zorganizowane w biblioteki. Biblioteka jest po prostu listą zestawów narzędzi i może być używana przez użytkownika do dowolnego celu. Biblioteka narzędzi jest jednak świetną reprezentacją fizycznego grupowania narzędzi, np. w automatycznej zmieniarce narzędzi. Narzędzia można też grupować według przeznaczenia, na przykład wszystkie narzędzia do cięcia tworzyw sztucznych.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM ToolBit Library/pl
