...
1.  Przejdź do menu {{MenuCommand|Projekt Części → <img src=images/PartDesign_InternalExternalGear.svg style="width:24px"> Przekładnia ewolwentowa ...}}.
...
-   Moduły: Średnica podziałki podzielona przez liczbę zębów.
