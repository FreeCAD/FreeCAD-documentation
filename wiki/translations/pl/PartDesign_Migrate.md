...
4.  If the migration works, a <img alt="" src=images/Std_Part.svg  style="width:24px;"> _, each hosting a chain of features.
...
---
[documentation index](../README.md) > [PartDesign](PartDesign_Workbench.md) > PartDesign Migrate/pl
