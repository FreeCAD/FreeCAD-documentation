...
1.  Utwórz [stronę rysunku](Drawing_Landscape_A3.md),
...
-   Teksty wyświetlane na wielu liniach nie są obsługiwane przez wewnętrzną, opartą na Qt przeglądarkę Svg, ale polecenie [otwórz widok w przeglądarce](Drawing_Openbrowser.md) pokazuje te teksty poprawnie.
