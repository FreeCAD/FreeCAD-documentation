...
2.  To invoke the command, do one of the following:
    ...
    -   Use the **Surfaces → Compression Spring** entry in the dropdown menu.
...
---
⏵ [documentation index](../README.md) > [Curves](Category_Curves.md) > Curves CompressionSpring/pl
