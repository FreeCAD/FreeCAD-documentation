---
 GuiCommand:
   ...
   Shortcut: **3**
   SeeAlso: Std_ViewFront/pl, Std_ViewTop/pl
---
...
1.  Istnieje kilka sposobów na wywołanie tego polecenia:
    ...
    -   Z menu podręcznego [widoku 3D](3D_view/pl.md) wybierz opcję **Widoki standardowe → <img src="images/Std_ViewRight.svg" width=16px> Od prawej**.
...
---
⏵ [documentation index](../README.md) > Std ViewRight/pl
