...
-   Nowe narzędzie Wstaw węzeł, które pozwala użytkownikowi wstawić węzeł do istniejącej krzywej złożonej [Pull request \#5311](https://github.com/FreeCAD/FreeCAD/pull/5311).
