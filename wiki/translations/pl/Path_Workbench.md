...
-   <img alt="" src=images/Path_Sanity.svg  style="width:32px;"> [Sprawdź, czy zadanie trasy nie zawiera typowych błędów](Path_Sanity/pl.md): Sprawdza, czy w wybranym zadaniu nie występują brakujące wartości.
...
-   <img alt="" src=images/Path_Inspect.svg  style="width:32px;"> [Przeglądaj polecenia ścieżki](Path_Inspect/pl.md): Wyświetla G-kod do weryfikacji.
...
-   <img alt="" src=images/Path_ToolBitLibraryOpen.svg  style="width:32px;"> [Edytor biblioteki narzędzi](Path_ToolBitLibraryOpen/pl.md): Otwiera edytor do zarządzania bibliotekami końcówek narzędzi.

-   <img alt="" src=images/Path_ToolBitDock.svg  style="width:32px;"> [Stacja dokująca narzędzi](Path_ToolBitDock/pl.md): Przełącza stacja dokującą narzędzi.



### Operacje podstawowe 

-   <img alt="" src=images/Path_Profile.svg  style="width:32px;"> [Profil](Path_Profile/pl.md): Tworzy operację profilowania całego modelu albo jednej lub kilku wybranych powierzchni lub krawędzi.
...
-   <img alt="" src=images/Path_MillFace.svg  style="width:32px;"> [Ściana](Path_MillFace/pl.md): Tworzy ścieżkę obróbki powierzchni.
...
-   <img alt="" src=images/Path_Slot.svg  style="width:32px;"> [Rowek](Path_Slot/pl.md): Tworzy operację szczelinowania na podstawie wybranych elementów lub punktów niestandardowych. [**funkcja eksperymentalna**](Path_experimental/pl.md).
...
-   <img alt="" src=images/Path_Vcarve.svg  style="width:32px;"> [Wycięcie V](Path_Vcarve/pl.md): Tworzy ścieżkę grawerowania przy użyciu kształtu narzędzia V.



### Operacje przestrzenne 

-   <img alt="" src=images/Path_Pocket_3D.svg  style="width:32px;"> [Kieszeń 3D](Path_Pocket_3D/pl.md): Tworzy ścieżkę dla kieszeni 3D.

-   <img alt="" src=images/Path_Surface.svg  style="width:32px;"> [Powierzchnia 3D](Path_Surface/pl.md): Tworzy ścieżkę dla powierzchni 3D. [**funkcja eksperymentalna**](Path_experimental/pl.md).

-   <img alt="" src=images/Path_Waterline.svg  style="width:32px;"> [Linia poziomu](Path_Waterline/pl.md): Tworzy ścieżkę linii poziomu dla powierzchni 3D. [**Experimental**](Path_experimental/pl.md).



### Ścieżki ulepszenia 

-   <img alt="" src=images/Path_DressupAxisMap.svg  style="width:32px;"> [Odwzorowanie osi](Path_DressupAxisMap/pl.md): Odwzorowuje jedną oś na drugą.

-   <img alt="" src=images/Path_DressupPathBoundary.svg  style="width:32px;"> [Kontur](Path_DressupPathBoundary/pl.md): Dodaje ulepszenie obrysu krawędzi do wybranej ścieżki.

-   <img alt="" src=images/Path_DressupDogbone.svg  style="width:32px;"> [Nadcięcie w narożnikach](Path_DressupDogbone/pl.md): Dodaje modyfikację nadcięcia narożników do wybranej ścieżki.

-   <img alt="" src=images/Path_DressupDragKnife.svg  style="width:32px;"> [Rylec](Path_DressupDragKnife/pl.md): Dodaje modyfikację dla noża do przeciągania do wybranej ścieżki.

-   <img alt="" src=images/Path_DressupLeadInOut.svg  style="width:32px;"> [Wprowadzenie / wyprowadzenie](Path_DressupLeadInOut/pl.md): Dodaje punkt wejścia i / lub wyjścia do wybranej ścieżki.

-   <img alt="" src=images/Path_DressupRampEntry.svg  style="width:32px;"> [Parkowanie narzędzia](Path_DressupRampEntry/pl.md): Dodaje modyfikację wejścia na rampę do wybranej ścieżki.

-   <img alt="" src=images/Path_DressupTag.svg  style="width:32px;"> [Pola mocujące](Path_DressupTag/pl.md): Dodaje modyfikację mostka przytrzymującego do wybranej ścieżki.

-   <img alt="" src=images/Path_DressupZCorrect.svg  style="width:32px;"> [Korekta głębokości Z](Path_DressupZCorrect/pl.md): Koryguje głębokość Z przy użyciu mapowania sondy.
...
-   <img alt="" src=images/Path_Probe.svg  style="width:32px;"> [Sonda](Path_Probe/pl.md): Tworzy siatkę pomiarową z zasobu zadania.
...
-   <img alt="" src=images/Path_ThreadMilling.svg  style="width:32px;"> [Frezowanie gwintów](Path_ThreadMilling/pl.md): Tworzy operację frezowania gwintów na podstawie cech obiektu bazowego. [**funkcja eksperymentalna**](Path_experimental/pl.md).
