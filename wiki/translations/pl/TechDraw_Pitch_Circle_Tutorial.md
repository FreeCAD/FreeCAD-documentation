...
W programie FreeCAD w wersji 0.20 i wyższej można utworzyć okrąg podziałowy za pomocą narzędzia [Rozszerzenie: Osie otworów w okręgu](TechDraw_ExtensionHoleCircle/pl.md).
...
2.  Spowoduje to uruchomienie środowiska pracy <img alt="" src=images/Workbench_PartDesign.svg  style="width:24px;"> [Projekt Części](PartDesign_Workbench/pl.md), jeśli będzie wymagane.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw Pitch Circle Tutorial/pl
