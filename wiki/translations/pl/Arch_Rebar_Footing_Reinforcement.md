...
2\. Następnie wybierz **[Zbrojenie stóp fundamentowych](Arch_Rebar_Footing_Reinforcement/pl.md)** z narzędzi zbrojeniowych.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Reinforcement](Category_Reinforcement.md) > [Arch](Arch_Workbench.md) > Arch Rebar Footing Reinforcement/pl
