---
 GuiCommand:
   ...
   Version: 0.19
   SeeAlso: Std_TreeSingleDocument/pl, Std_TreeMultiDocument/pl
---
...
1.  Istnieje kilka sposobów na wywołanie tego polecenia:
    -   Kliknij czarną strzałkę w dół po prawej stronie przycisku **<img src="images/Std_TreeSyncView.svg" width=16px>** i wybierz z menu opcję **Zwiń / rozwiń**. Uwaga: ikona przycisku zmieni się w zależności od wybranej opcji.
