...
*Uaktywnij okno dialogowe "O programie" poprzez menu **Pomoc → <img src="images/Std_About.svg" width=16px> Informacje o FreeCAD
***
...
Na karcie Biblioteki znajduje się lista zewnętrznych bibliotek używanych przez program oraz ich strony internetowe. Więcej informacji można znaleźć na stronie [biblioteki zewnętrzne](Third_Party_Libraries/pl.md).
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Common Questions](Category_Common Questions.md) > Std About/pl
