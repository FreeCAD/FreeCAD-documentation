...
### Migracja serwisu {#migracja_serwisu}
...
### Przejście na pyside, FreeCAD jest teraz całkowicie LGPL {#przejście_na_pyside_freecad_jest_teraz_całkowicie_lgpl}
...
### Wtyczki i projekty poboczne: Biblioteka części, BOLTS, importer Eagle {#wtyczki_i_projekty_poboczne_biblioteka_części_bolts_importer_eagle}
...
### Nadpisywanie stylów wyświetlania {#nadpisywanie_stylów_wyświetlania}
...
### Okno 3D i wygładzanie krawędzi {#okno_3d_i_wygładzanie_krawędzi}
...
### Połączenie przekrojów (Loft) i wyciągnięcie po ścieżce (Sweep) {#połączenie_przekrojów_loft_i_wyciągnięcie_po_ścieżce_sweep}
...
### Utwórz Kombinację (Make Compound) {#utwórz_kombinację_make_compound}
...
### Narzędzia pomiarowe {#narzędzia_pomiarowe}
...
## PartDesign & Szkicownik (Sketcher) {#partdesign_szkicownik_sketcher}

### Weryfikacja szkicu {#weryfikacja_szkicu}
...
### Generator kół zębatych {#generator_kół_zębatych}
...
## Rysunek (Drawing) {#rysunek_drawing}

### Automatyczne rzutowanie {#automatyczne_rzutowanie}
...
### Nowe narzędzia renderingu {#nowe_narzędzia_renderingu}
...
### Obsługa Luxrender {#obsługa_luxrender}
...
## Arkusz kalkulacyjny (Spreadsheet) {#arkusz_kalkulacyjny_spreadsheet}
...
## Rysunek (Draft) {#rysunek_draft}

### Import/eksport DWG {#importeksport_dwg}
...
### Draft to Drawing działa z grupami {#draft_to_drawing_działa_z_grupami}
...
### Wymiarowanie zostało przepisane {#wymiarowanie_zostało_przepisane}
...
### Upgrade i downgrade zostały przepisane {#upgrade_i_downgrade_zostały_przepisane}
...
## Środowisko pracy Arch {#środowisko_pracy_arch}

### Wstępne ustawienia struktury + profile {#wstępne_ustawienia_struktury_profile}
...
### Wstępne ustawienia okien {#wstępne_ustawienia_okien}
...
### Ściany wielowarstwowe {#ściany_wielowarstwowe}
...
### Pręty zbrojeniowe {#pręty_zbrojeniowe}
...
### Import/eksport IFC {#importeksport_ifc}
