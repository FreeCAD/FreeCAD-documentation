...
**[Lesser General Public Licence, wersja 2 lub wyższa *(LGPL2+)*](Wikipedia_LGPL.md)**. Dla całego kodu źródłowego FreeCAD znajdującego się w [oficjalnym repozytorium Git](https://github.com/FreeCAD/FreeCAD).

**[Creative Commons Attribution 3.0 License *(CC-BY-3.0)*](http://creativecommons.org/licenses/by/3.0/)**. Dla dokumentacji dotyczącej <https://www.freecad.org>
