...
Chociaż licencja [LGPL](Licence/pl.md) pozwala na używanie kodu źródłowego FreeCAD w aplikacjach o zamkniętym kodzie źródłowym, to jednocześnie podaje ścisłe zasady takiego postępowania i nie pozwala po prostu wziąć programu FreeCAD, zmienić jego nazwy i pozbawić go licencji.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Developer Documentation](Category_Developer Documentation.md) > Branding/pl
