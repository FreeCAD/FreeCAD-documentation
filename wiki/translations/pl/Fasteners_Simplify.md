...
2.  Polecenie można wywołać na kilka sposobów:
    -   Naciśnij przycisk z menu **<img src="images/Fasteners_Simplify.svg" width=16px> '''Uprość kształt'''**.
    -   Wybierz opcję **Elementy złączne → <img src="images/Fasteners_Simplify.svg" width=16px> Uprość kształt**.
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > Fasteners Simplify/pl
