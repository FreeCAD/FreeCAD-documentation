...
Narzędzie <img alt="" src=images/CAM_Vcarve.svg  style="width:24px;"> **Wycięcie V** służy przede wszystkim do grawerowania w linii środkowej <img alt="" src=images/Draft_ShapeString.svg  style="width:24px;"> [Kształtu z tekstu](Draft_ShapeString/pl.md) na części. Jednakże, może być przydatne dla innych rodzajów operacji 2D.
...
-    **[<img src=images/Draft_ShapeString.svg style="width:24px"> [Kształt z tekstu](Draft_ShapeString/pl.md)**są użyteczne od razu.
...
-   Przełącz się na środowisko pracy **[<img src=images/Workbench_CAM.svg style="width:16px"> [Część](CAM_Workbench/pl.md)** w [selektorze środowisk pracy](Std_Workbench/pl.md).
...
-   Operacja obsługuje tylko jeden obiekt (albo pojedynczy obiekt ściany, albo Kształtu z tekstu), więc dla każdego obiektu:
    -   Wybierz **Ścieżka → <img src="images/CAM_Vcarve.svg" width=24px> Wycięcie V** z menu głównego. Spowoduje to otwarcie panelu konfiguracji.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM Vcarve/pl
