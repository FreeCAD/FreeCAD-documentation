...
1.  Opcjonalnie przypisz kolory do ścian obiektu, który chcesz wyeksportować za pomocą narzędzia <img alt="" src=images/Part_ColorPerFace.svg  style="width:24px;"> [Kolor dla ściany](Part_ColorPerFace/pl.md) środowiska Część.
