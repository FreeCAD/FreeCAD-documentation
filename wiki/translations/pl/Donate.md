...
-   <img alt="" src=images/PayPal_Logo_Icon_2014.svg  style="width   *24px;"> FreeCAD ma oficjalne [konto PayPal](https   *//www.paypal.com/donate/?hosted_button_id=M3Z8BGW6DB69Q), gdzie można przekazać dowolną kwotę za pomocą karty kredytowej lub własnego konta Paypal, jednorazowo lub cyklicznie. Konto PayPal jest zarządzane przez [FPA *(FreeCAD Project association)*](https   *//github.com/FreeCAD/FPA). Paypal jest wygodną platformą, ale pobiera opłatę od tego co FreeCAD otrzymuje.
...
-   ♥ Sponsor   * od 1 USD / 1 EUR miesięcznie. Nie będziesz miał wyświetlonego swojego nazwiska na [stronie sponsorów](https   *//www.freecad.org/sponsor.php), ale i tak bardzo pomożesz projektowi. Razem sponsorzy utrzymują projekt na nogach tak samo jak więksi sponsorzy.
