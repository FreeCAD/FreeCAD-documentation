...
Szablony te są całkowicie pustą tabelką *(22 pola do wypełnienia)* i dedykowane dla makra [Macro_CartoucheFC_Full](Macro_CartoucheFC_Full.md).
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Macros](Category_Macros.md) > Misc templates Full/pl
