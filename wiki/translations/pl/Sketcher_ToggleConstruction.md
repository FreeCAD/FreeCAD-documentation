...
Podczas **<img src=images/Sketcher_EditSketch.svg style="width:16px"> <img src=images/Sketcher_LeaveSketch.svg style="width:Edycji szkicu](Sketcher_EditSketch.md)**, geometria konstrukcyjna jest ukazana jako niebieska i nie zmieni koloru na zielony nawet gdy szkic zostanie w pełni związany. Kiedy **[16px"> [Opuścisz szkic](Sketcher_LeaveSketch.md)**, geometria konstrukcyjna zostanie ukryta w [widoku 3D](3D_view/pl.md).
