...
2.  [Odśwież](Std_Refresh.md) widok jeśli nie zosał utworzony widok rysunku.
3.  Naciśnij przycisk **<img src="images/Drawing_Symbol.png" width=16px> [Symbol rysunkowy](Drawing_Symbol.md)**.
4.  Wybierz plik SVG.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Drawing](Drawing_Workbench.md) > Drawing Symbol/pl
