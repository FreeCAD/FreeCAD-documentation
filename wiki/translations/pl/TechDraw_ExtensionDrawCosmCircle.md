...
The <img alt="" src=images/TechDraw_ExtensionDrawCosmCircle.svg  style="width:24px;"> **TechDraw ExtensionDrawCosmCircle** tool adds a cosmetic circle based on two vertexes.
