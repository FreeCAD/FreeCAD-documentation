...
이 도구를 사용하면 점개선(漸開線 involute curve) 기어 또는 spline의 2D 윤곽선을 생성할 수 있습니다. 이 2D 윤곽선은 매개변수를 통해 완전히 제어할 수 있고 부품설계 작업대에서 [깔판(Pad)](PartDesign_Pad/ko.md) 또는 [나선 추가](PartDesign_AdditiveHelix/ko.md) 기능으로 두께를 주어 고체로 만들 수 있습니다.
...
2.  Go to the menu **Part Design → [<img src=images/PartDesign_InvoluteGear.svg style="width:16px"> Involute gear...**.
...
---
⏵ [documentation index](../README.md) > [PartDesign](PartDesign_Workbench.md) > PartDesign InvoluteGear/ko
