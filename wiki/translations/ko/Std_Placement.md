...
**표준 배치(Std Placement)** 명령은 선택한 개체의 배치 [작업 패널](Task_panel/ko.md)을 표시합니다.
...
1.  [속성 편집기](Property_editor/ko.md)에 **Placement** 속성이 있는 단일 개체를 선택합니다.
...
이 대화 상자는 [속성 편집기](Property_editor/ko.md)의 **Placement** 속성을 클릭했을 때 바로 옆에 나오는 생략 부호 버튼 **...**을 눌러 열 수도 있습니다.
...
-   배치 파라미터에 대한 자세한 내용은 [배치 작업](Tasks_Placement/ko.md)과 [배치](Placement/ko.md) 페이지 그리고 [비행기](Aeroplane/ko.md) 자습서를 참조하십시오.
...
[파이썬 스크립트 자습서](Python_scripting_tutorial/ko#벡터_및_배치.md)를 참조하십시오.
