...
이것은 FreeCAD가 구현하는 광범위하지만 완전하지 않은 특징 목록입니다. If you want to look into the future see the [Development roadmap](Development_roadmap.md) for a quick overview of what\'s coming next. Also, the [Screenshots](Screenshots.md) are a nice place to go.
...
-   [Release 0.11](Release_notes_0.11.md) - 2011. 3.
-   [Release 0.12](Release_notes_0.12.md) - 2011.12.
-   [Release 0.13](Release_notes_0.13.md) - 2013. 1.
-   [Release 0.14](Release_notes_0.14.md) - 2014. 3.
-   [Release 0.15](Release_notes_0.15.md) - 2015. 3.
-   [Release 0.16](Release_notes_0.16.md) - 2016. 4.
-   [Release 0.17](Release_notes_0.17.md) - 2018. 4.
-   [Release 0.18](Release_notes_0.18.md) - 2019. 3.
...
-   ![](images/Feature8.jpg ) A [technical drawing module](TechDraw_Workbench.md) with options for detail views, cross sectional views, dimensioning and others, allowing you to generate 2D views of existing 3D models. The module then produces ready-to-export SVG or PDF files.
...
-   **완전 GUI 응용프로그램**. FreeCAD has a complete Graphical User Interface based on the [Qt](http://www.qtsoftware.com/) framework, with a 3D viewer based on [Open Inventor](http://en.wikipedia.org/wiki/Open_Inventor); allowing fast rendering of 3D scenes and a very accessible scene graph representation.
...
-   **compound (ZIP based) document save format**. FreeCAD documents are saved with a **.[FCStd](File_Format_FCStd.md)** extension. The document can contain many different types of information such as geometry, scripts or thumbnail icons. The **.FCStd** file is itself a zip container; a saved FreeCAD file has already been compressed.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [User Documentation](Category_User Documentation.md) > Feature list/ko
