# Installing on Windows/ko
## 기본적인 설치 

프리캐드의 안정된 최신 버젼은 설치기를 이용하여 편리하게 설치 하시기 바랍니다, [Download](Download.md) 페이지를 읽어 보세요.
...
---
⏵ [documentation index](../README.md) > Installing on Windows/ko
