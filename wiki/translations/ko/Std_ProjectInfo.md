...
2.  다음 정보가 표시된 대화 상자가 열립니다:
    -   **이름**: 문서의 이름. **편집 불가능**. 문서의 Label 속성에 해당하며 [속성 편집기](Property_editor/ko.md)에서 편집할 수 있습니다..
...
-   작성자 이름, 회사 이름, 사용권 정보는 [환경 설정 편집기](Preferences_Editor/ko#문서.md)에서 미리 설정할 수 있습니다.
