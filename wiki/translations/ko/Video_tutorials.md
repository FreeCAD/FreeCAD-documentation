...
위키 문서 및 자습서 작성에 기여하고 싶다면 [FreeCAD 돕기](Help_FreeCAD/ko.md), [위키페이지의](WikiPages/ko.md) 일반 위키 지침을 참조하고 [Tutorial guidelines](Tutorial_guidelines.md)(페이지 번역 버튼 안보임)을 따르세요. .
...
이 주제를 다루는 동영상이 많이 있으므로 [제품 설계 동영상 자습서를](Video_tutorials_for_product_design/ko.md) 방문하세요
...
---
⏵ [documentation index](../README.md) > [Common Questions](Category_Common%20Questions.md) > Video tutorials/ko
