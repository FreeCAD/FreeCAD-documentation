# <img alt="스프레드시트 작업대 아이콘" src=images/Workbench_Spreadsheet.svg  style="width:64px;"> Spreadsheet Workbench/ko



## 소개

<img alt="" src=images/Workbench_Spreadsheet.svg  style="width:24px;"> **스프레드시트 작업대**를 사용하면 스프레드시트를 만들고 편집할 수 있으며, 스프레드시트의 데이터를 모델의 매개변수로 사용할 수 있으며, 모델에서 검색한 데이터로 스프레드시트를 채우고 계산을 수행한 후 LibreOffice 또는 Microsoft Excel과 같은 다른 스프레드시트 응용프로그램으로 데이터를 내보낼 수 있습니다.
...
-   <img alt="" src=images/Spreadsheet_CreateSheet.svg  style="width:24px;"> [시트 생성](Spreadsheet_CreateSheet.md): 새 스프레드시트를 만든다.
...
---
⏵ [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [Spreadsheet](Category_Spreadsheet.md) > Spreadsheet Workbench/ko
