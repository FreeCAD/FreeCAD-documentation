---
 GuiCommand:
   ...
   Workbenches: 모두
   Shortcut: **V** **O**
   SeeAlso: Std_PerspectiveCamera/ko
---
...
**표준 직교투영 카메라(Std OrthographicCamera)** 명령은 활성 [3D 보기](3D_view/ko.md)의 카메라를 직교투영 보기 모드로 전환합니다. 이 모드에서는 카메라에서 먼 개체가 가까운 개체보다 작게 보이지 않습니다.
...
-   카메라 유형은 환경 설정에서 변경할 수 있습니다: **편집 → 환경설정... → Display → 3D 보기 → 카메라 유형**. 선택한 유형은 모든 열린 문서 및 새로 열리는 문서의 3D 보기에 적용됩니다. [환경 설정 편집기](Preferences_Editor/ko#3D_보기.md)를 참조하십시오.
