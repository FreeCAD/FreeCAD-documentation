...
1.  이 명령을 실행하는 방법은 여러 가지입니다:
    -   메뉴에서 {{MenuCommand|보기 → <img src="images/Std_OrthographicCamera.svg" width=16px> 직교투영}} 옵션을 선택합니다.
    -   단축키를 사용합니다: **V**를 누른 다음 **O**.

## 비고

-   [네비게이션 큐브의](Navigation_Cube/ko.md) 미니-큐브 메뉴를 이용하여 직교투영 보기 모드로 변경할 수도 있습니다.
