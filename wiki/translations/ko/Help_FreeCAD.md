...
위키 마크업의 기본과 친해지세요. [Help:Editing](Help:Editing.md) 참조.
...
-   Since 2016, FreeCAD also participates in the [Google Summer of Code](Google_Summer_of_Code.md). Be sure to check our ideas there if you are interested in participating in a next edition.
...
---
[documentation index](../README.md) > [Command Reference]] page lists and documents all of the FreeCAD ](Category:Command Reference]] page lists and documents all of the FreeCAD .md) > Help FreeCAD/ko
