...
{{term|3D view|content=[3차원으로 보기](3D_view/ko.md)}}


{{defn|defn= 3차원으로 보기는 프리캐드 화면의 구성요소입니다. [프리캐드 화면](Interface/ko.md). 이것은 모델을 3차원 형태를 보여 줍니다.}}
...
{{term|Arch|content=[Arch](Arch_Workbench/ko.md)}}


{{defn|defn=주로 건물과 구조물의 모델링에 사용되는 건축요소 [작업환경](#Workbench/ko.md) 을 줄여서 쓴 용어. [설계도 제작 환경](#Draft.md) 과 상당히 비슷합니다.}}
