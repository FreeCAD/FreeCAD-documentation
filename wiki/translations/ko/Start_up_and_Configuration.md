# Start up and Configuration/ko
**FreeCAD 버전 0.20에서는 Linux용 프로그램 구성, 데이터 및 캐시 파일의 기본 위치가 변경되었습니다.<br> 자세한 내용은 [배포 노트 0.20](Release_notes_0.20#Core.md)을 참조하세요. 이 페이지는 아직 이에 따라 업데이트되지 않았습니다.**
...
| Config var name  | Synopsis                                                                                                               | Example                  |
+==================+========================================================================================================================+==========================+
| ExeName          | Name of the build Executable file. Can differ from FreeCAD if a different **main.cpp** is used. |           |
|                  |                                                                                                                        | **FreeCAD.exe** |
|                  |                                                                                                                        |                       |
++++
...
---
⏵ [documentation index](../README.md) > [Developer Documentation](Category_Developer%20Documentation.md) > [Start](Start_Workbench.md) > Start up and Configuration/ko
