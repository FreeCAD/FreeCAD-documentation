...
<img alt="BIM 외부 작업대 아이콘" src=images/IFC.svg  style="width:128px;">
...
---
⏵ [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [BIM](Category_BIM.md) > BIM Workbench/ko
