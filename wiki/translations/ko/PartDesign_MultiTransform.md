---
 GuiCommand:
   ...
   SeeAlso: PartDesign_Mirrored, PartDesign_LinearPattern, PartDesign_PolarPattern, PartDesign_Scaled
---

# PartDesign MultiTransform/ko



## 설명

부품설계 작업대의 <img alt="" src=images/PartDesign_MultiTransform.svg  style="width:24px;">**다중 변환** 도구는 하나 이상의 [도형특징들을](PartDesign_Feature/ko.md) 다중으로 복사 생성할 수 있습니다. 하나의 복사 생성 안에 또 다른 복사 생성을 다중으로 포함시킬 수 있습니다.

사용 가능한 변환은 다음과 같습니다: <img alt="" src=images/PartDesign_Mirrored.svg  style="width:16px;"> [대칭 복사](PartDesign_Mirrored/ko.md), <img alt="" src=images/PartDesign_LinearPattern.svg  style="width:16px;"> [선형 복사](PartDesign_LinearPattern/ko.md), <img alt="" src=images/PartDesign_PolarPattern.svg  style="width:16px;"> [원형 복사](PartDesign_PolarPattern/ko.md) 및 <img alt="" src=images/PartDesign_Scaled.svg  style="width:16px;"> [배율 변환](PartDesign_Scaled/ko.md). 처음 세 개는 별도의 도구로도 사용할 수 있습니다.
...
---
⏵ [documentation index](../README.md) > [PartDesign](PartDesign_Workbench.md) > PartDesign MultiTransform/ko
