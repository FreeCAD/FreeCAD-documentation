---
 GuiCommand:
   ...
   SeeAlso: PartDesign_MultiTransform/ko
---

# PartDesign Mirrored/ko



## 설명

부품설계 작업대에서<img alt="" src=images/PartDesign_Mirrored.svg  style="width:24px;">**대칭복사** 도구는 하나 이상의 도형특징을 대칭복사 합니다.
...
---
⏵ [documentation index](../README.md) > [PartDesign](PartDesign_Workbench.md) > PartDesign Mirrored/ko
