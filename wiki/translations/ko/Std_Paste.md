...
**
    ...
    -   메뉴에서 {{MenuCommand|편집 → <img src="images/Std_Paste.svg" width=16px> 붙여넣기}} 옵션을 선택합니다.

    -   [트리 보기의](Tree_view/ko.md) 상황에 맞는 메뉴에서 {{MenuCommand|<img src="images/Std_Paste.svg" width=16px> 붙여넣기}} 옵션을 선택합니다. 이 옵션은 기존에 선택한 개체가 있을 때에만 사용할 수 있습니다.
