...
FreeCAD history began in January 2001 when [Jürgen Riegel](User:Jriegel.md) started working on the Cas.CADE project, a commercial software development framework including a [geometric modeling kernel](Glossary#Geometric_modeling_kernel.md) (or CAD kernel) that in 2000 had been released under an open source license and renamed as [Open Cascade](Glossary#Open_CASCADE.md). This made the realization of an open source 3D CAD program possible, as having to program a CAD kernel from scratch would have required a huge amount of work.
...
이 프로젝트는 2003 년 [OpenCascade 포럼](http://www.opencascade.org/org/forum)에 일반 대중에게 발표되었습니다. Jürgen의 말에 따르면: The project was announced to the general public on the [OpenCascade Forum](http://www.opencascade.org/org/forum) in 2003. Again, in Jürgen\'s words:
...
#### Overview
  ...
  --------- -------------- ---------------- ----------------------------------------------------- ----------------------------------------------------------------------------------------- ---------------------------------------------------------------------------------------
  0.19      ?              in development   [Release notes 0.19](Release_notes_0.19.md)   [head master](https://github.com/FreeCAD/FreeCAD/commits/master)                          
  ...
  0.13      \-             2013-01-29       [Release notes 0.13](Release_notes_013.md)    [release commit 0.13](https://github.com/FreeCAD/FreeCAD/commits/releases/FreeCAD-0-13)   [branch bugfixes 0.13](https://github.com/FreeCAD/FreeCAD/tree/releases/FreeCAD-0-13)
  0.12      \-             2011-12-20       [Release notes 0.12](Release_notes_012.md)                                                                                              
  0.11      \-             2011-05-03       [Release notes 0.11](Release_notes_011.md)                                                                                              
  0.10      \-             2010-07-24                                                                                                                                                       
  0.9       \-             2010-01-16                                                                                                                                                       
  0.8       \-             2009-07-10                                                                                                                                                       
  0.7       \-             2009-04-24                                                                                                                                                       
