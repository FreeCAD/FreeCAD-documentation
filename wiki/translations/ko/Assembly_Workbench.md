# <img alt="조립 작업대 아이콘" src=images/Workbench_Assembly.svg  style="width:64px;"> Assembly Workbench/ko
...
<img alt="" src=images/Workbench_Assembly.svg  style="width:24px;"> 조립 작업대는 프리캐드에 새롭게 내장된 작업대입니다.
