...
# Arch CompSetMaterial/ru

## Описание

The Material tools allow to add materials to the active document.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Arch](Arch_Workbench.md) > Arch CompSetMaterial/ru
