...
### Написание кода на Python {#написание_кода_на_python}
...
### Манипуляция объектами FreeCAD {#манипуляция_объектами_freecad}
...
### Векторы и места размещения {#векторы_и_места_размещения}
