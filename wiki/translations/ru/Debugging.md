...
-   отладочная сборка FreeCAD (в настоящее время доступна только [сборка из исходного кода](Compile_on_Linux/ru#For_a_Debug_build.md))
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Developer Documentation](Category_Developer Documentation.md) > [Python Code](Category_Python Code.md) > Debugging/ru
