...
## Работа с панелью задач {#работа_с_панелью_задач}
...
## Написание скриптов {#написание_скриптов}
