...
## Компоненеты интерфейса {#компоненеты_интерфейса}
...
Эти опции находятся в меню {{MenuCommand|Инструменты → Customize}}. Смотри [настройку интерфейса](Interface_Customization/ru.md).
