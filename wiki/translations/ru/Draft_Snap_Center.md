...
Привязывается к центру дуг и кругов.<img alt="" src=images/Draft_Snap_Center.png  style="width   *400px;">
...
3.  Переместите курсор рядом с дугой / кругом / круговым краем, который вы хотите прикрепить к элементу
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft Snap Center/ru
