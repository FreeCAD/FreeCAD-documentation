...
## Mesh и Mesh Regions {#mesh_и_mesh_regions}
...
Затем создайте новый объект Mesh, как указано выше, и используйте макрос выделения (быстрые клавиши S, E), чтобы выбрать объект Cube\_Core в графическом окне. На этот раз в списке ссылок должно быть указано «CompoundFilter: Solid2», как показано ниже. Мы выбрали максимальный размер элемента 1 мм.
...
## Скользящая опора {#скользящая_опора}
...
## Фиксированные узлы {#фиксированные_узлы}
...
## Расчет CalculiX {#расчет_calculix}
...
## Дальнейшая работа {#дальнейшая_работа}
...
Позабавьте себя ! {{Tutorials navi}} {{FEM Tools navi}} 
