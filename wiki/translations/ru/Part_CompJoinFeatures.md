...
Команда представляет собой кнопку ниспадающей панели инструментов, содержащей все инструменты соединения. Смотрите отдельные страницы для дальнейшей информации.
[Connect](Part_JoinConnect/ru.md), [Embed](Part_JoinEmbed/ru.md), [Cutout](Part_JoinCutout/ru.md)
