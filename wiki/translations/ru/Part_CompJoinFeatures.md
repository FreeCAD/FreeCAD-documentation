...
Данная команда представляет собой кнопку на панели инструментов с выпадающим списком содержащим в себе все инструменты для соединения полых тел. Более подробную информацию можно получить на отдельных страницах каждого инструмента.
