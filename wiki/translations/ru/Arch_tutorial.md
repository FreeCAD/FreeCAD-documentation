...
## Типовой рабочий процесс {#типовой_рабочий_процесс}
...
## Возведение стен {#возведение_стен}
...
## Возведение конструкции {#возведение_конструкции}
...
## Полы, лестницы и камин {#полы_лестницы_и_камин}
...
### Организация Вашей модели {#организация_вашей_модели}
...
### Создание пользовательских окон {#создание_пользовательских_окон}
...
### Редактирование окон {#редактирование_окон}
...
## Работа без опоры на двумерных чертёж {#работа_без_опоры_на_двумерных_чертёж}
...
## Редактирование и исправления {#редактирование_и_исправления}
...
### Экспорт в IFC и другие приложения {#экспорт_в_ifc_и_другие_приложения}
...
### Двухмерные чертежи {#двухмерные_чертежи}
...
### Подсчёт материалов {#подсчёт_материалов}


<div class="mw-translate-fuzzy">

Это ещё одна очень важная задача, которая должна быть выполнена на модели BIM. В FreeCAD все хорошо с самого начала, поскольку ядро OpenCasCade уже занимается вычислением длин, площадей и объёмов для всех производимых им форм. Поскольку все [архитектурные](Arch_Module/ru.md) объекты это тела, Вы с гарантией можете получить из них объёмы.
