...
## Подготовка исходников {#подготовка_исходников}

### Основная информация {#основная_информация}
...
## Компилирование переводов {#компилирование_переводов}
...
## Тестирование переводов {#тестирование_переводов}
