...
**[Lesser General Public Licence, version 2 or superior (LGPL2+)](wikipedia_LGPL.md)** Для всех исходных кодов FreeCAD, находящихся в [официальном репозитории Git](https://github.com/FreeCAD/FreeCAD)
...
---
⏵ [documentation index](../README.md) > [Developer Documentation](Category_Developer%20Documentation.md) > License/ru
