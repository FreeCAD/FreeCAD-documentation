---
 GuiCommand:
   ...
   Workbenches: Arch Workbench/ru, BIM Workbench/ru
   SeeAlso: Arch_Rebar_ColumnReinforcement/ru, Arch_Rebar_BeamReinforcement/ru
   Version: 0.19
---

# Reinforcement ColumnRebars TwoTiesSixRebars/ru
...
*Two ties six rebars reinforcement inside a [column](Arch_Structure.md)*
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > [BIM](Category_BIM.md) > Reinforcement ColumnRebars TwoTiesSixRebars/ru
