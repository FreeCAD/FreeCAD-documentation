...
**Создать дугу** это кнопка на панели геометрических инструментов Sketcher, группирует в себе инструменты для создания дуг по трем опорным точкам. Нажмите на стрелку указывающую вниз справа от кнопки, чтобы развернуть список инструментов и выбрать инструмент.
