...
1.  Press the **<img src="images/Path_3DSurface.svg" width=24px> [3D Surface](Path_3DSurface.md)** icon, or select **Path → 3D Surface** from the dropdown menu.
...
---
[documentation index](../README.md) > [Path](Path_Workbench.md) > Path Surface/ru
