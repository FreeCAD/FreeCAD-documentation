...
## Создание чертежа {#создание_чертежа}
...
### Несколько видов одной детали {#несколько_видов_одной_детали}
...
### Связывание размеров с 3D-моделью {#связывание_размеров_с_3d_моделью}
