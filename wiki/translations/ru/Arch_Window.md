...
-   Окно разделяет общие параметры и действие со всеми [компонентами Arch](Arch_Component/ru.md)
...
-   Отверстие, создаваемое окном в базовом объекте, определяется двумя параметрами   * **Hole Depth** и **Hole Wire** (<small>(v0.17)</small> ). Число Hole Wire может быть получено в трёхмерном окне из панели задач окна, доступной при двойном клике на окне в древе проектов
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Arch](Arch_Workbench.md) > Arch Window/ru
