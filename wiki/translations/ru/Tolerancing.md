...
![GD&T 3D аннотации](images/Tolerancing_Annotated_Design_Model.png ) Геометрические размеры и допуски (GD&T) означают указание допустимых пределов/отклонений размеров. Здесь мы говорим строго о геометрических допусках: реальной погрешности формы, размеров, местоположения, по отношению к спроектированному идеалу.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Roadmap](Category_Roadmap.md) > [TechDraw](Category_TechDraw.md) > Tolerancing/ru
