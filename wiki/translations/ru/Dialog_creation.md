...
## Проектирование диалога {#проектирование_диалога}
...
## Создание диалога {#создание_диалога}
...
## Конвертация нашего диалога в python {#конвертация_нашего_диалога_в_python}
...
## Делаем так чтобы наш диалог делал что-нибудь {#делаем_так_чтобы_наш_диалог_делал_что_нибудь}
