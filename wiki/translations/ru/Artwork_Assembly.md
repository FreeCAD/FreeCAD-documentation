...
!!! Так как вышел FreeCAD 0.19, то папка Assembly больше не существует!!!

Некоторые из них все ещё используются с внешним верстаком Assembly3. Они могут быть найдены в ветке Realthunder\'s ссылок FreeCAD и добавлены ниже. Смотри английскую версию страницы.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Assembly](Category_Assembly.md) > Artwork Assembly/ru
