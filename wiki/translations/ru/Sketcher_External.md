...
### Внешний вид при успешном соединении {#внешний_вид_при_успешном_соединении}
...
### Сходство со вспомогательной геометрией {#сходство_со_вспомогательной_геометрией}
...
### Использование внешней геометрии в верстаке PartDesign {#использование_внешней_геометрии_в_верстаке_partdesign}
...
### Использование внешней геометрии в верстаке Part {#использование_внешней_геометрии_в_верстаке_part}
