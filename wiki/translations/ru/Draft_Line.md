...
1.  There are several ways to invoke the command:
    ...
    -   [Draft](Draft_Workbench.md): Select the **Drafting → <img src="images/Draft_Line.svg" width=16px> Line** option from the menu.
    -   [BIM](BIM_Workbench.md): Select the **2D Drafting → <img src="images/Draft_Line.svg" width=16px> Line** option from the menu.
