...
Инструмент «Линия» создает прямую линию, определяемую двумя точками. Он использует набор [Draft Linestyle](Draft_Linestyle.md) на панели инструментов «Тревожный лоток». Инструмент «Линия» ведет себя точно так же, как инструмент [Draft Wire](Draft_Wire.md), за исключением того, что он останавливается после двух точек.
...
1.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Drafting → <img src="images/Draft_Line.svg" width=16px> Line}} option from the menu.
    -   Use the keyboard shortcut: **L** then **I**.
2.  The {{MenuCommand|Line}} task panel opens. See [Options](#Options.md) for more information.
...
-    {{PropertyData/ru|Subdivisions}}: Разделяет линию с заданным количеством подразделений <small>(v0.16)</small> 
