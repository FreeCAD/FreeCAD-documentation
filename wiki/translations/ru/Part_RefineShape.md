...
- GuiCommand:/ru
   ...
   Name/ru:Part RefineShape
   MenuLocation:Деталь → Уточнить форму
...
Удаляет ненужные линии. После булевых операций некоторые линии, определённые в предшествующих формах, остаются видимыми, этот инструмент создаёт полностью очищенную копию.
...
-   Unlike the <img alt="" src=images/OpenSCAD_RefineShapeFeature.svg  style="width:24px;"> _ won\'t update when the preceding shapes are changed.
