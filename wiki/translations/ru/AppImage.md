...
{{VeryImportantMessage|Если приведенные ниже загрузочные ссылки не работают, загрузите файлы вручную из раздела «Assets» [https://github.com/FreeCAD/FreeCAD/releases '''FreeCAD Github Releases''']}}
