...
Файлы из этой папки не могут быть выложены здесь, так как имеют расширение файла `.xpm`.

В прошлом значки `.xpm` использовались в качестве наложений при отображении ограничений в [3D виде](3D_view/ru.md). Теперь вместо этого используются \"указатели\" в формате SVG.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Sketcher](Category_Sketcher.md) > Artwork Sketcher/ru
