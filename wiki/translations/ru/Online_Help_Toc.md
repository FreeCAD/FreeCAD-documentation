...
-   Введение
    ...
    -   [Установка дополнений](Installing_additional_components/ru.md)

-   Работа с FreeCAD
    -   [Начало работы](Getting_started/ru.md)
    -   [Управление мышью](Mouse_navigation/ru.md)
    -   [Методы выделения](Selection_methods/ru.md)
...
-   Настройка FreeCAD
    ...
    -   [Установка основных настроек](Preferences_Editor/ru.md)
