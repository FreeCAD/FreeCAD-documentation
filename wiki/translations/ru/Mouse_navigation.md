...
|Pan_mode_text=Режим перемещения: удерживая кнопку **Ctrl**, один раз нажимаем правую кнопку мыши, затем перемещаем указатель.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Mouse navigation/ru
