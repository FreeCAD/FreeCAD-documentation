...
Предыдущие версии: [0.12](Release_notes_012.md) - [0.11](Release_notes_011.md)
...
-   **Новый инструмент создания крыш**: Теперь в Архитектурном модуле доступен новый [инструмент создания крыш](Arch_Roof.md) , который позволяет вам быстро создать скатные крыши из выбранных граней.
