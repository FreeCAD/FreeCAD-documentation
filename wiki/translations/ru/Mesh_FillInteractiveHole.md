...
1.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Meshes → <img src="images/Mesh_FillInteractiveHole.svg" width=16px> Close hole}} option from the menu.
...
7.  Select the {{MenuCommand|Leave hole-filling mode}} option from the [3D view](3D_view.md) context menu to finish the command.
