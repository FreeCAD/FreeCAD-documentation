...
-   Используйте команду [Импортировать\...](Std_Import/ru.md) для импорта Excel ***.xlsx** файлов.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Spreadsheet](Spreadsheet_Workbench.md) > Spreadsheet Import/ru
