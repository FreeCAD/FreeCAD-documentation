...
## Преобразование объектов Part в полигональную сетку {#преобразование_объектов_part_в_полигональную_сетку}
...
## Преобразование полигональных сеток в объекты Part {#преобразование_полигональных_сеток_в_объекты_part}
