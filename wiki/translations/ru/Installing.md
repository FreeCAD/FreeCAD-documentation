...
## Стороннее программное обеспечение {#стороннее_программное_обеспечение}
...
#### Конвертер Файлов ODA {#конвертер_файлов_oda}
...
### Конечные элементы {#конечные_элементы}
...
[FEniCS](https://fenicsproject.org) - это вычислительная платформа для решения уравнений в частных производных (partial differential equations, PDE), которые широко используются при решении задач МКЭ. Он используется [верстаком FEM](FEM_Module/ru.md).
