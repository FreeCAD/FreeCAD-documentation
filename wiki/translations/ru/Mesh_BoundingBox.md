...
2.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Meshes → Analyze → <img src="images/Mesh_BoundingBox.svg" width=16px> Boundings info...}} option from the menu.
3.  The {{MenuCommand|Boundings}} dialog box opens showing the coordinates of the object\'s bounding box.
