...
### <img alt="" src=images/Std_DrawStyleAsIs.svg  style="width:32px;"> Как есть {#std_drawstyleasis.svg_как_есть}
...
### <img alt="" src=images/Std_DrawStylePoints.svg  style="width:32px;"> Точки {#std_drawstylepoints.svg_точки}
...
### <img alt="" src=images/Std_DrawStyleWireFrame.svg  style="width:32px;"> Каркас {#std_drawstylewireframe.svg_каркас}
...
### <img alt="" src=images/Std_DrawStyleHiddenLine.svg  style="width:32px;"> Скрытые линии {#std_drawstylehiddenline.svg_скрытые_линии}
...
### <img alt="" src=images/Std_DrawStyleNoShading.svg  style="width:32px;"> Без затенения {#std_drawstylenoshading.svg_без_затенения}
...
### <img alt="" src=images/Std_DrawStyleFlatLines.svg  style="width:32px;"> Плоские линии {#std_drawstyleflatlines.svg_плоские_линии}
