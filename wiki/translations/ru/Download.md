...
## Текущая стабильная версия {#текущая_стабильная_версия}
...
### Примечания для Windows пользователей {#примечания_для_windows_пользователей}
...
### Примечание для Mac OS X пользователей {#примечание_для_mac_os_x_пользователей}

Минимальная поддерживаемая версия: Mac OS X 10.12 *Sierra*

### Примечания для GNU/Linux пользователей {#примечания_для_gnulinux_пользователей}
...
## Разрабатываемые версии {#разрабатываемые_версии}
...
## Дополнительные модули и макросы {#дополнительные_модули_и_макросы}
