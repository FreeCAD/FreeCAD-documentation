...
2\. Убедитесь, что единицы измерения установлены в меню **Правка , Настройки , Основные , Единицы измерения** правильно. Например, {{incode   МКС }}{: mediawiki} хороши для работы с расстояниями в типичных строениях; и установите число знаков после запятой на {{incode   4}}{: mediawiki}, чтобы учитывать малейшие доли метра.

3\. Используйте кнопку Показывать сетку для показа сетки с достаточным разрешением. Вы можете изменить вид сетки в меню **Правка , Настройки , Draft , Сетка и привязка , Сетка**. Установите линии через каждые {{incode   50 mm}}{: mediawiki}, с главными линиями каждые {{incode   20}}{: mediawiki} линий , и {{incode   1000 линий}}{: mediawiki} всего .
...
:   5.1. Первая точка в ; в диалоге введите **0** **m** **Enter**, **4** **m** **Enter**, **0** **m** **Enter**.
:   5.2. Вторая точка в ; в диалоге введите **2** **m** **Enter**, **0** **m** **Enter**, **0** **m** **Enter**.
:   5.3. Третья точка в ; в диалоге введите **4** **m** **Enter**, **0** **m** **Enter**, **0** **m** **Enter**.
:   5.4. Четвёртая точка в ; в диалоге введите **6** **m** **Enter**, **2** **m** **Enter**, **0** **m** **Enter**.
:   5.4. Пятая точка в ; в диалоге введите **6** **m** **Enter**, **5** **m** **Enter**, **0** **m** **Enter**.
...
:   
    **Примечание:**убедитесь, что чекбокс **Относительно ** не отмечен, когда вводите абсолютные координаты.
:   
...
---
⏵ [documentation index](../README.md) > [Arch](Category_Arch.md) > [Draft](Category_Draft.md) > [Sketcher](Category_Sketcher.md) > Tutorial custom placing of windows and doors/ru
