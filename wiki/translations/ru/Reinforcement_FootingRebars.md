---
 GuiCommand:
   ...
   SeeAlso: Reinforcement_Workbench/ru, Arch_Rebar/ru
---

# Reinforcement FootingRebars/ru
...
Инструмент [Армирование фундамента](Arch_Rebar_Footing_Reinforcement/ru.md) позволяет пользователю армировать фундамент таких объектов как [Структуры](Arch_Structure/ru.md).
...
2\. Then select **[Footing Reinforcement](Reinforcement_FootingRebars.md)** from the rebar tools.
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > [BIM](Category_BIM.md) > Reinforcement FootingRebars/ru
