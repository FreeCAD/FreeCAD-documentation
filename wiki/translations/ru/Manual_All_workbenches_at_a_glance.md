...
<div class="mw-translate-fuzzy">
  ...
  <img alt="" src=images/Part_Torus.svg  style="width:32px;"> [Torus](Part_Torus/ru.md)                                Рисует тор (кольцо)                                             <img alt="" src=images/Part_CreatePrimitives.svg  style="width:32px;"> [Create primitives](Part_CreatePrimitives/ru.md)   Создаёт различные параметрические примитивы по выбору
