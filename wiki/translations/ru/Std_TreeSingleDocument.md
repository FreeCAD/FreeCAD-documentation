...
In SingleDocument mode you can switch to a different document by activating a 3D view belonging to that document. You can do this in the [Main view area](Main_view_area.md) or via the {{MenuCommand|Windows}} menu.
