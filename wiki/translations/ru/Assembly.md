...
В общих словах, вам не нужны специальные инструменты для создания сборок, нужно просто иметь множество различных [тел](Body/ru.md), расположенных каким-то образом.
...
-   изменить параметр [размещение](Placement/ru.md) непосредственно в [редакторе свойств](Property_editor/ru.md).
