...
-   Yorik van Havre wrote \"[The FreeCAD Manual](Manual:Introduction.md)\" as an introductory book on how to use FreeCAD.
...
## Дополнительные модула {#дополнительные_модула}
