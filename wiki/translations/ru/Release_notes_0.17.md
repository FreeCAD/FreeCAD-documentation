...
-   [Верстак Manipulator](Manipulator_Workbench.md) нацелен на помощь в Выравнивании, Перемещении, Вращении и Измерении 3D-объектов (Part Design allowed) через дружественный графический интерфейс.
...
-   [Верстак Flamingo](Flamingo_Workbench/ru.md), набор улучшенных команд и объектов FreeCAD, которые ускоряют черчение рам и трубопроводов.

-   [Верстак Civil Engineering/Transportation](Civil_Engineering_Workbench/ru.md)
...
---
[documentation index](../README.md) > [News](Category_News.md) > Release notes 0.17/ru
