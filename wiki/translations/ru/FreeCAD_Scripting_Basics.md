...
## Написание сценариев Python в FreeCAD {#написание_сценариев_python_в_freecad}
...
### Объекты модулей App и Gui {#объекты_модулей_app_и_gui}
...
### Объекты документа {#объекты_документа}
...
## Использование дополнительных модулей {#использование_дополнительных_модулей}
...
### Создание объектов {#создание_объектов}
...
### Запрос объектов {#запрос_объектов}
