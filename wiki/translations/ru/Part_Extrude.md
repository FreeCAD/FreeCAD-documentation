...
2.  Нажмите на кнопку **<img src="images/Part_Extrude.svg" width=16px> [Выдавить](Part_Extrude/ru.md)** на панели команд, или перейдите в меню {{MenuCommand|Деталь → Выдавить...}}
...
## Сравнение с [Выдавить в PartDesign](PartDesign_Pad/ru.md) {#сравнение_с_выдавить_в_partdesign}
