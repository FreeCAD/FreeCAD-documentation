...
### Экспорт в слайсеры {#экспорт_в_слайсеры}
...
### Преобразование объектов в сетки {#преобразование_объектов_в_сетки}
...
### Использование Slic3r {#использование_slic3r}
...
### Использование плагина Cura {#использование_плагина_cura}
...
### Генерация G-кода {#генерация_g_кода}


{{VeryImportantMessage|'''Внимание:''' Этот раздел был сделан для FreeCAD 0.16. В создание траекторий инструментов были внесены большие изменения. Смотрите документацию [верстака Path](Path_Workbench/ru.md) в целом или учебник вроде [Тропинки для нетерпеливых](Path_Walkthrough_for_the_Impatient/ru.md)!}}
