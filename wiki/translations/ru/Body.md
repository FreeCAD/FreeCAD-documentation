...
Или, вместо использования [эскизов](Sketch.md), можно добавить примитивный [PartDesign Features](PartDesign_Feature.md), например, **[<img src=images/PartDesign_AdditiveBox.svg style="width   *16px"> [PartDesign Additive box](PartDesign_AdditiveBox.md)**. Для создания финального объёма можно использовать любое число прибавляющих и вычитающих свойств.
