...
The preferences screen of the [Start Workbench](Start_Workbench.md) is found in the [Preferences Editor](Preferences_Editor.md), {{MenuCommand|Edit → Preferences → Start}}.
