...
Смотрите [piano_jonas unofficial \"Compile On openSUSE\" guide](https   *//forum.freecadweb.org/viewtopic.php?f=4&t=49726).
...
Для 0.20_dev   * {{Code|lang=bash|code=
cmake ../freecad-source
}}
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Developer_Documentation](Category_Developer_Documentation.md) > [Developer](Category_Developer.md) > Compile on Linux/ru
