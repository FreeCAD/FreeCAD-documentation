...
<img alt="" src=images/Link.svg  style="width:32px;"> _ из уже собранных узлов и из множества повторно используемых компонентов, таких как винты, гайки и аналогичные крепежные изделия.
