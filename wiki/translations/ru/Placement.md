...
![Размещение в панели Просмотр свойств](images/PlacementPropertiesv10-800x800.png ) 
...
![Скрипты размещения как y/p/r и Matrix и его [API](images/Placement_API/ru.md).](PlacePyConv10.png ) 
