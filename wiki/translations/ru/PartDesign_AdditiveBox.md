...
- GuiCommand   */ru
   ...
   Name/ru   *PartDesign AdditiveBox
...
Вставляет примитивный блок в активное тело в качестве первого элемента или объединяет его с существующим элементом (ами).
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [PartDesign](PartDesign_Workbench.md) > PartDesign AdditiveBox/ru
