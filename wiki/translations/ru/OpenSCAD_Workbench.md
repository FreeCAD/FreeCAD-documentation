...
-   [Импорт кода OpenSCAD](Import_OpenSCAD_code/ru.md)
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [OpenSCAD](Category_OpenSCAD.md) > OpenSCAD Workbench/ru
