...
**FreeCAD 1.0** был выпущен **DD MM 2023**, скачать его можно со [страницы загрузок](Download/ru.md). Текущая страница содержит описание новых возможностей и изменений.
...
## Интерфейс пользователя 
  ...
  <img alt="" src=images/DlgDisplayProperties_relnotes_1.0.png  style="width   *200px;">   В панель [внешнего вида](Std_SetAppearance/ru.md) добавлена возможность указания цвета вершин. [Pull request #7708](https   *//github.com/FreeCAD/FreeCAD/pull/7708)
...
-   *FreeCAD.EndingAdd*   * заменено на *FreeCAD.addImportType*. [Pull request #7167](https   *//github.com/FreeCAD/FreeCAD/pull/7167)
-   *FreeCAD.EndingGet*   * заменено на *FreeCAD.getImportType*. [Pull request #7167](https   *//github.com/FreeCAD/FreeCAD/pull/7167)
...
### Изменения в верстаке PartDesign 
...
Для сборки FreeCAD под определенную операционную систему ознакомьтесь с инструкциями   * [Windows](Compile_on_Windows/ru.md), [Linux](Compile_on_Linux/ru.md) и [macOS](Compile_on_MacOS/ru.md).

Поддерживаемые операционные системы   *

-   Windows 7, 8, 10 и 11
-   Linux Ubuntu Focal Fossa (20.04) и выше
