...
Скрипт [Macro_CartoucheFC](Macro_CartoucheFC/ru.md) позволяет создать пользовательское информационное поле на горизонтальном листе A3.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Obsolete Workbenches](Category_Obsolete Workbenches.md) > [Drawing](Category_Drawing.md) > Drawing Workbench/ru
