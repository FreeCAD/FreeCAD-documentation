...
-   Если вы никогда раньше не использовали программное обеспечение wiki, пожалуйста, прочитайте _, чтобы ознакомиться с используемой разметкой.
...
-   Используйте песочницу для тестирования кода, например, _ или конкретную страницу с вашим именем _.
...
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                      |                         | Используйте его, чтобы подчеркнуть фрагмент текста.                                                                                                                                                                                                                                            |
|                                                                                                               | **emphasis**                  |                                                                                                                                                                                                                                                                                                |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                                |                         | Используйте его в случае, когда нужно указать клавишу клавиатуры, которую необходимо нажать.                                                                                                                                                                                                   |
|                                                                                                               | **Alt**                            |                                                                                                                                                                                                                                                                                                |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                            |                         | Используйте его, для отображения клавиши в виде (.svg) изображения, которую нужно нажать. В качестве параметра, вы должны указать желаемый символ или номер ascii-кода символа.                                                                                                                |
|                                                                                                               | {{ASCII|A}}                            |                                                                                                                                                                                                                                                                                                |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                          |                         | Используйте его для указания кнопки в графическом пользовательском интерфейсе, которую необходимо нажать.                                                                                                                                                                                      |
|                                                                                                               | **Cancel**                      |                                                                                                                                                                                                                                                                                                |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                      |                         | Используйте его для указания имени файла или каталога.                                                                                                                                                                                                                                         |
|                                                                                                               | {{FileName|File name}}                 |                                                                                                                                                                                                                                                                                                |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                          |                         | Используйте его для выделения блоков исходного кода написанного моноширинным шрифтом. Содержимое должно умещаться в одну строку.                                                                                                                                                               |
|                                                                                                               | `import FreeCAD`              |                                                                                                                                                                                                                                                                                                |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                      |                         | Используйте его, чтобы указать, что функция устарела в указанной версии FreeCAD.                                                                                                                                                                                                               |
|                                                                                                               | {{Obsolete|0.19}}                      |                                                                                                                                                                                                                                                                                                |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                  |                         | Используйте его, чтобы указать, что функция была введена в указанной версии FreeCAD.                                                                                                                                                                                                           |
|                                                                                                               | {{Version/ru|0.18}}                    |                                                                                                                                                                                                                                                                                                |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
Изображения можно загрузить через _ страницу.
...
---
[documentation index](../README.md) > [Documentation](Category_Documentation.md) > WikiPages/ru
