...
## Настройка FreeCAD {#настройка_freecad}
...
## Написание сценариев FreeCAD {#написание_сценариев_freecad}
...
#### Получение доступа к визуализатору сцен - Coin {#получение_доступа_к_визуализатору_сцен___coin}
...
### Управление Qt интерфейсом {#управление_qt_интерфейсом}
...
### Работа с параметрическими объектами {#работа_с_параметрическими_объектами}
...
## Продвинутые модификации {#продвинутые_модификации}
...
## Учебники по Python {#учебники_по_python}
...
## Проекты сообщества {#проекты_сообщества}
