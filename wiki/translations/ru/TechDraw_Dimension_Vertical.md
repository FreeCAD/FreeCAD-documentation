...
- GuiCommand:/ru
   ...
   Name/ru:TechDraw Dimension Vertical
   Workbenches:[TechDraw](TechDraw_Workbench/ru.md)
   Shortcut:**Shift** + **V**
   SeeAlso:[TechDraw Dimension Length](TechDraw_Dimension_Length/ru.md), [TechDraw Dimension Horizontal](TechDraw_Dimension_Horizontal/ru.md)
---
