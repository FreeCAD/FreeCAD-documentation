---
 GuiCommand:
   ...
   Version: 0.19
   SeeAlso: Reinforcement_Workbench/ru, Arch_Rebar/ru, Arch_Rebar_ColumnReinforcement_TwoTiesSixRebars/ru
---

# Reinforcement BeamRebars/ru
...
The [Reinforcement BeamRebars](Reinforcement_BeamRebars.md) tool allows the user to create reinforcing bars inside a Beam [Arch Structure](Arch_Structure.md) object.
...
2\. Then select **<img src="images/Reinforcement_BeamRebars.svg" width=16px> [Beam Reinforcement](Reinforcement_BeamRebars.md)** from the rebar tools.
...
The Reinforcement BeamRebars tool can be used in [macros](macros.md) and from the [Python](Python.md) console by using the following function:
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > [BIM](Category_BIM.md) > Reinforcement BeamRebars/ru
