...
-   Когда эскизы используются в <img alt="" src=images/Workbench_PartDesign.svg  style="width:24px;"> <img src=images/PartDesign_Body.svg style="width:верстаке PartDesign](PartDesign_Workbench/ru.md), обычно эскиз для точной копии должен находиться в той же **[16px"> [теле PartDesign](PartDesign_Body/ru.md)** в качестве текущего активного эскиза. Если копируемый эскиз отсутствует в активном [теле](PartDesign_Body/ru.md), указатель мыши не даст выбирать. В этом случае удерживайте **Ctrl**, чтобы разрешить выбор эскизов из других тел.
