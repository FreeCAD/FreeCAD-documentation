...
Этот инструмент позволяет поместить вид выбранной [электронной таблицы](Spreadsheet_Workbench/ru.md) на [чертёжном](Drawing_Workbench/ru.md) листе.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Drawing](Drawing_Workbench.md) > Drawing SpreadsheetView/ru
