...
## Представление FreeCAD {#представление_freecad}
...
## Дополнительное опциональное содержимое {#дополнительное_опциональное_содержимое}
...
## Советы по быстрой установке {#советы_по_быстрой_установке}
...
### Приблизительный список вещей, которые Вы должны знать {#приблизительный_список_вещей_которые_вы_должны_знать}
...
## Упражнение: моделирование крышевой панели {#упражнение_моделирование_крышевой_панели}
