...
## Передача данных из верстака FEM {#передача_данных_из_верстака_fem}

В верстаке FEM выделите объект CCX\_Results, затем используйте меню {{MenuCommand|Файл > Экспортировать... > FEM result VTK (*.vtk *.vtu)}} для экспорта данных VTK.

## Импорт данных в Paraview {#импорт_данных_в_paraview}

На начальном экране отображается пустой Pipeline Browser. Здесь будут видны импортированные объекты данных VTK и примененные объекты фильтров (для геометрии или данных). <img alt="" src=images/PVPic1.png  style="width:500px;">
...
## Сохранение/загрузка состояния {#сохранениезагрузка_состояния}
...
## Визуализация результатов из верстака FEM {#визуализация_результатов_из_верстака_fem}
...
## Базовые данные, отображаемые на исходной геометрии {#базовые_данные_отображаемые_на_исходной_геометрии}
...
## Применение фильтров к результатам верстака FEM {#применение_фильтров_к_результатам_верстака_fem}
...
## Применение фильтров для получения сложных результатов из базовых данных импорта {#применение_фильтров_для_получения_сложных_результатов_из_базовых_данных_импорта}
...
## Интегрирование по срезу {#интегрирование_по_срезу}
...
## Интегрирование по линии {#интегрирование_по_линии}
...
## Представление векторных результатов с помощью фильтра Glyph 3D {#представление_векторных_результатов_с_помощью_фильтра_glyph_3d}
...
## Экспорт графических результатов {#экспорт_графических_результатов}

Чтобы экспортировать окно RenderView, выделите окно и используйте опцию меню {{MenuCommand|File > Save Screenshot}} {{Tutorials navi}} {{FEM Tools navi}} 
