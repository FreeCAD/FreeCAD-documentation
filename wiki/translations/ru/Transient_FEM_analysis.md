...
## Создание модели {#создание_модели}
...
5.  Сместите эту деталь на 2 мм по оси Z (через {{MenuCommand|Placement → Position → z}}).
...
## Подготовка и выполнение расчёта по МКЭ {#подготовка_и_выполнение_расчёта_по_мкэ}

### Назначение материалов {#назначение_материалов}
...
### Задание граничных условий {#задание_граничных_условий}
