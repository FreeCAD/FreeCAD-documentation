...
Заменить объект в [древе компонентов](tree_view/ru.md).
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [OpenSCAD](OpenSCAD_Workbench.md) > OpenSCAD ReplaceObject/ru
