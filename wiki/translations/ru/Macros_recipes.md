...
На этой странице перечислены [макросы](Macros/ru.md), которые могут добавить функциональность FreeCAD\'у.

Если вы написали макрос и хотите включить его в одну из категорий на этой странице, перейдите к [Документирование макросов](Macro_documentation/ru.md), чтобы узнать больше о правильном документировании макроса.
...
### <img alt="" src=images/Part_CheckGeometry.svg  style="width:32px;"> Операции в 3D виде 
...
### <img alt="" src=images/Draft_FlipDimension.svg  style="width:32px;"> Анимация 
...
### <img alt="" src=images/Applications-python.svg  style="width:32px;"> Программирование и создание скриптов 
...
### <img alt="" src=images/Arch_MeshToShape.svg  style="width:32px;"> Преобразование 
...
### <img alt="" src=images/Workbench_Draft.svg  style="width:32px;"> Верстак Draft и 2D 
...
### <img alt="" src=images/Drawing-orthoviews.svg  style="width:32px;"> Верстак Drawing 

[Верстак Drawing](Drawing_Workbench/ru.md) устарел с версии FreeCAD 0.17. Вместо него рассмотрите возможность использования [верстака TechDraw](TechDraw_Workbench/ru.md).
...
### <img alt="" src=images/Workbench_FEM.svg  style="width:32px;"> Верстак Fem 
...
### <img alt="" src=images/Part_Measure_Linear.svg  style="width:32px;"> Информация и измерения 


<div class="mw-collapsible-content">

-    <img style="width:16px;" src="images/BoundBoxTracing.png"> [Макрос BoundingBox Tracing](Macro_BoundingBox_Tracing.md): Этот макрос обводит красным контуром (можно редактировать) ограничивающую рамку с 6 прямоугольниками.
...
### <img alt="" src=images/Draft_VisGroup.svg  style="width:32px;"> Библиотеки 
...
### <img alt="" src=images/Bound-expression.svg  style="width:32px;"> Математические функции 
...
### <img alt="" src=images/Part_Primitives.svg  style="width:32px;"> Создание объектов 
...
### <img alt="" src=images/Std_TransformManip.svg  style="width:32px;"> Преобразование объекта 
...
### <img alt="" src=images/Workbench_PartDesign.svg  style="width:32px;"> Верстак PartDesign 
...
### <img alt="" src=images/View.svg  style="width:32px;"> 3D Принтер 
...
### <img alt="" src=images/Preferences-raytracing.svg  style="width:32px;"> Визуализация (Raytracing) 
...
-    <img style="width:16px;" src="images/Macro_FreeCAD_to_Kerkythea.png"> [Макрос "FreeCAD to Kerkythea"](Macro_FreeCAD_to_Kerkythea.md): Экспорт из FreeCAD в Kerkythea.
...
### <img alt="" src=images/Spreadsheet.svg  style="width:32px;"> Верстак Spreadsheet 
...
### <img alt="" src=images/Arch_Survey.svg  style="width:32px;"> Утилиты 
...
### <img alt="" src=images/Bulb.svg  style="width:32px;"> Мастера (Wizards) 
...
Используйте [Addon Manager](Std_AddonMgr/ru.md) в меню **Инструменты → Менеджер дополнений** для установки макроса, включенного в [FreeCAD-macros](https://github.com/FreeCAD/FreeCAD-macros) репозиторий. <small>(v0.17)</small> 
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Macros](Category_Macros.md) > [Python Code](Category_Python Code.md) > Macros recipes/ru
