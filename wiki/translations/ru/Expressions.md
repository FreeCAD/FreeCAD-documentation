...
Свойства можно определять с помощью математических выражений. В графическом интерфейсе счетчики или поля ввода, привязанные к свойствам, содержат синий значок <img alt="" src=images/Sketcher_Expressions.png  style="width:32px;">. Щелчок по значку или ввод знака равенства **&#61;** вызывает редактор выражения для этого конкретного свойства.
...
## Поддерживаемые константы {#поддерживаемые_константы}
...
## Поддерживаемые операторы {#поддерживаемые_операторы}
...
#### Форматирование строк {#форматирование_строк}
...
## Условные выражения {#условные_выражения}
...
## Единицы измерений {#единицы_измерений}
