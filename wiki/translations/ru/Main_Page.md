...
<img alt="" src=images/Crystal_Clear_app_display.png  style="width   *64px;"> [Центр пользователей](User_hub/ru.md)   * Эта страница содержит документацию, полезную для пользователей FreeCAD в целом   * список всех верстаков, подробные инструкции по установке и использованию FreeCAD, учебные пособия и всё необходимое для начала работы. 
 ...
 <img alt="" src=images/Crystal_Clear_app_tutorials.png  style="width   *64px;"> [Центр разработчиков](Developer_hub/ru.md)   * В этом разделе содержатся материалы для разработчиков   * как самостоятельно скомпилировать FreeCAD, какую структуру имеет исходный код FreeCAD и как в нем ориентироваться, а также как разработать новые верстаки и встроить собственное приложение в FreeCAD. 
...
В проекте FreeCAD есть чем заняться, если вы заинтересованы в том, чтобы помочь нам. Конечно, есть задачи программирования для программистов на C++ или Python, но есть также много вещей, которые вы можете сделать, даже если вы не умеете кодировать, например   *
