...
<img alt="" src=images/Crystal_Clear_app_display.png  style="width:64px;"> [Центр пользователей](User_hub/ru.md): Эта страница содержит документацию, полезную для пользователей FreeCAD в целом: список всех верстаков, подробные инструкции по установке и использованию FreeCAD, учебные пособия и всё необходимое для начала работы. 
 ...
 <img alt="" src=images/Crystal_Clear_app_tutorials.png  style="width:64px;"> [Центр разработчиков](Developer_hub/ru.md): Этот раздел содержит материалы для разработчиков: Как самостоятельно скомпилировать FreeCAD, какую структуру имеет исходный код FreeCAD, как ориентироваться в исходном коде, как разрабатывать новые верстаки и встраивать FreeCAD в собственное приложение. 
