...
Это wiki-документация о [FreeCAD](http://www.freecadweb.org/?lang=ru). Существует несколько способов использования данной документации: путём изучения пользовательских уголков, следуя руководству или используя пункт меню справки (Help) в FeeCAD . Это пока еще незавершенная работа, написанная сообществом пользователей и разработчиков FreeCAD. Если вы обнаружили неверную или отсутствующую информацию, пожалуйста [сделайте FreeCAD лучше](Special:MyLanguage/help_FreeCAD/ru.md)!

## Уголки

<img alt="" src=images/Crystal_Clear_app_display.png  style="width:64px;"> [Уголок пользователей](User_hub/ru.md): Эта страница содержит документацию, полезную для пользователей FreeCAD в целом: список всех верстаков, подробные инструкции по установке и использованию FreeCAD, учебные пособия и все необходимое для начала работы. 
 <img alt="" src=images/Crystal_Clear_app_terminal.png  style="width:64px;"> [Уголок опытных пользователей](Power_users_hub/ru.md): На этой странице собрана документация для опытных пользователей и людей, заинтересованных в написании скриптов на Python. Вы также найдете там хранилище макросов, инструкции по их установке и использованию и дополнительную информацию о настройке FreeCAD для специфических задач. 
 <img alt="" src=images/Crystal_Clear_app_tutorials.png  style="width:64px;"> [Уголок разработчиков](Developer_hub.md): В этом разделе содержатся материалы для разработчиков: как самостоятельно скомпилировать FreeCAD, какую структуру имеет исходный код FreeCAD и как в нем ориентироваться, а также как разработать новые верстаки и встроить собственное приложение в FreeCAD. 
...
В следующей таблице перечислены все статьи этой вики, которые составляют основу автономной документации, поставляемой с приложением FreeCAD. Они доступны на нескольких языках:
...
Если вы заинтересованы помочь нам, то внутри проекта FreeCAD найдётся множество дел. Есть задачи написания кода для программистов C++ или Python, но есть также множество вещей, которые вы могли бы делать даже не умея программировать, такие как

-   писать документацию и [редактировать вики](WikiPages/ru.md)
-   помогать новичкам
-   переводить приложение или документацию
...
Страница [Помоги FreeCAD](Special:MyLanguage/help_FreeCAD.md) описывает это более детально. Начиная с 2016 года, FreeCAD так же участвует в [Google Summer of Code](Google_Summer_of_Code.md). Еще один возможный путь помочь и внести вклад в проект FreeCAD это страница [Уголок участников](Contributors_hub.md)
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Documentation](Category_Documentation.md) > Main Page/ru
