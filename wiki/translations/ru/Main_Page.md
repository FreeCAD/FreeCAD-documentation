...
<img alt="" src=images/Crystal_Clear_app_display.png  style="width   *64px;"> [Центр пользователей](User_hub/ru.md)   * Эта страница содержит документацию, полезную для пользователей FreeCAD в целом   * список всех верстаков, подробные инструкции по установке и использованию FreeCAD, учебные пособия и всё необходимое для начала работы. 
 <img alt="" src=images/Crystal_Clear_app_terminal.png  style="width   *64px;"> [Центр опытных пользователей](Power_users_hub/ru.md)   * На этой странице собрана документация для опытных пользователей и людей, заинтересованных в написании скриптов на Python. Вы также найдете там хранилище макросов, инструкции по их установке и использованию и дополнительную информацию о настройке FreeCAD для специфических задач. 
 <img alt="" src=images/Crystal_Clear_app_tutorials.png  style="width   *64px;"> [Центр разработчиков](Developer_hub.md)   * В этом разделе содержатся материалы для разработчиков   * как самостоятельно скомпилировать FreeCAD, какую структуру имеет исходный код FreeCAD и как в нем ориентироваться, а также как разработать новые верстаки и встроить собственное приложение в FreeCAD. 
