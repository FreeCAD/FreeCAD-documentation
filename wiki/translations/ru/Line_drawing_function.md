...
## Основной скрипт {#основной_скрипт}
...
## Подробное описание {#подробное_описание}
...
## Тестирвание сценария {#тестирвание_сценария}
...
## Регистрация сценария {#регистрация_сценария}
...
## Вы хотите большего? {#вы_хотите_большего}
