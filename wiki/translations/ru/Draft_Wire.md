...
2.  Щелкните первую точку на трехмерном изображении или введите [ coord](Draft_Coordinates.md)
3.  Нажмите дополнительную точку на трехмерном представлении или введите [coordinate](Draft_Coordinates.md)
