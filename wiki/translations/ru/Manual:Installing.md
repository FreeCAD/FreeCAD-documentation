...
### Установка под Windows {#установка_под_windows}
...
### Установка в Linux {#установка_в_linux}
...
### Установка в Mac OS {#установка_в_mac_os}
...
### Установка базовых параметров {#установка_базовых_параметров}
...
### Установка дополнительного содержимого {#установка_дополнительного_содержимого}

Поскольку проект FreeCAD и его сообщество быстро растёт, и поскольку его легко расширять, сторонние разработчики и проекты членов сообщества и сторонних энтузиастов начинают появляться в самых неожиданных местах интернета. Большинство из этих внешних проектов представляют собой рабочие среды или макросы и могут быть легко установлены прямо из FreeCAD через [менеджер дополнений](AddonManager/ru.md) (Addons Manager), находящийся в меню **Инструменты**. Менеджер дополнений позволит вам установить много интересных компонентов, например:
