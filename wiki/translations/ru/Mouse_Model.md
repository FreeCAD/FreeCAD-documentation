...
-   В [Настройках](Preferences_Editor/ru#Navigation.md), {{MenuCommand|Правка → Настройки → Отображение → Трёхмерный вид → Трёхмерная навигация}}.
-   Правым кликом на пустом месте области пространственного вида и выбором {{MenuCommand|Стили навигации}} контекстного меню.

### Навигация CAD {#навигация_cad}
...
### Навигация OpenInventor {#навигация_openinventor}
...
### Навигация Blender {#навигация_blender}
...
### Навигация Touchpad {#навигация_touchpad}
...
### Навигация Gesture {#навигация_gesture}
...
В версии v0.18 этот метод по умолчанию отключён. Для разрешения {{MenuCommand|Правка → Параметры → Отображение}}, и снимите метку "Disable touchscreen tilt gesture".
}}

### Навигация MayaGesture {#навигация_mayagesture}
...
### Навигация Revit {#навигация_revit}
...
### Предварительный выбор {#предварительный_выбор}
...
## Управление Объектами {#управление_объектами}
...
## Поддержка оборудования {#поддержка_оборудования}

FreeCAD так же поддерживает несколько [3d мышей](3D_input_devices/ru.md).

## Проблемы Mac OS X {#проблемы_mac_os_x}
