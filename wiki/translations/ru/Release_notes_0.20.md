...
## Основные изменения {#основные_изменения}
...
### Известные Ограничения {#известные_ограничения}

## Пользовательский Интерфейс {#пользовательский_интерфейс}
...
## Менеджер Аддонов {#менеджер_аддонов}

## Архитектурный Верстак (Arch) {#архитектурный_верстак_arch}
...
## Верстак FEM (Метод Конечных Элементов) {#верстак_fem_метод_конечных_элементов}
...
### Further FEM Improvements {#further_fem_improvements}
...
## Верстак OpenSCAD {#верстак_openscad}
...
### Further improvements {#further_improvements_2}
...
### Верстак CurvedShapes {#верстак_curvedshapes}
