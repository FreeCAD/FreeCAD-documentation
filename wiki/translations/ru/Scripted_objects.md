...
### Что нужно знать {#что_нужно_знать}
...
## Другие примеры, посложней {#другие_примеры_посложней}
...
## Создание выделяемых объектов {#создание_выделяемых_объектов}
...
## Работа с простыми формами {#работа_с_простыми_формами}
...
## Дальнейшая информация {#дальнейшая_информация}
