...
#### Точка на плоскости {#точка_на_плоскости}
...
#### Круговая кромка на круговой кромке {#круговая_кромка_на_круговой_кромке}
...
#### Совпадение по оси {#совпадение_по_оси}
...
#### Параллельные оси {#параллельные_оси}
...
#### Ось параллельно плоскости {#ось_параллельно_плоскости}
...
#### Ось нормально плоскости {#ось_нормально_плоскости}
...
#### Ось под углом к плоскости {#ось_под_углом_к_плоскости}
...
#### Плоскости Параллельны {#плоскости_параллельны}
...
#### Плоскость на Плоскости {#плоскость_на_плоскости}
...
#### Плоскость под углом {#плоскость_под_углом}
...
#### Совпадение в Центре масс {#совпадение_в_центре_масс}
...
## Обработка ограничений {#обработка_ограничений}
...
## Специальные возможности {#специальные_возможности}

### Структура сборки {#структура_сборки}
...
### Вид всей сборки {#вид_всей_сборки}
...
### Конвертировать абсолютные пути в относительные {#конвертировать_абсолютные_пути_в_относительные}

С помощью меню {{MenuCommand|A2plus → Misc → <img src=images/A2p_SetRelativePathes.svg style="width:24px"> Convert absolute paths of imported parts to relative ones}} Вы можете конвертировать абсолютные пути импортированных деталей в относительные.
...
### Метод решения по умолчанию {#метод_решения_по_умолчанию}
...
### Поведение решателя по умолчанию {#поведение_решателя_по_умолчанию}
...
### Поведение при обновлении импортированных деталей {#поведение_при_обновлении_импортированных_деталей}
...
### Настройки интерфейса пользователя {#настройки_интерфейса_пользователя}
...
### Хранение файлов {#хранение_файлов}
...
### Использование Conflict Finder Tool {#использование_conflict_finder_tool}
...
### Проверка направления ограничения {#проверка_направления_ограничения}
...
### Удаление ограничений {#удаление_ограничений}
...
### Перемещение деталей {#перемещение_деталей}
...
### Настройка свойства Tip {#настройка_свойства_tip}
...
### Перенос старых сборок A2plus {#перенос_старых_сборок_a2plus}

Сборки, созданные с A2plus старше марта 2019 года, не показывают правильные значки для импортированных деталей и имеют устаревшие свойства. Эти сборки можно перенести в A2plus версии 0.4.35 и новее, используя меню {{MenuCommand|A2plus → Misc → <img src=images/A2p_Upgrade.svg style="width:24px"> Migrate proxies of imported parts}}. Сделав это, вы должны сохранить и снова открыть файл сборки.

### Избегайте символов подчеркивания {#избегайте_символов_подчеркивания}
...
### Фиксированная позиция {#фиксированная_позиция}
...
### Вращение деталей {#вращение_деталей}
...
#### Пример простого скрипта {#пример_простого_скрипта}
...
#### Пример интерактивного скрипта {#пример_интерактивного_скрипта}
...
### Команды скрипта {#команды_скрипта}
