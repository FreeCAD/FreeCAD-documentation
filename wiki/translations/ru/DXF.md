...
## Исторические данные {#исторические_данные}
...
## Методы импорта DXF в FreeCAD {#методы_импорта_dxf_в_freecad}
...
### Python DXF импортер {#python_dxf_импортер}
