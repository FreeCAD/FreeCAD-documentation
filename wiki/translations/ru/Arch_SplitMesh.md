...
Этот инструмент разбивает выбранную [сетку](Mesh_Workbench/ru.md) на отдельные компоненты
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Arch](Arch_Workbench.md) > Arch SplitMesh/ru
