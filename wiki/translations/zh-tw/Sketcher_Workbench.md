# <img alt="Sketcher workbench icon" src=images/Workbench_Sketcher.svg  style="width:64px;"> Sketcher Workbench/zh-tw
...
**速寫坊** 是用於創建平面幾何給 **[零件坊](PartDesign_Workbench.md)** 以及其他工作坊。一般而言平面幾何被視為大部分 CAD 模型起點。簡易平面草稿0可以\"擠出\"為立體形狀，進一步平面草稿可在立體表面開口，且草稿可在立體物表面定義\'路徑 （擠出）\'。搭配 [布林運算](Part_Workbench.md) 草稿形塑原創 solid shape 設計核心。
...
[<img src="images/Property.png" style="width:16px"> User Documentation/zh-tw](<img src="images/Property.png" style="width:16px"> User_Documentation/zh-tw.md) [<img src="images/Property.png" style="width:16px"> Workbenches](Category_Workbenches.md)
