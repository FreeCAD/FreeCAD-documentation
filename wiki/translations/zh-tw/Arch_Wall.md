...
本工具自草圖或任何 [物件](Part_Workbench.md) 或 [mesh](Mesh_Workbench.md) 生成牆體。一面牆無須以任何物件為生成基礎，這時牆為一立方體，以長寬高為其屬性。牆由其他形狀生成時，可基於：
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Arch](Arch_Workbench.md) > Arch Wall/zh-tw
