...
本手冊試圖以別於 [官方文件維基](Main_Page/zh-tw.md) 之方法構成。維基是由許多社群成員共同編纂，一如多數維基，包含巨量資訊，但不利新手存取與瀏覽。因此成為珍貴參考資源，卻非學習利器。本手冊將導覽維基資訊。然而我們希望由較少數量作者貢獻步驟教學、範例與統一筆調會更適合初次接觸 FreeCAD，且與維基相得益彰。

本手冊是為當前穩定版本 FreeCAD **0.18** (2019年早期) 而著。
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > Manual:Introduction/zh-tw
