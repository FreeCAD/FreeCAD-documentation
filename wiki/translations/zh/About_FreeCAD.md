...
FreeCAD项目最早始于2001年，详细内容详见[历史页面](history.md)。

FreeCAD由热情的开发人员和用户组成的社区进行维护和开发（参见[志愿者页面](contributors.md)）。他们在空闲时间志愿地为FreeCAD工作。他们无法保证FreeCAD包含您希望的所有内容，但他们通常会尽力而为！ 社区聚集在[FreeCAD论坛](http://forum.freecadweb.org)上，讨论了大多数想法和决定。加入我们吧！



---
![](images/Right_arrow.png) [documentation index](../README.md) > [User Documentation](Category_User Documentation.md) > About FreeCAD/zh
