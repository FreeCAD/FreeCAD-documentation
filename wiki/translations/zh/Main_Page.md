...
FreeCAD 会_。我们也缺乏 Mac OS X 平台的用户，如果你有一台 mac 机器，请[帮助我们](CompileOnMac.md)！另外，也欢迎你参与[FreeCAD 本地化翻译工作](Localisation.md)。如果你熟悉 C++ 或 Python 编程并且愿意参与开发，那就更好了，请到[论坛](http://forum.freecadweb.org/)联系我们！
