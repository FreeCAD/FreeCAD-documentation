...
FreeCAD 的功能被分为了不同的模块，每个模块负责某个具体[工作台的相关工作](Workbenches/zh.md)。FreeCAD 还使用了一种称之为后加载的观念，意即相关组件只有在需要时才被加载进来。或许你已经注意到，当你在 FreeCAD 工具栏中选择一个工作台时，此工作台和它的所有组件都同时被加载进来。这其中包含了它的首选项设置。
...
单击任何首选项显示左下角的**重置** 按钮，将freecad首选项的"全部"设置为其默认值。
...
[A2plus首选项](A2plus_Workbench#Preferences.md)
...
|                                                  |                                                                                                                                                                                                                                           |
+++
|                                      | If checked, the decimal separator of the selected language is used. Otherwise a dot is used.                                                                                                                                              |
| **Use selected language number format** |                                                                                                                                                                                                                                           |
|                                                  |                                                                                                                                                                                                                                           |
| <small>(v0.20)</small>                       |                                                                                                                                                                                                                                           |
+++
|                                      | If checked, the numerical keypad decimal separator will be substituted with the locale\'s separator. Needs FreeCAD to be restarted to take effect.                                                                                        |
...
{{docnav|[文档结构](Document_structure/zn.md)|[界面定制](Interface_Customization/zn.md)}}
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Preferences](Category_Preferences.md) > Preferences Editor/zh
