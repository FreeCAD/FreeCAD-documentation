...
## Изберете вашата операционна система {#изберете_вашата_операционна_система}
...
Освен включените по подразбиране в FreeCAD [работни плотове и модули](workbenches/bg.md), общността от потребители публикува постоянно растяща колекция от модули в интернет. Има няколко проекта да се обединят и организират тези модули, описани по-долу.
