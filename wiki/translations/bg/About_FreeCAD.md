...
За повече информация за възможностите на FreeCAD\'s вижте страниците [списък със способности](Feature_list/bg.md), [ последно добавените инструменти](Getting_started/bg#What's_new.md) или [\"Как да започнем\"](Getting_started/bg.md), или вижте още [скрийншот-и](screenshots.md).
...
Проектът FreeCAD е започнат през 2001. Историята му е описана [тук](history.md).
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [User Documentation](Category_User Documentation.md) > About FreeCAD/bg
