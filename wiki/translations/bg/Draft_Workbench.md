# <img alt="Draft workbench icon" src=images/Workbench_Draft.svg  style="width:64px;"> Draft Workbench/bg
...
Os objetos 2D criados podem ser usados para desenho geral de maneira similar ao Inkscape ou Autocad. Essas formas 2D também podem ser usadas como componentes básicos de objetos 3D criados com outras bancadas de trabalho, por exemplo, [ Part](Part_Workbench.md) e [ Bancada Arch](Arch_Workbench.md). A conversão de objetos do Draft para [ Sketches](Sketcher_Workbench.md) também é possível, o que significa que as formas também podem ser usadas com a [Bancada PartDesign](PartDesign_Workbench.md) para a criação de corpos sólidos.
...
---
⏵ [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [Draft](Category_Draft.md) > Draft Workbench/bg
