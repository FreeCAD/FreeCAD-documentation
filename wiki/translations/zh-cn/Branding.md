...
虽然[LGPL许可证允许在闭源应用程序中使用FreeCAD源代码](License.md)，但它也给出了严格的规则，即不允许将FreeCAD改个名字它并去掉它的许可证
...
接下来的几行定义FooApp应用程序的Config项。Config及其条目的描述，您可以在[启动和配置中找到](启动和配置.md)。
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Developer Documentation](Category_Developer Documentation.md) > Branding/zh-cn
