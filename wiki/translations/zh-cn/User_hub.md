...
-   [鼠标模块](Mouse_Model/zh-cn.md): 如何用鼠标在3D空间中游荡。
-   [文档结构](Document_structure/zh-cn.md): 一个FreeCAD文档是怎样组织的。
-   [偏好项和](Preferences_Editor/zh-cn.md)[个性化](Interface_Customization/zh-cn.md): 如何按你的需要配置FreeCAD。
-   [属性](Property_editor/zh-cn.md): 在FreeCAD里，如何使用对象属性。
-   [工作台式](Workbenches/zh-cn.md): FreeCAD怎样排布交互界面。
-   [宏](Macros/zh-cn.md): 如何轻松实现重复任务的自动化。
-   [文件格式](Import_Export/zh-cn.md): FreeCAD能够读写的不同文件格式。
...
发烧友们写了各种各样的宏用于扩展FreeCAD的能力。关于所有宏的列表，请参考[宏菜谱页面](macros_recipes/zh-cn.md)。

对于安装这些宏的指导说明，请参考[如何安装宏教程](How_to_install_macros/zh-cn.md)。
...
自FreeCAD 0.17版开始，可以利用[Addon Manager来安装宏](Std_AddonMgr.md)。对于现存的宏而言，可以参考[macros recipes](macros_recipes.md) 页面。而手动安装宏则可查阅[How to install macros](How_to_install_macros.md).
...
自FreeCAD 0.17版开始，可利用[Addon Manager来安装这些工作台](Std_AddonMgr.md)。关于手动安装请参考[How to install additional workbenches](How_to_install_additional_workbenches.md)。
