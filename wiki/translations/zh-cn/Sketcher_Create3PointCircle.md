...
此工具会根据用户拾取的圆周上三点来绘制一个圆。 在开启此工具时，鼠标指针会变为一个附有红色圆形图标的白色十字。 同时还会在侧面实时显示当前的指针坐标。
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher Create3PointCircle/zh-cn
