...
你可以从 [下载](Download/zh-cn.md) 页面下载最新的安装器。下载完成之后，只需要加载该磁盘映像，然后拖动它到应用程序目录或者你喜欢的任意目录下。
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Installing on Mac/zh-cn
