...
<div class="mw-translate-fuzzy">
  ...
  <img alt="" src=images/Part_Loft.png  style="width:32px;"> [Part_Loft](Part_Loft.md)                               从一个轮廓渐变到另一个轮廓                         <img alt="" src=images/Part_Offset.png  style="width:32px;"> [Offset](Part_Offset.md)                                            创建原始对象的缩放过的副本
