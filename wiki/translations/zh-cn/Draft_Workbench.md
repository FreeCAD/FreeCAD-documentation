...
-   _。
-   _，通过DXF导入工具导入或导出DWG文件。参见[FreeCAD and DWG Import](FreeCAD_and_DWG_Import.md)。
...
---
[documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Draft Workbench/zh-cn
