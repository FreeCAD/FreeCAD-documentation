...
|                                                 |     **Online**                                                                                                                                                                                                                                                                               |
|                                                 |                                                                                                                                                                                                                                                                                                       |
|                                                 |        * Enter the URL or leave blank to use the automatic [GitHub URL](https   *//github.com/FreeCAD/FreeCAD-documentation/tree/main/wiki). If {{Value|https   *//wiki.freecad.org/}} is used a **Translation suffix** can be specified, leave blank for the GitHub URL. |
|                                                 |                                                                                                                                                                                                                                                                                                          |
|                                                 | -                                                                                                                                                                                                                                                                                         |
|                                                 |     **From disk location**                                                                                                                                                                                                                                                                   |
|                                                 |                                                                                                                                                                                                                                                                                                       |
|                                                 |        * Enter the path where the downloaded FreeCAD documentation can be found.                                                                                                                                                                                                                            |
+++
