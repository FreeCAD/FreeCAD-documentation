...
捕捉功能可用于[底图工作台与](Draft_Workbench.md)[建筑工作台（Arch Workbench）中的大多工具](Arch_Workbench.md)，利用捕捉工具栏中的**<img src="images/Snap_Lock.svg" width=16px> [Draft ToggleSnap](Draft_ToggleSnap.md)**按钮即可对此功能进行全局开启或关闭。而通过{{MenuCommand|View → Toolbars → Draft Snap}}菜单便可以激活捕捉工具栏。通过点选捕捉工具栏中的各按钮，即可开启或关闭对应的捕捉方法。
