...
- GuiCommand:
   ...
   Version: 0.17
   SeeAlso: PartDesign_CompPrimitiveAdditive, PartDesign_SubtractiveCone
---

# PartDesign AdditiveCone/tr
...
---
⏵ [documentation index](../README.md) > [PartDesign](PartDesign_Workbench.md) > PartDesign AdditiveCone/tr
