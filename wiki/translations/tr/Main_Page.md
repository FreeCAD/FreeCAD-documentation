...
FreeCAD, cMake veya autotools kullanarak derlenebilir, git bağlantısı <https://github.com/FreeCAD/FreeCAD_sf_master> ve derleme talimatları için _, and [documented on the wiki](Source_documentation.md).
...
---
[documentation index](../README.md) > [Documentation](Category_Documentation.md) > Main Page/tr
