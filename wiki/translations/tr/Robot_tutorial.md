...
Bu eğitim, bir robot hücre kurulumunu simüle etmek için [Robot tezgahı](Robot_Workbench/tr.md) \'nın nasıl kullanılacağını öğretmek için buradadır.
...
3.  ![ 32px](images/_Robot_CreateTrajectory.png ) ile yeni bir yörünge oluşturun.
4.  Ağaç görünümünden robotu seçin.
5.  ![ 32px](images/_Robot_SetHomePos.png ) Robot resmini tıklatarak robot için ev pozisyonunu seçin.
6.  Görev paneline geçin
7.  Sürgüleri kullanarak robot pozisyonunu değiştirin
8.  Robot ve yörünge ağaç görünümünde seçiliyken ![ 32px](images/_Robot_InsertWaypoint.png ) öğesine tıklamak, yörüngeye yol noktasını ekleyecektir.
