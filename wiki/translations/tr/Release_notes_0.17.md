...
FreeCAD 0.17, 6 Nisan 2018\'de [İndir](Download/tr.md) sayfasında yayınlandı. Bu, en ilginç değişikliklerin bir özetidir. Değişikliklerin tam listesini [MantisBT bugtracker FC 0.17 changelog](https://www.freecadweb.org/tracker/changelog_page.php?version_id=73) adresinde bulabilirsiniz. Daha eski FreeCAD sürüm notları [ Başlangıç](Getting_started/tr.md) bölümünde bulunabilir.
...
---
[documentation index](../README.md) > [News](Category:News.md) > Release notes 0.17/tr
