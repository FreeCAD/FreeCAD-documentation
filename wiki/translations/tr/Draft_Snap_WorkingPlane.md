---
 GuiCommand:
   ...
   MenuLocation: Taslak , Draft Snap/tr , Çalışma düzlemi
   Workbenches: Draft_Workbench/tr, Arch_Workbench/tr
   Shortcut: 
   SeeAlso: 
---

# Draft Snap WorkingPlane/tr
...
Çalışma düzleminin dışındaki bir noktaya oturtsanız bile, yakalanan noktayı daima geçerli [Çalışma düzlemi](Draft_SelectPlane/tr.md) üzerine yerleştiren yakalama modu.
...
---
⏵ [documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft Snap WorkingPlane/tr
