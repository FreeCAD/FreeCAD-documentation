...
-   ![](images/Feature3.jpg ) **Tam parametrik bir model**. Tüm FreeCAD objeleri doğal olarak parametriktir, yani şekilleri [özelliklere dayal](Property.md)ı olabilir veya hatta diğer nesnelere bağlı olabilir, tüm değişiklikler talep üzerine yeniden hesaplanır ve geri al/yenile yığınıyla kaydedilir. [Tamamıyla Python\'da kodlanan](Scripted_objects.md) yeni nesne türleri kolayca eklenebilir.
