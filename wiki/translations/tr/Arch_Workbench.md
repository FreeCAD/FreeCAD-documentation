...
-   ![ 32px](images/_Arch_Wall.png ) [Duvar](Arch_Wall/tr.md): Sıfırdan veya seçilen bir nesneyi taban olarak kullanarak bir duvar oluşturur
-   ![ 32px](images/_Arch_Structure.png ) [ Yapı elemanı](Arch_Structure.md): Sıfırdan bir yapısal eleman oluşturur veya seçilen bir nesneyi taban olarak kullanır
