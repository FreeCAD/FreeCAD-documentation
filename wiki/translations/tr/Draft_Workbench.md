...
-   [ Autodesk .DWG](Draft_DXF.md): ODA Dönüştürücüsü\]\] yardımcı programı yüklendiğinde, DWG dosyalarını DXF içe aktarıcısı aracılığıyla alır ve verir. Ayrıca bakınız [ FreeCAD ve DWG Alma](FreeCAD_and_DWG_Import.md).
...
---
⏵ [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [Draft](Category_Draft.md) > Draft Workbench/tr
