---
 GuiCommand:
   ...
   Version: 0.16
   SeeAlso: Sketcher Copy/tr, Sketcher Move/tr
...
2.  ![ 32px](images/_Sketcher_Clone.png ) üzerine tıklayın veya üst menüden {{KEY | Eskiz}} → {{KEY | Eskiz araçları}} → {{KEY | <img src="images/_Sketcher_Clone.png_" width= 32px> Klonla}} seçin.
