...
### Boîte de recherche dans la Vue Sélection {#boîte_de_recherche_dans_la_vue_sélection}
...
### Le support des unités est déployé {#le_support_des_unités_est_déployé}
...
### Améliorations mineures {#améliorations_mineures}
...
### Amélioration de l'outil de sélection {#amélioration_de_loutil_de_sélection}
...
### Fusionner les esquisses {#fusionner_les_esquisses}

Il est maintenant possible de fusionner plusieurs esquisses en une.

### Améliorations des propriétés de l\'esquisse {#améliorations_des_propriétés_de_lesquisse}
...
### Améliorations mineures {#améliorations_mineures_1}
...
### Compatibilité des polices filaire dans Texte Surfacique {#compatibilité_des_polices_filaire_dans_texte_surfacique}
...
### Améliorations mineures {#améliorations_mineures_2}
...
## Atelier Mise en plan {#atelier_mise_en_plan}

### Export de la page en DXF {#export_de_la_page_en_dxf}
...
### Améliorations mineures {#améliorations_mineures_3}
...
## Atelier Architecture {#atelier_architecture}

### Mise à jour de l\'import/export IFC {#mise_à_jour_de_limportexport_ifc}
...
### Nouvelle fonctionnalité: Couper un objet avec un plan {#nouvelle_fonctionnalité_couper_un_objet_avec_un_plan}
...
### Nouvel outil de toit {#nouvel_outil_de_toit}
...
### Dessin dimensionnement {#dessin_dimensionnement}
...
### Caractéristiques de travail {#caractéristiques_de_travail}
