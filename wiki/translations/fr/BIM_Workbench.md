...
-   <img alt="" src=images/Sketcher_NewSketch.svg  style="width:32px;"> [Esquisse](Sketcher_NewSketch/fr.md): crée une nouvelle esquisse et passe en mode de dessin. Les esquisses sont des objets 2D avancés avec prise en charge des contraintes
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Addons](Category_Addons.md) > [External Workbenches](Category_External Workbenches.md) > [BIM](Category_BIM.md) > BIM Workbench/fr
