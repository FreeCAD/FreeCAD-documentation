...
2.  Appelez l\'outil de plusieurs manières:
    ...
    -   Utilisez {{MenuCommand|Sketch → Contraintes d'esquisse → <img src=images/Sketcher_ConstrainDistanceX.svg style="width:16px"> Contrainte distance horizontale}} dans le menu supérieur.
