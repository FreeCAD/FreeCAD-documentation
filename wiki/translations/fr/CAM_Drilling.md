...
L\'outil <img alt="" src=images/CAM_Drilling.svg  style="width:16px;"> [Perçage](CAM_Drilling/fr.md) génère une opération de perçage.
...
1.  Il existe plusieurs façons de lancer la commande :
    -   Appuyez sur le bouton **<img src="images/CAM_Drilling.svg" width=16px> [Percer](CAM_Drilling/fr.md)**.
    -   Sélectionnez l\'option **CAM → <img src="images/CAM_Drilling.svg" width=16px> Percer** du menu.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM Drilling/fr
