...
2.  Aller au menu {{MenuCommand|Pièce → Créer une copie → <img src=images/Part_TransformedCopy.svg style="width:16px"> [Create transformed copy](Part_TransformedCopy/fr.md)}}.
