...
2.  Il existe plusieurs façons de lancer la commande :
    -   Sélectionnez l\'option **Affichage → Visibilité → <img src="images/Std_ToggleVisibility.svg" width=16px> Activer/désactiver la visibilité** du menu.
    -   Sélectionnez l\'option **<img src="images/Std_ToggleVisibility.svg" width=16px> Activer/désactiver la visibilité** dans le menu contextuel de l\'arborescence ou de la vue 3D.
...
-   L\'action ne peut être annulée avec [Std Annuler](Std_Undo/fr.md) que si le paramètre **AutoTransactionView** dans le [réglage fin](Fine-tuning/fr.md) est réglé à `True`.
-   La visibilité d\'un objet peut également être modifiée via sa propriété **Visibility** associée dans l\'[éditeur de propriétés](Property_editor/fr.md).
