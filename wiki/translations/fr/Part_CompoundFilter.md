...
Le Filtre de composé peut être utilisé pour extraire chacune des parties du résultat par exemple, une opération [Part Scinder](Part_Slice/fr.md) avec laquelle vous avez divisé un objet.
