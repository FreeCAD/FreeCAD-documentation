...
2.  Appuyez sur le bouton **<img src="images/Arch_Axis_System.svg" width=16px> [Système d'axes](Arch_AxisSystem/fr.md)**.
...
5.  Définir la propriété {{PropertyData/fr|Axis}} de n\'importe quel objet Arch pour pointer vers ce système, pour que sa forme soit dupliquée aux points d\'intersection de ce système
...
---
[documentation index](../README.md) > [Arch](Category_Arch.md) > [Arch](Arch_Workbench.md) > Arch AxisSystem/fr
