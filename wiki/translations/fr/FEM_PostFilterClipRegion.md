...
2.  Lancez la commande de l\'une des façons suivantes    *
    -   Appuyez sur le bouton **<img src="images/FEM_PostFilterClipRegion.svg" width=16px> [Filtre d'écrêtage selon une région](FEM_PostFilterClipRegion/fr.md)**.
    -   Sélectionnez l\'option **Résultats → <img src="images/FEM_PostFilterClipRegion.svg" width=16px> Filtre d'écrêtage selon une région** dans le menu.
3.  Ajustez les **Options d'affichage des résultats** comme pour le pipeline [pipeline de résultats](FEM_PostPipelineFromResult/fr.md). Cachez ce pipeline pour voir l\'effet d\'un filtre d\'écrêtage selon une région.
