...
- GuiCommand   */fr
   ...
   Name/fr   *FEM Filtre de découpe selon une région
   MenuLocation   *Résultats → Filtre de découpe selon une région
...
2.  Lancez la commande de l\'une des façons suivantes    *
    -   Appuyez sur le bouton **<img src="images/FEM_PostFilterClipRegion.svg" width=16px> [Filtre de découpe selon une région](FEM_PostFilterClipRegion/fr.md)**.
