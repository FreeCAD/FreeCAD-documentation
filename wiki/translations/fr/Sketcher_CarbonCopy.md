...
-   Si le mode Sketcher a été changé en mode construction en utilisant **[<img src=images/Sketcher_ToggleConstruction.svg style="width:24px"> [Basculer le mode de la géométrie de construction](Sketcher_ToggleConstruction/fr.md)**, toute la géométrie copiée sera créée en mode construction.
