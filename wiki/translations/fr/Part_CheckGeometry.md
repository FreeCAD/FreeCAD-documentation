...
2.  Lancez l\'outil :
    -   soit en cliquant sur le bouton **<img src="images/Part_CheckGeometry.svg" width=16px> [Vérifier la géométrie](Part_CheckGeometry/fr.md)** disponible dans la barre d\'outils de l\'atelier Part.
    -   soit en utilisant **Part → <img src="images/Part_CheckGeometry.svg" width=16px> Vérifier la géométrie** du menu supérieur.
3.  La fenêtre de dialogue des **Réglages** s\'ouvre sauf si **Sauter cette page des paramètres** est activé. Voir [Options](#Options.md) pour plus d\'informations. Cliquez sur **Lancer la vérification**.
