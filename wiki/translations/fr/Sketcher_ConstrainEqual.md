...
Cliquez sur l\'icône de **<img src=images/Sketcher_ConstrainEqual.svg style="width:16px"> [Créer une contrainte d'égalité...](Sketcher_ConstrainEqual/fr.md)** dans la barre d\'outils Sketcher ou sélectionnez l\'entrée de menu Contrainte d\'égalité depuis le sous-menu Contraintes d\'esquisse du menu Sketch pour appliquer la contrainte aux éléments sélectionnés.
...
et appliquez **<img src=images/Sketcher_ConstrainEqual.svg style="width:16px"> [Créer une contrainte d'égalité...](Sketcher_ConstrainEqual/fr.md)** comme précédemment.
...
et appliquez **<img src=images/Sketcher_ConstrainEqual.svg style="width:16px"> [Créer une contrainte d'égalité...](Sketcher_ConstrainEqual/fr.md)** comme auparavant.
...
et appliquez à nouveau **<img src=images/Sketcher_ConstrainEqual.svg style="width:16px"> [Créer une contrainte d'égalité...](Sketcher_ConstrainEqual/fr.md)** . Un message indique que les éléments contraints doivent être du même type géométrique (lignes de courbure nulle ou lignes de courbure non nulle).
