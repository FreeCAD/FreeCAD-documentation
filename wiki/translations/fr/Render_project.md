...
### Fonctionnalités de Render {#fonctionnalités_de_render}
...
### Matériaux de Render {#matériaux_de_render}
...
### Utiliser le module Render : {#utiliser_le_module_render}
...
### Lancer un Render {#lancer_un_render}
...
#### Vitesse de rendu {#vitesse_de_rendu}
...
### Rattacher des matériaux {#rattacher_des_matériaux}
