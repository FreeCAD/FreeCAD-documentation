...
- GuiCommand:/fr
   Name:Part Point
   Name/fr:Part Point
   MenuLocation:Part → [Créer des primitives...](Part_Primitives/fr.md) → Point
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Part](Part_Workbench.md) > Part Point/fr
