...
La la boîte de dialogue Cote propose les paramètres suivants :
...
:   
    ...
    :   
        ...
        \- le contenu de **Format Spec** sera affiché sous forme de texte à la place si la valeur de la cote .
...
-    **Gap Factor ASME|Float**: ajuste l\'écart entre les points de la cote et le début des lignes d\'extension. L\'écart est égal à cette valeur multipliée par la largeur de la ligne. {{Version/fr|1.0}}

-    **Gap Factor ISO|Float**: ajuste l\'écart entre les points de dimension et le début des lignes d\'extension. L\'écart est égal à cette valeur multipliée par la largeur de la ligne. {{Version/fr|1.0}}
