# Macro BSurf from grid/fr
{{Macro/fr
|Name=BSurf_from_grid
|Description=Crée une surface B-spline à travers une grille de points.
|Author=heda
|Version=0.1
|Date=2022-07-31
}}
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro BSurf from grid/fr
