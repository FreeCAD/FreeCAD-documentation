...
- GuiCommand:/fr
   ...
   MenuLocation:Utilitaire → Appliquer le style actuel
...
3.  Sélectionnez l\'option {{MenuCommand|Utilitaires → <img src="images/Draft_ApplyStyle.svg" width=16px> Appliquer le style actuel}} dans le menu.
