...
- GuiCommand:/fr
   ...
   MenuLocation:Lancer de rayon → Insérer une pièce
...
2.  Cliquez sur <img alt="" src=images/Raytrace_NewPartSegment.svg  style="width:32px;"> ou choisissez **Lancer de rayon** → **<img src="images/Raytrace_NewPartSegment.svg" width=32px> Insérer une pièce** à partie du menu du haut.
