...
## Version stable courante {#version_stable_courante}
...
### Notes aux utilisateurs de Windows {#notes_aux_utilisateurs_de_windows}
...
### Notes aux utilisateurs de MacOS X {#notes_aux_utilisateurs_de_macos_x}

MacOS OS X 10.12 *Sierra* est la version minimum compatible.

### Note aux utilisateurs de GNU/Linux {#note_aux_utilisateurs_de_gnulinux}
...
## Versions de développement {#versions_de_développement}
...
## Modules additionnels et macros {#modules_additionnels_et_macros}
