...
La page [Liste des Macros](Macros_recipes/fr.md) contient une sélection de macros créées par des utilisateurs expérimentés, qui peuvent être installées directement à partir du <img alt="" src=images/Std_AddonMgr.svg  style="width   *24px;"> [Gestionnaire d\'Addon](Std_AddonMgr/fr.md).
