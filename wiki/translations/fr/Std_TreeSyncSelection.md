---
 GuiCommand:
   ...
   MenuLocation: Affichage , Actions dans la vue en arborescence , Synchroniser la sélection
   Workbenches: Tous
   Shortcut: **T** **2**
   Version: 0.19
---
...
1.  Il existe plusieurs façons de lancer la commande :
    ...
    -   Sélectionnez l\'option **Affichage → Actions dans la vue en arborescence → <img src="images/Std_TreeSyncSelection.svg" width=16px> Synchroniser la sélection** du menu.
...
Le mode Synchroniser la sélection de l\'arborescence peut également être défini dans le [Réglage des préférences](Preferences_Editor/fr#Sélection.md) : **Édition → Préférences → Général → Sélection**.
