...
La longueur est fixée à une certaine valeur en modifiant le paramètre de longueur dans le panneau des propriétés.

## Utilisation

1.  Sélectionnez une ligne 2D
2.  Appuyez sur le bouton **<img src="images/Assembly_ConstraintLineLength.svg" width=16px> [Line length](Assembly3_ConstraintLineLength/fr.md)**.
