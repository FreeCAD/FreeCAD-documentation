...
1.  Pour utiliser cette commande dans FreeCAD version 0.19 et antérieure, au moins un groupe doit exister.
...
4.  Un menu s\'affiche près du curseur. Effectuez l\'une des opérations suivantes :
    -   Sélectionnez **Ungroup** pour déplacer les objets hors du ou des groupes dans lesquels ils se trouvent.
    -   Sélectionnez le groupe vers lequel vous voulez déplacer les objets.
    -   Sélectionnez **+ Add new group** pour déplacer les objets vers un nouveau groupe : {{Version/fr|0.20}}
        1.  Le panneau de tâches **Add group** s\'ouvre.
        2.  Saisissez un **Group name**.
