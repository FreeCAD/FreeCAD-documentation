...
1.  Dans la [vue en arborescence](tree_view/fr.md) du modèle, cliquer avec le bouton droit sur l\'objet à déplacer.
2.  Sélectionner **Déplacer vers un autre corps** del la liste ddu menu contextuel.
3.  Dans la boîte de dialogue **Sélectionner le corps**, sélectionner le corps pour déplacer l\'objet dans le menu déroulant.
4.  Appuyez sur **OK**.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [PartDesign](PartDesign_Workbench.md) > PartDesign MoveFeature/fr
