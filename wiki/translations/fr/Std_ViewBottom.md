...
![](images/FreeCAD_views_rear.svg ) *La flèche 5 pointe dans le sens de la vue de dessous*
...
1.  Il existe plusieurs façons d\'appeler la commande:
    ...
    -   Sélectionnez l\'option {{MenuCommand|Affichage → Vues standard → <img src="images/Std_ViewBottom.svg" width=16px> Dessous}} dans le menu.
    -   Sélectionnez l\'option {{MenuCommand|Vues standard → <img src="images/_Std_ViewBottom.svg_" width= 16px> Dessous}} dans le menu contextuel de la [vue 3D](3D_view/fr.md).
