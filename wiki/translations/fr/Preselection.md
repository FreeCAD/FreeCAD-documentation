...
La couleur de l\'objet présélectionné peut être choisie à partir du menu {{MenuCommand|Édition → Préférences → Affichage → Couleurs →}} cocher **Activer la surbrillance de la présélection** et choisir une couleur.
