...
2.  Cliquez sur <img alt="" src=images/OpenSCAD_MeshBoolean.svg  style="width:32px;"> ou choisissez **OpenSCAD** → **<img src="images/OpenSCAD_MeshBoolean.svg" width=32px> Opération booléenne sur le maillage** dans le menu principal.
