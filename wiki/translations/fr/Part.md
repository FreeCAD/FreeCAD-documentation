...
Dans un usage informel, une \"pièce\" peut être n\'importe quelle figure géométrique visible dans la [vue 3D](3D_view/fr.md), et son concept peut donc être confondu avec celui de \"[Corps](Body/fr.md)\" ou \"[Assemblage](Assembly/fr.md)\".
