...
*Ci-dessus: succession de sélections|center* {{TechDraw Tools navi}}



---
![](images/Button_right.svg) [documentation index](../README.md) > [TechDraw](Category_TechDraw.md) > Measurement Of Angles On Holes/fr
