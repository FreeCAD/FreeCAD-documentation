...
2.  Si **Draft Aimantation Perpendiculaire** n\'est pas actif, faites l\'une des choses suivantes    *
    ...
    -   Appuyez sur le bouton **<img src="images/Draft_Snap_Lock.svg" width=16px><img src="images/Toolbar_flyout_arrow.svg" width=8px>** du [Draft Widget aimantation](Draft_snap_widget/fr.md) et dans le menu, sélectionnez l\'option **<img src="images/Draft_Snap_Perpendicular.svg" width=16px> Aimanter à la perpendiculaire (OFF)**.
