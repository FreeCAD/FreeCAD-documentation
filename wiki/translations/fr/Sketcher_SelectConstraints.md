...
2.  Lancez la commande Sélecteur de constraintes de plusieurs manières
    ...
    -   Choisissez {{MenuCommand|Sketch → Outils d'esquisse → <img src=images/Sketcher_SelectConstraints.svg style="width:16px"> Sélectionner les contraintes}} dans le menu Sketch.
