...
2.  Il existe plusieurs façons de lancer la commande :
    ...
    -   Choisissez la commande **Esquisse → Outils d'esquisse → [<img src=images/Sketcher_SelectConstraints.svg style="width:16px"> Sélectionner les contraintes associées** dans le menu.
