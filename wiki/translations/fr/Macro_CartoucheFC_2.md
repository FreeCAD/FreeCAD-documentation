...
|Description=Cette macro est une application complète, il permet de remplir le cartouche de la feuille de dessin avec texteditable (Seulement pour l'[atelier Drawing](Drawing_Module/fr.md)).
|Author=Mario52
|Version=5.0
|Date=2014-08-08
...
Cette macro est une application complète, elle permet de remplir simplement tous les champs du cartouche [A3 Landscape english](Drawing_templates/fr.md)
