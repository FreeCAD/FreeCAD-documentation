...
1.  Il existe plusieurs façons d\'appeler la commande:
    ...
    -   Dans le menu, accédez à {{MenuCommand|Affichage → Style de représentation}} et sélectionnez un style.
...
## Styles de représentation disponibles {#styles_de_représentation_disponibles}

### <img alt="" src=images/Std_DrawStyleAsIs.svg  style="width:32px;"> Tel quel {#std_drawstyleasis.svg_tel_quel}
...
### <img alt="" src=images/Std_DrawStyleWireFrame.svg  style="width:32px;"> Filaire {#std_drawstylewireframe.svg_filaire}
...
### <img alt="" src=images/Std_DrawStyleHiddenLine.svg  style="width:32px;"> Ligne cachée {#std_drawstylehiddenline.svg_ligne_cachée}
...
### <img alt="" src=images/Std_DrawStyleNoShading.svg  style="width:32px;"> Pas d\'ombre {#std_drawstylenoshading.svg_pas_dombre}
...
### <img alt="" src=images/Std_DrawStyleShaded.svg  style="width:32px;"> Ombré {#std_drawstyleshaded.svg_ombré}
...
### <img alt="" src=images/Std_DrawStyleFlatLines.svg  style="width:32px;"> Lignes plates {#std_drawstyleflatlines.svg_lignes_plates}
