...
2.  Choisir {{MenuCommand|Sketch → Outils d'esquisse → <img src=images/Sketcher_SelectConflictingConstraints.svg style="width:16px"> Sélectionner les contraintes conflictuelles}}.
