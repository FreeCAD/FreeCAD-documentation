...
## Propriétés utilisées pour l\'armature des dalles avec des barres d\'armature en forme de U 
...
### Créer une armature de dalle avec des armatures en forme de U 

Pour créer des armatures de dalles en forme de U comme indiqué dans les figures ci-dessus, vous pouvez utiliser la fonction makeSlabReinforcement comme suit :
...
### Edition de l\'armature des dalles avec des armatures en forme de U 

Vous pouvez modifier les propriétés de l\'armature de dalle avec des armatures en forme de U en utilisant la fonction editSlabReinforcement comme suit :
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Reinforcement](Category_Reinforcement.md) > [Arch](Category_Arch.md) > Example Slab Having UShape Rebars Reinforcement Mesh/fr
