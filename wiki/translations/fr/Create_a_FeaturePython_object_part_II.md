...
Ajoutez le code ViewProvider à la fin de {{FileName|box.py}} et dans la méthode `create()` insérez la ligne suivante au-dessus de l\'instruction `recompute()`:
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Developer Documentation](Category_Developer Documentation.md) > [Python Code](Category_Python Code.md) > Create a FeaturePython object part II/fr
