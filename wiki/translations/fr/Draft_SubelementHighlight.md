...
*Un Arch mur dont la base, une Draft Polyligne, a été mis en surbrillance.*
...
2.  Il existe plusieurs façons de lancer la commande :
    ...
    -   Sélectionnez l\'option **Modification → <img src="images/Draft_SubelementHighlight.svg" width=16px> Surbrillance des sous-éléments** du menu.
