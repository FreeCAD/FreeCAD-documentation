...
Le gestionnaire d\'addons a été modifié pour prendre en charge la distribution des kits de préférences et pour afficher les informations contenues dans les métadonnées d\'un addon (pour les ateliers et les kits de préférences, il s\'agit du fichier package.xml ; pour les macros, il s\'agit des métadonnées intégrées au fichier de macro principal). Le gestionnaire d\'addons comprend également une prise en charge améliorée des addons dont le code source se trouve sur quatre sites d\'hébergement directement pris en charge : GitHub, Gitlab, Framagit et salsa.debian.org. La prise en charge de la mise en réseau a été améliorée afin de fournir une gestion plus robuste des connexions SSL et la prise en charge des proxies nécessitant une authentification.
...
|                                                                                                                                                                                                                                                                                                                                    | **Remarque** : L\'extrusion de profils imbriqués ne fonctionne que si le résultat est toujours un seul corps. [request \#6381](https://github.com/FreeCAD/FreeCAD/pull/6381Pull)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
+++
...
## Atelier Sketcher 
  ...
  <img alt="" src=images/SketcherBSplineInsertKnot_relnotes_0.20.gif )                                          Nouvel outil ![](images/Sketcher_BSplineInsertKnot.svg  style="width:24px;"> [Insérer un nœud](Sketcher_BSplineInsertKnot/fr.md) pour insérer un nœud dans un B-spline existant. [Pull request \#5311](https://github.com/FreeCAD/FreeCAD/pull/5311)
