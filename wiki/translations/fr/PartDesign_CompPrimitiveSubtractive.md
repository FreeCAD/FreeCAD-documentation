...
- GuiCommand:/fr
   ...
   MenuLocation:Conception de pièces → Créer une primitive soustractive
...
-   <img alt="" src=images/PartDesign_SubtractiveWedge.svg  style="width:32px;"> [Cale soustractive](PartDesign_SubtractiveWedge/fr.md)
