...
L\'<img alt="" src=images/Workbench_Reverse_Engineering.svg  style="width   *24px;"> [Atelier Reverse Engineering](Reverse_Engineering_Workbench/fr.md) (atelier ingénierie inverse) est conçu pour vous fournir des outils spécifiques permettant de convertir des formes, des solides, des maillages, en fonctions paramétriques compatibles avec FreeCAD. Il est toujours en développement.
