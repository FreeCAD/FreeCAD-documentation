...
-   La case à cocher **Continue**, affichée dans FreeCAD version 0.19 et antérieure, n\'a aucune utilité pour cette commande.
-   La case à cocher **Modifier les sous-éléments**, affichée dans FreeCAD version 0.19 et antérieure, n\'a pas d\'utilité pour cette commande.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft Mirror/fr
