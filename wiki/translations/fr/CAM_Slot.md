...
L\'outil <img alt="" src=images/CAM_Slot.svg  style="width:24px;"> [Rainure](CAM_Slot/fr.md) crée une simple opération de rainurage en utilisant différentes méthodes de saisie.
...
L\'objet CAM Rainure est conçu pour faire partie d\'une <img alt="" src=images/CAM_Job.svg  style="width:24px;"> [CAM Tâche](CAM_Job/fr.md).
...
2.  Lancer la commande Rainure en utilisant plusieurs méthodes :
    -   En appuyant sur la touche **<img src="images/CAM_Slot.svg" width=24px> [Rainurer](CAM_Slot/fr.md)** dans la barre d\'outils.

#\* En utilisant **CAM** → **<img src="images/CAM_Slot.svg" width=24px> [Rainurer](CAM_Slot/fr.md)** du menu.

1.  Ajuster les propriétés souhaitées. Les descriptions des propriétés disponibles se trouvent ci-dessous.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM Slot/fr
