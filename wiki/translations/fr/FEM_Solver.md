...
[PolyFEM](https://polyfem.github.io/) PolyFEM est une simple bibliothèque d\'éléments finis C++ et Python. Nous proposons un large éventail de PDEs courants, notamment: Laplace, Helmholtz, élasticité linéaire, élasticité Saint-Venant, élasticité néo-hookéenne et Stokes. [Sujet sur le forum](https://forum.freecadweb.org/viewtopic.php?f=18&t=42857).
