...
## Copier des objets liés {#copier_des_objets_liés}
...
## Recherche et positionnement d\'objet(s) collé(s) {#recherche_et_positionnement_dobjets_collés}
...
## Autres méthodes {#autres_méthodes}
