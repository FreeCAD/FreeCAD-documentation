...
1\. Sélectionnez les objets **<img src="images/Arch_Rebar.svg" width=16px> [Arch Armatures](Arch_Rebar/fr.md)** et Rebar2 que vous souhaitez inclure dans la nomenclature de façonnage des armatures ou sélectionnez les objets **<img src="images/Arch_Structure.svg" width=16px> [Arch Structure](Arch_Structure/fr.md)** à inclure aux **<img src="images/Arch_Rebar.svg" width=16px> [Arch Armatures](Arch_Rebar/fr.md)** et les objets Rebar2 hébergés par ceux-ci dans la nomenclature de façonnage des armatures. Si rien n\'est sélectionné, la nomenclature de façonnage des armatures sera générée pour tous les objets **<img src="images/Arch_Rebar.svg" width=16px> [Arch Armatures](Arch_Rebar/fr.md)** et Rebar2 présents dans le modèle.

2\. Sélectionnez ensuite **<img src="images/Reinforcement_BarShapeCutList.svg" width=16px> [Rebar Shape Cut List](Reinforcement_BarShapeCutList/fr.md)** dans les outils d\'armature.
...
-    **Stirrup Extended Edge Offset**: décalage des bords d\'extrémité étendus de l\'étrier, de sorte que les bords d\'extrémité de l\'étrier avec un angle de pliage de 90 degrés ne se chevauchent pas avec les bords de l\'étrier.

-    **Rebars Stroke Width**: largeur de trait des armatures dans la nomenclature de façonnage.

-    **Rebars Color Style**: style de couleur des armatures.

-    **Row Height**: hauteur de chaque ligne de forme d\'armature dans la nomenclature de façonnage.

-    **Column Width**: largeur de chaque colonne de forme d\'armature dans la nomenclature de façonnage.

-    **Column Count**: nombre de colonnes dans la nomenclature de façonnage.

-    **Side Padding**: rembourrage de chaque côté de la forme de l\'armature.

-    **Horizontal Rebar Shape**: si True, alors la forme de l\'armature sera rendue horizontale en faisant pivoter le bord de longueur maximale de la forme d\'armature.

-    **Include Mark**: si elle est définie sur True, alors rebar.Mark sera inclus pour chaque forme d\'armature dans la nomenclature de façonnage.

-    **SVG Output File**: fichier de sortie pour écrire le SVG de la nomenclature de façonnage.

**Données de dimension :**

-    **Include Dimensions**: si True, les dimensions de chaque arête d\'armature et les cotes d\'angle plié seront incluses dans la nomenclature de façonnage.
...
-    **Rebar Edge Dimension Precision**: nombre de décimales à afficher pour la longueur du bord de l\'armature comme étiquette de cote.
...
-    **Helical Rebar Dimension Label Format**: format de l\'étiquette de dimension d\'armature hélicoïdale. Par exemple : \"%L,r=%R,pitch=%P\" où %L -\> Longueur de l\'armature hélicoïdale, %R -\> Rayon d\'hélice de l\'armature hélicoïdale, %P -\> Pas d\'hélice de l\'armature hélicoïdale.
...
L\'outil Nomenclature de façonnage peut être utilisé dans des [macros](Macros/fr.md) et à partir de la console [Python](Python/fr.md) à l\'aide des fonctions suivantes :
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > Reinforcement BarShapeCutList/fr
