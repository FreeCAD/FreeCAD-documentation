# Macro Alias For Table For Object/fr
{{Macro/fr
...
La syntaxe des alias créé par la macro est la suivante : {{Incode|LabelObject_Property}}.
...
Partie du dico (vérifiez le code de la macro pour le dico complet) : {{Code|lang=text|code=
dico={
...
---
⏵ [documentation index](../README.md) > Macro Alias For Table For Object/fr
