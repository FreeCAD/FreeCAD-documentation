...
2.  Appuyez sur le bouton **<img src="images/TechDraw_VerticalDimension.svg" width=16px> [Insérer une cote verticale](TechDraw_VerticalDimension/fr.md)
**
...
L\'outil Cote verticale peut être utilisé dans des [macros](Macros/fr.md) et à partir de la console [Python](Python/fr.md) à l\'aide des fonctions suivantes:
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw VerticalDimension/fr
