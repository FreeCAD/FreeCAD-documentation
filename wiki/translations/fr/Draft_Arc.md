...
- GuiCommand:/fr
   Name:Draft_Arc
   Name/fr:Draft Arc
   MenuLocation:Drafting → Outils arcs → Arc
...
1.  Il existe plusieurs façons d\'invoquer la commande :
    ...
    -   Sélectionnez l\'option **Drafting → Outils arc → <img src="images/Draft_Arc.svg" width=16px> Arc** dans le menu.
...
-   La case à cocher **Relative** n\'est d\'aucune utilité pour cette commande.
