...
La méthode recommandée pour installer des addons, c\'est-à-dire [Ateliers externes](external_workbenches/fr.md) et les macros, est le [Addon Manager](Addon_Manager/fr.md). Toutefois, vous pouvez toujours ajouter des macros à votre système avec les méthodes manuelles décrites dans les sections suivantes. Ceci est utile si vous développez et testez votre propre code.
