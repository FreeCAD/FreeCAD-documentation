...
La commande **Std Synchroniser la vue** bascule en mode Synchronisation de vue de la [vue en arborescence](Tree_view/fr.md). Si ce mode est activé, la sélection d\'un objet dans un autre document dans l\'arborescence active automatiquement la dernière [vue 3D](3D_view/fr.md) ancrée et utilisée de ce document.
