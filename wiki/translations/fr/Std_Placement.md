...
1.  Sélectionnez un seul objet ayant une propriété **Placement**.
2.  Sélectionnez l\'option **Édition → <img src="images/Std_Placement.svg" width=16px> Positionner...** du menu.
