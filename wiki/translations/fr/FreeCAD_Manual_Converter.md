# FreeCAD Manual Converter/fr
{{Macro/fr
|Name=FreeCAD Manual Converter
|Description=Script en Python qui génère automatiquement les versions PDF et EPUB du manuel FreeCAD.
|Version = 0.1
|Author=Adrianos
|Date=2024-12-16
|FCVersion=Toutes
...
Le [Manuel : Introduction](Manual:Introduction/fr.md) est un document vivant qui évolue continuellement grâce aux contributions des membres de la communauté. Bien que cela en fasse une excellente ressource à jour, il arrive que les utilisateurs aient besoin d\'un accès hors ligne au manuel ou préfèrent le lire sur des lecteurs électroniques et des tablettes. Ce script comble cette lacune en permettant aux utilisateurs de :
...
-   **FreeCAD_User_Manual.pdf** : version PDF complète du manuel
-   **FreeCAD_User_Manual.epub** : version EPUB adaptée aux lecteurs électroniques
...
---
⏵ [documentation index](../README.md) > FreeCAD Manual Converter/fr
