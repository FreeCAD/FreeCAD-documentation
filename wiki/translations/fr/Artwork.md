# Artwork/fr
Voici les icônes créés pour FreeCad. N\'hésitez pas à les utiliser dans vos applications. Si vous voulez contribuer en créant des icônes, veuillez lire les [directives de style graphique](Artwork_Guidelines/fr.md).
...
Voir [Graphisme BIM](Artwork_BIM/fr.md).



### Depuis src/Mod/CAM/ 

Voir [Graphisme CAM](Artwork_CAM/fr.md).
...
Voir [Graphisme SheetMetal](Artwork_SheetMetal/fr.md).
...
---
⏵ [documentation index](../README.md) > [Artwork](Category_Artwork.md) > [Developer_Documentation](Category_Developer_Documentation.md) > Artwork/fr
