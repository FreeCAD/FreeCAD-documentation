...
Lorsqu\'il est importé dans un interpréteur Python en cours d\'exécution, Pivy nous permet de communiquer directement avec n\'importe quel Coin [Graphe de scène](Scenegraph/fr.md), tel que la [vue 3D](3D_view/fr.md), ou même d\'en créer de nouveaux. Pivy n\'est pas nécessaire pour compiler FreeCAD, mais il est requis lors de l\'exécution lors de l\'exécution d\'établis basés sur Python qui créent des formes à l\'écran, comme [Draft](Draft_Module/fr.md) et [Arch](Arch_Module/fr.md). Pour cette raison, Pivy est normalement installé lors de l\'installation d\'une distribution de FreeCAD.
...
-   [Coin3D](https://github.com/coin3d) page d\'accueil.
-   [Pivy](https://github.com/coin3d/pivy) page d\'accueil.
-   [Coin3D wiki](https://github.com/coin3d/coin/wiki), sur GitHub.
