...
3.  
    **Save Image**   * Sauve l\'image ex   * **imageBox_000.png** (le \_000 toujours ajouté

4.  
    **Follow**   * Après avoir enregistré la première image, appuyez sur ce bouton si vous souhaitez enregistrer l\'image suivante avec le même nom. Les images enregistrées sont incrémentées ex   * **imageBox_001.png**, **imageBox_002.png**, **imageBox_003.png**, etc ..
