...
2.  Il existe plusieurs façons d\'appeler la commande :
    -   Sélectionnez l\'option {{MenuCommand|Édition → <img src="images/Std_SendToPythonConsole.svg" width=16px> Envoyer vers la console Python}} dans le menu.
    -   Sélectionnez l\'option {{MenuCommand|<img src="images/Std_SendToPythonConsole.svg" width=16px> Envoyer vers la console Python}} dans le menu contextuel de la [vue en arborescence](Tree_view/fr.md) ou le menu contextuel de la [vue 3D](3D_view/fr.md).
