...
3.  Si nécessaire, la [console Python](Python_console/fr.md) s\'ouvre. {{Version/fr|0.20}}
4.  La [console Python](Python_console/fr.md) reçoit le focus du clavier. {{Version/fr|0.20}}
