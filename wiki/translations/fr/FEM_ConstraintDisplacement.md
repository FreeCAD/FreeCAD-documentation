...
1.  Il existe plusieurs façons d\'appeler la commande:
    ...
    -   Sélectionnez l\'option {{MenuCommand|Model → Mechanical Constraints → <img src="images/FEM_ConstraintDisplacement.svg" width=16px> Constraint displacement}} dans le menu.
