...
1.  Téléchargez le [fichier ZIP](https://github.com/donovaly/FreeCAD-Qt-Designer-plugin/releases/tag/Qt-5.15.x-1). (Compilé en utilisant Qt 5.15, voir [ci-dessous](#Compilation.md).)
...
2.  Ouvrez une *Invite de commande de l\'outil natif x64* en utilisant le menu Démarrer de Windows et allez dans le dossier ci-dessus. Il est important que ce soit la version x64 de l\'invite de commande !
3.  Exécuter cette commande *D:\\FreeCAD-build\\FreeCADLibs\_12.5.4\_x64\_VC17\\bin\\qmake -t vclib plugin.pro*pour une installation complète de Qt, c\'est*C:\\Qt\\5.15.2\\msvc2019\_64\\bin\\qmake -t vclib plugin.pro* (adaptez les chemins à votre installation !)
