...
2.  Selectionnez le menu {{MenuCommand|Web Tools → <img src="images/WebTools_BimServer.svg" width=16px> [BIM Server](WebTools_BimServer/fr.md)}}
...
### Téléchargement de révisions {#téléchargement_de_révisions}
...
### Téléchargement de révisions {#téléchargement_de_révisions_1}
