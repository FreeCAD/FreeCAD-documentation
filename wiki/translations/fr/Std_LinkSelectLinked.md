...
2.  Sélectionnez l\'option {{MenuCommand|Link actions → <img src="images/Std_LinkSelectLinked.svg" width=16px> Go to linked object}} dans le menu contextuel de la [Vue en arborescence](Tree_view/fr.md).
