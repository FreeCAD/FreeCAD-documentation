...
2.  Il existe 2 méthodes pour utiliser l\'outil Esquisse sur une surface:
    ...
    Vous avez déjà une esquisse que vous souhaitez appliquer sur une surface :
    ...
    Vous n\'avez pas encore d\'esquisse à appliquer:
    ...
    2.  Activez Esquisse sur une surface soit :
        ...
        :   Cliquez sur la barre d\'espace pour activer \"Mapped sketch\". Avec un double clic sur \"Mapped sketch\", un cadre bleu apparaît. Les dimensions données du cadre bleu correspondent à la surface de l\'objet sur lequel vous souhaitez appliquer votre esquisse. L\'esquisse sera placée perpendiculairement à la surface à couvrir.
