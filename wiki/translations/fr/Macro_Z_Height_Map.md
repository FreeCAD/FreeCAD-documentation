...
|Description=Crée une carte de hauteur en niveaux de gris en Z.
|Author=heda
|Version=0.1
|Date=2022-08-28
}}
...
Par le biais du [Gestionnaire d\'Addons](Std_AddonMgr/fr.md).
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [File_Formats](Category_File_Formats.md) > Macro Z Height Map/fr
