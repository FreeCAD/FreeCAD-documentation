...
3.  Sélectionnez l\'option {{MenuCommand|Édition → Alignement ...}} dans le menu.
...
7.  Cliquez avec le bouton droit sur l\'une des vues et sélectionnez l\'option {{MenuCommand|Align}} dans le menu contextuel pour terminer la commande.

## Options

Les options supplémentaires suivantes sont disponibles dans le menu contextuel :

-   Sélectionnez l\'option {{MenuCommand|Remove last point}} pour supprimer le dernier point de la vue.
-   Sélectionnez l\'option {{MenuCommand|Cancel}} pour abandonner la commande.
-   Cochez l\'option {{MenuCommand|Syncronize views}} si des changements de vue (panoramique, rotation et zoom) doivent être appliqués aux deux vues en même temps.
