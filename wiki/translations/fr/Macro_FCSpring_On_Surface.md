...
|Name/fr=Macro FCSpring On Surface
|Icon=FCSpring_On_Surface.png
|Description=Cette macro crée une hélice (ou ressort) autour d'un objet solide quelle que soit sa forme, l'hélice suit toute la surface de l'objet (Python2 est nécessaire).
|Author=Mario52
|Version=00.01
|Date=2024/01/15
|Download=|Download=[https://wiki.freecad.org/images/3/38/FCSpring_On_Surface.png Icône de la barre d'outils]
