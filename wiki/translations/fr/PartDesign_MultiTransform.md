...
### Méthode standard {#méthode_standard}
...
### Méthode alternative 1 {#méthode_alternative_1}
...
### Méthode alternative 2 {#méthode_alternative_2}
...
+--------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ![](images/Multitransfrom_parameters.png ) | Lors de la création d\'une fonction Transformation multiple, la boîte de dialogue \'MultiTransform parameters\' propose deux listes différentes.                                                                                                                                                                                                                                                                                                                                     |
|                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|                                                                    | ### Sélectionnez les originaux {#sélectionnez_les_originaux}                                                                                                                                                                                                                                                                                                                                                                                                                         |
|                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|                                                                    | La liste affiche les \"originaux\", les fonctions à appliquer. En cliquant sur une fonction, vous l\'ajouterez à la liste.                                                                                                                                                                                                                                                                                                                                                           |
|                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|                                                                    | ### Sélectionnez les transformations {#sélectionnez_les_transformations}                                                                                                                                                                                                                                                                                                                                                                                                             |
|                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|                                                                    | Cette liste peut être complétée par une combinaison des transformations simples [PartDesign Symétrie](PartDesign_Mirrored/fr.md), [PartDesign Répétition linéaire](PartDesign_LinearPattern/fr.md), [PartDesign Répétition circulaire](PartDesign_PolarPattern/fr.md) et [PartDesign Mise à l\'échelle](PartDesign_Scaled/fr.md). Les transformations seront appliquées les unes après les autres. Le menu contextuel propose les entrées suivantes: |
|                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|                                                                    | #### Modifier                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
|                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|                                                                    | #### Ajouter une transformation {#ajouter_une_transformation}                                                                                                                                                                                                                                                                                                                                                                                                                        |
|                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
