...
-    **Growth|Length**: distance entre deux tours consécutifs de la spirale. La valeur par défaut est {{Value|1mm}}.

-    **Radius|Length**: rayon de départ de la spirale, la distance entre son centre et son point de départ. Peut être {{Value|0mm}}. La valeur par défaut est {{Value|1mm}}.

-    **Rotations|QuantityConstraint**: nombre de rotations, ou de tours, de la spirale. La valeur par défaut est {{Value|2}}.

-    **Segment Length|QuantityConstraint**: nombre de tours par subdivision de la spirale. La valeur par défaut est {{Value|1}}, ce qui signifie que chaque tour complet de la spirale est un segment séparé. Utilisez {{Value|0}} pour supprimer la subdivision.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Part](Part_Workbench.md) > Part Spiral/fr
