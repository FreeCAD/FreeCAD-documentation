...
-   Cliquez sur **Placement** (le titre, pas la petite flèche) et une ellipse **...** apparaît : <img alt="Tache Placement" src=images/Tache_Placement_01_fr_00.png  style="width:384px;">
...
-    {{TasksTag|Défini par l'utilisateur...}}: permet de modifier les trois axes (**X, Y, Z**) en une seule opération <img alt="définie par l\'utilisateur" src=images/Part_Revolve_fr_06.png  style="width:96px;">.
...
-   Première option. Sélectionnez **Axe de rotation et angle** <img alt="Option Axe de rotation et angle" src=images/Tache_Placement_fr_05.png  style="width:384px;"> (Par défaut)
    -   
        {{TasksTag|Axis: X}}
...
-   Deuxième option. Sélectionnez **Angles d\'Euler** ![384x\|Option Angles d\'Euler](images/Tache_Placement_fr_04.png ).
...
![Rien\|Lacet](images/Tache_Placement_Lacet_fr_Mini.gif )
...
![Rien\|Tangage](images/Tache_Placement_Tangage_fr_Mini.gif )

-    {{TasksTag|axe de tangage}}**Le tangage est la rotation autour de l\'axe Y**, c\'est-à-dire le cabré et le piqué. (L\'angle de tangage est le **Phi φ**). Valeur **-360.00°** à **360.00°** (Par défaut, **0.00°**).

![Rien\|Roulis](images/Tache_Placement_Roulis_fr_Mini.gif )
