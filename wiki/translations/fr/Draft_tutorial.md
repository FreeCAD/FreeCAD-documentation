...
3\. Appuyez sur **[<img src=images/Draft_SelectPlane.svg style="width   *16px"> [SelectPlane](Draft_SelectPlane/fr.md)** ou allez dans le menu **Utilities → [<img src=images/Draft_SelectPlane.svg style="width   *16px"> [Select plane](Draft_SelectPlane/fr.md)** pour ouvrir le plan de travail [Panneau des tâches](Task_panel/fr.md).
