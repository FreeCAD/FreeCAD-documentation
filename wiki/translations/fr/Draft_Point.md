...
1.  Il existe plusieurs façons de lancer la commande :
    ...
    -   Sélectionnez l\'option {{MenuCommand|Drafting → <img src="images/Draft_Point.svg" width=16px> Point}} dans le menu.
2.  Le panneau de tâches {{MenuCommand|Point}} s\'ouvre. Voir [Options](#Options.md) pour plus d\'informations.
...
-   Appuyez sur **T** ou cliquez sur la case {{MenuCommand|Continuer}} pour activer le mode continu. Si le mode continu est activé, la commande redémarre après avoir terminé, ce qui vous permet de continuer à créer des points.
