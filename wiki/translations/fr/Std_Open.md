...
1.  Il existe plusieurs façons de lancer la commande :
    -   Appuyez sur le bouton **<img src="images/Std_Open.svg" width=16px> [Ouvrir](Std_Open/fr.md)**.
    -   Sélectionnez l\'option **Fichier → <img src="images/Std_Open.svg" width=16px> Ouvrir...** du menu.
