...
La commande <img alt="" src=images/Draft_Snap_Lock.svg  style="width:24px;"> **Draft Verrouillage de l\'aimantation** permet d\'activer ou de désactiver l\'aimantation de manière globale.
...
1.  Pour lancer **Draft Verrouillage de l\'aimantation**, faites l\'une des choses suivantes :
    ...
    -   Appuyez sur le bouton **<img src="images/Draft_Snap_Lock.svg" width=x16px><img src="images/Toolbar_flyout_arrow.svg" width=x16px>** (clic court) dans le [Draft Widget aimantation](Draft_snap_widget/fr.md). {{Version/fr|0.21}}
    -   Maintenez enfoncé le bouton **<img src="images/Draft_Snap_Lock.svg" width=x16px><img src="images/Toolbar_flyout_arrow.svg" width=x16px>** dans le [Draft Widget aimantation](Draft_snap_widget/fr.md) et dans le menu qui s\'ouvre, sélectionnez l\'option **<img src="images/Draft_Snap_Lock.svg" width=16px> Verrouiller l'aimantation**.
