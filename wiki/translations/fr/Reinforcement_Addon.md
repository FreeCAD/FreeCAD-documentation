...
L\'extension Reinforcement (armature) fournit des types de barres supplémentaires :
...
Nouveaux outils avec interface graphique pour saisir les valeurs
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Reinforcement](Category_Reinforcement.md) > [Arch](Category_Arch.md) > Reinforcement Addon/fr
