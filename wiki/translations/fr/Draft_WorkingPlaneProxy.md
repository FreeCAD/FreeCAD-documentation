...
-   Les proxies de plan de travail peuvent être [déplacés](Draft_Move/fr.md) et [pivoté](Draft_Rotate/fr.md) comme tout autre objet. Utilisez <img alt="" src=images/Draft_Snap_Center.svg  style="width:16px;"> [Draft Aimantation Centre](Draft_Snap_Center/fr.md) pour s\'aimanter à leur point de {{PropertyData/fr|Placement}}.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft WorkingPlaneProxy/fr
