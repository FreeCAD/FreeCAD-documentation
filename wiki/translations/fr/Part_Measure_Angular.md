...
Cette commande mesure l\'angle entre deux arêtes droites, deux faces planes ou une arête droite et une face plane, puis affiche la mesure dans la [vue 3D](3D_view/fr.md).
...
2.  Il existe plusieurs façons de lancer la commande :
    -   Appuyez sur le bouton **<img src="images/Part_Measure_Angular.svg" width=16px> [Mesure angulaire](Part_Measure_Angular/fr.md)**.
