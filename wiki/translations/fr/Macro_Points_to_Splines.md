# Macro Points to Splines/fr
{{Macro/fr
|Name=Macro Points to Splines
|Description=Crée des splines à partir de sections d'objets Points.
|Author=heda
|Version=0.1
|Date=2024-10-23
|FCVersion=
...
Sélectionnez l\'objet Points (contenant des sections) et lancez-le. Voir \_\_doc\_\_ dans le [code](#Code.md) ci-dessous.
...
---
⏵ [documentation index](../README.md) > Macro Points to Splines/fr
