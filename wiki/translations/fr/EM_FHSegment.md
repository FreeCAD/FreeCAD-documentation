...
L\'objet FHSegment peut être basé sur la position d\'un objet <img alt="" src=images/Draft_Line.svg  style="width:16px;"> _ qui seront les points d\'extrémité FHSegment, ou bien, vous pouvez sélectionner l\'emplacement 3D des deux points d\'extrémité, où deux FHNodes supplémentaires seront créés.
