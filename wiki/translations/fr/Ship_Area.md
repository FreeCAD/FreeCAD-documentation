...
Pour calculer la courbe des aires transversales, sélectionnez une **instance de navire** (voir [Ships creation](Ship_New/fr.md)), et lancez **Ship design → Areas curve**.
