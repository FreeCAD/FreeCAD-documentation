...
3.  Vous pouvez modifier les dimensions et **Placement** du cylindre en effectuant l\'une des opérations suivantes :
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Part](Part_Workbench.md) > Part Cylinder/fr
