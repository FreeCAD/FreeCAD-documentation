...
-   <img alt="" src=images/Points_Structure.svg  style="width:32px;"> [Nuage de points structuré ](Points_Structure/fr.md): Crée un nuage de points structuré à partir des points d\'un nuage de points existant.
...
-   <img alt="" src=images/Points_Merge.svg  style="width:32px;"> [Fusionner les nuages de points ](Points_Merge/fr.md): Crée un nuage de points en combinant les points de deux ou plusieurs nuages de points.
