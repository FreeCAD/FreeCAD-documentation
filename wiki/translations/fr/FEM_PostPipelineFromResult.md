...
2.  Cliquez sur le bouton **<img src="images/FEM_PostPipelineFromResult.svg" width=16px> '''Pipeline de résultats'''**, ou sélectionnez l\'option **Résultats → <img src="images/FEM_PostPipelineFromResult.svg" width=16px> Pipeline de résultats** dans le menu.
