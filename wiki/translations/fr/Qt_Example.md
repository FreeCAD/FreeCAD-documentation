...
|Icon=MEPlan.png
|Name/fr=Macro Qt Example
|Description=Description de commandes Qt.
|Author=Mario52
|Version=0.4
|Date=2019-06-19
|FCVersion=Toutes
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Poweruser Documentation](Category_Poweruser Documentation.md) > [Python Code](Category_Python Code.md) > Qt Example/fr
