...
Cette page est une prolongation de la page _ et donne des directives communes pour la rédaction et la mise à jour de la documentation du wiki FreeCAD. Elle résume plusieurs discussions et séances de réflexion.
...
-   Si vous n\'avez jamais utilisé de logiciel wiki auparavant, veuillez lire _ pour vous familiariser avec le balisage utilisé.
...
-   Utilisez un bac à sable (sandbox) pour tester votre code, par exemple, _ ou une page particulière avec votre nom _. Les pages Sandbox doivent être placées dans la catégorie Sandbox. Cela se fait en ajoutant [[Category:Sandbox]] au bas du code du wiki.
...
N\'utilisez pas la transclusion de pages (_) car cela rend le wiki difficile à traduire. Utilisez uniquement les modèles décrits ci-dessous dans [Modèles](#Mod.C3.A8les.md).
...
Le _ est utilisé pour lier séquentiellement des pages, en suivant la structure de la [Table des matières de l\'aide en ligne](Online_Help_Toc/fr.md). Voir [Modèles](#Mod.C3.A8les.md) pour une liste de tous les modèles.
...
Le style des pages du wiki FreeCAD est réalisé grâce à l\'utilisation de modèles (_). Ils garantissent une apparence standardisée pour toutes les pages et permettent également de modifier le style du wiki. Vous pouvez voir la liste complète des modèles définis en accédant à _. Mais veuillez n\'utiliser que les modèles figurant dans les tableaux ci-dessous. Vous ne devez utiliser directement les balises HTML que dans des cas très particuliers.
...
+===============================================================================================================+========================================+=============================================================================================================================================================================================================================================================================================================================+
| _                                                                                |                         | Utilisez-le pour ajouter un lien en haut de la page.                                                                                                                                                                                                                                                                        |
|                                                                                                               | {{Top}}                                |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                      |                         | Utilisez-le pour mettre en valeur un élément de texte.                                                                                                                                                                                                                                                                      |
|                                                                                                               | **emphasis**                  |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                                |                         | Utilisez-le pour indiquer une touche du clavier qui doit être enfoncée.                                                                                                                                                                                                                                                     |
|                                                                                                               | **Alt**                            |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                            |                         | Utilisez-le pour indiquer une touche ascii dans une image (.svg) qui doit être utilisée. Vous devez donner le caractère souhaité ou le numéro du code ascii du caractère.                                                                                                                                                   |
|                                                                                                               | {{ASCII|A}}                            |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                          |                         | Utilisez-le pour indiquer un bouton de l\'interface utilisateur graphique sur lequel il faut appuyer.                                                                                                                                                                                                                       |
|                                                                                                               | **Cancel**                      |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                |                         | Utilisez-le pour indiquer un bouton radio dans l\'interface utilisateur graphique qui doit être {{RadioButton|TRUE|Selected}} ou {{RadioButton|FALSE|Not}}.                                                                                                                                     |
|                                                                                                               | {{RadioButton|Option}}                 |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                      |                         | Utilisez-le pour indiquer une case à cocher dans l\'interface utilisateur graphique qui doit être {{CheckBox|TRUE|Checked}} ou {{CheckBox|FALSE|Not}}.                                                                                                                                          |
|                                                                                                               | {{CheckBox|Option}}                    |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                        |                         | Utilisez-le pour indiquer une spinbox dans l\'interface utilisateur graphique qui doit être modifiée.                                                                                                                                                                                                                       |
|                                                                                                               | {{SpinBox|1.50}}                       |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                      |                         | Utilisez-le pour indiquer une combobox dans l\'interface utilisateur graphique qui doit être modifiée.                                                                                                                                                                                                                      |
|                                                                                                               | {{ComboBox|Menu 1}}                    |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _, _                                        |                         | Utilisez-le pour indiquer une valeur booléenne fausse, par exemple, en tant que propriété dans l\'_ {{Value|false}}                    |
|                                                                                                               | `False`                              |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               | , {{false}}              |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _, _                                            |                         | Utilisez-le pour indiquer une valeur booléenne vraie, par exemple, en tant que propriété dans l\'_ {{Value|true}}                      |
|                                                                                                               | `True`                               |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               | , {{true}}               |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                |                         | Utilisez-le pour indiquer l\'emplacement d\'une commande dans un menu particulier.                                                                                                                                                                                                                                          |
|                                                                                                               | **File → Save**            |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                      |                         | Utilisez-le pour indiquer le nom d\'un fichier ou d\'un répertoire.                                                                                                                                                                                                                                                         |
|                                                                                                               | {{FileName|File name}}                 |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                |                         | Utilisez-le pour indiquer le texte d\'entrée tapé par l\'utilisateur.                                                                                                                                                                                                                                                       |
|                                                                                                               | {{SystemInput|Type this text}}         |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                              |                         | Utilisez-le pour indiquer la sortie de texte du système.                                                                                                                                                                                                                                                                    |
|                                                                                                               | {{SystemOutput|Output text}}           |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                          |                         | Utilisez-le pour inclure du code source en ligne avec une police monospace. Il doit tenir sur une seule ligne.                                                                                                                                                                                                              |
|                                                                                                               | `import FreeCAD`              |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                              |                         | Utilisez-le pour indiquer une propriété de vue dans l\'[Éditeur de propriétés](Property_editor/fr.md). Des exemples de propriétés de vue incluent {{emphasis|Line Color}}, {{emphasis|Line Width}}, {{emphasis|Point Color}}, {{emphasis|Point Size}}, etc. |
|                                                                                                               | **Color**                 |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                              |                         | Utilisez-le pour indiquer une propriété Data dans l\'[Éditeur de propriétés](Property_editor/fr.md). Les propriétés de données sont différentes selon les types d\'objets.                                                                                                                                          |
|                                                                                                               | **Position**              |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _ / _ |                         | Utilisez-le pour indiquer le titre d\'un groupe de propriétés dans l\'[Éditeur de propriétés](Property_editor/fr.md). Le titre ne sera pas inclus dans la table des matières automatique.                                                                                                                           |
|                                                                                                               | {{Properties_Title|Base}}              |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                      |                         | Utilisez-le pour indiquer qu\'une fonctionnalité est devenue obsolète dans la version de FreeCAD spécifiée.                                                                                                                                                                                                                 |
|                                                                                                               | {{Obsolete|0.19}}                      |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                        |                         | Utilisez-le pour indiquer qu\'une fonctionnalité a été introduite dans la version de FreeCAD spécifiée.                                                                                                                                                                                                                     |
|                                                                                                               | <small>(v0.18)</small>                        |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                              |                         | Utilisez-le pour indiquer qu\'une fonctionnalité est disponible dans la version de FreeCAD spécifiée et les versions antérieures.                                                                                                                                                                                           |
|                                                                                                               | {{VersionMinus|0.16}}                  |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                |                         | Utilisez-le pour indiquer qu\'une fonctionnalité est disponible dans la version de FreeCAD spécifiée et les versions ultérieures.                                                                                                                                                                                           |
|                                                                                                               | <small>(v0.17)</small>                    |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                |                         | Utilisez ce modèle pour colorer l\'arrière-plan, le texte, ou l\'arrière-plan et le texte. (_ page pour plus d\'exemples)                                                                                                                                                      |
|                                                                                                               | {{ColoredText|Colored Text}}           |                                                                                                                                                                                                                                                                                                                             |
|                                                                                                               |                                     |                                                                                                                                                                                                                                                                                                                             |
+---------------------------------------------------------------------------------------------------------------+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                      |                         | Utilisez ce modèle pour colorer le fond, le texte, ou le fond et le texte d\'un paragraphe entier. La page _ pour plus d\'exemples)                                                                                                                                  |
...
| Modèle                                                                                           | Apparence                                                                                                                    | Description                                                                                                                                                                                                                                                                                                                                   |
+==================================================================================================+==============================================================================================================================+===============================================================================================================================================================================================================================================================================================================================================+
| _                                                   | Ce tableau                                                                                                                   | Utilisez-le pour formater des tableaux comme celui-ci. Des propriétés de tableaux supplémentaires peuvent être ajoutées.                                                                                                                                                                                                                      |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                           |                                                                                                                    | Utilisez-le pour ajouter une explication sous une image. Elle peut être alignée à gauche ou au centre.                                                                                                                                                                                                                                        |
...
|                                                                                                  | .                                                                                                                            |                                                                                                                                                                                                                                                                                                                                               |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                               |                                                                                                                              | Utilisez-le pour effacer des colonnes. Suivez la définition du modèle pour une explication détaillée. Il est souvent utilisé pour empêcher le texte de déborder à côté d\'images sans rapport.                                                                                                                                                |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                                 |                                                                                                               | Utilisez-le pour inclure des exemples de code multi-lignes avec une police monospace. Le langage par défaut est Python, mais d\'autres langages peuvent être spécifiés.                                                                                                                                                                       |
|                                                                                                  | 
...
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                 |                                                                                                               | Utilisez-le pour créer un titre qui ne sera pas automatiquement inclus dans la table des matières.                                                                                                                                                                                                                                            |
|                                                                                                  | {{Fake heading|Heading|2}}                                                                                                   |                                                                                                                                                                                                                                                                                                                                               |
|                                                                                                  |                                                                                                                           |                                                                                                                                                                                                                                                                                                                                               |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                     | See [GuiCommand model](GuiCommand_model.md)                                                                          | UUtilisez-le pour créer une boîte contenant des informations utiles pour documenter les commandes de l\'atelier (outils).                                                                                                                                                                                                                     |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                 | Voir par exemple [Tutoriel de modélisation de base](Basic_modeling_tutorial/fr.md).                                  | Utilisez-le pour créer une boîte contenant des informations utiles pour documenter les [tutoriels](Tutorials/fr.md).                                                                                                                                                                                                                  |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                               | Voir par exemple [Macro FlattenWire](Macro_FlattenWire/fr.md).                                                       | Utilisez-le pour créer une boîte contenant des informations utiles pour documenter les [macros](Macros/fr.md).                                                                                                                                                                                                                        |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                             |                                                                                                               | Utilisez-le pour créer une barre avec les mots \"suivant\", \"précédent\" et \"index\" et les liens appropriés, ce qui est utile pour placer les pages dans un ordre particulier.                                                                                                                                                             |
|                                                                                                  |                                                                                 |                                                                                                                                                                                                                                                                                                                                               |
|                                                                                                  |                                                                                                                           |                                                                                                                                                                                                                                                                                                                                               |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                 |                                                                                                               | Utilisez-le pour créer une boîte en surbrillance contenant un message très important. Utilisez-le avec parcimonie, uniquement pour indiquer des problèmes majeurs dans la fonctionnalité du logiciel, l\'abandon d\'outils, etc.                                                                                                              |
|                                                                                                  | **Important Message**                                                                                   |                                                                                                                                                                                                                                                                                                                                               |
|                                                                                                  |                                                                                                                           |                                                                                                                                                                                                                                                                                                                                               |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                         |                                                                                                               | Utilisez cette option pour les pages qui sont toujours en cours ou qui sont en train d\'être retravaillées. N\'oubliez pas de le supprimer lorsque la page est prête.                                                                                                                                                                         |
|                                                                                                  | {{Page in progress|Page in progress}}                                                                                        |                                                                                                                                                                                                                                                                                                                                               |
|                                                                                                  |                                                                                                                           |                                                                                                                                                                                                                                                                                                                                               |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                             |                                                                                                               | Utilisez-le pour créer une boîte en surbrillance indiquant une page de documentation inachevée.                                                                                                                                                                                                                                               |
|                                                                                                  |                                                                                                            |                                                                                                                                                                                                                                                                                                                                               |
|                                                                                                  |                                                                                                                           |                                                                                                                                                                                                                                                                                                                                               |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                 |                                                                                                                              | Utilisez-la à la place de la redirection normale, lorsque vous redirigez vers une page spéciale (comme Media: ou Category:), auquel cas la redirection normale est désactivée.                                                                                                                                                                |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _                                                               |                                                                                                               | Utilisez-le pour créer un encadré de texte avec une citation et une référence littérale.                                                                                                                                                                                                                                                      |
|                                                                                                  | {{Quote|text=Cry "Havoc" and let slip the dogs of war.|sign=William Shakespeare|source=''Julius Caesar'', act III, scene I}} |                                                                                                                                                                                                                                                                                                                                               |
|                                                                                                  |                                                                                                                           |                                                                                                                                                                                                                                                                                                                                               |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| _, _ |                                                                                                                              | Utilisez-les pour créer des boîtes de navigation pour la documentation utilisateur, la documentation pour les utilisateurs expérimentés et la documentation pour les développeurs. Cela permet de passer rapidement d\'une section à l\'autre de la documentation. Ils placent également la page correspondante dans la catégorie appropriée. |
+--------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
Les images peuvent être téléchargées via la page _.
...
Pour créer une capture d\'écran, vous pouvez utiliser les options fournies par votre système d\'exploitation, ou l\'une de ces macros : <img alt="" src=images/Snip.png  style="width:24px;"> _.
...
---
[documentation index](../README.md) > [Documentation](Category_Documentation.md) > WikiPages/fr
