...
|Icon=GW_Dim.png
|Description=Macro avec interface graphique qui permet à l'utilisateur de créer un mécanisme de roue de Genève à partir de zéro. Cette macro est basée sur la macro de _ [Macro Geneva Wheel](Macro_Geneva_Wheel/fr.md)
|Author=quick61
|Version=1.0
|Date=2014-09-21
|FCVersion=All
...
Cette macro est la version graphique de l\'original _
