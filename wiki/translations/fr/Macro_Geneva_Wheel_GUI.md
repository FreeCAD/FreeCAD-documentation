...
|Icon=GW_Dim.png
|Description=Macro avec interface graphique qui permet à l'utilisateur de créer un mécanisme de roue de Genève à partir de zéro. Cette macro est basée sur la macro de [Drei](User_Drei.md) [Macro Geneva Wheel](Macro_Geneva_Wheel/fr.md)
|Author=quick61
|Version=1.0
|Date=2014-09-21
|FCVersion=All
...
Interface graphique permettant à l'utilisateur de créer un mécanisme de roue de Genève à partir de rien. Basé sur la [Macro Geneva Wheel](Macro_Geneva_Wheel.md) de drei.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro Geneva Wheel GUI/fr
