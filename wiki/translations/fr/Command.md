...
---
⏵ [documentation index](../README.md) > [Command_Reference|:Category:Command_Reference]]. Les commandes peuvent être lancées à l'aide d'un bouton de la barre d'outils, d'un élément de menu, d'un script ](Category_Command_Reference|:Category:Command_Reference]].%20Les%20commandes%20peuvent%20être%20lancées%20à%20l'aide%20d'un%20bouton%20de%20la%20barre%20d'outils,%20d'un%20élément%20de%20menu,%20d'un%20script%20.md) > [Developer Documentation](Category_Developer%20Documentation.md) > [Python Code](Category_Python%20Code.md) > [Glossary](Category_Glossary.md) > Command/fr
