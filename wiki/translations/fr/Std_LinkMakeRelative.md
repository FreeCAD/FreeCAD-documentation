---
 GuiCommand:
   ...
   Workbenches: Tous
   Version: 0.19
   SeeAlso: Std Part/fr, Std Group/fr, Std_LinkMake/fr
---
...
crée un [App Link](App_Link/fr.md) (classe `App::Link`), tout comme **[<img src=images/Std_LinkMake.svg style="width:16px"> [Std Créer un lien](Std_LinkMake/fr.md)** mais il fonctionne d\'abord sur les sous-éléments sélectionnés et définit **Link Transform** sur {{TRUE }}.
...
1.  Sélectionnez un sous-élément dans la [vue 3D](3D_view/fr.md), c\'est à dire un sommet, une arête ou une face ou toute combinaison de ceux-ci. Ces sous-éléments doivent appartenir à un seul objet.
...
En particulier, **Link Transform** est défini sur `True`, donc **Placement** devient masqué et à la place **Link Placement** contrôle la position du lien par rapport à la position de **Linked Object**.
