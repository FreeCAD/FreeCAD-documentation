...
-   [Invent Box Tutorials playlists](https://www.youtube.com/channel/UCRQCzMftIUElX03kHjV4rmQ/playlists) : de nombreuses vidéos de différents programmes de conception, notamment GIMP, Krita, Inkscape, Blender, KiCad et FreeCAD.
    -   [Learn FreeCAD](https://www.youtube.com/watch?v=CG_czsNdUfs&list=PL2935W76vRNFvUGefQr3q9P9eezJZyj-u) : FreeCAD 0.17, une série de 15 vidéos par Invent Box Tutorials en anglais. Cette série présente de nombreux outils courants utilisés dans l\'[atelier PartDesign](PartDesign_Workbench/fr.md) et dans [atelier CAM](CAM_Workbench/fr.md) pour modéliser une pièce adaptée à la fabrication : esquisses, extrusion, lissage, balayage, miroir, motifs linéaires et polaires, opérations booléennes , hélice, parcours d\'outils, découpe de cavités, perçage, gravure, post-traitement et découpe.
...
-   [bavariaSHAPE - Listes de lecture FreeCAD Practice](https://www.youtube.com/channel/UCUO0Kd8_XgZk3GE-IiqnCmQ/playlists): diverses vidéos sur l\'utilisation de FreeCAD 0.17 à 0.19 avec annotations en anglais et en allemand.
    -   [FreeCAD Wissenshäppchen 2018](https://www.youtube.com/watch?v=nYStPcmINR4&list=PLsygOHSYV43UrQAWmEWJBY8GwX5t74ufz): une série de 16 courtes vidéos montrant comment effectuer certaines actions: travaillez avec des engrenages, utilisez la clé **M} } dans Sketcher, mesurez un STEP importé, configurez LuxRender, préparez des illustrations techniques à l'aide d'Inkscape, évaluez et réparez des fichiers STL et exportez des fichiers STL.
        ** [https://www.youtube.com/watch?v=sMsXfQ9hQEI&list=PLsygOHSYV43WzeqFkB1X4chHPFIq_LId5 FreeCAD Wissenshäppchen 2019]: une série de 8 courtes vidéos montrant comment effectuer certaines actions: convertir un croquis dessiné à la main en un objet 3D, nettoyer un séparez et gérez les associations paramétriques, utilisez l'interface de placement, comprenez les méthodes de projection dans TechDraw, gérez l'historique de construction dans une feuille de calcul et utilisez l'atelier de tôlerie.

        * [https://www.youtube.com/channel/UCGuJsIoXW-exBAwdn38dXow/playlists German_Plasma_CNC] listes de lecture pour FreeCAD, CNC, G-code, Blender et d'autres sujets. Principalement en allemand, quelques vidéos en anglais.
        ...
        ** [https://www.youtube.com/watch?v=r5LBKEA0mks&list=PLsfgGA_lzHGdHSecmkDHI7i8gJFWKwiU4 FreeCAD Tutorial]: FreeCAD 0.18, une série de 7 vidéos montrant comment modéliser divers objets: structures tubulaires de base, connexions de tuyaux, clé à fourche , un boulon et un écrou.
...
---
⏵ [documentation index](../README.md) > [Tutorials](Category_Tutorials.md) > Video tutorials for product design/fr
