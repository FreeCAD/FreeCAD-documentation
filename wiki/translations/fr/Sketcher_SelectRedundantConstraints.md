...
2.  Choisissez **Sketch → Outils d'esquisse → [<img src=images/Sketcher_SelectRedundantConstraints.svg style="width   *16px"> Sélectionner les contraintes redondantes** dans le menu principal.
