...
1.  Sélectionnez l\'option **Affichage → Vues standards → Axonométrique → <img src="images/Std_ViewTrimetric.svg" width=16px> Trimétrique** du menu.



## Script

Voir [Std Vue isométrique](Std_ViewIsometric/fr#Script.md).
