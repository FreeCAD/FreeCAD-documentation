...
- GuiCommand   */fr
   ...
   MenuLocation   *Modèle → Contraintes thermiques → Contrainte de chaleur pour le corps
...
1.  Il existe plusieurs façons de lancer la commande    *
    -   Appuyez sur le bouton **<img src="images/FEM_ConstraintBodyHeatSource.svg" width=16px> [Contrainte source de chaleur pour le corps](FEM_ConstraintBodyHeatSource/fr.md)**.
    -   Sélectionnez l\'option **Modèle → Contraintes thermiques → <img src="images/FEM_ConstraintBodyHeatSource.svg" width=16px> Contrainte source de chaleur pour le corps** dans le menu.
