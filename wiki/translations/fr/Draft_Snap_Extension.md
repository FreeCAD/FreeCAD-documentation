...
2.  Si **Draft Aimantation Extension** n\'est pas actif, faites l\'une des choses suivantes :
    ...
    -   Appuyez sur le bouton **<img src="images/Draft_Snap_Lock.svg" width=16px><img src="images/Toolbar_flyout_arrow.svg" width=8px>** dans le [Draft Widget aimantation](Draft_snap_widget/fr.md) et dans le menu sélectionnez l\'option {{MenuCommand|<img src="images/Draft_Snap_Extension.svg" width=16px> Extension de l'aimantation}}.
