...
-    {{StdMenu|[Affichage](Std_View_Menu/fr.md)}}: e menu Affichage fournit des outils pour modifier la [Vue 3D](3D_view.md) et les propriétés de vue des objets dans le modèle, et des outils liés à l\'affichage des composants d\'interface .
