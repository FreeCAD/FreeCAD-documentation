...
-   Un placement de milieu à milieu de deux lignes droites peut être obtenu en créant un nouveau <img alt="" src=images/Sketcher_CreatePoint.svg  style="width:24px;"> _ contraintes de sorte qu\'il se trouve au milieu des deux lignes.
...
-   Un placement colinéaire de deux lignes droites peut être obtenu en leur appliquant une contrainte <img alt="" src=images/Sketcher_ConstrainTangent.svg  style="width:24px;"> _ et une contrainte <img alt="" src=images/Sketcher_ConstrainParallel.svg  style="width:24px;"> [Parallèle](Sketcher_ConstrainParallel/fr.md).
...
-   Deux cercles peuvent être rendus identiques en utilisant une contrainte <img alt="" src=images/Sketcher_ConstrainCoincident.svg  style="width:24px;"> _ à leurs bords. Pour les arcs, cela garantira que les deux arcs font partie du même cercle, tout en leur permettant d\'avoir des points de départ et d\'arrivée différents.
