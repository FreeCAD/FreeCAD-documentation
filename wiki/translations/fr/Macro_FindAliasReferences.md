# Macro FindAliasReferences/fr
{{Macro
|Name=FindAliasReferences
|Description=Cette macro analysera toutes les expressions de tous les documents ouverts, puis affichera, dans la vue du rapport, toutes les expressions contenant l'alias ou, si l'alias n'est pas défini, la valeur dans la ou les cellules sélectionnées de la feuille de calcul.
|Author=RoyW
|Download=[https://wiki.freecad.org/images/b/bd/FindAliasReferences.png?20240117201630 Icône de la barre d'outils ]
|Version=2024.04.09
|Date=2024-04-09
|FCVersion=0.22
}}
...
---
⏵ [documentation index](../README.md) > Macro FindAliasReferences/fr
