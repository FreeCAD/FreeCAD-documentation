...
-   L\'orientation par défaut de la caméra peut être personnalisée dans les préférences : **Edition → Préférences ... → Affichage → Navigation → Orientation par défaut de la caméra**. Voir [Réglage des préférences](Preferences_Editor/fr#Navigation.md).
