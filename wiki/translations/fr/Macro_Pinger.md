...
|Description=Utilisez cette macro pour envoyer facilement un message aux utilisateurs du forum FreeCAD. Sélectionnez l'utilisateur dans la liste déroulante, cliquez sur Ping, collez le code dans le message du forum. Vous pouvez ajouter de nouveaux utilisateurs.
|Author=TheMarkster
|Version=1.81
|Date=2022.03.28
|FCVersion=0.19
|Download=[https://wiki.freecadweb.org/images/6/67/Pinger_Icon.svg Icône de la barre d'outils]
|SeeAlso=[Macro Snip](Macro_Snip/fr.md)
}}

## Description

Utilisez cette macro pour envoyer un ping à un autre utilisateur du forum afin que celui-ci reçoive une notification. Pour effectuer un ping, il faut connaître le nom d\'utilisateur exact et le numéro d\'identification de l\'utilisateur. Vous devez également connaître la syntaxe requise pour produire le ping. C\'est très peu convivial, pour ne pas dire plus. La macro Pinger vient sauver la situation. Exécutez la macro, sélectionnez l\'utilisateur que vous souhaitez pinger, cliquez sur le bouton Ping, copiez le code dans le message du forum.
