...
- GuiCommand:/fr
   ...
   MenuLocation:Parcours → Modèle d'exportation
...
1.  Sélectionnez l\'option **Parcours → <img src="images/Path_ExportTemplate.svg" width=16px> Modèle d'exportation** dans le menu.
