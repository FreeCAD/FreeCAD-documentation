...
## Barre de recherche {#barre_de_recherche}
...
-    {{MenuCommand|Select only}}: désélectionne tout et sélectionne uniquement l\'objet parent qui contient l\'élément donné.

-    {{MenuCommand|Deselect}}: supprime complètement la sélection de tous les objets.
