...
-   <img alt="" src=images/Std_About.svg  style="width:32px;"> [A propos de FreeCAD](Std_About/fr.md): ouvre une boîte de dialogue contenant des informations sur FreeCAD.
...
---
[documentation index](../README.md) > [Workbenches](Category:Workbenches.md) > Std Help Menu/fr
