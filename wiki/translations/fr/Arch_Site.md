...
-   Vous pouvez ajouter un objet terrain en éditant le site propriété **Terrain**. Le terrain doit être une coquille ouverte (open shell) ou une surface.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Arch](Arch_Workbench.md) > Arch Site/fr
