...
Parfois, lorsqu\'un utilisateur applique des modifications au modèle, FreeCAD ne semble pas les reconnaître/les intégrer. En outre, le bouton bleu **<img src="images/Std_Refresh.svg" width=24px> [Std Recalculer](Std_Refresh/fr.md)** reste grisé. Cette petite macro a donc été conçue pour forcer un recalcul manuel du modèle.

**Remarque :** a partir de {{VersionPlus/fr|0.17}}, l\'effet de cette macro peut être obtenu via l\'interface graphique. Cliquez avec le bouton droit sur le projet dans la [vue en arborescence](Tree_view/fr.md) du modèle et choisissez **Marquer pour recalculer** dans le menu contextuel. Cela revient à réactiver l\'icône Recalculer. Appuyez maintenant sur le bouton <img alt="" src=images/Std_Refresh.svg  style="width:24px;"> [Std Recalculer](Std_Refresh/fr.md) pour déclencher un recalcul.
