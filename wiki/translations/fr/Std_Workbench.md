...
-   Des [ateliers externes](External_workbenches/fr.md) supplémentaires peuvent être téléchargés à l\'aide du <img alt="" src=images/AddonManager.svg  style="width:24px;"> [Gestionnaire d\'Addon](Addon_Manager/fr.md).
