---
 GuiCommand:
   ...
   Name/fr: Fasteners Calculateur de trous de vis
   MenuLocation: Fasteners , Calculateur de trous de vis
...
La commande <img alt="" src=images/Fasteners_ScrewCalculator.svg  style="width:24px;"> **Fasteners Calculateur de trous de vis** affiche une calculatrice permettant de déterminer la taille du trou taraudé des vis.
