# <img alt="Icône de Base" src=images/Freecad.svg  style="width:64px;"> Std View Menu/fr
...
-   <img alt="" src=images/Std_ViewCreate.svg  style="width:32px;"> [Créer une nouvelle vue](Std_ViewCreate/fr.md) : crée une nouvelle vue 3D.

-   <img alt="" src=images/Std_OrthographicCamera.svg  style="width:32px;"> [Vue orthographique](Std_OrthographicCamera/fr.md) : bascule en mode de vue orthographique.

-   <img alt="" src=images/Std_PerspectiveCamera.svg  style="width:32px;"> [Vue en perspective](Std_PerspectiveCamera/fr.md) : bascule en mode vue en perspective.

-   <img alt="" src=images/Std_MainFullscreen.svg  style="width:32px;"> [Plein écran](Std_MainFullscreen/fr.md) : bascule le mode plein écran de la fenêtre principale.
...
-   Vues standards
    ...
    -   Axonométrique
        ...
        -   <img alt="" src=images/Std_ViewTrimetric.svg  style="width:32px;"> [Trimétrique](Std_ViewTrimetric/fr.md) : bascule vers une vue trimétrique.
    -   <img alt="" src=images/Std_ViewHome.svg  style="width:32px;"> [Accueil](Std_ViewHome/fr.md) : passe à la vue d\'accueil par défaut.
    -   <img alt="" src=images/Std_ViewFront.svg  style="width:32px;"> [Vue de devant](Std_ViewFront/fr.md) : bascule vers la vue de face.
    -   <img alt="" src=images/Std_ViewTop.svg  style="width:32px;"> [Vue de dessus](Std_ViewTop/fr.md) : bascule vers la vue de dessus.
    -   <img alt="" src=images/Std_ViewRight.svg  style="width:32px;"> [Vue de droite](Std_ViewRight/fr.md) : bascule vers la vue de droite.
...
-   [Style de représentation](Std_DrawStyle/fr.md)
    -   <img alt="" src=images/Std_DrawStyleAsIs.svg  style="width:32px;"> [Par défaut](Std_DrawStyle/fr#Par_défaut.md) : bascule le style de dessin sur : Par défaut.
    -   <img alt="" src=images/Std_DrawStylePoints.svg  style="width:32px;"> [Points](Std_DrawStyle/fr#Points.md) : bascule le style de dessin sur : Points.
    -   <img alt="" src=images/Std_DrawStyleWireFrame.svg  style="width:32px;"> [Filaire](Std_DrawStyle/fr#Filaire.md) : bascule le style de dessin sur : Filaire.
    -   <img alt="" src=images/Std_DrawStyleHiddenLine.svg  style="width:32px;"> [Ligne cachée](Std_DrawStyle/fr#Ligne_cachée.md) : bascule le style de dessin sur : Ligne cachée.
    -   <img alt="" src=images/Std_DrawStyleNoShading.svg  style="width:32px;"> [Pas d\'ombrage](Std_DrawStyle/fr#Pas_d'ombrage.md) : bascule le style de dessin sur : Pas d\'ombrage.
    -   <img alt="" src=images/Std_DrawStyleShaded.svg  style="width:32px;"> [Ombré](Std_DrawStyle/fr#Ombré.md) : bascule le style de dessin sur : Ombré.
    -   <img alt="" src=images/Std_DrawStyleFlatLines.svg  style="width:32px;"> [Filaire ombré](Std_DrawStyle/fr#Filaire_ombré.md) : bascule le style de dessin sur : Filaire ombré.

-   <img alt="" src=images/Std_SelBoundingBox.svg  style="width:32px;"> [Boîte englobante](Std_SelBoundingBox/fr.md) : bascule le mode de surbrillance du cadre de sélection.
...
-   Vue stéréoscopique
    ...
    -   <img alt="" src=images/Std_ViewIvStereoQuadBuff.svg  style="width:32px;"> [Tampon stéréo quadruple](Std_ViewIvStereoQuadBuff/fr.md) : bascule vers la vue stéréo du tampon quadruple.
...
-   Zoom
    ...
    -   <img alt="" src=images/Std_ViewZoomOut.svg  style="width:32px;"> [Zoom arrière](Std_ViewZoomOut/fr.md) : effectue un zoom arrière sur la vue.
    -   <img alt="" src=images/Std_ViewBoxZoom.svg  style="width:32px;"> [Zoom de sélection](Std_ViewBoxZoom/fr.md) : Effectue un zoom avant sur une zone rectangulaire.

-   Fenêtre de document
    -   [Ancrer](Std_ViewDockUndockFullscreen/fr#Ancrer.md) : ancre une vue 3D.
    -   [Désancrer](Std_ViewDockUndockFullscreen/fr#Désancrer.md) : désancre une vue 3D.
    -   <img alt="" src=images/Std_ViewFullscreen.svg  style="width:32px;"> [Plein écran](Std_ViewFullscreen/fr.md) : bascule le mode plein écran d\'une vue 3D.

-   <img alt="" src=images/Std_AxisCross.svg  style="width:32px;"> [Axes du repère](Std_AxisCross/fr.md) : bascule les axes du repère.
...
-   Visibilité
    -   <img alt="" src=images/Std_ToggleVisibility.svg  style="width:32px;"> [Basculer la visibilité](Std_ToggleVisibility/fr.md) : active/désactive la visibilité des objets sélectionnés.
    -   <img alt="" src=images/Std_ShowSelection.svg  style="width:32px;"> [Afficher la sélection](Std_ShowSelection/fr.md) : affiche les objets sélectionnés.
    -   <img alt="" src=images/Std_HideSelection.svg  style="width:32px;"> [Masquer la sélection](Std_HideSelection/fr.md) : masque les objets sélectionnés.
    -   <img alt="" src=images/Std_SelectVisibleObjects.svg  style="width:32px;"> [Sélectionner les objets visibles](Std_SelectVisibleObjects/fr.md) : sélectionne tous les objets visibles.
    -   <img alt="" src=images/Std_ToggleObjects.svg  style="width:32px;"> [Basculer tous les objets](Std_ToggleObjects/fr.md) : active/désactive la visibilité de tous les objets.
...
-   Fenêtres ancrables superposées {{Version/fr|1.0}}
    ...
    -   [Basculer une transparence](Std_DockOverlayToggleTransparent/fr.md) : active/désactive le mode transparent pour la fenêtre ancrée sous le curseur. Cela permet à la fenêtre ancrée de rester transparente tout le temps.
    -   [Souris sans effet sur les fenêtres superposées ancrées](Std_DockOverlayMouseTransparent/fr.md) : ignore tous les événements de la souris dans les fenêtres superposées ancrées.
    -   [Basculer à gauche](Std_DockOverlayToggleLeft/fr.md) : affiche/masque le panneau de recouvrement de gauche.
    -   [Basculer à droite](Std_DockOverlayToggleRight/fr.md) : affiche/masque le panneau de recouvrement de droite.
...
-   Actions sur l\'arborescence
    ...
    -   <img alt="" src=images/Std_SelForward.svg  style="width:32px;"> [Sélection suivante](Std_SelForward/fr.md) : rétablit la sélection suivante de l\'arborescence.
