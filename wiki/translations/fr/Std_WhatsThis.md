...
-   Sur Debian/Ubuntu et éventuellement d\'autres systèmes Linux, la documentation hors ligne peut devoir être installée séparément. Le package est nommé {{FileName|freecad-doc}} ou {{FileName|freecad-daily-doc}} (pour le PPA freecad-daily). Voir [Installation du fichier d\'aide](Installing_Helpfile/fr.md).
