...
1.  Si vous envisagez d\'identifier les paramètres d\'un type de surface, notez que la commande utilise la couleur rouge pour marquer les faces sélectionnées pour cette option. Pour les voir correctement   *
    -   La **Display Mode** de l\'objet maillage devrait idéalement être {{Value|Flat lines}}, mais devrait au moins montrer des faces. Si nécessaire, utilisez la commande [Std Style de représentation](Std_DrawStyle/fr.md) pour remplacer cette propriété.
    -   La **Shape Color** de l\'objet mesh ne doit pas être rouge.
...
5.  Appuyez éventuellement sur l\'un des boutons **Paramètres...** pour identifier les paramètres d\'une surface   *
    ...
    -   Sélectionnez une ou plusieurs faces appartenant à la surface   *
        ...
        -   Appuyez éventuellement sur le bouton **Effacer** pour effacer la sélection.
