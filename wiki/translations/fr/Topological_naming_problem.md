...
-   [PartDesign Congé - Nom topologique](PartDesign_Fillet/fr#Nom_topologique.md)
-   [Topological Naming, My Take](https://forum.freecadweb.org/viewtopic.php?t=27278), une solution possible par realthunder.
-   [Projet Nommage](Naming_project/fr.md): Efforts pour mettre en place une dénomination topologique robuste dans FreeCAD.
...
---
[documentation index](../README.md) > [Common Questions](Category:Common Questions.md) > Topological naming problem/fr
