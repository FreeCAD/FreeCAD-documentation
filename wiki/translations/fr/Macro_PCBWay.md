...
3.  Ouvrez le [gestionnaire de macros](Std_DlgMacroExecute/fr.md) depuis le menu **Macro → Macros...**.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro PCBWay/fr
