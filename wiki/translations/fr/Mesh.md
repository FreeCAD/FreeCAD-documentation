...
Lorsqu\'un objet avec un solide [Shape](Shape/fr.md) est utilisé dans [FEM Workbench](FEM_Workbench/fr.md), il sera discrétisé en un maillage triangulaire. Dans ce cas, l\'objet résultant est un [Fem FemMeshObject](Fem_FemMeshObject/fr.md) (classe `Fem::FemMeshObject`) et n\'est pas dérivé d\'une [Mesh Feature](Mesh_Feature/fr.md) (`Mesh::Feature` classe).
