...
2.  Cliquez éventuellement sur la flèche vers le bas à droite du bouton pour ouvrir le menu :
    ...
    -   
        **Espacement**
        ...
        spécifie la distance entre deux lignes de la grille. Utilisé comme valeur de base si **Espacement automatique de la grille** est activé. Cela est enregistré dans la propriété de l\'esquisse **Grid Size**.
