...
Un [Std Group](Std_Group/fr.md) est appelé en interne [App DocumentObjectGroup](App_DocumentObjectGroup/fr.md) (classe `App::DocumentObjectGroup`) et dérive de [App DocumentObject](App_DocumentObject/fr.md) (classe `App::DocumentObject`). Il partage donc toutes les propriétés de ce dernier.
...
Un [Std Group](Std_Group.md) est formellement une instance de la classe `App::DocumentObjectGroup` dont le parent est le [App DocumentObject](App_DocumentObject/fr.md) (`App::DocumentObject` class) et est complété par une extension de groupe.
