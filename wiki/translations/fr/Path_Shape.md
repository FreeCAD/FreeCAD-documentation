...
-   min\_dist(0.0): distance minimale pour les nouveaux fils générés. Les fils peuvent être cassés si l\'algorithme (?) voir les ajustements. Réglez sur zéro pour désactiver la rupture de fil.
...
-   threshold(0.0): si les points d\'extrémité de deux fils sont séparés à l\'intérieur de ce seuil, ils sont considérés

comme connecté. Vous souhaiterez peut-être définir ce paramètre sur le diamètre de l\'outil pour maintenir l\'outil vers le bas.
