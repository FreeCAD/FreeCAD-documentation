...
2.  Appuyez sur le bouton **<img src="images/Arch_Equipment.png" width=16px> [Crée un objet d'équipement...](Arch_Equipment/fr.md)** ou appuyez la touche **E** puis **Q**.
...
-    {{PropertyData/fr|Model}}: Une description du modèle de cet équipement.

-    {{PropertyData/fr|Url}}: Une URL de la page du produit, où plus d\'informations sur cet équipement peut être trouvée.

-    {{PropertyData/fr|Mesh}}: Représentation de cet équipement en objet [Mesh](Mesh_Workbench/fr.md). Lorsqu\'il est défini, le mode d\'affichage **Maillage** devient disponible.
...
[Arch API](Arch_API/fr.md) et [FreeCAD Script de Base](FreeCAD_Scripting_Basics/fr.md).
