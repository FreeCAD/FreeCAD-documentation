...
Pour convertir des objets en esquisses, utilisez la méthode `make_sketch` ({{Version/fr|0.19}}) du module Draft. Cette méthode remplace la méthode dépréciée `makeSketch`.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft Draft2Sketch/fr
