...
Actuellement, cette commande pointe vers [<https://www.freecadweb.org>](https://www.freecadweb.org/).

## Utilisation

1.  Sélectionnez l\'option {{MenuCommand|Aide → <img src=images/Std_FreeCADWebsite.svg style="width:16px"> [Site Web de FreeCAD](Std_FreeCADWebsite/fr.md)}} dans le menu.
