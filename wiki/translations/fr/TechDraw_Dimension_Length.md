...
2.  Appuyez sur le bouton **<img src="images/TechDraw_Dimension_Length.svg" width=20px> [Insérer une cote de longueur](TechDraw_Dimension_Length/fr.md)
**
...
Voir [TechDraw Cote linéaire](TechDraw_Dimension_Landmark/fr.md) pour une autre approche pour contourner le problème de dénomination topologique.
...
L\'outil Dimension Length peut être utilisé dans des [macros](Macros/fr.md) et à partir de la console [Python](Python/fr.md) à l\'aide des fonctions suivantes:
