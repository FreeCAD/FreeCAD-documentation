...
Les fichiers de ce dossier ne peuvent pas être téléchargés car l\'extension de fichier est `.xpm`.

Par le passé, les icônes `.xpm` étaient utilisées comme superpositions lors de l\'affichage des contraintes dans la [vue 3D](3D_view/fr.md). Maintenant, les SVG \"pointeurs\" sont utilisés à la place.
