...
3.  Il existe plusieurs façons d\'appeler la commande:
    ...
    -   Sélectionnez l\'option **Maillages → <img src="images/Mesh_AddFacet.svg" width=16px> Ajouter un triangle** dans le menu.
...
8.  Choisissez **Finish** dans le menu contextuel de la vue 3D pour terminer la commande.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Mesh](Mesh_Workbench.md) > Mesh AddFacet/fr
