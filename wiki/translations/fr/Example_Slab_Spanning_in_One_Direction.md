---
 TutorialInfo:r
   Topic/fr: Example Slab Spanning in One Direction
   Topic: Exemple Dalle s'étendant dans une direction
   Level: Intermédiaire
   Author: Shiv Charan
   FCVersion: 0.20
---
...
*Exemple de renfort de dalle s'étendant dans une direction dans la dalle de [Arch Structure](Arch_Structure/fr.md)*
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > Example Slab Spanning in One Direction/fr
