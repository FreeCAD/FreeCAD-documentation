...
{{VeryImportantMessage|Les icônes de cette section sont utilisées dans le wiki mais sont erronées. Elles sont répertoriées à titre de référence uniquement. Veuillez ne pas les utiliser}}

## Icônes erronées {#icônes_erronées}

### Icônes avec des noms de fichiers incorrects {#icônes_avec_des_noms_de_fichiers_incorrects}
...
### Icônes PNG hautes résolutions pour les commandes sans icône GUI {#icônes_png_hautes_résolutions_pour_les_commandes_sans_icône_gui}
...
### Icônes PNG basse résolution pour les commandes sans icône GUI {#icônes_png_basse_résolution_pour_les_commandes_sans_icône_gui}
