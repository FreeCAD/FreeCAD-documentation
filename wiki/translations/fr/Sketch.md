...
3.  Cliquez sur le bouton **<img src=images/PartDesign_NewSketch.svg style="width:16px"> [PartDesign Nouvelle esquisse](PartDesign_NewSketch/fr.md)**.
...
Une esquisse est très couramment utilisée en conjonction avec l\'<img alt="" src=images/Workbench_PartDesign.svg  style="width:16px;"> <img src=images/PartDesign_Pad.svg style="width:Atelier PartDesign](PartDesign_Workbench/fr.md) pour créer des solides par extrusion, en utilisant le bouton **[16px"> [PartDesign Protrusion](PartDesign_Pad/fr.md)**.

Néanmoins, une esquisse peut toujours être créée à toute autre fin. Elle ne doit pas être liée à un <img src=images/Arch_Window.svg style="width:PartDesign Corps](PartDesign_Body/fr.md). Par exemple, l\'outil **[16px"> <img src=images/Arch_Wall.svg style="width:Arch Fenêtre](Arch_Window/fr.md)** de l\'<img alt="" src=images/Workbench_Arch.svg  style="width:16px;"> [Atelier Arch](Arch_Workbench/fr.md) utilise des esquisses pour définir les formes des fenêtres et des portes. De la même manière, elles peuvent être utilisées pour définir la forme de **[16px"> [Arch Murs](Arch_Wall/fr.md)**.
