...
- GuiCommand:/fr
   ...
   MenuLocation:Esquisse → Outils d'esquisse B-Spline → Augmenter le degré d'une B-spline
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher BSplineIncreaseDegree/fr
