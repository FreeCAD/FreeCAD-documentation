...
6.  Appuyez éventuellement sur le bouton **Inverser** pour inverser la sélection.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Mesh](Mesh_Workbench.md) > Mesh RemoveComponents/fr
