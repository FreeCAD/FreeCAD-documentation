...
2.  Si **Draft Aimantation Centre** n\'est pas actif, faites l\'une des choses suivantes :
    ...
    -   Appuyez sur le bouton **<img src="images/Draft_Snap_Lock.svg" width=16px><img src="images/Toolbar_flyout_arrow.svg" width=8px>** dans le [Draft Widget aimantation](Draft_snap_widget.md) et dans le menu sélectionnez l\'option {{MenuCommand|<img src="images/Draft_Snap_Center.svg" width=16px> Aimantation Centre}}.
