...
2.  Si **Draft Aimantation Centre** n\'est pas actif, faites l\'une des choses suivantes :
    ...
    -   Appuyez sur le bouton **<img src="images/Draft_Snap_Lock.svg" width=16px><img src="images/Toolbar_flyout_arrow.svg" width=8px>** dans le [Draft Widget aimantation](Draft_snap_widget.md) et dans le menu sélectionnez l\'option **<img src="images/Draft_Snap_Center.svg" width=16px> Aimantation Centre**.
...
5.  Effectuez l\'une des opérations suivantes :
    ...
    -   Pour sélectionner le point {{PropertyData/fr|Placement}} d\'un [Draft Proxy pour plan de travail](Draft_WorkingPlaneProxy/fr.md) :
    ...
    -   Pour sélectionner le point {{PropertyData/fr|Placement}} d\'une [Arch Partie de bâtiment](Arch_BuildingPart/fr.md) :
        -   Déplacez le curseur sur l\'un des bords du petit symbole d\'axe de la Partie de bâtiment, ou sur le texte à côté qui affiche les {{PropertyData/fr|Label}} de la Partie de bâtiment et son niveau.
...
---
[documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft Snap Center/fr
