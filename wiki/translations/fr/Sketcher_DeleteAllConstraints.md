...
1.  Aller dans le menu {{MenuCommand|Sketch → Outils d'esquisse → <img src=images/Sketcher_DeleteAllConstraints.svg style="width:16px"> Supprimer toutes les contraintes}}.
