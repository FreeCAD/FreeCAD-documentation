...
L\'outil <img alt="" src=images/CAM_Post.svg  style="width:16px;"> [Post-traitement](CAM_Post/fr.md) exporte la <img alt="" src=images/CAM_Job.svg  style="width:16px;"> [CAM Tâche](CAM_Job/fr.md) sélectionnée vers un fichier G-code.
...
Si vous souhaitez écrire votre propre post-processeur, consultez la page [CAM Personnaliser le post-processeur](CAM_Postprocessor_Customization/fr.md).
...
1.  Sélectionnez une <img alt="" src=images/CAM_Job.svg  style="width:16px;"> [CAM Tâche](CAM_Job/fr.md) dans la [vue en arborescence](Tree_view/fr.md).
2.  Il existe plusieurs façons de lancer la commande :
    -   Appuyez sur le bouton **<img src="images/CAM_Post.svg" width=16px> [Post-traiter](CAM_Post/fr.md)**.
    -   Sélectionnez l\'option **CAM → <img src="images/CAM_Post.svg" width=16px> Post-traiter ** du menu.
...
Les propriétés du fichier de sortie et du post-processeur peuvent être définies dans la [tâche](CAM_Job/fr.md) à tout moment, avant de lancer le post-processeur.
...
→ **Préférences...** → **CAM** → **Préférences des tâches** → **Valeurs par défaut** → **Parcours** permet de définir le post-processeur par défaut sélectionné lors de la création de la tâche. Ceci permet à l\'atelier CAM d\'être configuré pour n\'afficher que les post-processeurs souhaités et de définir une valeur par défaut.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM Post/fr
