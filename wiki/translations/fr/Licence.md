...
**[Licence publique générale limitée GNU (LGPL2+)](http://fr.wikipedia.org/wiki/Licence_publique_g%C3%A9n%C3%A9rale_limit%C3%A9e_GNU)** pour tout le code source FreeCAD trouvé dans le [dépôt officiel Git](https://github.com/FreeCAD/FreeCAD)

**[Creative Commons Attribution 3.0 License (CC-BY-3.0)](http://creativecommons.org/licenses/by/3.0/)** pour la documentation sur <https://www.freecad.org>
