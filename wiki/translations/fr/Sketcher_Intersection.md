...
1.  Il y a plusieurs façons de lancer l\'outil :
    -   Appuyez sur le bouton **<img src="images/Sketcher_Intersection.svg" width=16px> [Créer une géométrie externe de l'intersection](Sketcher_Intersection/fr.md)**.
    -   Sélectionnez l\'option **Esquisse → Outils d'esquisse → <img src="images/Sketcher_Intersection.svg" width=16px> Créer une géométrie externe de l'intersection** du menu.
    -   Cliquez avec le bouton droit de la souris dans la [vue 3D](3D_view/fr.md) et sélectionnez l\'option **<img src="images/Sketcher_Intersection.svg" width=16px> Créer une géométrie externe de l'intersection** dans le menu contextuel.
...
---
⏵ [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher Intersection/fr
