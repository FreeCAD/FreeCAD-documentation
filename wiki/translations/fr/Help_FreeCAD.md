...
-   La catégorie [Command Reference](:Category:Command_Reference.md) liste toutes les [commandes](command/fr.md) FreeCAD. La plupart d\'entre elles contiennent peu ou pas d\'informations. Veuillez vous référer à [WikiPages](WikiPages.md) (en) pour des recommandations de ce que devrait être une bonne page de documentation de commandes.
