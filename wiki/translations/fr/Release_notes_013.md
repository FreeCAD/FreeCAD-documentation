...
Les versions plus anciennes : [0.12](Release_notes_012/fr.md) - [0.11](Release_notes_011/fr.md)
...
-   **Nouveau moteur de rendu solide** : En plus du moteur de rendu 2D filaire OpenCasCADe actuellement utilisé par le module de [mise en plan](Drawing_Module/fr.md), le module **Arch** dispose désormais d\'un nouveau moteur de rendu 2D qui est capable d\'afficher les faces pleines sur une feuille de dessin .SVG, ce qui donne des vues 2D beaucoup plus agréables.
