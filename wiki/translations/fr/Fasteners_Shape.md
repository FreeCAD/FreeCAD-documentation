...
La commande <img alt="" src=images/Fasteners_Shape.svg  style="width:24px;"> **Fasteners Shape** crée des copies non-paramétriques des fixations sélectionnées. Cela peut être utile si vous souhaitez partager un document contenant des fixations avec des utilisateurs qui n\'ont pas installé l\'[atelier Fasteners](Fasteners_Workbench/fr.md).
...
---
[documentation index](../README.md) > [External Command Reference](Category_External Command Reference.md) > Fasteners Shape/fr
