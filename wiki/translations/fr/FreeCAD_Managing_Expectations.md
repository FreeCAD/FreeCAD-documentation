...
-   Modélisation paramétrique basée sur des splines à l\'aide des ateliers [Part](Part_Workbench/fr.md), [PartDesign](PartDesign_Workbench/fr.md) et [Sketcher](Sketcher_Workbench/fr.md).
...
-   Conception [BIM](BIM_Workbench/fr.md)
