...
Pour l\'**<img src=images/Sketcher_CreateEllipseByCenter.svg style="width:16px"> <img src=images/Sketcher_CreateArcOfEllipse.svg style="width:Ellipse](Sketcher_CreateEllipseByCenter/fr.md)** et l\'**[16px"> <img src=images/Sketcher_CreatePoint.svg style="width:Arc d'ellipse](Sketcher_CreateArcOfEllipse/fr.md)**, l\'outil prend en charge les lignes contraignantes pour devenir des diamètres majeurs et mineurs et contraint les **[16px"> [points](Sketcher_CreatePoint/fr.md)** aux positions des foyers de l\'ellipse.
...
## Opération sur une ellipse {#opération_sur_une_ellipse}
...
2.  L\'invocation de la contrainte peut se faire de plusieurs manières:
    ...
    -   Utilisation de l\'entrée {{MenuCommand|Sketch → Contraintes d'esquisse → <img src=images/Sketcher_ConstrainInternalAlignment.svg style="width:16px"> Contrainte d'alignement interne}} dans le menu supérieur.
