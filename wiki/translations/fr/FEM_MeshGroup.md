...
- GuiCommand   */fr
   Name   *FEM MeshGroup
   Name/fr   *FEM Groupe de mailles MEF
   MenuLocation   *Mesh → Groupe de type maillage MEF
...
Groupe de type maillage MEF permet donc à FreeCAD d\'être utilisé avec des solveurs externes (ou des visionneurs tels que ParaView) lorsqu\'ils ne sont pas encore implémentés avec leur propre routine d\'écriture de cas dans FreeCAD.
