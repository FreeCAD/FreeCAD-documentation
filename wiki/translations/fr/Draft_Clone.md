...
-    {{PropertyData/fr|Fuse|Bool}}: spécifie si les formes qui se chevauchent dans le clone sont fusionnées ou non.

-    {{PropertyData/fr|Objects|LinkListGlobal}}: spécifie les objets qui sont clonés.

-    {{PropertyData/fr|Scale|Vector}}: spécifie les facteurs d\'échelle X, Y et Z.
