...
-   Cliquez sur l\'icône [Profilage de faces](CAM_Profile/fr#Opération_Profilage_de_face.md) pour démarrer l\'opération
...
-   Cliquez sur l\'icône [CAM Poche](CAM_Pocket_Shape/fr.md) pour démarrer l\'opération.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM fourth axis/fr
