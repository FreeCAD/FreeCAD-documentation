# <img alt="" src=images/Crystal_Clear_app_tutorials.png  style="width:64px;"> Developer hub/fr
...
-   [Détails de licence](License/fr.md) à propos des licences de FreeCAD
-   [Bibliothèques tierces](Third_Party_Libraries/fr.md)
-   [Outils tierces](Third_Party_Tools/fr.md)
...
Le [Packaging](Packaging/fr.md) consiste à prendre les fichiers binaires compilés et les fichiers sources Python de FreeCAD, puis à les distribuer pour les utiliser dans un système particulier.

-   [Packaging sous Linux](Linux_packaging/fr.md)
    -   [Développement de Debian](Debian_development/fr.md)
    -   [Debian Unstable](Debian_Unstable/fr.md)
    -   [Buildpackage sous Git](Git_buildpackage/fr.md)
-   [Création de paquets Windows](Windows_packaging/fr.md)
