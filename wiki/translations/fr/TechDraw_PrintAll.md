...
1.  Il existe plusieurs façons de lancer l\'outil :
    ...
    -   Sélectionnez l\'option **TechDraw → Page → <img src="images/TechDraw_PrintAll.svg" width=16px> Imprimer toutes les pages** du menu.
...
---
⏵ [documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw PrintAll/fr
