...
1.  Il existe plusieurs façons de lancer la commande :
    ...
    -   Sélectionnez l\'option **Drafting → <img src="images/Draft_ShapeString.svg" width=16px> Formes à partir de texte** dans le menu.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft ShapeString/fr
