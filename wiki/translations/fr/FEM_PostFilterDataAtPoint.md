...
1.  Sélectionnez un [pipeline de résultats](FEM_PostPipelineFromResult/fr.md) précédemment créé ou un autre filtre (sauf un filtre de ligne).
2.  Lancez la commande soit en    *
    ...
    -   Utilisant le menu **Résultats → <img src="images/FEM_PostFilterDataAtPoint.svg" width=16px> Données du filtre d'écrêtage du point**.
