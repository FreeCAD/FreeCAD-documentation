...
### Activité Courante {#activité_courante}
...
### Changements Récents {#changements_récents}

-   voir ci-dessous

## Modifications pour v0.19 {#modifications_pour_v0.19}

Voir aussi <https://forum.freecadweb.org/viewtopic.php?f=10&t=34586&hilit=release+notes#p290433>

### Options d\'affichage {#options_daffichage}
...
### Conformité aux normes {#conformité_aux_normes}
...
### GD&T, ControlFrames, Symboles {#gdt_controlframes_symboles}
...
### Dimensions \"non-Vertex\" {#dimensions_non_vertex}
...
### coexistence Draft/Arch {#coexistence_draftarch}
...
### Corrections de bogues / demandes de fonctionnalités {#corrections_de_bogues_demandes_de_fonctionnalités}
