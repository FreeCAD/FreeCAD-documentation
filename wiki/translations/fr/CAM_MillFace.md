...
L\'outil <img alt="" src=images/CAM_MillFace.svg  style="width:24px;"> [Surfaçage](CAM_MillFace/fr.md) crée une trajectoire pour effectuer une opération de surfaçage sur une surface horizontale. Cette opération est généralement utilisée :
...
<img alt="Exemple de surfaçage utilisée pour préparer la surface du brut pour une opération de dégagement ultérieure." src=images/MillFace_Sample.png  style="width:600px;">
...
2.  Il existe plusieurs façons de lancer la commande :
    -   Appuyez sur le bouton **<img src="images/CAM_MillFace.svg" width=16px> [Surfacer](CAM_MillFace/fr.md)**.
    -   Sélectionnez l\'option **CAM → <img src="images/CAM_MillFace.svg" width=16px> Surfacer** du menu.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM MillFace/fr
