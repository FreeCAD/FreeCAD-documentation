...
### Modèle multiple {#modèle_multiple}
...
### Gestion de projet {#gestion_de_projet}
...
### Droits d\'auteurs {#droits_dauteurs}
...
### Assemblages et contraintes {#assemblages_et_contraintes}
...
### Contrôle des mises à jour {#contrôle_des_mises_à_jour}
...
#### Arborescences de pièces {#arborescences_de_pièces}
...
#### Interface unifiée Glisser/Déposer/Copier/Coller {#interface_unifiée_glisserdéposercopiercoller}
...
#### Ressources externes {#ressources_externes}
...
### Modèles d\'objets {#modèles_dobjets}
...
## Boucle de vérification STEP {#boucle_de_vérification_step}
...
### Solveur d\'assemblage de contraintes {#solveur_dassemblage_de_contraintes}

Définir l\'interface d\'un solveur d\'assemblage de contraintes très similaire à l\'interface du solveur d\'esquisse.

### Interface de simulation physique {#interface_de_simulation_physique}
