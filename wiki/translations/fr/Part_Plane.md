...
-    **Length|Length**: La longueur du plan. Il s\'agit de la dimension dans sa direction X. La valeur par défaut est {{Value|10mm}}.

-    **Width|Length**: La largeur du plan. Il s\'agit de la dimension dans sa direction Y. La valeur par défaut est {{Value|10mm}}.
