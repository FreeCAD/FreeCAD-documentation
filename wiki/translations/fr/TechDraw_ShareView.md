...
L\'outil <img alt="" src=images/TechDraw_ShareView.svg  style="width:24px;"> **TechDraw Partager une vue** rend visible une vue et toutes ses dépendances (infobulles, cotes, etc.) sur une deuxième page.
...
2.  Il existe plusieurs façons de lancer l\'outil :
    -   Appuyez sur le bouton **<img src="images/TechDraw_ShareView.svg" width=16px> [Partager la vue](TechDraw_ShareView/fr.md)**.
    -   Sélectionnez l\'option **TechDraw → <img src="images/TechDraw_ShareView.svg" width=16px> Partager la vue** à partir du menu.
...
L\'outil Partager une vue peut être utilisé dans des [macros](Macros/fr.md) et à partir de la console [Python](Python/fr.md) à l\'aide des fonctions suivantes:
