...
-   Créer une liste de poutres en bois : Générer un listing sous forme de tableur des différents matériaux sélectionnés dans la [vue 3D](3D_view/fr.md).
...
Pour installer cet atelier externe à partir de GitHub, allez dans le [Gestionnaire des extensions](Std_AddonMgr/fr.md) et cliquez sur Configure, puis ajoutez <https://github.com/JeromeL63/Wood-Frame> comme dépôt personnalisé. Rafraîchissez la liste des extensions puis ajoutez Wood Frame.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [User Documentation](Category_User Documentation.md) > [Addons](Category_Addons.md) > [External Workbenches](Category_External Workbenches.md) > Wood Frame Workbench/fr
