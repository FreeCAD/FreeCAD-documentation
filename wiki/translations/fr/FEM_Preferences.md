 {{TOCright}} La fenêtre des préférences de l\'[atelier FEM](FEM_Workbench/fr.md) se trouve dans l\'[Éditeur de préférences](Preferences_Editor/fr.md), {{MenuCommand|Édition → Préférences → FEM}}.
