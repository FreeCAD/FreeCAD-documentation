...
1.  Pendant la commande, la [vue 3D](3D_view/fr.md) ne peut pas être modifiée. Il est conseillé de commencer par aligner correctement la vue 3D.
...
3.  Il existe plusieurs façons de lancer la commande :
    ...
    -   Sélectionnez l\'option **Points → <img src="images/Points_PolyCut.svg" width=16px> Couper un nuage de points** du menu.
