...
Faites un clic droit sur la propriété de Placement dans l\'éditeur de propriétés, sélectionnez \"montrer tout\" puis les propriétés supplémentaires s\'afficheront. Si vous cliquez à nouveau avec le bouton droit sur Placement, le menu contextuel comprendra Expression, sélectionnez Expression puis la fenêtre de dialogue Expression s\'ouvrira et tout ce que vous tapez ira dans la propriété Placement plutôt que dans ses propriétés enfants.
