...
1.  Il existe plusieurs façons d\'appeler la commande:
    -   Sélectionnez l\'option {{MenuCommand|Affichage → Vues standards → <img src="images/Std_ViewRotateRight.svg" width=16px> Rotation à droite}} dans le menu.
    -   Sélectionnez l\'option {{MenuCommand|Vues standards → <img src="images/Std_ViewRotateRight.svg" width=16px> Rotation à droite}} dans le menu contextuel de la [vue 3D](3D_view/fr.md).
