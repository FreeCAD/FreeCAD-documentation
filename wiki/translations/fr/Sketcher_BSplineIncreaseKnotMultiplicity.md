...
1.  Sélectionnez un nœud B-spline, soit:
    ...
    -   par le menu **Sketch → Outils d'esquisse B-Spline → [<img src=images/_Sketcher_BSplineIncreaseKnotMultiplicity.svg style="width:16px"> Augmenter la multiplicité des nœuds**.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher BSplineIncreaseKnotMultiplicity/fr
