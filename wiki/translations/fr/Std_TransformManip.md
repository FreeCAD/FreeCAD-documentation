...
1.  Clic droit sur un objet dans la [Vue par arborescence](Tree_view/fr.md) du modèle. Pour certains objets, l\'outil est aussi disponible par double clic dans l\'arborescence du modèle.
