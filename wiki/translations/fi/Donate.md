# Donate/fi
Alla on tämänhetkiset tuetut lahjoitusvaihtoehdot projektissa. Muista, että FreeCADin käyttö, opiskelu, jakelu tai kehittäminen ei koskaan edellytä maksua. Lahjoitukset kuitenkin auttavat FreeCADia ja sen kehittäjiä antamaan enemmän aikaa ja resursseja, jotta projekti voi kasvaa nopeammin ja pidemmälle.
...
On myös muita tapoja auttaa rahalahjoituksien tai koodaamisen sijaan, kuten työskennellä dokumentaation parissa, käännöstyöt tai uusien käyttäjien opastaminen alkuun pääsemiseen. Lisätietoja löydät sivulta [auta FreeCADia](Help_FreeCAD/fi.md).



## Lisää tietoa erilaisista vaihtoehdoista 
...
## Osoita tukesi suoraan kehittäjälle 
...
---
⏵ [documentation index](../README.md) > Donate/fi
