...
|Description=Ovaj makro prikazuje sve elemente ispod pokazivača (prikazat će se i svi elementi koje pokrivaju drugi elementi).
|Author=HoWil
|Version=01.00
|Date=2016-12-26
|FCVersion=All
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > Macro FC element selector/hr
