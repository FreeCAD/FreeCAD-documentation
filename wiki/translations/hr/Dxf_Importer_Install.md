...
{{TutorialInfo/hr|Topic=SampleClass|Level=Medium user|Time=15 minutes|Author=[Mario52](User_Mario52.md)|FCVersion=All}}
...
---
[documentation index](../README.md) > Dxf Importer Install/hr
