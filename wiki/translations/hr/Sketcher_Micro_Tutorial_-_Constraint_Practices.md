...
{{TutorialInfo/hr|Topic=Modeling|Level=Beginner|Author=Mark Stephen ([Quick61](User:Quick61.md))|Time=Less than 15 minutes|FCVersion=0.15.4671 Release or greater}}
...
## First approach: datum constraints {#first_approach_datum_constraints}
...
## A better way: datum and geometric constraints {#a_better_way_datum_and_geometric_constraints}
...
## Optimum scheme: mostly geometric constraints {#optimum_scheme_mostly_geometric_constraints}
