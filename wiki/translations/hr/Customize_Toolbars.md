...
{{TutorialInfo/hr|Topic=SampleTopic|Level=Beginner|Time=5 minutes|Author=[Mario52](User_Mario52.md)|FCVersion=All}}
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Preferences](Category_Preferences.md) > Customize Toolbars/hr
