...
|Description=Alternativna provedba [Part Section](Part_Section/hr.md) alat (parametarski)
|Author=DeepSOIC
|Version=1.1
|Date=2018-04-28
|FCVersion=All
...
[Part Section](Part_Section/hr.md) alat proizvodi rubove s kontinuitetom C0 i velikim brojem segmenata (čvorova), što nije baš prikladno kao[Sweep](Part_Sweep/hr.md) staza.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro Section/hr
