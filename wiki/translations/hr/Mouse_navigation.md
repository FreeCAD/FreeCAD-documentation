...
FreeCAD **navigacija mišem**\' sastoji se od naredbi koje se koriste za vizualno kretanje 3D prostorom i interakciju s prikazanim objektima. FreeCAD podržava više stilova navigacije mišem. Zadani navigacijski stil naziva se [CAD ​​navigacija](#CAD_navigation.md) i vrlo je jednostavan i praktičan, ali FreeCAD također nudi nekoliko alternativnih navigacijskih stilova za odabir. Odabrani stil koristi se za sve radne površine.
