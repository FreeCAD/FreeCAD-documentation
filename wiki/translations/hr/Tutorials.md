...
Vi možete pogledati na [Vanjske Upute ](offsite_tutorials/hr.md) i [Video Upute](video_tutorials/hr.md) koji su linkovi na vanjske web stranice. Koristan izvor video vježbi je na [YouTube](https://YouTube.com),upišite *FreeCAD* u tražilicu.
...
Robot Tutorial RobotSimulation.gif\|link=[Robot tutorial](Robot_tutorial.md)\|[Robot tutorial/hr](Robot_tutorial/hr.md)
...
{{docnav/hr|[Lista svih naredbi](List_of_Commands/hr.md)|
[Podesi izgled prozora](Interface_Customization/hr.md)}}
