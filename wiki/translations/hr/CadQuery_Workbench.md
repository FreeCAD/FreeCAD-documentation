# <img alt="CadQuery workbench icon" src=images/Cadquery_module_workbench_icon.svg  style="width:64px;"> CadQuery Workbench/hr
...
---
[documentation index](../README.md) > [Sandbox](Category_Sandbox.md) > CadQuery Workbench/hr
