...
|Translate=Makro Rozbal Krabici
|Description=Toto makro rozloží povrchy krabice jakéhokoliv tvaru a nakreslí je na stránku.<BR/>{{ColoredText|#ff0000|#ffff00|This macro must be upgraded cause error indentation and space mixed with tabulation}}
|Author=Hervé B.
|Version=1.0
|Date=2013-09-20
|FCVersion=
...
Přidejte šablony : A3\_Landscape\_Empty.svg A3\_Landscape.svg A4\_Landscape\_Empty.svg A4\_Landscape.svg
