# <img alt="Std Base icon" src=images/Freecad.svg  style="width:64px;"> Std Edit Menu/cs
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Std Edit Menu/cs
