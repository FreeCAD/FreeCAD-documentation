...
|Description=Toto makro je kompletní aplikace, umožňuje jednoduše vyplňovat všechna pole kazety. (Pro [Drawing Workbench](Drawing_Workbench/cs.md)).
|Author=Mario52
|Version=5.0
|Date=2014-08-08
...
Použití je velmi snadné, spusťte makro a upravte pole.

-   Tlačítkem **Quit** ukončete aplikaci.
-   Tlačítko **Memo** vykreslí obsah kazety při otevření makra.
-   Tlačítkem **Clear** vyčistíte všechna pole makra (pole jsou vykreslena stisknutím tlačítka **Memo**).
-   Tlačítko **Apply** použije změny ve šabloně.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro CartoucheFC 2/cs
