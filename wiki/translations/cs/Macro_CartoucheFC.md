...
{{Macro/cs
|Name=Macro_CartoucheFC
|Translate=Macro CartoucheFC
|Icon=Macro_CartoucheFC.png
|Description=This macro is a complete application, it allows to fill the cartridge of the drawing sheet delivered with FreeCAD(Only For [Drawing Workbench](Drawing_Workbench/cs.md))..
|Author=Mario52
|Version= 0.3
|Date=2014-07-02
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro CartoucheFC/cs
