# <img alt="Draft workbench icon" src=images/Workbench_Draft.svg  style="width:64px;"> Draft Workbench/cs
...
-   ![](images/Draft_tray_button_plane.png ) [Select plane](Draft_SelectPlane.md): defines the current Draft working plane. Also available in the menu: **Draft → Utilities → <img src="images/Draft_SelectPlane.svg" width=16px> Select Plane**.
...
-   [Uchopování](Draft_Snap/cs.md): Umožňuje umístit nové body na zvláštní místa na existujících objektech
-   [Omezování](Draft_Constrain/cs.md): Umožňuje umístit nové body horizontálně nebo vertikálně v relaci k předchozím bodům
-   [Working plane](Draft_SelectPlane/cs.md): Allows you to define a plane in the 3D space, where next operations will take place
...
-   [Autodesk .DXF](Draft_DXF/cs.md): Importy a exporty [Drawing Exchange Format](http://en.wikipedia.org/wiki/AutoCAD_DXF) souborů vytvořených 2D CAD aplikacemi
-   [SVG (as geometry)](Draft_SVG/cs.md): Importy a exporty [Scalable Vector Graphics](http://en.wikipedia.org/wiki/Scalable_Vector_Graphics) souborů vytvořených vektorovými kreslicími aplikacemi
-   [Open Cad format .OCA](Draft_OCA/cs.md): Importy a exporty OCA/GCAD soubory, potenciálně novým [open CAD file format](http://groups.google.com/group/open_cad_format)
-   [Airfoil Data Format .DAT](Draft_DAT/cs.md): Importy DAT souborů popisujících [Airfoil profiles](http://www.ae.illinois.edu/m-selig/ads/coord_database.html)
-   [Autodesk .DWG](Draft_DXF/cs.md): Importy and exporty DWG soubory pomocí DXF importeru, když je nainstalována utilita [Teigha Converter](Extra_python_modules.md).
...
Kreslicí modul má vlastnosti kompletního [Kreslicího API](Draft_API/cs.md), takže můžete využívat jeho funkce ve skriptech a makrech
...
-   [Draft tutorial](Draft_tutorial/cs.md)
...
{{docnav/cs|Image Workbench/cs|Arch Workbench/cs}}
...
---
⏵ [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [Draft](Category_Draft.md) > Draft Workbench/cs
