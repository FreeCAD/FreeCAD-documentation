...
<img alt="Assembly workbench icon" src=images/Workbench_Assembly.svg  style="width:128px;">
...
---
⏵ [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [Assembly](Category_Assembly.md) > Assembly Workbench/cs
