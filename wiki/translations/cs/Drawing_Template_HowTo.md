...
### Nastavení stránky {#nastavení_stránky}
...
### Popisové pole (Title Block) {#popisové_pole_title_block}
...
### Editovatelný text {#editovatelný_text}
...
### Přidání Artworku {#přidání_artworku}
...
## Když je šablona vytvořena {#když_je_šablona_vytvořena}

### Otevření souboru textovým editorem {#otevření_souboru_textovým_editorem}
...
### Značka "xmlns:freecad" {#značka_xmlnsfreecad}
...
### Značky Pracovního prostoru (Working space) a Popisového pole (Title Block) {#značky_pracovního_prostoru_working_space_a_popisového_pole_title_block}
...
#### Značka Working space {#značka_working_space}
...
#### Značka Title block {#značka_title_block}
...
### Značka freecad:editable {#značka_freecadeditable}
...
### Značka DrawingContent {#značka_drawingcontent}
...
## Dokončení příkladu šablony {#dokončení_příkladu_šablony}
