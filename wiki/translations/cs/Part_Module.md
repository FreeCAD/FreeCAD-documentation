...
CAD možnosti FreeCADu jsou založeny na jádře _, jsou mnohem komplexnější a proto umožňují mnohem dokonalejší operace, jako jsou logické boolean operace, modifikace historie a parametrické chování.
