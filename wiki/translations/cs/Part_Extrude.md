...
-   Vysunutí [Textového řetězece](Draft_ShapeString.md) vytvoří složeninu těles (textový řetězec je složenina písmen, z nichž každé je těleso)
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Part](Part_Workbench.md) > Part Extrude/cs
