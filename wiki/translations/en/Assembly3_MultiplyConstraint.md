...
1.  Activate the <img alt="" src=images/Assembly_ConstraintMultiply.svg  style="width:16px;"> **Multiply constraint** command using one of the following:
    -   The **<img src="images/Assembly_ConstraintMultiply.svg_" width=16px> [Multiply constraint](Assembly3_MultiplyConstraint.md)** button.
    -   The **Assembly3 → <img src="images/Assembly_ConstraintMultiply.svg_" width=16px> Multiply constraint** menu option.
