...
- GuiCommand:
   ...
   Shortcut: 
   Version: 0.20
   SeeAlso: TechDraw_ExtensionExtendLine
---
...
3.  There are several ways to invoke the tool:
    -   Press the **<img src="images/TechDraw_ExtensionShortenLine.svg" width=16px> [Shorten Line](TechDraw_ExtensionShortenLine.md)** button.
...
---
⏵ [documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw ExtensionShortenLine/en
