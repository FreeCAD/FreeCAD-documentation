...
# Reinforcement SlabRebars/en

## Description

The [Reinforcement SlabRebars](Reinforcement_SlabRebars.md) tool allows the user to create reinforcing bars inside a Slab [Arch Structure](Arch_Structure.md) object.
...
The Reinforcement SlabRebars tool can be used from the [Python](Python.md) console by using the following function:
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > [BIM](Category_BIM.md) > Reinforcement SlabRebars/en
