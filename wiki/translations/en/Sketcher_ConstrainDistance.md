...
- GuiCommand:
   ...
   Shortcut: **K** **D**
   SeeAlso: Sketcher_ConstrainDistanceX, Sketcher_ConstrainDistanceY
---

# Sketcher ConstrainDistance/en
...
---
⏵ [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher ConstrainDistance/en
