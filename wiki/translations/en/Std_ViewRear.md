...
1.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|View → Standard views → <img src="images/Std_ViewRear.svg" width=16px> Rear}} option from the menu.
    -   Select the {{MenuCommand|Standard views → <img src="images/Std_ViewRear.svg" width=16px> Rear}} option from the [3D view](3D_view.md) context menu.
