...
3.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Meshes → <img src="images/Mesh_AddFacet.svg" width=16px> Add triangle}} option from the menu.
...
8.  Choose {{MenuCommand|Finish}} from the 3D view contex menu to finish the command.
