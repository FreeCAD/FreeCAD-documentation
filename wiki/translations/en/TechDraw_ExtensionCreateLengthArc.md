...
2.  There are several ways to invoke the tool:
    -   Press the **<img src="images/TechDraw_ExtensionCreateLengthArc.svg" width=16px> [Create Arc Length Dimension](TechDraw_ExtensionCreateLengthArc.md)** button.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw ExtensionCreateLengthArc/en
