...
The <img alt="" src=images/Sketcher_Offset.svg  style="width:24px;"> [Sketcher Offset](Sketcher_Offset.md) tool draws equidistant edges around selected edges. When starting the tool, the mouse pointer changes to a white cross with a red offset icon:  <img alt="" src=images/Sketcher_Pointer_Create_Offset.svg  style="width:32px;"> .
