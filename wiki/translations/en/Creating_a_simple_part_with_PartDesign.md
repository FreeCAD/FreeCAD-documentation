---
 TutorialInfo:
   ...
   Files: 
   SeeAlso: Creating_a_simple_part_with_Part_WB, Creating_a_simple_part_with_Draft_and_Part_WB
---
...
---
⏵ [documentation index](../README.md) > [PartDesign](Category_PartDesign.md) > [Sketcher](Category_Sketcher.md) > Creating a simple part with PartDesign/en
