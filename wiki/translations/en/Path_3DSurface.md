...
1.  Press the **<img src="images/Path_3DSurface.svg" width=24px> [3D Surface](Path_3DSurface.md)** icon, or select {{MenuCommand|Path → 3D Surface}} from the dropdown menu.
