...
- GuiCommand:
   ...
   Version: 0.17
   SeeAlso: PartDesign_CompPrimitiveSubtractive, PartDesign_AdditiveWedge
---

# PartDesign SubtractiveWedge/en
...
---
⏵ [documentation index](../README.md) > [PartDesign](PartDesign_Workbench.md) > PartDesign SubtractiveWedge/en
