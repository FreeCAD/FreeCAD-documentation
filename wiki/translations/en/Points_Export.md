...
2.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Points → <img src="images/Points_Export.svg" width=16px> Export Points...}} option from the menu.
3.  Enter a filename. If you do not specify a file extension the {{FileName|.asc}} extension will be used.
