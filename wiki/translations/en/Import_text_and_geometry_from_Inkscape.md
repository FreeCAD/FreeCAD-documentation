---
- TutorialInfo:   Topic:Import text and geometry from Inkscape
   Level:Beginner
   Time:30 minutes
   Author:r-frank
   FCVersion:0.16.6704
...
# Import text and geometry from Inkscape/en
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Import](Import_Workbench.md) > Import text and geometry from Inkscape/en
