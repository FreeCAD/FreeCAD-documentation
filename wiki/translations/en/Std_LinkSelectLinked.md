...
1.  Select a link.
2.  Select the {{MenuCommand|Link actions → <img src="images/Std_LinkSelectLinked.svg" width=16px> Go to linked object}} option from the [Tree view](Tree_view.md) context menu.
