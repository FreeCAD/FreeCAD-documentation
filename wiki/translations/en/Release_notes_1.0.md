# Release notes 1.0/en
**FreeCAD 1.0** was released on **18 November 2024**, get it from the [Download](Download.md) page. This page lists all new features and changes.
...
---
⏵ [documentation index](../README.md) > [News](Category_News.md) > [Documentation](Category_Documentation.md) > [Releases](Category_Releases.md) > Release notes 1.0/en
