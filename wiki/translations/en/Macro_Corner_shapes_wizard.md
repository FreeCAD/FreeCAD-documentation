# Macro Corner shapes wizard/update/en
{{Macro
...
This macro is a complete application, it pops up a dialog asking for the dimensions of your corner piece, then creates the object in the document and creates a page view with top, front and lateral views of the piece. Original source: [Macro Corner shapes wizard](Macro_Corner_shapes_wizard.md)
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro Corner shapes wizard/update/en
