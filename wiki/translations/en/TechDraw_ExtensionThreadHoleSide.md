...
- GuiCommand:
   ...
   Shortcut: 
   Version: 0.20
   SeeAlso: TechDraw_ExtensionThreadBoltSide
---

# TechDraw ExtensionThreadHoleSide/en
...
3.  There are several ways to invoke the tool:
    -   Press the **<img src="images/TechDraw_ExtensionThreadHoleSide.svg" width=16px> [Add Cosmetic Thread Hole Side View](TechDraw_ExtensionThreadHoleSide.md)** button.
...
---
⏵ [documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw ExtensionThreadHoleSide/en
