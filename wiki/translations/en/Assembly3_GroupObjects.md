...
The <img alt="" src=images/Assembly_New_Group.svg‎‎  style="width:24px;"> [Group objects](Assembly3_GroupObjects.md) command adds a new (sub-) **Group** folder object to the Assembly branch of the model tree.
...
2.  There are several ways to invoke the command:
    -   Press the **<img src="images/Assembly_New_Group.svg‎‎" width=16px> [Group objects](Assembly3_GroupObjects.md)** button.
    -   Select the **Assembly3 → <img src="images/Assembly_New_Group.svg‎‎" width=16px> Group objects** option from the menu.
