---
 GuiCommand:
   ...
   Shortcut: 
   Version: 0.20
   SeeAlso: TechDraw_ExtensionCircleCenterLines
---

# TechDraw ExtensionHoleCircle/en
...
3.  There are several ways to invoke the tool:
    -   Press the **<img src="images/TechDraw_ExtensionHoleCircle.svg" width=16px> [Add Bolt Circle Centerlines](TechDraw_ExtensionHoleCircle.md)** button.
...
---
⏵ [documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw ExtensionHoleCircle/en
