...
2.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Meshes → Analyze → <img src="images/Mesh_EvaluateSolid.svg" width=16px> Check solid mesh}} option from the menu.
3.  The {{MenuCommand|Solid Mesh}} dialog box opens informing that the selected mesh object is solid or not.
