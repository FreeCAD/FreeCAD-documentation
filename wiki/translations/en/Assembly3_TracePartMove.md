...
1.  Activate the <img alt="" src=images/Assembly_Trace.svg  style="width:16px;"> **Trace part move** command using one of the following:
    -   The **<img src="images/Assembly_Trace.svg_" width=16px> [Trace part move](Assembly3_TracePartMove.md)** button.
    -   The **Assembly3 → <img src="images/Assembly_Trace.svg_" width=16px> Trace part move** menu option.
