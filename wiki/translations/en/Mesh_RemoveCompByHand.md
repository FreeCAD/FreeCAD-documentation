...
3.  Select the {{MenuCommand|Meshes → <img src="images/Mesh_RemoveCompByHand.svg" width=16px> Remove components by hand...}} option from the menu.
4.  The cursor changes to a hand icon.
5.  Select the components you wish to delete in the [3D view](3D_view.md).
6.  Optionally select {{MenuCommand|Clear selected faces}} from the 3D view context menu to deselect all components.
7.  Select {{MenuCommand|Delete selected faces}} from the 3D view context menu to delete the selected components.
8.  Select {{MenuCommand|Leave removal mode}} from the 3D view context menu to finish the command.
