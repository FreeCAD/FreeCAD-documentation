---
 GuiCommand:
   ...
   MenuLocation: Modification , Draft to sketch<br>Modify , Draft to sketch
...
2.  There are several ways to invoke the command:
    -   Press the **<img src="images/Draft_Draft2Sketch.svg" width=16px> [Draft to sketch](Draft_Draft2Sketch.md)** button.
    -   [Draft](Draft_Workbench.md): Select the **Modification → <img src="images/Draft_Draft2Sketch.svg" width=16px> Draft to sketch** option from the menu.
    -   [BIM](BIM_Workbench.md): Select the **Modify → <img src="images/Draft_Draft2Sketch.svg" width=16px> Draft to sketch** option from the menu.
