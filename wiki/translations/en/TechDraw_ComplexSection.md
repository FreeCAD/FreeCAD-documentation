---
 GuiCommand:
   ...
   Version: 0.21
   SeeAlso: TechDraw_SectionView, TechDraw_View
---
...
A Complex Section, formally a {{Incode|TechDraw::DrawComplexSection}} object, is derived from a [Section View](TechDraw_SectionView#Properties.md), formally a {{Incode|TechDraw::DrawViewSection}} object, and inherits all its properties. It also has the following additional properties:
...
A Complex Section can be created with [macros](Macros.md) and from the [Python](Python.md) console by using the following functions:
...
---
⏵ [documentation index](../README.md) > [TechDraw](TechDraw_Workbench.md) > TechDraw ComplexSection/en
