...
{{APIFunction|isEqual|Vector|Checks if the distance between the points represented by this Vector and Vector2 is less than or equal to the given tolerance.|float}}
...
---
⏵ [documentation index](../README.md) > [API](Category_API.md) > [Poweruser Documentation](Category_Poweruser Documentation.md) > Vector API/en
