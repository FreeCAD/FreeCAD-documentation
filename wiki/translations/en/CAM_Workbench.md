# <img alt="CAM workbench icon" src=images/Workbench_CAM.svg  style="width:64px;"> CAM Workbench/en
...
---
⏵ [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [CAM](Category_CAM.md) > CAM Workbench/en
