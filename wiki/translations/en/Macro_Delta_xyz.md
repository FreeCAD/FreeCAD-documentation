...
|Shortcut=**SHIFT**, **Q**
|SeeAlso=<img src=images/Part_Measure_Linear.svg style="width:Part Measure Linear](Part_Measure_Linear.md) [24px">
}}
...
For modify the value : go to : FreeCAD → Menu → Tools → Edit parameters\... → BaseApp/Preferences/Macros/FCMmacros/Delta\_XYZ.
...
---
[documentation index](../README.md) > Macro Delta xyz/en
