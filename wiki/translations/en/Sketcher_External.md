...
- GuiCommand:
   ...
   MenuLocation:Sketch → Sketcher geometries → External geometry
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher External/en
