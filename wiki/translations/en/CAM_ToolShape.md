...
8.  Open the <img alt="" src=images/Workbench_CAM.svg  style="width:16px;"> [CAM Workbench](CAM_Workbench.md).
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM ToolShape/en
