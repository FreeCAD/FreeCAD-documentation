...
|Description={{ColoredText|#ff0000|!!! This macro needs to be corrected. !!!}}<br/>This macro allow to find and joint all non connected edge to the closest non connected one using a line. It take a shape matrix in entry ([shape1, shape2, ...])
|Author=Tremblou
|Version=1.0
|Date=2011-08-24
|FCVersion=All
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro JointWire/en
