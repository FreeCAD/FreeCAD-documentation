...
1.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Macro → <img src="images/Std_DlgMacroRecord.svg" width=16px> Macro recording...}} option from the menu.
...
8.  To end the recording session do one of the following:
    ...
    -   Select the {{MenuCommand|Macro → <img src="images/Std_MacroStopRecord.svg" width=16px> Stop macro recording}} option from the menu.
