...
# Reinforcement BentShapeRebar/en

## Description

The [Reinforcement BentShapeRebar](Reinforcement_BentShapeRebar.md) tool allows the user to create a set of bent reinforcing bars inside an [Arch Structure](Arch_Structure.md) object.
...
2.  Then select **<img src="images/Reinforcement_BentShapeRebar.svg" width=16px> [Bent-Shape Rebar](Reinforcement_BentShapeRebar.md)** from the rebar tools.
...
The Reinforcement BentShapeRebar tool can be used in [macros](Macros.md) and from the [Python](Python.md) console by using the following function: 
```python
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > [BIM](Category_BIM.md) > Reinforcement BentShapeRebar/en
