# <img alt="Std Base icon" src=images/Freecad.svg  style="width:64px;"> Std File Menu/en
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Std File Menu/en
