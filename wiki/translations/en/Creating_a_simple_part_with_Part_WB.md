---
 TutorialInfo:
   ...
   Files: 
   SeeAlso: Creating_a_simple_part_with_PartDesign, Creating_a_simple_part_with_Draft_and_Part_WB
---
...
---
⏵ [documentation index](../README.md) > [Part](Category_Part.md) > Creating a simple part with Part WB/en
