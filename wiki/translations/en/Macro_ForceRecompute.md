...
**Note:** As of <small>(v0.17)</small>  the effect of this macro can be achieved through the GUI. Right-click project in _ button to trigger a recompute.
...
---
[documentation index](../README.md) > Macro ForceRecompute/en
