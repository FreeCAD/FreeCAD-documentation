---
 GuiCommand:
   ...
   Version: 0.17
   SeeAlso: PartDesign_CompPrimitiveAdditive, PartDesign_SubtractiveEllipsoid
---

# PartDesign AdditiveEllipsoid/en
...
---
⏵ [documentation index](../README.md) > [PartDesign](PartDesign_Workbench.md) > PartDesign AdditiveEllipsoid/en
