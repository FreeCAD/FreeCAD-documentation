...
1.  Select the solver object in the [Tree view](Tree_view.md), e.g. <img alt="" src=images/FEM_SolverCalculixCxxtools.svg  style="width:16px;"> [Solver CalculiX Standard](FEM_SolverCalculixCxxtools.md).
2.  There are several ways to invoke the command:
    -   Press the **<img src="images/FEM_SolverRun.svg" width=16px> [Run solver calculations](FEM_SolverRun.md)** button.
...
---
⏵ [documentation index](../README.md) > [FEM](Category_FEM.md) > FEM SolverRun/en
