...
1.  Activate the <img alt="" src=images/Assembly_TogglePartVisibility.svg  style="width:16px;"> **Toggle part visibility** command using one of the following:
    -   The **<img src="images/Assembly_TogglePartVisibility.svg_" width=16px> [Toggle part visibility](Assembly3_TogglePartVisibility.md)** button.
    -   The **Assembly3 → <img src="images/Assembly_TogglePartVisibility.svg_" width=16px> Toggle part visibility** menu option.
