...
<div class="mw-translate-fuzzy">
  ...
  <img alt="" src=images/Part_Loft.png  style="width:32px;"> [Part\_Loft](Part_Loft.md)                              Lofts from one profile to another                                         <img alt="" src=images/Part_Offset.png  style="width:32px;"> [Offset](Part_Offset.md)                                            Creează o copie scalată a obiectului original
