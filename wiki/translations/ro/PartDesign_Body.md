...
### Funcție de bază {#funcție_de_bază}
...
### Funcția Rezultantă/Vărf {#funcția_rezultantăvărf}
...
### Interacțiunea cu alte Ateliere {#interacțiunea_cu_alte_ateliere}
...
### Managementul Vizibilității {#managementul_vizibilității}
