...
Acesta este planul proiectului pentru cadrul de resursă ca parte a foii de parcurs [Development roadmap](Development_roadmap.md).
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Roadmap](Category_Roadmap.md) > Resource framework project/ro
