...
1.  Apăsați butonul **<img src="images/Path_3DSurface.png" width=16px> [3D Surface](Path_3DSurface.md)** button.
...
3.  Locate the Data tab and Properties View for the new [3D Surface](Path_3DSurface.md) operation. A **Rotation** section should be available with additional properties to adjust, listed below.
