...
---
- GuiCommand:   Name:Ship Hydrostatics   MenuLocation:Ship design → Hydrostatics   |Workbenches:[[Ship Workbench   Ship]]|Shortcut:   SeeAlso:---
...
When the Hydrostatics tool is executed, a task dialog is shown. Usually Hydrostatics curves are presented for each trim angle.
...
---
[documentation index](../README.md) > Ship Hydrostatics/ro
