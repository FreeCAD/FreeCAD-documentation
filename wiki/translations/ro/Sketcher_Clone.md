...
2.  Click pe <img alt="" src=images/Sketcher_Clone.png  style="width:32px;"> or choose ** Sketch** → ** Sketcher tools** → **<img src="images/Sketcher_Clone.png" width=32px> Clone** din meniul principal.
