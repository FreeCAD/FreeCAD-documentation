...
{{TutorialInfo/ro|Topic=2D Drafting|Level=Intermediate|Author=Mark Stephen ([Quick61](User:Quick61.md))|Time=An hour or less|FCVersion=0.14.3700 or greater}}
...
## Model complet ca exemplu {#model_complet_ca_exemplu}
...
Cele două instrumente folosite în acest tutorial au fost Inkscape și Kate. Acestea pot fi găsite urmând link-urile de mai jos.
