...
2.  Click pe <img alt="" src=images/OpenSCAD_Minkowski.png  style="width:32px;"> sau selectați ** OpenSCAD** → **<img src="images/OpenSCAD_Minkowski.png" width=32px> Minkowski** din meniul principal.
