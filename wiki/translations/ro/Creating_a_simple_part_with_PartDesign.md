...
Acest tutorial își propune să-i învețe pe începători de la FreeCAD câteva caracteristici de bază, printr-un exemplu. După ce acoperiți elementele de bază din [User hub](User_hub.md), veți putea modela o primă etapă pas cu pas.

**We will cover in this tutorial in particular:**

-   Using [Part Design workbench v0.17](PartDesign_Workbench.md), tracing the sketch.
...
[Basic Part Design Tutorial 017](Basic_Part_Design_Tutorial_017.md)
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [PartDesign](Category_PartDesign.md) > [Sketcher](Category_Sketcher.md) > Creating a simple part with PartDesign/ro
