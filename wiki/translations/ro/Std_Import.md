# Std Import/ro
---
 GuiCommand:   Name: Std Import   Name/ro: Importul   Workbenches: All   MenuLocation: File , Importul   Shortcut: CTRL+I   SeeAlso: Std_Open/ro...---
...
Când este încărcat, fișierul este adăugat la proiectul curent(de asemenea deschis). Dacă doriți să încărcați un nou fișier într-o nouă fereastră, atunci utilizați comanda [Open](Std_Open.md).
