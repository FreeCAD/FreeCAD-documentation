---
 TutorialInfo:o   Topic: Programming   Level: Medium programmer   Time: 15 minutes   FCVersion: All   Author: User:Mario52
---
 ...
 **\<type \'exceptions.IndentationError\'\>: (\'expected an indented block\', (\'C:/Users/d/AppData/Roaming/FreeCAD/Macro_Apothem_Based_Prism_GUI.FCMacro\', 21, 3, \'def priSm(self):\\n\'))** 
...
---
⏵ [documentation index](../README.md) > [Developer Documentation](Category_Developer%20Documentation.md) > [Python Code](Category_Python%20Code.md) > How to install macros/ro
