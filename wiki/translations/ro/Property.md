...
O **proprietate** este o informație ca un șir de caractere sau un text care este atașat unui document FreeCAD sau unui obiect dintr-un document. Proprietățile pot fi vizualizate și modificate prin [Property editor](Property_editor.md).
...
Obiecte personalizate [scripted objects](scripted_objects.md) în FreeCAD pot avea următoarele tipuri de proprietăți:
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Developer Documentation](Category_Developer Documentation.md) > [Python Code](Category_Python Code.md) > Property/ro
