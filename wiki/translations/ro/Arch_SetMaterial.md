...
Instrumentul Material permite să se adauge [materials](Material.md) la documentul activ, și să atribuie un material la obiectul [Arch](Arch_Workbench/ro.md). Materialele pot avea toate propreitățile unui anumit material, și să controleze culoarea obiectului la care este atașat. Materialele susnt depozitate într-un folder **Materials** în documentul activ.
...
2.  Apăsați butonul **<img src="images/Arch_SetMaterial.png" width=16px> [Set Material](Arch_SetMaterial.md)
**
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Arch](Arch_Workbench.md) > Arch SetMaterial/ro
