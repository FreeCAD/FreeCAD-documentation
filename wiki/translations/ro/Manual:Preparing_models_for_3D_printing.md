...
-   Acum, tot ce a rămas de făcut este să unească aceste două operațiuni într-una singură. Acest lucru se poate face cu ajutorul unei funcții [Path Compound](Path_Compound.md) sau a [Path Project](Path_Project.md). Deoarece va trebui să mergem deja la lucru, vom folosi proiectul. Apăsați pe butonul <img alt="" src=images/Path_Project.png  style="width:16px;"> [Project](Path_Project.md) .
