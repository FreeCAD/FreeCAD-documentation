...
2.  Apăsați tasta **<img src="images/Path-3DPocket.png" width=16px> [3D Pocket](Path_Pocket_3D.md)** .
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM Pocket 3D/ro
