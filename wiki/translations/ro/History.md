...
Istoricul FreeCAD a început în ianuarie 2001, când [Jürgen Riegel](User:Jriegel.md) a început să lucreze la proiectul Cas.CADE, un cadru de dezvoltare software comercial care include un [geometric modeling kernel](Glossary#Geometric_modeling_kernel.md) (or CAD kernel), care în 2000 a fost lansat sub licență open source și redenumit ca [Open Cascade](Glossary#Open_CASCADE.md). Acest lucru a făcut posibilă realizarea unui program open-source 3D CAD, având în vedere faptul că programarea unui nucleu CAD de la zero, ar fi necesitat o cantitate imensă de muncă.
...
Version 0.10 released on July 2010 introduced the [Sketcher Workbench](Sketcher_Workbench.md), based on Sketchsolve, a constraint-based solver to create 2D geometry. The first version was limited to creation of rectangles and lines.
...
-   Overview
  ...
  0.15      2015-04-08     [Note despre Ediția 0.15](Release_notes_0.15.md)
  0.14      2014-07-01     [Note despre Ediția 0.14](Release_notes_0.14.md)
  0.13      2013-01-29     [Note despre Ediția 0.13](Release_notes_0.13.md)
  0.12      2011-12-20     [Note despre Ediția 0.12](Release_notes_0.12.md)
  0.11      2011-05-03     [Note despre Ediția 0.11](Release_notes_0.11.md)
  0.10      2010-07-24     
  0.9       2010-01-16     
  0.8       2009-07-10     
  0.7       2009-04-24     
...
---
[documentation index](../README.md) > [News](Category:News.md) > History/ro
