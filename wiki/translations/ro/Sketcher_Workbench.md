...
-   <img alt="" src=images/Constraint_InternalAlignment.png  style="width:32px;"> [Internal Alignment](Sketcher_ConstrainInternalAlignment.md): Aliniază elementele selectate la forma selectată (de exemplu, o linie pentru a deveni axa majoră a unei elipse).
