...
-   Un set de axuri [Axe arc](Arch_Axis.md), prin definirea numărului și distanței lor. Axele sunt folosite ca linii directoare pentru alinierea obiectelor 2D și 3D. Aceste axe pot fi modificate sau se pot introduce noi axe mai târziu.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > BIM Project/ro
