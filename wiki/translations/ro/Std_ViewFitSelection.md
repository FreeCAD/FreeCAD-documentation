...
2.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|View → Standard views → <img src="images/Std_ViewFitSelection.svg" width=16px>Fit selection}} option from the menu.
    -   Select the {{MenuCommand|<img src="images/Std_ViewFitSelection.svg" width=16px> Fit selection}} option from the [3D view](3D_view.md) context menu.
