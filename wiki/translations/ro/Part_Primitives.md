...
- GuiCommand:/ro
   ...
   Name/ro:Part CreatePrimitives/ro
   MenuLocation:Part -> CreatePrimitives...
|
   Workbenches:[Part](Part_Workbench/ro.md)
   SeeAlso:[Part Shapebuilder](Part_Shapebuilder/ro.md)---
...
-   Currently this tools can create a parametric
    -   [Plane](Part_Plane.md)
    -   [Box](Part_Box.md)
    -   [Cylinder](Part_Cylinder.md)
    -   [Cone](Part_Cone.md)
    -   [Sphere](Part_Sphere.md)
    -   [Ellipsoid](Part_Ellipsoid.md)
    -   [Torus](Part_Torus.md)
    -   [Prism](Part_Prism.md) <small>(v0.14)</small> \*:
    -   [Wedge](Part_Wedge.md)
    -   [Helix](Part_Helix.md)
    -   [Spiral](Part_Spiral.md) <small>(v0.14)</small> \*:
    -   [Circle](Part_Circle.md)
    -   [Ellipse](Part_Ellipse.md)
    -   [Line](Part_Line.md) (Edge)
    -   [Point](Part_Point.md) (Vertex)
    -   [Regular Polygon](Part_RegularPolygon.md) <small>(v0.14)</small> \*:
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Part](Part_Workbench.md) > Part Primitives/ro
