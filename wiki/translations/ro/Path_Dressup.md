...
-   O [Job](Path_Job/ro.md) este creată în Path Workbench. Aceasta conține toate informațiile necesare pentru a genera codul G necesar pentru a procesa lucrarea pe o moară CNC: există material stoc, moara are un anumit [set de instrumente](Path_EditToolsTable/ro.md) și urmează anumite comenzi care controlează viteza și mișcările (de obicei, Codul G).
