...
## Prezentarea FreeCAD {#prezentarea_freecad}
...
## Instalarea FreeCAD {#instalarea_freecad}
...
## Conținut opțional Adițional {#conținut_opțional_adițional}
...
## Sfaturi pentru startup rapid {#sfaturi_pentru_startup_rapid}
...
### O listă foarte aproximativă de lucruri pe care trebuie să le știi {#o_listă_foarte_aproximativă_de_lucruri_pe_care_trebuie_să_le_știi}
...
## Exercițiu: modelarea unui panou de acoperiș {#exercițiu_modelarea_unui_panou_de_acoperiș}
...
### 13. Comutarea ferestrei în alt tip de componentă Arch {#comutarea_ferestrei_în_alt_tip_de_componentă_arch}
...
### 14. Duplicarea panourilor {#duplicarea_panourilor}
...
### 15. Rotirea și poziționarea panourilor. {#rotirea_și_poziționarea_panourilor.}
