...
-   _ where new Draft objects are created.
...
-   _.
-   _ utility is installed. See also [FreeCAD and DWG Import](FreeCAD_and_DWG_Import.md).
...
-   [Draft tutorial Outdated](Draft_tutorial_Outdated/pt.md)
...
---
[documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Draft Workbench/pt
