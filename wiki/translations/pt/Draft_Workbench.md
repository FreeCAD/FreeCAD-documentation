# <img alt="Draft workbench icon" src=images/Workbench_Draft.svg  style="width:64px;"> Draft Workbench/pt
...
The <img alt="" src=images/Workbench_Draft.svg  style="width:32px;"> **Draft Workbench** is primarily focused on the creation and modification of 2D objects in FreeCAD. But it is not restricted to the XY plane of the global coordinate system. Its objects can have any orientation and position in 3D space, and some Draft objects can either be planar or non-planar.
...
-   [Draft tutorial](Draft_tutorial/pt.md)
...
{{docnav/pt|Raytracing Workbench/pt|Arch Workbench/pt}}
...
---
⏵ [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [Draft](Category_Draft.md) > Draft Workbench/pt
