# <img alt="Spreadsheet workbench icon" src=images/Workbench_Spreadsheet.svg  style="width:64px;"> Spreadsheet Workbench/pt
...
A bancada de trabalho Folha de Cálculo permite criar e editar folhas de cálculo, executar cálculos, e obter informação de um modelo, e exportar informação para outras aplicações de folha de cálculo tais como o LibreOffice ou Microsoft Excel.
...
---
⏵ [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [Spreadsheet](Category_Spreadsheet.md) > Spreadsheet Workbench/pt
