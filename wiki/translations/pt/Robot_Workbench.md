...
The <img alt="" src=images/Workbench_Robot.svg  style="width:24px;"> [Robot Workbench](Robot_Workbench.md) is a tool to simulate a standard [6-axis industrial robot](Robot_6-Axis.md), like [Kuka](http://kuka.com/).
...
{{docnav/pt|Arch_Workbench/pt|Macros/pt}}
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [Robot](Category_Robot.md) > Robot Workbench/pt
