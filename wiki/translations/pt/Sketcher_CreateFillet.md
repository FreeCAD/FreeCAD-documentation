...
---
- GuiCommand:/pt   Name:Sketcher CreateFillet   Name/pt:Sketcher CreateFillet   Workbenches:[[Sketcher Workbench/pt   Sketcher]]|Shortcut:F   MenuLocation:Sketch → Sketcher geometries → Create fillet---
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher CreateFillet/pt
