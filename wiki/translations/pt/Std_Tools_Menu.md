# <img alt="Std Base icon" src=images/Freecad.svg  style="width:64px;"> Std Tools Menu/pt
...
-   <img alt="" src=images/Std_ProjectUtil.svg  style="width:32px;"> [Document utility\...](Std_ProjectUtil.md): Assists in repairing damaged project files.
...
---
⏵ [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Std Tools Menu/pt
