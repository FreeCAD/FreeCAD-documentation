...
O FreeCAD 0.17 foi lançado a 06 de abril de 2018, obtenha-o na página de [Download](Download.md). Isto é um resumo das alterações mais importantes. A lista completa de alterações pode ser encontrada em [MantisBT bugtracker FC 0.17 changelog](https://www.freecadweb.org/tracker/changelog_page.php?version_id=73).

Versões anteriores das Notas de lançamento do FreeCAD podem ser encontradas em [Por onde começar](Getting_started/pt.md).
...
---
[documentation index](../README.md) > [News](Category_News.md) > Release notes 0.17/pt
