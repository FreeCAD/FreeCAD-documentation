# <img alt="Plot workbench icon" src=images/Workbench_Plot.svg  style="width:64px;"> Plot Module/pt
...
---
[documentation index](../README.md) > [External_Workbenches](Category_External_Workbenches.md) > Plot Module/pt
