...
O módulo Arch (Arquitetura) pode ser usado em scripts python e [ macros](macros/pt.md) usando funções [Arch Python API](http://www.freecadweb.org/api/Arch.html).
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [Arch](Category_Arch.md) > Arch Workbench/pt
