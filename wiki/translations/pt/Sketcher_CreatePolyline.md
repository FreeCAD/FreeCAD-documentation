...
---
- GuiCommand:/pt   Name:Sketcher CreatePolyline   Name/pt:Sketcher CreatePolyline   Workbenches:[MenuLocation:Sketch → Sketcher geometries → Create polyline   SeeAlso:[[Sketcher CreateLine/pt|Sketcher Line](Sketcher_Workbench/pt___Sketcher]].md)---
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher CreatePolyline/pt
