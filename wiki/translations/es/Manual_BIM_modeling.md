...
-   En la barra de herramientas de **snapping** asegúrese de que el <img alt="" src=images/Draft_Snap_Grid.svg  style="width:16px;"> [grid snap](Draft_Snap_Grid.md) esté habilitado, para que podamos usar la rejilla tanto como sea posible.
-   Si no ves los ejes entonces haz clic en el <img alt="" src=images/Draft_Snap_Grid.svg  style="width:16px;"> [alternar rejilla de borrador](Draft_Snap_Grid/es.md).
-   Establece el [Plano trabajo](Draft_SelectPlane/es.md) en el plano **XY**
-   Aleja el zoom y desplázalo para que puedas ver el área desde (0,0) hasta (4,3). Ver el [Mouse Model](Mouse_Model.md) para las instrucciones.
-   Dibuja cuatro líneas con la herramienta <img alt="" src=images/Draft_Line.svg  style="width:16px;"> [Borrador línea](Draft_Line/es.md). Puedes introducir las coordenadas manualmente, o simplemente elegir los puntos de la cuadrícula con el ratón:
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Tutorials](Category_Tutorials.md) > [BIM](Category_BIM.md) > [Arch](Category_Arch.md) > Manual:BIM modeling/es
