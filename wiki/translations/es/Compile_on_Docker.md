...
## Docker Repositorio {#docker_repositorio}
...
### Descargar la fuente {#descargar_la_fuente}
...
### Create build directory {#create_build_directory}
...
### Allow access to your window manager {#allow_access_to_your_window_manager}
...
### Launch the docker image {#launch_the_docker_image}
