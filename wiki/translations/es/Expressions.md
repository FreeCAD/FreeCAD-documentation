...
### Argumentos de la función {#argumentos_de_la_función}
...
### Referencia de objetos {#referencia_de_objetos}
...
## Constantes soportadas {#constantes_soportadas}
...
## Operadores soportados {#operadores_soportados}
...
## Funciones soportadas {#funciones_soportadas}

### Funciones matemáticas generales {#funciones_matemáticas_generales}
...
### Funciones estadísticas/agregadas {#funciones_estadísticasagregadas}
...
## Expresiones condicionales {#expresiones_condicionales}
...
## Caracteres y nombres no válidos {#caracteres_y_nombres_no_válidos}
...
## Referencia a los datos CAD {#referencia_a_los_datos_cad}
...
## Variables globales de todo el documento {#variables_globales_de_todo_el_documento}
...
## Enlace entre documentos {#enlace_entre_documentos}
...
## Problemas conocidos / tareas pendientes {#problemas_conocidos_tareas_pendientes}
