...
{{docnav/es|[Arch CompPipe](Arch_CompPipe/es.md)|[Pipe Connector](Arch_PipeConnector/es.md)|[Arch](Arch_Module/es.md)|IconL=Arch_CompPipe.png |IconC=Workbench_Arch.svg |IconR=Arch_PipeConnector.svg}}
