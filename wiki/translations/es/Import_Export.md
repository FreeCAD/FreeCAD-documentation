...
<div class="mw-translate-fuzzy">
  ...
  [FCMat](Material.md)                  Tarjeta de material de FreeCAD                                                                                                                      si         si         Incorporado                                                                             no
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [File_Formats](Category_File_Formats.md) > [Import](Import_Workbench.md) > Import Export/es
