...
Esta herramienta puede proyectar toda la cara, o sólo un alambre o borde de una [Forma](Shape/es.md). El resultado puede ser una nueva cara o un alambre en la superficie, o incluso un sólido de proyección, que puede ser usado en un [corte booleano](Part_Cut/es.md).
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Part](Part_Workbench.md) > Part ProjectionOnSurface/es
