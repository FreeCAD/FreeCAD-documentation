...
**Este comando no está actualmente en uso**. Servirá para generar vistas planas y basadas en la forma desde un objeto basado en [ Mesh](Mesh_Workbench.md), para ser utilizado por la herramienta [Arch Equipment](Arch_Equipment.md).
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Arch](Arch_Workbench.md) > Arch 3Views/es
