...
{{VeryImportantMessage|Esta página registra las nuevas características a medida que se añaden a la versión de desarrollo de FreeCAD, que actualmente es la 0.20. Cuando se produzca la congelación de las características de la 0.20, se borrarán estos mensajes y no se añadirán más características a esta página. Se espera que FreeCAD 0.20 sea lanzado en 202x.}}


{{VeryImportantMessage|!!! Todas las imágenes de esta página deben utilizar el sufijo {{FileName|_relnotes_0.20}} !!!}}
...
## Puntos culminante {#puntos_culminante}

## General

### Python 3 y Qt5 {#python_3_y_qt5}

### Algunos problemas {#algunos_problemas}
...
### Limitaciones conocidas {#limitaciones_conocidas}

## Interfaz de usuario {#interfaz_de_usuario}
...
### Otras mejoras de la interfaz de usuario {#otras_mejoras_de_la_interfaz_de_usuario}
...
## Aplicación::Enlace y ensamble {#aplicaciónenlace_y_ensamble}

## Núcleo sistema, Aplicación, Base, y Gui espaciosnombres {#núcleo_sistema_aplicación_base_y_gui_espaciosnombres}

## Gestor de complementos {#gestor_de_complementos}

## Ambiente de Trabajo Arquitectura {#ambiente_de_trabajo_arquitectura}

## Ambiente de Trabajo Borrador {#ambiente_de_trabajo_borrador}

### Otras mejoras del Borrador {#otras_mejoras_del_borrador}
...
## Ambiente de Trabajo MEF {#ambiente_de_trabajo_mef}
...
### Otras mejoras del MEF {#otras_mejoras_del_mef}
...
## Manejo de materiales {#manejo_de_materiales}

## Malla

### Otras mejoras {#otras_mejoras}

## Ambiente de Trabajo OpenSCAD {#ambiente_de_trabajo_openscad}
...
## Ambiente de Trabajo Pieza {#ambiente_de_trabajo_pieza}

### Otras mejoras {#otras_mejoras_1}
...
## Ambiente de Trabajo Trayectoria {#ambiente_de_trabajo_trayectoria}
...
### Corrección de errores {#corrección_de_errores}
...
## Ambiente de Trabajo Hoja de cálculo {#ambiente_de_trabajo_hoja_de_cálculo}
...
## Ambiente de Trabajo Inicio {#ambiente_de_trabajo_inicio}

## Ambiente de Trabajo Superficie {#ambiente_de_trabajo_superficie}

## Ambiente de Trabajo DibujoTécnico {#ambiente_de_trabajo_dibujotécnico}

### Otras mejoras DibujoTécnico {#otras_mejoras_dibujotécnico}
...
### Elementos de Unión {#elementos_de_unión}
