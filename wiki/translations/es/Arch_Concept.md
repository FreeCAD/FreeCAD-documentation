...
## software similar {#software_similar}
...
## sobre los arquetipos {#sobre_los_arquetipos}
...
## arquetipos (tipos de objetos) {#arquetipos_tipos_de_objetos}
...
### Puerta/Ventana (Insertar elementos) {#puertaventana_insertar_elementos}
...
### Viga/Pilares (Elementos estructurales) {#vigapilares_elementos_estructurales}
...
## mecanismos genéricos {#mecanismos_genéricos}
...
### Analisis energético {#analisis_energético}
...
### Simulación de la luz solar {#simulación_de_la_luz_solar}
...
### HVAC(Heating, Ventilation, and Air Conditioning) & Ventilación Natural {#hvacheating_ventilation_and_air_conditioning_ventilación_natural}
...
## Capturando el conocimiento en Construcción {#capturando_el_conocimiento_en_construcción}
...
### Descripciones de Procedimientos para Identificar Objetos {#descripciones_de_procedimientos_para_identificar_objetos}
...
#### Objeto 1: Situación de la construcción {#objeto_1_situación_de_la_construcción}
...
#### Objeto 2: Dirección Norte {#objeto_2_dirección_norte}
...
#### Objeto 3: Retranqueo {#objeto_3_retranqueo}
...
#### Objeto 4: Nivel de construcción {#objeto_4_nivel_de_construcción}
...
#### Objeto 5: Espacio de construcción {#objeto_5_espacio_de_construcción}
...
#### Objeto 6: Objeto espacio {#objeto_6_objeto_espacio}
...
#### Objeto 7: Contenedor de construcción {#objeto_7_contenedor_de_construcción}
...
### Diagrama de objetos {#diagrama_de_objetos}
