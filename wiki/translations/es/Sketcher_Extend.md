...
<img alt="" src=images/Sketcher_Extend_example_01.png  style="width:600px;"> *Se muestra a la izquierda (1), los dos elementos del croquis antes de la operación; en el centro (2), la línea se está extendiendo hasta el arco; a la derecha (3), el resultado final*.
...
-   En este momento sólo se pueden ampliar los arcos y las líneas.
