...
## Descripción de esta lista {#descripción_de_esta_lista}
...
Usuarios pueden ejecutar estos scripts como una [macro](Macro/es.md) o directamente en la [consola de Python](Python_console/es.md). Tenga en cuenta que muchas de las funciones tienen \'Exe\' o \'Execu\', abreviatura de \'Execute\', en su nombre.

Estos archivos también se mencionan en el [Inventor Mentor tutorial](http://www-evasion.imag.fr/Membres/Francois.Faure/doc/inventorMentor/sgi_html/pr01.html) para el lenguaje C.

## Lista de los archivos y sus capturas de pantalla (scripts de Python) {#lista_de_los_archivos_y_sus_capturas_de_pantalla_scripts_de_python}
...
## Software para el aprendizaje de la biblioteca COIN3D {#software_para_el_aprendizaje_de_la_biblioteca_coin3d}
...
3.  Generalmente, COIN3D no proporciona buenos dibujos primitivos. El sistema de widgets Design456 sí proporciona algunos: algunas formas básicas, y también algunas formas complejas. El widget de flecha y el widget de línea utilizados por el [Ambiente de trabajo Design456](Design456_Workbench/es.md) son ejemplos.
