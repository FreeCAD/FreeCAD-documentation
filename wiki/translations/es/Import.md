...
12.3 Abra **house.FCStd**, seleccione el objeto raíz \"Edificio\" y expórtelo (**Archivo → Exportar**) estableciendo el Tipo de archivo como \"Industry Foundation Classes (\*.ifc)\". Pulsa **Guardar** y si funciona y no lanza un error en la [Report view/es](Report_view/es.md) entonces está funcionando.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [BIM](Category_BIM.md) > [Arch](Category_Arch.md) > [3rd Party](Category_3rd Party.md) > [File_Formats](Category_File_Formats.md) > Import/Export IFC - compiling IfcOpenShell/es
