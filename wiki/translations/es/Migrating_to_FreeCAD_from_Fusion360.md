...
{{VeryImportantMessage|Por favor, consulte también el proyecto en curso [CAD Rosetta Stone](CAD_Rosetta_Stone/es.md) para aprender los nombres análogos que usan los CADs propietarios populares}}
