...
La función ComprobarGeometría comprueba si la [Representación del límite](https://en.wikipedia.org/wiki/Boundary_representation) (BRep o [B-rep](Glosario#B.md)) del modelo es válida. Adicionalmente a esta comprobación de BRep, es posible tener una comprobación adicional de BOP (BOP= Boolean OPerations).
