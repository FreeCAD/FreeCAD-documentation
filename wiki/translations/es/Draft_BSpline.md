...
1.  Hay varias formas de invocar el comando:
    ...
    -   Seleccione la opción {{MenuCommand|Borrador → <img src="images/Draft_BSpline.svg" width=16px> B-spline}} en el menú.
    -   Utilice el atajo de teclado: **B** y luego **S**.
2.  Se abre el panel de tareas {{MenuCommand|B-spline}}. Ver [Opciones](#Opciones.md) para más información.
