...
FreeCAD se ha estado desarrollando desde 2002, y ofrece una amplia lista de _.
...
El _ y [Atrapar objeto](Draft_Snap/es.md).
...
2.  _, encontrarás el principio y una lista de las bibliotecas existentes.
