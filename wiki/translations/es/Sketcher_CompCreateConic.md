...
-   <img alt="" src=images/Sketcher_CreateArcOfEllipse.svg  style="width:32px;"> [Arco de elipse](Sketcher_CreateArcOfEllipse/es.md) : Dibuja un arco de elipse por punto central, punto de radio mayor, punto inicial y punto final.
-   <img alt="" src=images/Sketcher_CreateArcOfHyperbola.svg  style="width:32px;"> [Arco de hipérbola](Sketcher_CreateArcOfHyperbola/es.md): dibuja un arco de hipérbola.
-   <img alt="" src=images/Sketcher_CreateArcOfParabola.svg  style="width:32px;"> [Arco de parábola](Sketcher_CreateArcOfParabola/es.md): dibuja un arco de parábola.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher CompCreateConic/es
