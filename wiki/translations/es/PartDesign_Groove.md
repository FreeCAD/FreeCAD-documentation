...
Cuando se crea una ranura, los parámetros del letrero de diálogo de \'ranura\' ofrece varios parámetro especificando como debería revolucionarse. Tienen exactamente el mismo significado que para la operación de [revolución](PartDesign_Revolution/es#Opciones.md).
