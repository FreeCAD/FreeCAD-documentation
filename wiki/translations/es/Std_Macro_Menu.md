# <img alt="Std Base icon" src=images/Freecad.svg  style="width:64px;"> Std Macro Menu/es
...
El **menú Macro** es uno de los 7 sub-menús en el [menú estándar](Standard_Menu/es.md):
...
El menú Macro proporciona herramientas relacionadas con la grabación y ejecución de [macros](Macros/es.md).
...
-   <img alt="" src=images/Std_DlgMacroRecord.svg  style="width:32px;"> [Grabación de Macro\...](Std_DlgMacroRecord/es.md): Abre un cuadro de diálogo para iniciar una sesión de grabación de macros.
...
-   [Pasar al siguiente](Std_MacroStepOver/es.md): Pasa sobre el código.

-   [Entrar en](Std_MacroStepInto/es.md): Entra al código.

-   [Conmutar punto de parada](Std_ToggleBreakpoint/es.md): Alterna un punto de interrupción.
