...
Desde esta interfaz puedes ver información útil y saltar a los archivos abiertos recientemente, ejemplos, la documentación, y las últimas noticias del mundo de FreeCAD. Puedes cambiar cómo se comporta el ambiente de trabajo de inicio, o cambiar el ambiente de trabajo por defecto, en el [Editor de preferencias](Preferences_Editor/es.md) del menú {{MenuCommand|Edición → Preferencias → Inicio}}.
