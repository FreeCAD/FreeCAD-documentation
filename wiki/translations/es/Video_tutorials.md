...
Visite [tutoriales externos](offsite_tutorials/es.md) para ver las listas de tutoriales alojados en sitios externos.
...
## Fabricación asistida por ordenador (CAM) {#fabricación_asistida_por_ordenador_cam}
...
## Visualización y representación {#visualización_y_representación}
...
## Método de los Elementos Finitos (MEF) simulación {#método_de_los_elementos_finitos_mef_simulación}
...
Para más información ver [Tutoriales de vídeo obsoletos](Video_tutorials_obsolete/es.md).
