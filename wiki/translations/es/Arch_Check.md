---
- GuiCommand:/es   Name:Arch Check   Name/es:Arch Check   Workbenches:[MenuLocation:Arquitectura → Utilidades → Comprobar   SeeAlso:[[Arch CloseHoles/es|Tapar agujeros](Arch_Module/es___Arquitectura]].md)---
