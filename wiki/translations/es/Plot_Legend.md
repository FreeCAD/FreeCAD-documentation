# Plot Legend/es
---
- GuiCommand:/es   Name:Plot Legend   MenuLocation:Plot → Legend‏‎   |Workbenches:[[Plot_Workbench/es   Plot]]|Shortcut:   SeeAlso:---
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [External_Workbenches](Category_External_Workbenches.md) > [Addons](Category_Addons.md) > [Plot](Plot_Workbench.md) > Plot Legend/es
