...
Esta página es una extensión de la página _ y da pautas comunes para escribir y actualizar la documentación del wiki de FreeCAD. Resume varias discusiones y sesiones de brainstorming
...
-   Si nunca has usado el software wiki antes, por favor lee _ para familiarizarte con el marcado que se usa.
...
-   Usa un sandbox para probar tu código, por ejemplo, _ o una página particular con tu nombre _.
...
No utilices la transclusión de páginas (_), ya que esto dificulta la traducción del wiki. Utiliza sólo las plantillas descritas en [\#Plantillas](#Templates.md).
