...
2.  Hay varias formas de invocar el comando:
    ...
    -   Seleccione la opción {{MenuCommand|Modificación → Herramientas de matriz → <img src="images/Draft_PolarArray.svg" width=16px> Arreglo polar}} en el menú.
3.  Se abre el panel de tareas {{MenuCommand|Arreglo polar}}. Ver [Opciones](#Opciones.md) para más información.
