...
<File:11_T01_window_all_symbol_top.png%7Clink=>[Tutorial for open windows/es](Tutorial_for_open_windows/es.md)\|[Ventanas y puertas abiertas](Tutorial_for_open_windows/es.md) (v0.18)
Cómo mostrar ventanas y puertas abiertas, con símbolos de alzado y planta, y producir un plano básico con TechDraw.

<File:17_T02_sketch_2_attached_correctly.png%7Clink=>[Tutorial custom placing of windows and doors/es](Tutorial_custom_placing_of_windows_and_doors/es.md)\|[Diseñar ventanas personalizadas](Tutorial_custom_placing_of_windows_and_doors/es.md). (v0.18)
...
<File:Arch_Wikihouse_01.jpg%7Clink=>[Wikihouse porting tutorial/es](Wikihouse_porting_tutorial/es.md)\|[Modelado de la WikiHouse](Wikihouse_porting_tutorial/es.md)
