---
- GuiCommand:/es   Name:Draft Stretch   Workbenches:[Arch](Draft_Module/es___Draft]],_[[Arch_Module/es.md)|MenuLocation:Draft → Stretch   SeeAlso:[[Draft Offset]]---
...
2.  There are several ways to invoke the command:
    ...
    -   Select the {{MenuCommand|Modification → <img src="images/Draft_Stretch.svg" width=16px> Stretch}} option from the menu.
    -   Use the keyboard shortcut: **S** then **H**.
3.  If you have not yet selected an object: select an object in the [3D view](3D_view.md).
4.  The {{MenuCommand|Stretch}} task panel opens. See [Options](#Options.md) for more information.
