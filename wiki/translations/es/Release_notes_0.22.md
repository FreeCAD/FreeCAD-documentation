# Release notes 0.22/es
**FreeCAD 0.22 está en desarrollo, todavía no hay fecha de lanzamiento.**


{{Message|
¿Faltan características? Menciónelas en el hilo del foro [https://forum.freecadweb.org/viewtopic.php?f&#61;10&t&#61;80197 Notas de la versión v0.22].

Vea [Ayuda a FreeCAD](Help_FreeCAD/es.md) para ver formas de como contribuir a FreeCAD.
}}


{{Message|Todas la imágenes en esta página deben usar el sufijo **_relnotes_0.22**}}




**FreeCAD 0.22** fue liberado el **DD de Mes del 2024**, consíguelo desde la página [Descarga](Download/es.md). Este es un resumen de las nuevas características y los cambios más interesantes.
...
## Entorno de Trabajo Web 



### Otras mejoras de Web 
...
---
⏵ [documentation index](../README.md) > [News](Category_News.md) > [Documentation](Category_Documentation.md) > [Releases](Category_Releases.md) > Release notes 0.22/es
