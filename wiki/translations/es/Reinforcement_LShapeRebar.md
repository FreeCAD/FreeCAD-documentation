---
 GuiCommand:Addon/es
   ...
   Workbenches: Arch_Workbench/es, BIM Workbench/es
   Shortcut: None
   SeeAlso: Arch_Rebar_BentShape/es, Arch Rebar/es
   Version: 0.17
   Addon: Reinforcement
---

# Reinforcement LShapeRebar/es
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > [BIM](Category_BIM.md) > Reinforcement LShapeRebar/es
