...
### ¿Cuál es la forma más fácil de instalar FreeCAD en mi sistema? {#cuál_es_la_forma_más_fácil_de_instalar_freecad_en_mi_sistema}
...
### ¿Cuáles son los requisitos previos para ejecutar FreeCAD? {#cuáles_son_los_requisitos_previos_para_ejecutar_freecad}
...
#### Para los usuarios Mac {#para_los_usuarios_mac}

Sólo se admite la arquitectura MacIntel. No hay versiones disponibles para la arquitectura PowerPC.

### ¿Qué pasa si quiero compilar FreeCAD yo mismo? {#qué_pasa_si_quiero_compilar_freecad_yo_mismo}
...
### FreeCAD me dice que falta algún módulo o aplicación {#freecad_me_dice_que_falta_algún_módulo_o_aplicación}
...
### FreeCAD no se inicia en absoluto {#freecad_no_se_inicia_en_absoluto}
...
### FreeCAD se inicia normalmente, pero no se muestran todos los iconos, algunos de ellos son reemplazados por una \'X\' negra {#freecad_se_inicia_normalmente_pero_no_se_muestran_todos_los_iconos_algunos_de_ellos_son_reemplazados_por_una_x_negra}
...
### Tengo problemas de visualización, la vista 3D no se comporta correctamente, hay basura cuando muevo/roto la vista, etc. {#tengo_problemas_de_visualización_la_vista_3d_no_se_comporta_correctamente_hay_basura_cuando_muevoroto_la_vista_etc.}
...
### FreeCAD se bloquea al iniciar {#freecad_se_bloquea_al_iniciar}
...
#### Los controladores OpenGL no están instalados, o no funcionan correctamente {#los_controladores_opengl_no_están_instalados_o_no_funcionan_correctamente}
...
#### Alguna biblioteca, necesaria para FreeCAD, no está presente en su sistema, o no fue encontrada por FreeCAD {#alguna_biblioteca_necesaria_para_freecad_no_está_presente_en_su_sistema_o_no_fue_encontrada_por_freecad}
...
### FreeCAD se congela tras el arranque {#freecad_se_congela_tras_el_arranque}
...
### FreeCAD se bloquea al crear un nuevo documento o abrir un archivo {#freecad_se_bloquea_al_crear_un_nuevo_documento_o_abrir_un_archivo}
...
### FreeCAD se bloquea después de Edición → Alineación {#freecad_se_bloquea_después_de_edición_alineación}
...
### Tengo problemas para ejecutar FreeCAD en Mac OSX {#tengo_problemas_para_ejecutar_freecad_en_mac_osx}
...
### No puedo cambiar los valores numéricos en los paneles de propiedades de FreeCAD {#no_puedo_cambiar_los_valores_numéricos_en_los_paneles_de_propiedades_de_freecad}
...
### FreeCAD se estaba ejecutando normalmente, y de repente ya no se inicia {#freecad_se_estaba_ejecutando_normalmente_y_de_repente_ya_no_se_inicia}
...
### ¿Es FreeCAD realmente gratuito? ¿Incluso para uso comercial? {#es_freecad_realmente_gratuito_incluso_para_uso_comercial}
...
### ¿Cómo puedo girar la vista 3D? {#cómo_puedo_girar_la_vista_3d}


<center>

Image:Style\_of\_navigation.png\|From the **right button** mouse Image:Style of navigation menu.png\|From the menu {{MenuCommand|Edit → Preferences →}}
...
### ¿Qué puedo hacer con FreeCAD? ¿Por dónde empiezo? {#qué_puedo_hacer_con_freecad_por_dónde_empiezo}
...
### ¿Hay documentación para los recién llegados? ¿Cómo puedo aprender a usar FreeCAD? {#hay_documentación_para_los_recién_llegados_cómo_puedo_aprender_a_usar_freecad}
...
### Quiero importar/exportar datos en formato XYZ a/desde FreeCAD. ¿Cómo lo hago? {#quiero_importarexportar_datos_en_formato_xyz_adesde_freecad._cómo_lo_hago}
...
## Trabajar con la geometría de la pieza {#trabajar_con_la_geometría_de_la_pieza}

### ¿Cómo puedo extrudir cosas en sólidos? No obtengo el resultado correcto {#cómo_puedo_extrudir_cosas_en_sólidos_no_obtengo_el_resultado_correcto}
...
### Mis operaciones booleanas fallan, o dan resultados extraños {#mis_operaciones_booleanas_fallan_o_dan_resultados_extraños}
...
### Mis objetos paramétricos se rompen cuando modifico sus bocetos base {#mis_objetos_paramétricos_se_rompen_cuando_modifico_sus_bocetos_base}
...
## Contribución a FreeCAD {#contribución_a_freecad}

### ¡FreeCAD es un gran programa! ¿Cómo puedo ayudar? {#freecad_es_un_gran_programa_cómo_puedo_ayudar}
...
### ¿Cómo puedo obtener permiso de edición en el wiki? {#cómo_puedo_obtener_permiso_de_edición_en_el_wiki}
...
### ¿Participa FreeCAD en el Google Summer of Code? {#participa_freecad_en_el_google_summer_of_code}
...
### Quiero empezar a traducir el wiki en mi propio idioma. ¿Qué hago? {#quiero_empezar_a_traducir_el_wiki_en_mi_propio_idioma._qué_hago}
...
## Licencia, copia y reutilización {#licencia_copia_y_reutilización}

### ¿Tengo que pagar algo para usar FreeCAD? {#tengo_que_pagar_algo_para_usar_freecad}
...
### ¿Puedo reutilizar cualquier parte del material gráfico de FreeCAD o piezas del sitio web? {#puedo_reutilizar_cualquier_parte_del_material_gráfico_de_freecad_o_piezas_del_sitio_web}
...
### ¿Puedo reutilizar piezas de FreeCAD en otra aplicación? {#puedo_reutilizar_piezas_de_freecad_en_otra_aplicación}
