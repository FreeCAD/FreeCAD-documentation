...
-   [Borrador](Draft_Module/es.md) comandos como <img alt="" src=images/Draft_Line.svg  style="width:24px;"> [Linea Borrador](Draft_Line/es.md) y <img alt="" src=images/Draft_BSpline.svg  style="width:24px;"> [Borrador BSpline](Draft_BSpline/es.md) pueden utilizarse para conectar los puntos de una nube de puntos. Utiliza <img alt="" src=images/Draft_Snap_Endpoint.svg  style="width:24px;"> [Borrador Punto final Snap](Draft_Snap_Endpoint/es.md) para ajustarse a los puntos.
