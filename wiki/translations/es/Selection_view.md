...
La [vista de selección](selection_view/es.md) es un panel en la [interfaz](interface.md) localizada por defecto en debajo de la [vista combo](combo_view/es.md). Justo como el [editor de propiedades](property_editor/es.md), muestra más información sobre los objetos seleccionados actualmente.

Se puede hacer una selección eligiendo un objeto en la [vista 3D](3D_view/es.md) o en la [vista de árbol](tree_view/es.md). Se pueden seleccionar varios cuerpos manteniendo presionado **Ctrl**.
...
---
⏵ [documentation index](../README.md) > Selection view/es
