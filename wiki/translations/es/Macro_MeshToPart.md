...
|Description=Esta macro convierte las mallas seleccionadas en piezas. Tiene una tolerancia bastante grande, así que utilízala sólo con objetos que no tengan curvas pues de otro modo obtendrás resultados extraños
|Author=Wmayer
|Version=1.0
|Date=2011-08-01
|FCVersion=All
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro MeshToPart/es
