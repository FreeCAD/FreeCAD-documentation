...
-   Usar el comando [Std Importar](Std_Import/es.md) para importar archivos de Excel ***.xlsx**.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Spreadsheet](Spreadsheet_Workbench.md) > Spreadsheet Import/es
