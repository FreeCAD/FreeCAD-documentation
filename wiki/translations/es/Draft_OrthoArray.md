...
2.  Hay varias formas de invocar el comando:
    ...
    -   Seleccione la opción {{MenuCommand|Modificación → Herramientas de arreglo →
        <img src="images/Draft_OrthoArray.svg" width=16px> Array}} en el menú.
3.  Se abre el panel de tareas {{MenuCommand|Arreglo Ortogonal}}. Ver [Opciones](#Opciones.md) para más información.
