# Release notes 0.21/es
**FreeCAD 0.21** fue lanzado el **2 de agosto del 2023**, consíguelo desde la página [Descarga](Download/es.md). Este es un resumen de las nuevas características y los cambios más interesantes.
...
El esquema de nombres de archivos de respaldo predeterminado ahora es **FCBak**. El formato anterior (**FCStd#**) está obsoleto y se eliminará en una versión futura. Los usuarios con el esquema anterior habilitado recibirán una advertencia al iniciar. [Pull request #9668](https://github.com/FreeCAD/FreeCAD/pull/9668)
...
-   It is now possible to set a default transparency for new [Part](Part_Workbench.md) or [PartDesign](PartDesign_Workbench.md) objects in the [Preferences](PartDesign_Preferences.md). [Pull request #7103](https://github.com/FreeCAD/FreeCAD/pull/7103)
