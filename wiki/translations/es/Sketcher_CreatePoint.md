...
-   Haga clic en el botón **<img src="images/Sketcher_CreatePoint.svg" width=24px> Crear punto**, para activar la función.
-   Haciendo clic en el croquis se crea un punto.
...
El punto creado no está disponible fuera del croquis. En caso de que se necesite un punto en la vista 3D, utilice el [DiseñoPieza Punto](PartDesign_Point/es.md) para un punto de referencia o el [Pieza Punto](Part_Point/es.md) en su lugar.
