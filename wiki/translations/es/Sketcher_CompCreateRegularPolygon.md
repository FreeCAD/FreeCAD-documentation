...
-   <img alt="" src=images/Sketcher_CreateHexagon.svg  style="width:32px;"> [Crear un hexágono](Sketcher_CreateHexagon/es.md): Dibuja un hexágono escogiendo dos puntos, el centro y una esquina.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher CompCreateRegularPolygon/es
