...
-   Da kopierte Maßbeschränkungen Ausdrücke verwenden, werden sie in einer anderen Farbe gerendert. Die Farbe kann mit dem [Voreinstellungeneditor](Preferences_Editor/de.md) unter {{MenuCommand|Bearbeiten → Einstellungen → Skizzierer → Farben → Ausdrucksabhängige Beschränkungsfarbe}} angepasst werden.
