---
 GuiCommand:
   ...
   Name/de: Reinforcement ZeichnungBemaßen
   MenuLocation: 
...
# Reinforcement DrawingDimensioning/de



## Beschreibung

Das Werkzeug [Reinforcement ZeichnungBemaßen](Reinforcement_DrawingDimensioning.md) ermöglicht dem Anwender Zeichnungen mit Bemaßung von Bewehrungen zu erstellen.
...
2\. Select **<img src="images/Arch_Structure.svg" width=16px> [Arch Structure](Arch_Structure.md)** object and then select **<img src="images/Reinforcement_DrawingDimensioning.svg" width=16px> [Reinforcement Drawing Dimensioning](Reinforcement_DrawingDimensioning.md)** from the rebar tools.
...
The Reinforcement DrawingDimensioning tool can be used in [macros](macros.md) and from the [Python](Python.md) console by using the following function:
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > Reinforcement DrawingDimensioning/de
