---
 GuiCommand:
   ...
   Name/de: CAM ToolBitLibraryOpen
   MenuLocation: CAM , ToolBit Library editor
   Workbenches: CAM_Workbench/de
   Version: 0.19
   SeeAlso: CAM_ToolBitDock/de, CAM_Tools/de, CAM_ToolBit/de
---

# CAM ToolBitLibraryOpen/de



## Beschreibung

Der <img alt="" src=images/_CAM_ToolBitLibraryOpen.svg  style="width:16px;"> [Werkzeug-Bit-Bibliothek-Editor](CAM_ToolBitLibraryOpen/de.md) ist das Werkzeug zum Erstellen, Verwalten und Sortieren von Toolbits. Wird der Bibliothek-Manager gestartet, wird er als modaler (?) Dialog angezeigt.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM ToolBitLibraryOpen/de
