...
FreeCAD begann im Januar 2001, als [Jürgen Riegel](User:Jriegel.md) mit der Arbeit an dem Cas.CADE Projekt begann. Cas.CADE war ein kommerzielles Softwareentwicklungsrahmenwerk, das einen [geometrischen Modellierungskern](Glossary#Geometric_modeling_kernel.md) (oder CAD Kernel) enthielt: Es wurde im Jahr 2000 unter einer Open-Source Lizenz veröffentlicht und in [OpenCASCADE](OpenCASCADE/de.md) umbenannt. Dies ermöglichte die Realisierung eines quelloffenen 3D CAD Programms, da die Programmierung eines CAD Kerns von Grund auf einen enormen Arbeitsaufwand bedeutet hätte.
...
|sign=[Jürgen Riegel](User:Jriegel.md)|source=''[https://dev.opencascade.org/content/announcing-freecad-project Ankündigung FreeCAD Projekt am Sun, 08/17/2003 - 19:23]''}}
