...
Videos, die die Modellierung von Räumen, Häusern, Bürogebäuden und ähnlichen Strukturen und das Zeichnen von Grundrissen unter Verwendung von Arbeitsbereichen wie <img alt="" src=images/Workbench_Draft.svg  style="width:24px;"> _, und <img alt="" src=images/Workbench_BIM.svg  style="width:24px;"> [BIM](BIM_Workbench/de.md) durchlaufen.

-   _ Hauptentwickler hat verschiedene Listen zu FreeCAD für Gebäudemodellierung sowie allgemeine Architektur.
