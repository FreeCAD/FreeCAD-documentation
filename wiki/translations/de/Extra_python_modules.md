...
Diesen Code in die [Python-Konsole](Python_console/de.md) Einfügen:
...
---
⏵ [documentation index](../README.md) > [Python Code](Category_Python%20Code.md) > [Developer Documentation](Category_Developer%20Documentation.md) > Extra python modules/de
