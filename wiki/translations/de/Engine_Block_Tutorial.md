...
## Ausräumen des Blocks {#ausräumen_des_blocks}

Beginnen wir nun mit der Arbeit am eigentlichen Modell. Wir beginnen mit dem Hinzufügen eines Kastens für den Gesamtumriss des Motorblocks. Dazu müssen wir dem Modell ein *Teil* hinzufügen, gehe zu {{MenuCommand|Ansicht → Arbeitsbereich → Part}} und wähle den [Part Arbeitsbereich](Part_Workbench/de.md). Nachdem du den Arbeitsbereich ausgewählt hast, wirst du feststellen, dass du oben auf der Werkzeugleiste einen anderen Satz von Schaltflächen erhältst. Blättere durch einige der anderen Arbeitsbereiche, um sich mit dem Arbeitsbereichsystem vertraut zu machen, und kehre dann zum Part Arbeitsbereich zurück.

### Der Rohling {#der_rohling}
...
### Der erste Zylinder {#der_erste_zylinder}
...
### Der zweite Zylinder {#der_zweite_zylinder}
...
### Ausbohren der Zylinder {#ausbohren_der_zylinder}
...
### Der wichtigste Vorteil des parametrischen Modellierens {#der_wichtigste_vorteil_des_parametrischen_modellierens}
...
## Das Kurbelgehäuse {#das_kurbelgehäuse}

### Rohling und Lagerdeckel {#rohling_und_lagerdeckel}
...
### Herausarbeiten der Lager {#herausarbeiten_der_lager}
...
### Fertigstellen des Kurbelgehäuses {#fertigstellen_des_kurbelgehäuses}
...
## 2D Entwurf der Zylinderkopfdichtung {#d_entwurf_der_zylinderkopfdichtung}
...
### Eingabe des 2D Zeichenmodus {#eingabe_des_2d_zeichenmodus}
...
### Auslegen der Kopfbolzen {#auslegen_der_kopfbolzen}
...
### Die andere Seite des Blocks {#die_andere_seite_des_blocks}
...
### Extrudieren der 2D Kopfkonstruktion in unser 3D Modell, um die Konstruktion abzuschließen {#extrudieren_der_2d_kopfkonstruktion_in_unser_3d_modell_um_die_konstruktion_abzuschließen}
