...
Das Werkzeug <img alt="" src=images/Path_Job.svg  style="width:16px;"> [Auftrag](Path_Job/de.md) erstellt ein neues Auftragsobjekt im aktiven Dokument. Das Auftragsobjekt enthält die folgenden Informationen:
...
1.  Es gibt mehrere Möglichkeiten, den Befehl aufzurufen
    -   Die Schaltfläche **<img src="images/Path_Job.svg" width=16px> [Auftrag](Path_Job/de.md)** Drücken.
