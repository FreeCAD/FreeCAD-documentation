---
 GuiCommand:
   ...
   Name/de: Arch Armierung Plattenbewehrung
...
# Arch Rebar Slab Reinforcement/de



## Beschreibung

Das Werkzeug [Plattenbewehrung](Arch_Rebar_Slab_Reinforcement/de.md) ermöglicht dem Anwender Bewehrungsstäbe innerhalb eines [Arch Struktur](Arch_Structure/de.md)-Objekts Platte zu erstellen.
...
---
⏵ [documentation index](../README.md) > [Reinforcement](Category_Reinforcement.md) > [Arch](Arch_Workbench.md) > Arch Rebar Slab Reinforcement/de
