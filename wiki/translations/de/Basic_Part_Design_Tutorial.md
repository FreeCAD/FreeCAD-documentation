---
 TutorialInfo:e
   Topic: Modellieren
   Level: Einsteiger
   Author: Mark Stephen  und HarryGeier 
...
---
⏵ [documentation index](../README.md) > [PartDesign](Category_PartDesign.md) > [Sketcher](Category_Sketcher.md) > Basic Part Design Tutorial/de
