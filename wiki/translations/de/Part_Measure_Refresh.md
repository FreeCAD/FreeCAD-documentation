...
- GuiCommand:/de
   ...
   MenuLocation:{{StdMenu|[Messen](Std_Measure_Menu/de.md)}} → Aktualisieren
...
1.  Aufrufen des Befehls auf verschiedene Weise:
    ...
    -   Verwende {{MenuCommand/de|{{StdMenu|<img src=images/Part_Measure_Refresh.svg style="width:Messen](Std_Measure_Menu/de.md)}} → [16px"> aktualisieren}}.
