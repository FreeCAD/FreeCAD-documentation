...
Dieser Arbeitsbereich kann über den [Addon-Manager](Std_AddonMgr/de.md) installiert werden.
...
-   [Arbeitsbereich Symbolbibliothek](Parts_Library_Workbench/de.md), [Arbeitsbereich Fasteners](Fasteners_Workbench/de.md), [Arbeitsbereich FCGear](FCGear_Workbench/de.md)
...
---
⏵ [documentation index](../README.md) > [Sandbox](Category_Sandbox.md) > [User Documentation](Category_User%20Documentation.md) > [Addons](Category_Addons.md) > [External Workbenches](Category_External%20Workbenches.md) > Symbols Library Workbench/de
