...
Es wird von der Gemeinschaft der FreeCAD Benutzer gepflegt und ist nicht Teil des FreeCAD Projekts, obwohl es mit dem Ziel erstellt wurde, in Zukunft als Repositorium für Teile von FreeCAD zu dienen.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Sandbox](Category_Sandbox.md) > [User Documentation](Category_User Documentation.md) > [Addons](Category_Addons.md) > [External Workbenches](Category_External Workbenches.md) > Symbols Library Workbench/de
