...
|Version=1.12
|Date=2014-03-05
|SeeAlso=[Macro FCInfo](Macro_FCInfo/de.md)
}}
...
Gibt eine Reihe von Informationen über die ausgewählte Form und kann eine Umwandlung von Länge, Neigung (Grad, Bogenmaß, Neigung, Fließvermögen), Form, Oberfläche, Volumen und Gewicht der Form in der ausgewählten Dichte in verschiedenen Mengeneinheiten, internationalen und angelsächsischen, anzeigen (nur für PyQt4).
