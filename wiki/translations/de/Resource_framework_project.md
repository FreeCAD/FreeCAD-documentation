...
Hierbei handelt es sich um ein Software Entwicklungsprojekt zur Implementierung von [Produkt Daten Management (PDM)](http://en.wikipedia.org/wiki/Product_Data_Management) Fähigkeiten. Es geht darum, die benötigten Bits und Stücke zu implementieren.

Die Entwicklungsschritte werden hier geplant und im Mantis Problemverfolgungssystem verfolgt, um ein wohlgeformtes Änderungs Protokoll zu erhalten: [1](http://www.freecadweb.org/tracker/change_log.php)

## Ergebnis

-   Revisionskontrolle für große Entwurfsprojekte.
-   Arbeit mit anderen über das Internet/Intranet(s) teilen: **Zusammenarbeit**
-   Online und Offline Kataloge mit [Normteilen](http://en.wikipedia.org/wiki/Interchangeable_parts).
...
Thad führt zu folgendem Szenario:
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Roadmap](Category_Roadmap.md) > Resource framework project/de
