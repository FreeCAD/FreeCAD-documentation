...
## Export-Methode 1: Benutzung von \"Datei → Exportieren\" {#export_methode_1_benutzung_von_datei_exportieren}
...
## Export-Methode 2: Benutzung des Mesh-Design-Arbeitsbereichs in FreeCAD {#export_methode_2_benutzung_des_mesh_design_arbeitsbereichs_in_freecad}
...
## Welche Methode sollte man wählen? {#welche_methode_sollte_man_wählen}
