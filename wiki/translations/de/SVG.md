...
FreeCAD kann SVG-Grafiken mit der Funktion [**Draft SVG**](Draft_SVG/de.md) aus dem Arbeitsbereich <img alt="" src=images/Workbench_Draft.svg  style="width:24px;"> [Draft](Draft_Workbench/de.md) lesen und exportieren. SVG-Dateien werden für viele Dinge verwendet, einschließlich Zeichnungselemente ([symbols](TechDraw_Symbol/de.md)) und Symbole ([icons](Artwork_Guidelines/de.md)) auf der grafischen Benutzeroberfläche und für Vorlagen ([templates](TechDraw_Templates/de.md)).
