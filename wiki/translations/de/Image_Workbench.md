...
Eine Hauptanwendung dieses Arbeitsbereichs ist das Nachzeichnen auf dem Bild mit Werkzeugen der Arbeitsbereiche [Draft](Draft_Workbench/de.md) oder [Sketcher](Sketcher_Workbench/de.md), um auf Basis der Konturen des Bildes einen Festkörper zu erzeugen.
...
---
⏵ [documentation index](../README.md) > [Obsolete Workbenches](Category_Obsolete%20Workbenches.md) > [Image](Category_Image.md) > Image Workbench/de
