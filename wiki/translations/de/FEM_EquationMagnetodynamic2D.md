...
- GuiCommand:
   ...
   Version:0.21
   SeeAlso:[FEM GleichungElektrodynamik2D](FEM_EquationMagnetodynamic/de.md)
---
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [FEM](Category_FEM.md) > FEM EquationMagnetodynamic2D/de
