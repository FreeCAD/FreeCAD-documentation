...
Das Werkzeug **<img src="images/CAM_Post.svg" width=16px> [Nachbereitung](CAM_Post/de.md)** exportiert den ausgewählten **<img src="images/CAM_Job.svg" width=16px> [CAM-Auftrag](CAM_Job/de.md)** in eine G-Code-Datei.
...
Wenn du einen eigenen Postprozessor schreiben möchtest, wirf einen Blick auf die Seite [CAM Postprozessor-Anpassung](CAM_Postprocessor_Customization/de.md).
...
1.  Einen <img alt="" src=images/CAM_Job.svg  style="width:16px;"> [CAM-Auftrag](CAM_Job.md) in der [Baumansicht](Tree_view/de.md) auswählen.
2.  Es gibt mehrere Möglichkeiten, den Befehl aufzurufen:
    -   Die Schaltfläche **<img src="images/CAM_Post.svg" width=16px> [Nachbearbeitung](CAM_Post/de.md)** drücken.
    -   Den Menüeintrag **CAM → <img src="images/CAM_Post.svg" width=16px> Nachbearbeitung** auswählen.
...
Die Eigenschaften der Ausgabedatei und des Postprozessors können jederzeit vor dem Aufruf des Postprozessors im [Auftrag](CAM_Job/de.md) eingestellt werden.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM Post/de
