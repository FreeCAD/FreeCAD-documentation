...
## Verschiedene Symbole {#verschiedene_symbole}

### FreeCAD Logo {#freecad_logo}

<img alt="" src=images/Freecad.svg  style="width:64px;">

### Arbeitsbereichssymbole, die im Wiki verwendet werden {#arbeitsbereichssymbole_die_im_wiki_verwendet_werden}
...
Siehe [Grafik Startbildschirm](Artwork_Splash_screen/de.md).

## Symbole nach ihrer Position im Quellcode {#symbole_nach_ihrer_position_im_quellcode}

### Aus src/Gui/ {#aus_srcgui}

Siehe [Grafik Gui](Artwork_Gui/de.md).

### Aus src/Mod/Arch/ {#aus_srcmodarch}

Siehe [Grafik Arch](Artwork_Arch/de.md).

### Aus src/Mod/Assembly/ {#aus_srcmodassembly}

Siehe [Grafik Zusammenbau](Artwork_Assembly/de.md).

### Aus src/Mod/Complete/ {#aus_srcmodcomplete}

Siehe [Grafik Vollständig](Artwork_Complete/de.md).

### Aus src/Mod/Draft/ {#aus_srcmoddraft}

Siehe [Grafik Entwurf](Artwork_Draft/de.md).

### Aus src/Mod/Drawing/ {#aus_srcmoddrawing}

Siehe [Grafik Zeichnung](Artwork_Drawing/de.md).

### Aus src/Mod/Fem/ {#aus_srcmodfem}

Siehe [Grafik FEM](Artwork_Fem/de.md).

### Aus src/Mod/Image/ {#aus_srcmodimage}

Siehe [Grafik Bild](Artwork_Image/de.md).

### Aus src/Mod/Inspection/ {#aus_srcmodinspection}

Siehe [Artwork Inspektion](Artwork_Inspection/de.md).

### Aus src/Mod/Material/ {#aus_srcmodmaterial}

Siehe [Grafik Material](Artwork_Material/de.md).

### Aus src/Mod/Mesh/ {#aus_srcmodmesh}

Siehe [Grafik Netz](Artwork_Mesh/de.md).

### Aus src/Mod/MeshPart/ {#aus_srcmodmeshpart}

Siehe [Grafik NetzPart](Artwork_MeshPart/de.md).

### Aus src/Mod/OpenSCAD/ {#aus_srcmodopenscad}

Siehe [Grafik OpenSCAD](Artwork_OpenSCAD/de.md).

### Aus src/Mod/Part/ {#aus_srcmodpart}

Siehe [Grafik Part](Artwork_Part/de.md).

### Aus src/Mod/PartDesign/ {#aus_srcmodpartdesign}

Siehe [Grafik PartDesign](Artwork_PartDesign.md).

### Aus src/Mod/Path/ {#aus_srcmodpath}

Siehe [Grafik Pfad](Artwork_Path/de.md).

### Aus src/Mod/Plot/ {#aus_srcmodplot}

Siehe [Grafik Plot](Artwork_Plot/de.md).

### Aus src/Mod/Points/ {#aus_srcmodpoints}

Siehe [Grafik Punkte](Artwork_Points/de.md).

### Aus src/Mod/Raytracing/ {#aus_srcmodraytracing}

Siehe [Grafik Strahlverfolgung](Artwork_Raytracing/de.md).

### Aus src/Mod/ReverseEngineering/ {#aus_srcmodreverseengineering}

Siehe [Grafik Nachkonstruktion](Artwork_ReverseEngineering/de.md).

### Aus src/Mod/Robot/ {#aus_srcmodrobot}

Siehe [Artwork Robot](Artwork_Robot.md).

### Aus src/Mod/Ship/ {#aus_srcmodship}

Siehe [Grafik Schiff](Artwork_Ship.md).

### Aus src/Mod/Sketcher/ {#aus_srcmodsketcher}

Siehe [Grafik Skizzierer](Artwork_Sketcher/de.md).

### Aus src/Mod/Spreadsheet/ {#aus_srcmodspreadsheet}

Siehe [Grafik Tabellenkalkulation](Artwork_Spreadsheet/de.md).

### Aus src/Mod/Start/ {#aus_srcmodstart}

Siehe [Grafik Start](Artwork_Start/de.md).

### Aus src/Mod/Surface/ {#aus_srcmodsurface}

Siehe [Grafik Oberfläche](Artwork_Surface/de.md).

### Aus src/Mod/TechDraw/ {#aus_srcmodtechdraw}

Siehe [Grafik TechDraw](Artwork_TechDraw/de.md).

### Aus src/Mod/Test/ {#aus_srcmodtest}

Siehe [Grafik Test](Artwork_Test/de.md).

### Aus src/Mod/Tux/ {#aus_srcmodtux}

Siehe [Grafik Tux](Artwork_Tux/de.md).

### Aus src/Mod/Web/ {#aus_srcmodweb}

Siehe [Grafik Web](Artwork_Web/de.md).

## Externe Arbeitsbereiche und Erweiterungen {#externe_arbeitsbereiche_und_erweiterungen}

### Aus Mod/Reinforcement/ {#aus_modreinforcement}

Siehe [Artwork Bewehrung](Artwork_Reinforcement/de.md).

## Fehlerhafte Symbole {#fehlerhafte_symbole}

Siehe [Grafik Fehlerhaft](Artwork_Erroneous/de.md).
