...
- GuiCommand:/de
   ...
   SeeAlso:[TechDraw Radiusbemaßung](TechDraw_RadiusDimension/de.md)
---
...
2.  Drücke die **<img src="images/TechDraw_DiameterDimension.svg" width=24px> [Durchmesserbemaßen](TechDraw_DiameterDimension/de.md)** Schaltfläche
...
Diese Funktion hat die gleichen Eigenschaften wie das [TechDraw Längenbemassungs](TechDraw_LengthDimension/de.md) Werkzeug. Siehe dieses Werkzeug für weitere Einzelheiten.
