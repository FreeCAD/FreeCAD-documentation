...
Dies ist der Projektplan für die FreeCAD FEM Integration im Rahmen der [Development roadmap/de](Development_roadmap/de.md).
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Roadmap](Category_Roadmap.md) > [FEM](Category_FEM.md) > FEM project/de
