...
|Description=Erzeugt einen Kreis aus 3 ausgewählten Punkten oder Formen
|Author=Mario52
|Version=1.0
|Date=2014-08-08
|FCVersion=All
...
<File:Macro> Draft Circle 3 Points02.png\|Kreis auf 3 Formularen (Vorderansicht), <File:Macro> Draft Circle 3 Points03.png\|orthogonal zur gewählten Form (rechte Ansicht) <File:Macro> Draft Circle 3 Points04.png\| <File:Macro> Draft Circle 3 Points05.png\|Drei Zuschauer orthogonale Kreise nach der gewählten Form.
...
Hier eine Anaglyphenansicht, die es Ihnen ermöglicht, zwei verschiedene Positionen der Ansicht zu sehen, indem Sie eine Brille mit roten und Cyan-Filtern verwenden <img alt="" src=images/_Anaglyph_Tango.png  style="width:24px;">.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > Macro Make Circle 3 Points/de
