...
Die Funktion PrüfeGeometrie prüft, ob die [Randdarstellung](https://en.wikipedia.org/wiki/Boundary_representation) korrekt ist. (BRep oder [B-rep](Glossar#B.md)) des Modells ist gültig. Zusätzlich zu dieser BRep Prüfung ist es möglich, eine zusätzliche BOP Prüfung (BOP= Boolesche OPerationen) durchzuführen.
