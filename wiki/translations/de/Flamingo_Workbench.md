...
Die [external workbenches](external_workbenches.md) Seite enthält einige Informationen und Tutorials zu einigen von ihnen, und das [FreeCAD Addons](https://github.com/FreeCAD/FreeCAD-addons) Projekt zielt darauf ab, sie zu sammeln und einfach aus FreeCAD heraus zu installieren.
...
---
⏵ [documentation index](../README.md) > [Addons](Category_Addons.md) > [External Workbenches](Category_External%20Workbenches.md) > Flamingo Workbench/de
