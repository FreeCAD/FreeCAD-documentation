...
An Stelle von Abmessungen werden Randbedingungen (auch Beschränkungen, Einschränkungen, Zwangsbedingung genannt) verwendet, um die Freiheitsgrade eines Objektes zu begrenzen. Beispielsweise besitzt eine Linie ohne Randbedingung 4 [Freiheitsgrade](#Degrees_Of_Freedom/de.md) (abgekürzt als \" DoF \")(engl. degree(s) of freedom)   * Sie kann horizontal oder vertikal verschoben, sie kann gestreckt, oder gedreht werden.
