# Part API/de
**(November 2018) Diese Information kann unvollständig und veraltet sein. Für die neueste API siehe die (engl.)  [https://www.freecadweb.org/api autogenerated API documentation] oder [https://freecad-python-stubs.readthedocs.io/en/latest/autoapi/Part/ autogenerated Python Part API documentation].**
...
---
⏵ [documentation index](../README.md) > [API](Category_API.md) > [Poweruser Documentation](Category_Poweruser%20Documentation.md) > [Part](Part_Workbench.md) > Part API/de
