---
 GuiCommand:
   ...
   MenuLocation: 
   Workbenches: Reinforcement_Workbench/de
   Version: 0.19
   SeeAlso: 
---
...
Das Werkzeug [Reinforcement Stückliste](Reinforcement_BillOfMaterial/de.md) ermöglicht dem Anwender eine Stückliste von Bewehrungsstäben zu erstellen.
...
1\. Select **<img src="images/Arch_Rebar.svg" width=16px> [Arch Rebar](Arch_Rebar.md)** and Rebar2 objects you want to include in the Bill Of Material. Or select **<img src="images/Arch_Structure.svg" width=16px> [Arch Structure](Arch_Structure.md)** objects to include **<img src="images/Arch_Rebar.svg" width=16px> [Arch Rebar](Arch_Rebar.md)** objects hosted by those into Bill Of Material. If nothing is selected, then Bill Of Material will be generated for all **<img src="images/Arch_Rebar.svg" width=16px> [Arch Rebar](Arch_Rebar.md)** and Rebar2 objects present in the model.

2\. Then select **<img src="images/Reinforcement_BillOfMaterial.svg" width=16px> [Rebar Bill Of Material](Reinforcement_BillOfMaterial.md)** from the rebar tools.
...
5\. To edit **<img src="images/Reinforcement_BillOfMaterial.svg" width=16px> [Rebar Bill Of Material](Reinforcement_BillOfMaterial.md)** SVG configurations, click on **Edit SVG Configurations**. A dialog box will pop-out as shown below.
...
6\. Modify **<img src="images/Reinforcement_BillOfMaterial.svg" width=16px> [Rebar Bill Of Material](Reinforcement_BillOfMaterial.md)** SVG configurations and then click on **OK** to apply changes.
...
The Reinforcement BillOfMaterial tool can be used in [macros](macros.md) and from the [Python](Python.md) console by using the following function:
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > Reinforcement BillOfMaterial/de
