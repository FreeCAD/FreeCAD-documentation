...
Die Bibliothek ist ein einfacher Behälter für FreeCAD- (.fcstd) und STEP- (.stp) Dateien. Du kannst sie überall herunterladen und ihre Dateien in deine FreeCAD-Projekte importieren. Innerhalb der Bibliothek befindet sich auch eine [Macro Bauteilbibliothek](Macro_PartsLibrary/de.md), die in FreeCADs Makro-Ordner abgelegt werden kann. Dieses Makro erstellt ein Browser-Fenster innerhalb von FreeCAD, aus dem du die Teile einfach per Doppelklick hinzufügen kannst.
...
-   Arbeitsbereich Wiki:
-   FreeCAD Wiki: [Macro Bauteilbibliothek](Macro_PartsLibrary/de.md)
...
-   [Makro BOLTS](Macro_BOLTS/de.md)
-   Arbeitsbereich [Fasteners](Fasteners_Workbench/de.md)
-   [Externe Arbeitsbereiche](External_workbenches/de.md)
-   [Makrorezepte](Macros_recipes/de.md)
-   [FreeCAD Herunterladen](Download/de.md)
-   [Portal der FreeCAD-Community](FreeCAD_Community_Portal/de.md)



---
![](images/Button_right.svg) [documentation index](../README.md) > [User Documentation](Category_User Documentation.md) > [Addons](Category_Addons.md) > [External Workbenches](Category_External Workbenches.md) > Parts Library Workbench/de
