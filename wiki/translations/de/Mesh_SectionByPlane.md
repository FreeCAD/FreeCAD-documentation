...
Der Befehl **Mesh SchnittMitEbene** erstellt einen Schnitt durch ein Netzobjekt (Querschnitt). Dieser Schnitt ist ein [Part Formelement](Part_Feature/de.md).
...
---
⏵ [documentation index](../README.md) > [Mesh](Mesh_Workbench.md) > Mesh SectionByPlane/de
