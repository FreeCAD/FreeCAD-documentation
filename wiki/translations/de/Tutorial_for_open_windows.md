...
13\. Wähle `Tür` und verändere die Eigenschaft **Symbol Elevation** auf `True`. Die Spitze des erzeugten Linienzuges zeigt an, nach welcher Seite sich die Tür öffnet; dies ist einfacher zu erkennen, wenn Du in die [Vorderansicht](Std_ViewFornt/de.md) wechselst. Verändere jetzt die Eigenschaft **Symbol Plan** auf `True`: ein Kreisbogen sollte nun anzeigen, nach welcher Seite die Tür aufschwingt; dies ist einfacher zu erkennen, wenn Du in die [Draufsicht](Std_ViewTop/de.md) wechselst.
