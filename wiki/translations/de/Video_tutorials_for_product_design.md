...
-   [Invent Box Tutorials playlists](https://www.youtube.com/channel/UCRQCzMftIUElX03kHjV4rmQ/playlists): viele Videos von verschiedenen Designprogrammen wie GIMP, Krita, Inkscape, Blender, KiCad und FreeCAD.
    -   [Lerne FreeCAD](https://www.youtube.com/watch?v=CG_czsNdUfs&list=PL2935W76vRNFvUGefQr3q9P9eezJZyj-u): FreeCAD 0.17, eine Reihe von 15 Videos von Invent Box Tutorials auf Englisch. Diese Serie stellt viele gängige Werkzeuge vor, die in den Arbeitsbereichen [PartDesign](PartDesign_Workbench/de.md) und [CAM](CAM_Workbench/de.md) eingesetzt werden, um ein für die Fertigung geeignetes Bauteil zu modellieren: Skizzen, Extrusion, Ausformung, Austragung, Spiegel, lineare und polare Muster, Boolesche Verknüpfungen, Wendel, Werkzeugbahnen, Taschenschneiden, Bohren, Gravieren, Nachbearbeitung und Schneiden.
