...
-   _. Es werden auch Dinge besprochen wie [Makros](macros/de.md), der [Arbeitsbereich Tabellenkalkulation](Spreadsheet_Workbench/de.md), und der [Arbeitsbereich Skizzierer](Sketcher_Workbench/de.md).
...
-   [Invent Box Tutorials playlists](https://www.youtube.com/channel/UCRQCzMftIUElX03kHjV4rmQ/playlists): viele Videos von verschiedenen Designprogrammen wie GIMP, Krita, Inkscape, Blender, KiCad und FreeCAD.
    -   _ und dem [Pfad Arbeitsbereich](Path_Workbench/de.md) um ein für die Fertigung geeignetes Teil zu modellieren: Skizzen, Extrusion, Ausformung, Austragung, Spiegel, lineare und polare Muster, Boolesche Operationen, Helix, Werkzeugwege, Taschenschneiden, Bohren, Gravieren, Nachbearbeitung und Schneiden.

-   _ verschiedene Objekte baut: eine gedrehte Vase, einen Verbindungsblock, eine Schachfigur und ein Hausschild.

-   _: austragen, ausformen, drehen, extrudieren, eine Kupplung, ein Trichter.
...
-   [Glasson Design Studio playlists](https://www.youtube.com/channel/UC-Nio4u1JhP7eUFeBtz7XFw/playlists): verschiedene Videos auf Englisch über Holzbearbeitung und Möbeldesign, einschließlich der Verwendung von FreeCAD.
    -   _, [Skizzierer](Sketcher_Workbench/de.md), [Tabellenkalkulation](Spreadsheet_Workbench/de.md), und [TechDraw](TechDraw_Workbench/de.md).
...
-   [flowwies corner playlists](https://www.youtube.com/user/stolz3d/playlists): viele Videos mit FreeCAD 0.18 und 0.19, einschließlich einführender Informationen und fortgeschrittener Tutorien. In deutscher Sprache.
    -   _ und die [PartDesign Arbeitsbereich](PartDesign_Workbench/de.md) zum Modellieren von Volumenkörpern.
    -   _, des [Tabellenkalkulation Arbeitsbereich](Spreadsheet_Workbench/de.md), sowie die Visualisierung mit Blender besprochen.
