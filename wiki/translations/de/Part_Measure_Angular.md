...
Dieser Befehl misst den Winkel zwischen zwei geraden Kanten, zwei ebenen Flächen oder einer geraden Kante und einer ebenen Fläche und zeigt das Maß in der [3D-Ansicht](3D_view/de.md) an.
...
2.  Es gibt mehrere Möglichkeiten, den Befehl aufzurufen:
    -   Die Schaltfläche **<img src="images/Part_Measure_Angular.svg" width=16px> [Winkel messen](Part_Measure_Angular/de.md)** drücken.
    -   Den Menüeintrag **Messen → <img src="images/Part_Measure_Angular.svg" width=16px> Winkel messen** auswählen
