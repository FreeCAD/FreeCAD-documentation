...
-   Verwende den Befehl [Std Import](Std_Import/de.md), um Excel ***.xlsx** Dateien zu importieren.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Spreadsheet](Spreadsheet_Workbench.md) > Spreadsheet Import/de
