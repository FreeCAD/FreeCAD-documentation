---
 GuiCommand:
   ...
   SeeAlso: Mesh_FillupHoles, Mesh_FillInteractiveHole
---
...
3.  There are several ways to invoke the command:
    -   Press the **<img src="images/Mesh_AddFacet.svg" width=16px> [Add triangle](Mesh_AddFacet.md)** button.
...
---
⏵ [documentation index](../README.md) > [Mesh](Mesh_Workbench.md) > Mesh AddFacet/de
