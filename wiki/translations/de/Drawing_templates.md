...
## SVG-Vorlagenerstellung {#svg_vorlagenerstellung}
...
## A3 Vorlagen {#a3_vorlagen}


<div class="mw-translate-fuzzy">

### A3 Klassisch: {#a3_klassisch}
...
### A3 Querformat englisch: {#a3_querformat_englisch}
...
## A4 Vorlagen {#a4_vorlagen}

### A4 Querformat englisch: {#a4_querformat_englisch}

<img alt="" src=images/A4_Landscape_english.svg  style="width:800px;">

### A4 Hochformat 1 englisch: {#a4_hochformat_1_englisch}

<img alt="" src=images/A4_Portrait_1_english.svg  style="width:400px;">

## US Letter Vorlagen {#us_letter_vorlagen}

### US Letter Querformat: {#us_letter_querformat}

<img alt="" src=images/US_Letter_landscape.svg  style="width:800px;">

### US Letter Hochformat: {#us_letter_hochformat}

<img alt="" src=images/US_Letter_portrait.svg  style="width:400px;">

### US Letter ds Querformat: {#us_letter_ds_querformat}

<img alt="" src=images/US_Letter_ds_Landscape.svg  style="width:800px;">

### US Legal ds Querformat: {#us_legal_ds_querformat}

<img alt="" src=images/US_Legal_ds_Landscape.svg  style="width:800px;">

### US Ledger ds Querformat: {#us_ledger_ds_querformat}
