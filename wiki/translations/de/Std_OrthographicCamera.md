...
![](images/Std_OrthographicCamera_example.svg ) *Zwei Würfel mit den gleichen Abmessungen in orthogonaler Ansicht*

## Anwendung

1.  Es gibt mehrere Möglichkeiten, den Befehl aufzurufen:
    -   Wähle die Option {{MenuCommand|Ansicht → <img src="images/Std_OrthographicCamera.svg" width=16px> Orthogonale Ansicht}} aus dem Menü.
