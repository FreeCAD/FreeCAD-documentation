...
2.  Es gibt mehrere Möglichkeiten, den Befehl aufzurufen:
    ...
    -   Die Menüoption **<img src="images/Std_ToggleVisibility.svg" width=16px> Ein/Ausblenden** im Kontextmenü der Baumansicht oder der 3d-Ansicht auswählen.
...
-   Die Ausführung dieses Befehls kann nur dann mit [Std Rückgängig](Std_Undo/de.md) rückgängig gemacht werden, wenn der [Fine-Tuning](Fine-tuning/de.md)-Parameter **AutoTransactionView** auf `True` gesetzt ist.
-   Die Sichtbarkeit eines Objekts kann auch durch seine zugehörige {{PropertyData/de|Visibility}} im [Eigenschafteneditor](Property_editor/de.md) geändert werden.
