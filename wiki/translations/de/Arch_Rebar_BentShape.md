...
Dieser Befehl ist Teil des [Reinforcement-Workbench](Reinforcement_Workbench/de.md)-Arbeitsbereichs, der mit dem ![](images/AddonManager.svg ) [Addon-Manager](Addon_Manager/de.md) über das Menü {{MenuCommand|Werkzeuge → Addon-Manager → Reinforcement}} installiert werden kann.
