...
Die Option <img alt="" src=images/Draft_Snap_Dimensions.svg  style="width:24px;"> **Draft EinrastenAufMaße** zeigt temporäre X- und Y-Maße an. Sie stellen die X- und Y- Abstände zwischen dem Mauszeiger und dem vorherigen Punkt im Koordinatensystem der [Arbeitsebene](Draft_SelectPlane/de.md) dar. Die Maße werden auf der [Arbeitsebene](Draft_SelectPlane/de.md) erstellt.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft Snap Dimensions/de
