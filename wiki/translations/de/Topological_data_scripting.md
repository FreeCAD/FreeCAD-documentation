...
Siehe die Seite [Part API](Part_API/de.md) oder diese [autogenerated Python Part API documentation](https://freecad-python-stubs.readthedocs.io/en/latest/autoapi/Part/) für eine vollständige Liste der verfügbaren Methoden des Arbeitsbereichs Part. 
...
---
⏵ [documentation index](../README.md) > [Developer Documentation](Category_Developer%20Documentation.md) > [Python Code](Category_Python%20Code.md) > Topological data scripting/de
