...
- GuiCommand:/de
   ...
   Name/de:Skizzierer ErzeugeViereck
   MenuLocation:Skizze → Skizzengeometrien → Erzeuge Viereck
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Sketcher](Sketcher_Workbench.md) > Sketcher CreateSquare/de
