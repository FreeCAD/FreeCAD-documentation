...
-   Wähle deine Formatseite
-   Die Schaltfläche **Symbole EU** oder US ändert die Bedeutung des Symbols für die Projektion. \"Wählen Sie Ihr Symbol aus\" wird standardmäßig angezeigt, und das aktive Symbol wird angezeigt. Klicken Sie auf die Schaltfläche und überprüfen Sie das Blattsymbol. Klicken Sie ein zweites Mal, um das Symbol zu ändern.
...
Mit der Schaltfläche **Apply** werden alle Felder der Patrone im Blatt gespeichert. Sie können mit der Schaltfläche **Memo** zu den ursprünglichen Daten zurückkehren (mit Ausnahme des regionalen Symbols, das unabhängig arbeitet und sofort wirksam ist).
...
Die Felder haben keine Längenbegrenzung, überprüfen Sie Ihre Kartusche.

Dieses Programm erstellt eine Zeichnung, die das regionale Projektionssymbol in Ihrem Projekt darstellt. Berühren Sie nicht, da es registriert ist und daher unsichtbar ist.

Wenn Sie möchten, dass die unkommentiert werden soll, kommentieren Sie die Kommentarzeilen und umgekehrt
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro CartoucheFC Full/de
