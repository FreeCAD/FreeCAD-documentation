...
Erfahrene Anwender haben die Möglichkeit, [Benutzeroberflächen zu erstellen](Interface_creation/de.md), die sie bei der Erstellung komplexer Werkzeuge für ihre benutzerdefinierten [Erweiterungen](Addon/de.md) (Addons) unterstützen, wie z.B. [Makros](Macros/de.md) oder vollständige [Arbeitsbereiche](Workbenches/de.md).

Benutzeroberflächen werden mit [PySide](PySide/de.md) erstellt, einer Bibliothek die die Verwendung von Qt mit [Python](Python/de.md) ermöglicht.
...
Beispiele für diese Methode befinden sich unter [Dialogerstellung](Dialog_creation/de.md).



---
⏵ [documentation index](../README.md) > [Developer Documentation](Category_Developer%20Documentation.md) > [Python Code](Category_Python%20Code.md) > Interface creation/de
