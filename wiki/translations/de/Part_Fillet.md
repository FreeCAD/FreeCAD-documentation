...
## Formteilverrundung VS. PartDesign Verrundung {#formteilverrundung_vs._partdesign_verrundung}
...
## Hinweise zur Anwendung der Teilverrundung {#hinweise_zur_anwendung_der_teilverrundung}
...
-   Verwende die {{MenuCommand|Part → Gemetrie prüfen}}, um auf Fehler in der Formgeometrie zu prüfen und zu korrigieren;
-   Verwende {{MenuCommand|Teil → Form verfeinern}}, um Artefakte zu entfernen, die durch frühere boolesche Operationen vor dem Verrundungsvorgang (und in einigen Fällen zwischen den Verrundungsvorgängen in Folge) verursacht wurden;
