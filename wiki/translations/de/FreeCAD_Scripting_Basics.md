...
Jetzt kannst du wirklich anfangen, mit FreeCAD zu spielen! Eine vollständige Liste der verfügbaren Module und ihrer Werkzeuge findest du im [Category   *API](   *Category_API.md) Abschnitt. {{Top}}
