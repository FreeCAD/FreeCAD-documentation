...
Wenn du dich im Befehlszeilenmodus befindest und keine GUI hast, wird in der letzten Zeile 
...
---
⏵ [documentation index](../README.md) > [Developer Documentation](Category_Developer%20Documentation.md) > [Python Code](Category_Python%20Code.md) > FreeCAD Scripting Basics/de
