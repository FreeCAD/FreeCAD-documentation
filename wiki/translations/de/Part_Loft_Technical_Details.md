...
## Stufen der Ausformungserstellung {#stufen_der_ausformungserstellung}
...
### Schritt 1. Erstellen der Segmentanzahl mit Profilübereinstimmung {#schritt_1._erstellen_der_segmentanzahl_mit_profilübereinstimmung}
...
### Schritt 2. Übereinstimmung zwischen den Segmenten herstellen {#schritt_2._übereinstimmung_zwischen_den_segmenten_herstellen}
...
### Schritt 3. Die Ausformungsoberfläche herstellen. {#schritt_3._die_ausformungsoberfläche_herstellen.}
...
## Das Wesentliche {#das_wesentliche}
...
## Zusätzliche Anmerkungen {#zusätzliche_anmerkungen}
