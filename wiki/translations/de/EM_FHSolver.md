---
 GuiCommand:
   ...
   Shortcut: **E** **X**
   Version: 0.17
   SeeAlso: EM FHInputFile, EM FHNode, EM FHSegment, EM FHPath, EM FHPlane, EM FHEquiv, EM FHPort
---
...
Das Objekt FHSolver kann in [Makros](Macros/de.md) und von der [Python](Python/de.md)-Konsole aus mit der folgenden Funktion verwendet werden:
...
---
⏵ [documentation index](../README.md) > [EM](Category_EM.md) > EM FHSolver/de
