...
Aber das wird trotzdem nicht funktionieren, da ein FreeCAD Befehl auf eine bestimmte Art und Weise formatiert werden muss, um zu funktionieren. Also müssen wir unser `line()` Werkzeug ein wenig umwandeln. Unser neues {{FileName|exercise.py}} Skript wird nun so aussehen:
