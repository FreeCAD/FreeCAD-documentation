# <img alt="Std Basis Symbol" src=images/Freecad.svg  style="width:64px;"> Std View Menu/de
...
-   <img alt="" src=images/Std_ViewCreate.svg  style="width:32px;"> [Neue Ansicht](Std_ViewCreate/de.md): Erstellt eine neue 3D-Ansicht.

-   <img alt="" src=images/Std_OrthographicCamera.svg  style="width:32px;"> [Orthogonale Ansicht](Std_OrthographicCamera/de.md): Wechselt in den orthogonalen Ansichtsmodus.

-   <img alt="" src=images/Std_PerspectiveCamera.svg  style="width:32px;"> [Perspektivische Ansicht](Std_PerspectiveCamera/de.md): Wechselt in den perspektivischen Ansichtsmodus.
...
-   Standardansichten
    -   <img alt="" src=images/Std_ViewFitAll.svg  style="width:32px;"> [Einpassen](Std_ViewFitAll/de.md): Passt alle sichtbaren Objekte in die Ansicht ein.
    ...
    -   <img alt="" src=images/Std_AlignToSelection.svg  style="width:32px;"> [Auf die Auswahl ausrichten](Std_AlignToSelection/de.md): Richtet die Ansicht zur Auswahl aus. {{Version/de|1.0}}
    -   Axonometrisch
    ...
    -   <img alt="" src=images/Std_ViewRotateLeft.svg  style="width:32px;"> [Nach links drehen](Std_ViewRotateLeft/de.md): Dreht die Ansicht nach links.
    -   <img alt="" src=images/Std_ViewRotateRight.svg  style="width:32px;"> [Nach rechts drehen](Std_ViewRotateRight/de.md): Dreht die Ansicht nach rechts.
...
-   [Ansicht einfrieren](Std_FreezeViews/de.md)
    -   [Ansichten speichern\...](Std_FreezeViews/de#Ansichten_speichern.md): Speichert eingefrorene Ansichten in einer Datei.
    -   [Ansichten laden\...](Std_FreezeViews/de#Ansichten_laden.md): Lädt eingefrorene Ansichten aus einer Datei.
...
-   Stereo
    -   <img alt="" src=images/Std_ViewIvStereoRedGreen.svg  style="width:32px;"> [Stereo rot/cyan](Std_ViewIvStereoRedGreen/de.md): Wechselt zur Stereo-Ansicht Rot/Cyan.
    -   <img alt="" src=images/Std_ViewIvStereoQuadBuff.svg  style="width:32px;"> [Stereo Vierfachpuffer](Std_ViewIvStereoQuadBuff/de.md): Wechselt zur Stereo-Ansicht Vierfachpuffer.
    -   <img alt="" src=images/Std_ViewIvStereoInterleavedRows.svg  style="width:32px;"> [Stereo Horizontales Interlacing](Std_ViewIvStereoInterleavedRows/de.md): Wechselt zur Stereo-Ansicht mit verschachtelten Zeilen.
    -   <img alt="" src=images/Std_ViewIvStereoInterleavedColumns.svg  style="width:32px;"> [Stereo Vertikales Interlacing](Std_ViewIvStereoInterleavedColumns/de.md): Wechselt zur Stereo-Ansicht mit verschachtelten Spalten.
    -   <img alt="" src=images/Std_ViewIvStereoOff.svg  style="width:32px;"> [Stereo aus](Std_ViewIvStereoOff/de.md): Schaltet die Stereo-Ansicht aus.
    -   <img alt="" src=images/Std_ViewIvIssueCamPos.svg  style="width:32px;"> [Kameraposition ausgeben](Std_ViewIvIssueCamPos/de.md): Gibt die Kameraeinstellungen im[Ausgabefenster](Report_view/de.md) und der [Python-Konsole](Python_console/de.md) aus.

-   Zoom
    -   <img alt="" src=images/Std_ViewZoomIn.svg  style="width:32px;"> [Vergrößern](Std_ViewZoomIn/de.md): Zoomt die Ansicht heran.
    -   <img alt="" src=images/Std_ViewZoomOut.svg  style="width:32px;"> [Verkleinern](Std_ViewZoomOut/de.md): Zoomt aus der Ansicht heraus.
    -   <img alt="" src=images/Std_ViewBoxZoom.svg  style="width:32px;"> [Zoomen mit Rechteck](Std_ViewBoxZoom/de.md): Vergrößert die Ansicht auf einen rechteckigen Bereich.

-   Dokumentfenster
    -   [Angedockt](Std_ViewDockUndockFullscreen/de#Angedockt.md): Dockt eine 3D-Ansicht an.
    -   [Abgedockt](Std_ViewDockUndockFullscreen/de#Abgedockt.md): Dockt eine 3D-Ansicht ab.
...
-   <img alt="" src=images/Std_AxisCross.svg  style="width:32px;"> [Achsenkreuz ein-/ausblenden](Std_AxisCross/de.md): Aktiviert/deaktiviert das Achsenkreuz.

-   <img alt="" src=images/Std_ToggleClipPlane.svg  style="width:32px;"> [Schnittebene](Std_ToggleClipPlane/de.md): Beschneidet Objekte zeitweise.

-   <img alt="" src=images/Part_SectionCut.svg  style="width:32px;"> [Dauerhafte Schnittdarstellung](Part_SectionCut/de.md): Erstellt dauerhafte Ausschnitte an objekten und Baugruppen. 
**-- Steht zur Verfügung, sobald einer der Arbeitsbereiche [Part](Part_Workbench/de.md) oder [PartDesign](PartDesign_Workbench/de.md) geladen wurde.**

-   <img alt="" src=images/Std_TextureMapping.svg  style="width:32px;"> [Texturabbildung\...](Std_TextureMapping/de.md): Bildet Texturen zetweise auf allen Objekten ab.

-   Sichtbarkeit
    -   <img alt="" src=images/Std_ToggleVisibility.svg  style="width:32px;"> [Ein-/ausblenden umschalten](Std_ToggleVisibility/de.md): Schaltet die Sichtbarkeit von ausgewählten Objekten um.
    -   <img alt="" src=images/Std_ShowSelection.svg  style="width:32px;"> [Auswahl einblenden](Std_ShowSelection/de.md): Blendet ausgewählte Objekte ein.
    ...
    -   <img alt="" src=images/Std_ToggleObjects.svg  style="width:32px;"> [Alle Objekte umschalten](Std_ToggleObjects/de.md): Schaltet die Sichtbarkeit aller Objekte um.
    -   <img alt="" src=images/Std_ShowObjects.svg  style="width:32px;"> [Alle Objekte anzeigen](Std_ShowObjects/de.md): Zeigt alle Objekte an.
    -   <img alt="" src=images/Std_HideObjects.svg  style="width:32px;"> [Alle Objekte ausblenden](Std_HideObjects/de.md): Blendet alle Objekte aus.
    -   <img alt="" src=images/Std_ToggleSelectability.svg  style="width:32px;"> [Auswählbarkeit umschalten](Std_ToggleSelectability/de.md): Schaltet die Auswählbarkeit von Objekten um.
...
-   <img alt="" src=images/Std_SetMaterial.svg  style="width:32px;"> [Material\...](Std_SetMaterial/de.md): Legt das Material von ausgewählten Objekten fest. **-- Steht zur Verfügung, wenn der Arbeitsbereich [Material](Material_Workbench/de.md) direkt geladen wurde oder indirekt (z.B. über den Arbeitsbereich [Part](Part_Workbench/de.md) oder [PartDesign](PartDesign_Workbench/de.md)).** {{Version/de|1.0}}

-   <img alt="" src=images/Std_SetAppearance.svg  style="width:32px;"> [Darstellung\...](Std_SetAppearance/de.md): Legt die Anzeigeeigenschaften von ausgewählten Objekten fest. 
**-- Steht zur Verfügung, wenn der Arbeitsbereich [Material](Material_Workbench/de.md) direkt geladen wurde oder indirekt (z.B. über den Arbeitsbereich [Part Workbench](Part_Workbench/de.md) oder [PartDesign](PartDesign_Workbench/de.md)).**

-   <img alt="" src=images/Std_RandomColor.svg  style="width:32px;"> [Zufällige Farbe](Std_RandomColor/de.md): Färbt Objekte mit einer zufällig gewählten Streulicht-Farbe ein.

-   <img alt="" src=images/Part_ColorPerFace.svg  style="width:32px;"> [Farbe pro Fläche](Part_ColorPerFace/de.md): Legt die Anzeigeeigenschaften von ausgewählten Flächen fest. 
**-- Steht zur Verfügung, wenn der Arbeitsbereich [Part](Part_Workbench/de.md) oder [PartDesign](PartDesign_Workbench.md) aktiviert wurde.**

-   <img alt="" src=images/Std_ToggleTransparency.svg  style="width:32px;"> [Transparenzmodus umschalten](Std_ToggleTransparency/de.md): Schaltet den Transparenzmodus für ausgewählte Objekte ein bzw. aus. {{Version/de|1.0}}

-   [Arbeitsbereich](Std_Workbench/de.md) **-- Einen Arbeitsbereich aus dem Untermenü auswählen.**

-   Symbolleisten **-- Jede Symbolleiste kann im Untermenü ein- oder ausgeschaltet werden.**
    -   Datei
    ...
    -   Makro
    -   Ansicht
    -   Individuelle Ansichten <small>(v1.0)</small> 
    -   Struktur
    -   Hilfe {{Version/de|0.21}}
    -   \... Wenn der aktuelle Arbeitsbereich Symbolleisten besitzt, werden sie hier angezeigt.
    -   [Symbolleisten sperren](Std_ToggleToolBarLock/de.md): Wenn aktiviert, können Symbolleisten nicht bewegt werden. {{Version/de|1.0}}

-   Fenster **-- Jedes Fenster kann im Untermenü ein- oder ausgeschaltet werden.**
    -   [Baumansicht](Tree_view.md) **-- Steht als eigenständiges Fenster zur Verfügung, wenn [Anzeige von Baumansicht und Eigenschaften-Ansicht](Preferences_Editor/de#Allgemein_2.md) auf {{Value|Eigenständig** gesetzt ist.}}
    -   [Eigenschafteneditor](Property_editor/de.md) **-- Wie vorher.**
    -   [Modell](Combo_view/del.md) **-- Steht zur Verfügung, wenn [Anzeige von Baumansicht und Eigenschaften-Ansicht](Preferences_Editor#Allgemein_2.md) auf {{Value|Kombiniert** gesetzt ist.}}
    -   [Auswahlansicht](Selection_view/de.md)
    -   [Python-Konsole](Python_console/de.md)
    -   [Ausgabefenster](Report_view/de.md)
    -   [Aufgaben-Fenster](Task_panel/de.md)
    -   [DAG-Ansicht](DAG_view/de.md) **-- Steht nicht standardmäßig zur Verfügung, siehe [DAG-Ansicht](DAG_view/de.md).**

-   Überlagerungsmodus angedockter Fenster {{Version/de|1.0}}
...
-   Aktionen in der Baumansicht
    -   [Sync-Ansicht](Std_TreeSyncView/de.md): Schaltet den SyncView-Modus der [Baumansicht](Tree_view/de.md) ein/aus.
    -   [Sync-Auswahl](Std_TreeSyncSelection/de.md): Schaltet den SyncSelection-Modus der Baumansicht ein/aus.
    -   [Sync-Platzierung](Std_TreeSyncPlacement/de.md): Schaltet den SyncPlacement-Modus der Baumansicht ein/aus.
    -   [Vorauswahl](Std_TreePreSelection/de.md): Schaltet den PreSelection-Modus der Baumansicht ein/aus.
    -   [Auswahl aufzeichnen](Std_TreeRecordSelection/de.md): Schaltet den RecordSelection-Modus der Baumansicht ein/aus.
    -   [Einzeldokment](Std_TreeSingleDocument/de.md): Schaltet die Baumansicht in den SingleDocument-Modus.
    -   [Mehrfachdokument](Std_TreeMultiDocument/de.md): Schaltet die Baumansicht in den MultiDocument-Modus.
    -   [Reduzieren/Erweitern](Std_TreeCollapseDocument/de.md): Schaltet die Baumansicht in den CollapseDocument-Modus.
