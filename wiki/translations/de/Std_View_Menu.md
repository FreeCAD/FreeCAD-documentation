...
-   <img alt="" src=images/Std_ViewCreate.svg  style="width:32px;"> [Neue Ansicht erstellen](Std_ViewCreate/de.md): erstellt eine neue 3D Ansicht.

-   <img alt="" src=images/Std_OrthographicCamera.svg  style="width:32px;"> [Orthogonale Ansicht](Std_OrthographicCamera/de.md): Wechselt in den orthografischen Ansichtsmodus.
...
-   Stereo
    ...
    -   <img alt="" src=images/Std_ViewIvStereoQuadBuff.svg  style="width:32px;"> [Stereo Vierfachpuffer](Std_ViewIvStereoQuadBuff/de.md): Schaltet auf Vierfachpuffer Stereoansicht um.
...
-   Zoom
    ...
    -   <img alt="" src=images/Std_ViewZoomOut.svg  style="width:32px;"> [Herauszoomen](Std_ViewZoomOut/de.md): Zoomt die Ansicht heraus.
    -   <img alt="" src=images/Std_ViewBoxZoom.svg  style="width:32px;"> [Bereichszoom](Std_ViewBoxZoom/de.md): Vergrößert die Ansicht auf einen rechteckigen Bereich.

-   Dokumentfenster
    -   [Angedockt\|Angedockt](Std_ViewDockUndockFullscreen/de#Docked.md): Dockt eine 3D Ansicht an.
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Std View Menu/de
