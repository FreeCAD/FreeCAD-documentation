...
-   <img alt="" src=images/Std_SaveAs.svg  style="width:32px;"> [Speichern unter\...](Std_SaveAs/de.md) Speichert das Dokument unter einem neuen Dateinamen.

-   <img alt="" src=images/Std_SaveCopy.svg  style="width:32px;"> [Speichern einer Kopie\...](Std_SaveCopy/de.md): Speichert eine Kopie des Dokuments unter einem neuen Dateinamen.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Std File Menu/de
