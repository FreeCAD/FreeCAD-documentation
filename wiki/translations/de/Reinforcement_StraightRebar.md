...
Das Werkzeug [Reinforcement GeradlinigeBewehrung](Reinforcement_StraightRebar/de.md) ermöglicht dem Anwender, einen Satz von geraden Bewehrungsstäben in einem [Arch Struktur](Arch_Structure/de.md)-Objekt zu erstellen.
...
2.  Dann **<img src="images/Reinforcement_StraightRebar.svg" width=16px> [Geradlinige Bewehrung](Reinforcement_StraightRebar/de.md)** aus den Armierungswerkzeugen auswählen.
...
Das Werkzeug Reinforcement GeradlinigeBewehrung kann in [Makros](Macros/de.md) und von der [Python](Python/de.md)-Konsole aus mit folgender Funktion verwendet werden:
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > [BIM](Category_BIM.md) > Reinforcement StraightRebar/de
