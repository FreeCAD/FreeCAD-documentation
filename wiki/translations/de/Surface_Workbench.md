...
-   <img alt="" src=images/Surface_Sections.svg  style="width   *32px;"> [Querschnitte](Surface_Sections/de.md)   * erstellt eine Oberfläche über Kanten, die Querschnitte einer Fläche repräsentieren. {{Version/de|0.19}}
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > [Surface](Category_Surface.md) > Surface Workbench/de
