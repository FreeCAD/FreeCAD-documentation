...
Der Befehl <img alt="" src=images/Assembly_New_Group.svg‎‎  style="width:24px;"> [Objekte gruppieren](Assembly3_GroupObjects/de.md) fügt einen neues (Unter-) **Gruppenordner**-Objekt zum Baugruppenast des Modellbaumes hinzu.
...
1.  Mehrere **Bedingungen**, mehrere **Elemente** oder mehrere **Part-Objekte** im Modellbaum auswählen
2.  Es gibt mehrere Möglichkeiten, den Befehl aufzurufen:
    -   Die Schaltfläche **<img src="images/Assembly_New_Group.svg‎‎" width=16px> [Objekte gruppieren](Assembly3_GroupObjects/de.md)** drücken.
    -   Den Menüeintrag **Assembly3 → <img src="images/Assembly_New_Group.svg‎‎" width=16px> Objekte gruppieren** auswählen.
    -   Das Tastaturkürzel **A** dann **Z**
