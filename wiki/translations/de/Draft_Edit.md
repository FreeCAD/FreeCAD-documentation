...
2.  Es gibt mehrere Möglichkeiten, den Befehl aufzurufen:
    ...
    -   Wähle die Option {{MenuCommand|Änderung → <img src="images/Draft_Edit.svg" width=16px> Bearbeiten}} aus dem Menü.
    -   Wähle die Option {{MenuCommand|Hilfsprogramme → <img src="images/Draft_Edit.svg" width=16px> Bearbeiten}} aus dem Menü.
...
### Knoten Aufgabenpaneel {#knoten_aufgabenpaneel}
...
-   Um Polarkoordinaten zu verwenden, gib einen Wert für die {{MenuCommand|Länge}} und einen Wert für den {{MenuCommand|Winkel}} ein, und drücke jeweils **Eingabe**.
-   Hake das {{MenuCommand|Winkel}} Kontrollkästchen, um den Zeiger auf den angegebenen Winkel zu beschränken.
-   Das {{MenuCommand|Relativ}} Kontrollkästchen hat bei diesem Befehl keine Bedeutung.
-   Drücke **G** oder klicke auf das {{MenuCommand|Global}} Kontrollkästchen, um den globalen Modus zu aktivieren. Wenn der globale Modus eingeschaltet ist, sind die Koordinaten relativ zum globalen Koordinatensystem, andernfalls sind sie relativ zur [Arbeitsebene](Draft_SelectPlane/de.md) des Koordinatensystems. {{Version/de|0.20}}
-   Das {{MenuCommand|Weiter}} Kontrollkästchen hat bei diesem Befehl keine Bedeutung.
...
## Unterstützte Objekte {#unterstützte_objekte}

### <img alt="" src=images/Draft_Line.svg  style="width:24px;"> [Entwurf Linie](Draft_Line/de.md) und <img alt="" src=images/Draft_Wire.svg  style="width:24px;"> [Entwurf Draht](Draft_Wire/de.md) {#draft_line.svg_entwurf_linie_und_draft_wire.svg_entwurf_draht}
...
### <img alt="" src=images/Draft_Arc.svg  style="width:24px;"> [Entwurf Bogen](Draft_Arc/de.md) und <img alt="" src=images/Draft_Arc_3Points.svg  style="width:24px;"> [Entwurf Bogen 3Punkte](Draft_Arc_3Points/de.md) {#draft_arc.svg_entwurf_bogen_und_draft_arc_3points.svg_entwurf_bogen_3punkte}
...
### <img alt="" src=images/Draft_Circle.svg  style="width:24px;"> [Entwurf Kreis](Draft_Circle/de.md) {#draft_circle.svg_entwurf_kreis}

-   Keine Kontextmenüs für dieses Objekt.

### <img alt="" src=images/Draft_Ellipse.svg  style="width:24px;"> [Entwurf Ellipse](Draft_Ellipse/de.md) {#draft_ellipse.svg_entwurf_ellipse}

-   Keine Kontextmenüs für dieses Objekt.

### <img alt="" src=images/Draft_Rectangle.svg  style="width:24px;"> [Entwurf Rechteck](Draft_Rectangle/de.md) {#draft_rectangle.svg_entwurf_rechteck}

-   Keine Kontextmenüs für dieses Objekt.

### <img alt="" src=images/Draft_Polygon.svg  style="width:24px;"> [Entwurf Polygon](Draft_Polygon/de.md) {#draft_polygon.svg_entwurf_polygon}

-   Keine Kontextmenüs für dieses Objekt.

### <img alt="" src=images/Draft_BSpline.svg  style="width:24px;"> [Entwurf BSpline](Draft_BSpline/de.md) {#draft_bspline.svg_entwurf_bspline}
...
### <img alt="" src=images/Draft_CubicBezCurve.svg  style="width:24px;"> [Entwurf KubischeBezKurve](Draft_CubicBezCurve/de.md) und <img alt="" src=images/Draft_BezCurve.svg  style="width:24px;"> [Entwurf BezKurve](Draft_BezCurve/de.md) {#draft_cubicbezcurve.svg_entwurf_kubischebezkurve_und_draft_bezcurve.svg_entwurf_bezkurve}
...
### <img alt="" src=images/Draft_Dimension.svg  style="width:24px;"> [Entwurf Bemaßen](Draft_Dimension/de.md) {#draft_dimension.svg_entwurf_bemaßen}
...
### <img alt="" src=images/Arch_Wall.svg  style="width:24px;"> [Architektur Wand](Arch_Wall/es.md) {#arch_wall.svg_architektur_wand}
...
### <img alt="" src=images/Sketcher_NewSketch.svg  style="width:24px;"> [Skizzierer Skizze](Sketcher_NewSketch/de.md) {#sketcher_newsketch.svg_skizzierer_skizze}
