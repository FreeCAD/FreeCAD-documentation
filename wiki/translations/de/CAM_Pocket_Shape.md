...
Das Werkzeug <img alt="" src=images/CAM_Pocket_Shape.svg  style="width:16px;"> [Taschenform](CAM_Pocket_Shape/de.md) erzeugt eine Taschenbearbeitung von ausgewählten Bodenflächen oder Wänden einer oder mehrerer Taschen des Basisobjekts des Auftrags.

Das Path-Pocket_Shape-Objekt ist dazu gedacht, Teil eines <img alt="" src=images/CAM_Job.svg  style="width:24px;"> [CAM-Auftrags](CAM_Job/de.md) zu sein.
...
2.  There are several ways to invoke the command:
    -   Press the **<img src="images/CAM_Pocket_Shape.svg" width=16px> [CAM Pocket Shape](CAM_Pocket_Shape.md)** button.
    -   Select the **CAM → <img src="images/CAM_Pocket_Shape.svg" width=16px> Pocket Shape** option from the menu.
...
---
⏵ [documentation index](../README.md) > [CAM](CAM_Workbench.md) > CAM Pocket Shape/de
