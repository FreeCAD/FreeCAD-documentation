...
2.  Es gibt verschiedene Möglichkeiten das Werkzeug aufzurufen:
    ...
    -   Auswahl des Menüeintrags **Fasteners → <img src="images/Fasteners_Shape.svg" width=16px> Simplify shape**.
...
---
![](images/Right_arrow.png) [documentation index](../README.md) > [External Command Reference](Category_External Command Reference.md) > [Fasteners](Category_Fasteners.md) > Fasteners Shape/de
