...
-   <img alt="" src=images/Std_DlgParameter.svg  style="width:32px;">[Parameter bearbeiten\...](Std_DlgParameter/de.md): Öffnet ein Dialogfeld mit Zugriff auf die Parameter, die das Programm steuern.

-   <img alt="" src=images/Std_ViewScreenShot.svg  style="width:32px;"> [Bild speichern\...](Std_ViewScreenShot/de.md): Speichert ein Bildschirmfoto der aktiven [3D-Ansicht](3D_view/de.md).
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Std Tools Menu/de
