...
|Description=Dieses Makro erstellt einen Würfel, indem 4 Punkte abgefragt werden
|Author=Yorik
|Version=2.0
|Date=2011-08-01
|FCVersion=<=0.11
...
Dieses Makro erstellt einen Würfel, indem 4 Punkte abgefragt werden
...
---
![](images/Button_right.svg) [documentation index](../README.md) > Macro Make Cube/de
