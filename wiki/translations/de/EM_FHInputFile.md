...
Das Werkzeug FHInputFile kann in [Makros](Macros/de.md) und von der [Python](Python/de.md)-Konsole aus mit der folgenden Funktion verwendet werden:
...
---
⏵ [documentation index](../README.md) > [EM](Category_EM.md) > EM FHInputFile/de
