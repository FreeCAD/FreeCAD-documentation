# LuxRender/de
**LuxRender wird nicht mehr weiterentwickelt, da das Projekt als [LuxCoreRender](LuxCoreRender/de.md) neu gestartet wurde, mit einem wesentlich umgeschriebenen Code und vielen inkompatiblen Änderungen. Diese Information wird hier vorgehalten, da FreeCAD noch immer (Version 0.19-24276) mit dem Arbeitsbereich [Raytracing](Raytracing_Workbench/de.md) ausgeliefert wird, der offiziell nur LuxRender unterstützt. Er scheint aber auch mit [LuxCoreRender](LuxCoreRender/de.md) zu funktionieren, daher sollte man ihn ausprobieren, bevor man LuxRender verwendet**
...
---
⏵ [documentation index](../README.md) > LuxRender/de
