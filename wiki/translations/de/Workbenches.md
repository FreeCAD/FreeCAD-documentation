...
-   <img alt="" src=images/Workbench_Surface.svg  style="width:32px;"> Der [Arbeitsbereich Surface](Surface_Workbench/de.md) (Oberfläche) bietet Werkzeuge zum Erstellen und Ändern von Oberflächen. Er ähnelt der Option *Fläche aus Kanten* des [Part Form-Generators](Part_Builder/de.md).
