...
Das **<img src=images/Draft_CircularArray.svg style="width:16px"> _ mit einem Polarwinkel von 360 Grad und die Schaffung mehrerer solcher konzentrischen Anordnungen.
...
Dieses Werkzeug kann für 2D Formen verwendet werden, die mit dem <img alt="" src=images/Workbench_Draft.svg  style="width:16px;"> _ oder <img alt="" src=images/Workbench_PartDesign.svg  style="width:16px;"> [PartDesign Arbeitsbereich](PartDesign_Workbench/de.md) erstellt wurden.
