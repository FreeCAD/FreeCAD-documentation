...
### <img alt="" src=images/Drawing-orthoviews.svg  style="width:32px;"> Arbeitsbereich Drawing 

Der [Arbeitsbereich Zeichnung](Drawing_Workbench/de.md) ist seit der FreeCAD-Version 0.17 veraltet. Stattdessen sollte der [Arbeitsbereich TechDraw](TechDraw_Workbench/de.md) verwendet werden.
...
Wenn der [Erweiterungsverwalter](Std_AddonMgr/de.md) nicht verwendet wird, kann das Makro manuell installiert werden.
