...
[Makros](Macros/de.md) sind relativ kleine Ausschnitte [Python Code](Python/de.md), die eine spezielle einfache oder komplexe Aufgabe ausführen, die im Basis FreeCAD System nicht verfügbar ist.
...
-   Das [Hauptanwenderzentrum](Power_users_hub/de.md) ist die Anlaufstelle, wenn du mehr über die fortgeschrittene Nutzung von FreeCAD sehen möchtest.
