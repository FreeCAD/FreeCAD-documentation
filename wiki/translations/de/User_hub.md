...
FreeCAD wird ständig weiterentwickelt, so dass es zu fehlenden oder veralteten Informationen kommen kann. Wenn du die Informationen, die du brauchst, nicht findest, zögere nicht, sie im [FreeCAD Forum](http://forum.freecadweb.org) zu erfragen.
...
-   <img alt="" src=images/Workbench_Arch.svg  style="width:32px;"> Der [Arbeitsbereich Architektur](Arch_Workbench/de.md) für die Arbeit mit architektonischen Elementen.

-   <img alt="" src=images/Workbench_Draft.svg  style="width:32px;"> Der [Arbeitsbereich Entwurf](Draft_Workbench/de.md) enthält 2D Werkzeuge und grundlegende 2D und 3D CAD Bearbeitungen.
...
-   <img alt="" src=images/Workbench_Image.svg  style="width:32px;"> Der [Arbeitsbereich Bild](Image_Workbench/de.md) für die Arbeit mit Bitmap Bildern.

-   <img alt="" src=images/Workbench_Inspection.svg  style="width:32px;"> Der [Arbeitsbereich Inspektion](Inspection_Workbench/de.md) bietet spezielle Werkzeuge für die Untersuchung von Formen. Er befindet sich noch in der Entwicklung.

-   <img alt="" src=images/Workbench_Mesh.svg  style="width:32px;"> Der [Arbeitsbereich Polygonnetz](Mesh_Workbench/de.md) für die Arbeit mit triangulierten Polygonnetzen.
...
-   <img alt="" src=images/Workbench_Path.svg  style="width:32px;"> Der [Arbeitsbereich Path](Path_Workbench/de.md) wird zur Erstellung von G-Code Anweisungen verwendet. Er befindet sich noch in der Entwicklung.

-   <img alt="" src=images/Workbench_Points.svg  style="width:32px;"> Der [Arbeitsbereich Punkte](Points_Workbench/de.md) für die Arbeit mit Punktwolken.
...
-   <img alt="" src=images/Workbench_Robot.svg  style="width:32px;"> Der [ Arbeitsbereich Roboter](Robot_Workbench/de.md) zur Untersuchung von Roboterbewegungen.

-   <img alt="" src=images/Workbench_Sketcher.svg  style="width:32px;"> Der [Arbeitsbereich Skizzierer](Sketcher_Workbench/de.md) für die Arbeit mit geometrie-beschränkten Skizzen.
...
-   <img alt="" src=images/Workbench_Test.svg  style="width:32px;"> Der [Arbeitsbereich Test Rahmenwerk](Testing/de.md) ist für die FreeCAD Fehlersuche.
...
Seit FreeCAD v0.17 können viele Makros mit Hilfe des [Erweiterungsverwalters](Std_AddonMgr/de.md) installiert werden. Eine Liste der Makros finden Sie auf der [Makro Rezepte](Macros_recipes/de.md)-Seite. Für eine manuelle Installation siehe [Wie Makros installiert werden](How_to_install_macros/de.md).
...
-   Verstehen Sie einen Begriff oder eine Beschreibung in FreeCAD nicht? Versuchen Sie die [Glossar](Glossary/de.md) Seite.
