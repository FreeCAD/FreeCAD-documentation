...
2.  Es gibt mehrere Wege, den Befehl aufzurufen:
    ...
    -   Wähle die {{MenuCommand|{{StdMenu|[Ansicht](Std_View_Menu/de.md)}}  → Standardansichten → <img src="images/Std_ViewFitSelection.png" width=16px>-Option einpassen}} aus dem Menü.
    -   Wähle die {{MenuCommand|<img src="images/Std_ViewFitSelection.svg" width=16px> Auswahl einpassen}}-Option aus dem [3D-Ansicht](3D_view/de.md)-Kontextmenü.
