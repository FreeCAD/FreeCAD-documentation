...
2.  Es gibt mehrere Wege, den Befehl aufzurufen:
    ...
    -   Wähle die {{MenuCommand|Netze → Analyse → <img src="images/Mesh_BoundingBox.svg" width=16px> Begrenzungsinfo...}}-Option aus dem Menü.
3.  Das {{MenuCommand|Begrenzungen}}-Dialogfeld öffnet sich, zeigt die Koordinaten der Begrenzungsrahmen des Objekts an.
