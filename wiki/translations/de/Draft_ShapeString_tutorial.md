...
4.  Hänge das `FormZeichenfolge` Objekt an eine der Flächen des Volumenkörpers oder an ein **[<img src=images/PartDesign_Plane.svg style="width:16px"> [PartDesign Ebene](PartDesign_Plane/de.md)**, unter Verwendung **[<img src=images/Part_Attachment.svg style="width:16px"> [/de|Part Bindung](Part_EditAttachment.md)**.
5.  Erstelle jetzt ein **[<img src=images/PartDesign_Pad.svg style="width:16px"> [PartDesign Polster](PartDesign_Pad/de.md)** oder ein **[<img src=images/PartDesign_Pocket.svg style="width:16px"> [PartDesign Tasche](PartDesign_Pocket/de.md)** aus der `Formzeichenfolge`, um eine additive bzw. subtraktive [Grundelement](PartDesign_Feature/de.md) des Grundkörpers zu erzeugen.
