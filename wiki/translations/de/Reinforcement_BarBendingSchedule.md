---
 GuiCommand:
   ...
   Name/de: Reinforcement Bewehrungsbiegeplan
   MenuLocation: 
...
# Reinforcement BarBendingSchedule/de



## Beschreibung

Das Werkzeug [Reinforcement Bewehrungsbiegeplan](Reinforcement_BarBendingSchedule/de.md) ermöglicht dem Anwender einen Bewehrungsbiegeplan aus Bewehrungsstäben abzuleiten.
...
---
⏵ [documentation index](../README.md) > [External_Command_Reference](Category_External_Command_Reference.md) > [Reinforcement](Category_Reinforcement.md) > Reinforcement BarBendingSchedule/de
