...
1.  Es gibt mehrere Möglichkeiten den Befehl aufzurufen:
    -   Die Schaltfläche **<img src="images/FEM_ConstraintContact.svg" width=16px> [Randbedingung Flächenkontakt](FEM_ConstraintContact/de.md)** drücken.
    -   Den Menüeintrag **Modell → Mechanische Randbedingungen → <img src="images/FEM_ConstraintContact.svg" width=16px> Randbedingung Flächenkontakt** auswählen.
