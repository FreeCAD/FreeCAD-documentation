# FreeCAD API/de
 ...
 {{VeryImportantMessage|(October 2019) Diese Seite nicht bearbeiten. Die Informationen sind unvollständig und veraltet. Die neueste API findest du in der [https://www.freecadweb.org/api autogenerated API documentation], oder du generierst die Dokumentation selbst, siehe [Quelldokumentation](Source_documentation/de.md).}}
