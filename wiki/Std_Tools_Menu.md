# <img alt="Std Base icon" src=images/Freecad.svg  style="width:64px;"> Std Tools Menu
...
---
⏵ [documentation index](../README.md) > [Workbenches](Category_Workbenches.md) > Std Tools Menu
