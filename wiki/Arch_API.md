...
#### <img src="images/Arrow-right.svg" style="width:16px;"> cutComponentwithPlane <small>(baseObj, cutterShp=None, side=0)</small>
...
#### <img src="images/Arrow-right.svg" style="width:16px;"> getSVG <small>(source, renderMode='Wireframe', allOn=False, showHidden=False, scale=1, rotation=0, linewidth=1, lineColor=(0.0, 0.0, 0.0), fontsize=1, linespacing=None, showFill=False, fillColor=(1.0, 1.0, 1.0), techdraw=False, fillSpaces=False, cutlinewidth=0, joinArch=False)</small>
