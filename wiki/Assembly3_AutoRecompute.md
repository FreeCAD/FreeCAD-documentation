...
1.  Activate the <img alt="" src=images/Assembly_AutoRecompute.svg  style="width:16px;"> **Auto recompute** command using one of the following:
    -   The **<img src="images/Assembly_AutoRecompute.svg_" width=16px> [Auto recompute](Assembly3_AutoRecompute.md)** button.
    -   The **Assembly3 → <img src="images/Assembly_AutoRecompute.svg_" width=16px> Auto recompute** menu option.
