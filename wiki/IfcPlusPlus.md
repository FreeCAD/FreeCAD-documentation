...
If this is the case, it may be enough to update the cache of the  
```python
sudo ldconfig
```
...
---
![](images/Button_right.svg) [documentation index](../README.md) > [Arch](Category_Arch.md) > [FEM](Category_FEM.md) > IfcPlusPlus
