...
The <img alt="" src=images/SheetMetal_Relief.svg  style="width:16px;"> [Make Relief](SheetMetal_AddRelief.md) command starts the **first** of three steps to convert a shell object made with tools of the Part or PartDesign workbench into an unfoldable SheetMetal object.

All edges where faces meet need to be separate; that\'s why the corners have to be cut off.

These cut-offs resemble corner reliefs, thus the naming Make Relief.
...
---
[documentation index](../README.md) > [SheetMetal](Category_SheetMetal.md) > SheetMetal AddRelief
