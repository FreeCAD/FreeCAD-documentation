...
You may define any new style by adding the necessary information to a key that starts with  
```python
import json
...
---
[documentation index](../README.md) > [Draft](Draft_Workbench.md) > Draft AnnotationStyleEditor
