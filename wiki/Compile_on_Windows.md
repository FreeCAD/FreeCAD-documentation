...
Here is a description of some of these variables:
  ...
  FREECAD\_USE\_MP\_COMPILE\_FLAG          Adds the /MP (multiprocessor) option to the Visual Studio projects, enabling speedups on multi-core CPUs. This can greatly accelerate builds on modern processors.**Note:** If you turned off **FREECAD\_USE\_PCH**, the compilation can quickly overload your heap space, even when you have 16 GB RAM.                                                                                                                                                                                                                                             OFF
